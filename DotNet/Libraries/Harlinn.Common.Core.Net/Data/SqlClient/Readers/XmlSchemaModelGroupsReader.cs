...
public class XmlSchemaModelGroupsReader : DataReaderWrapper
{
    public const string QualifiedTableName = "[sys].[xml_schema_model_groups]";
    public const string TableName = "xml_schema_model_groups";
    public const string ShortName = "xsmg";
    ...
    public const int COMPOSITOR_FIELD_ID = 13;
    public const int COMPOSITORDESC_FIELD_ID = 14;


    public XmlSchemaModelGroupsReader([DisallowNull] ILoggerFactory loggerFactory, [DisallowNull] SqlDataReader sqlDataReader, bool ownsReader = true)
        : base(loggerFactory, sqlDataReader, ownsReader)
    {
    }

    public XmlSchemaModelGroupsReader([DisallowNull] SqlDataReader sqlDataReader, bool ownsReader = true)
        : base(sqlDataReader, ownsReader)
    {
    }

    public XmlSchemaModelGroupsReader([DisallowNull] ILogger logger, [DisallowNull] SqlDataReader sqlDataReader, bool ownsReader = true)
    ...
    public string Compositor
    {
        get
        {
            return base.GetString(COMPOSITOR_FIELD_ID);
        }
    }

    public string? CompositorDesc
    {
        get
        {
            return base.GetNullableString(COMPOSITORDESC_FIELD_ID);
        }
    }
