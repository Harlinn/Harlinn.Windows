...
public class EventNotificationsReader : DataReaderWrapper
{
    public const string QualifiedTableName = "[sys].[event_notifications]";
    public const string TableName = "event_notifications";
    public const string ShortName = "en";
    ...
    public EventNotificationsReader([DisallowNull] ILoggerFactory loggerFactory, [DisallowNull] SqlDataReader sqlDataReader, bool ownsReader = true)
        : base(loggerFactory, sqlDataReader, ownsReader)
    {
    }

    public EventNotificationsReader([DisallowNull] SqlDataReader sqlDataReader, bool ownsReader = true)
        : base(sqlDataReader, ownsReader)
    {
    }

    public EventNotificationsReader([DisallowNull] ILogger logger, [DisallowNull] SqlDataReader sqlDataReader, bool ownsReader = true)
    ...
    public Types.EventNotificationsDataType ToDataObject()
    {
        return new Types.EventNotificationsDataType(Name,
            ObjectId,
            ParentClass,
            ParentClassDesc,
            ParentId,
    ...
    public List<Types.EventNotificationsDataType> ToList()
    {
        var list = new List<Types.EventNotificationsDataType>();
        while (Read())
        {
