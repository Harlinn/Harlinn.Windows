...
public class TcpEndpointsReader : DataReaderWrapper
{
    public const string QualifiedTableName = "[sys].[tcp_endpoints]";
    public const string TableName = "tcp_endpoints";
    public const string ShortName = "te1";
    ...
    public const int PORT_FIELD_ID = 10;
    public const int ISDYNAMICPORT_FIELD_ID = 11;
    public const int IPADDRESS_FIELD_ID = 12;


    public TcpEndpointsReader([DisallowNull] ILoggerFactory loggerFactory, [DisallowNull] SqlDataReader sqlDataReader, bool ownsReader = true)
        : base(loggerFactory, sqlDataReader, ownsReader)
    {
    }

    public TcpEndpointsReader([DisallowNull] SqlDataReader sqlDataReader, bool ownsReader = true)
        : base(sqlDataReader, ownsReader)
    {
    }

    public TcpEndpointsReader([DisallowNull] ILogger logger, [DisallowNull] SqlDataReader sqlDataReader, bool ownsReader = true)
    ...
    public bool IsDynamicPort
    {
        get
        {
            return base.GetBoolean(ISDYNAMICPORT_FIELD_ID);
        }
    }
    ...
    public Types.TcpEndpointsDataType ToDataObject()
    {
        return new Types.TcpEndpointsDataType(Name,
            EndpointId,
            PrincipalId,
            Protocol,
            ProtocolDesc,
    ...
    public List<Types.TcpEndpointsDataType> ToList()
    {
        var list = new List<Types.TcpEndpointsDataType>();
        while (Read())
        {
