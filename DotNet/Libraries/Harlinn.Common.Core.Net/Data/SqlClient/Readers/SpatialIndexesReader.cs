...
public class SpatialIndexesReader : DataReaderWrapper
{
    public const string QualifiedTableName = "[sys].[spatial_indexes]";
    public const string TableName = "spatial_indexes";
    public const string ShortName = "si";
    ...
    public const int SPATIALINDEXTYPE_FIELD_ID = 17;
    public const int SPATIALINDEXTYPEDESC_FIELD_ID = 18;
    public const int TESSELLATIONSCHEME_FIELD_ID = 19;
    public const int HASFILTER_FIELD_ID = 20;
    public const int FILTERDEFINITION_FIELD_ID = 21;
    public const int AUTOCREATED_FIELD_ID = 22;


    public SpatialIndexesReader([DisallowNull] ILoggerFactory loggerFactory, [DisallowNull] SqlDataReader sqlDataReader, bool ownsReader = true)
        : base(loggerFactory, sqlDataReader, ownsReader)
    {
    }

    public SpatialIndexesReader([DisallowNull] SqlDataReader sqlDataReader, bool ownsReader = true)
        : base(sqlDataReader, ownsReader)
    {
    }

    public SpatialIndexesReader([DisallowNull] ILogger logger, [DisallowNull] SqlDataReader sqlDataReader, bool ownsReader = true)
    ...
    public int SpatialIndexType
    {
        get
        {
            return base.GetInt32(SPATIALINDEXTYPE_FIELD_ID);
        }
    }
    ...
    public string? SpatialIndexTypeDesc
    {
        get
        {
            return base.GetNullableString(SPATIALINDEXTYPEDESC_FIELD_ID);
        }
    }
    ...
    public Types.SpatialIndexesDataType ToDataObject()
    {
        return new Types.SpatialIndexesDataType(ObjectId,
            Name,
            IndexId,
            Type,
            TypeDesc,
    ...
    public List<Types.SpatialIndexesDataType> ToList()
    {
        var list = new List<Types.SpatialIndexesDataType>();
        while (Read())
        {
