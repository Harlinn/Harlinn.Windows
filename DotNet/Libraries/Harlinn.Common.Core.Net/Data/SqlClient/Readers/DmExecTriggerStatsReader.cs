...
public class DmExecTriggerStatsReader : DataReaderWrapper
{
    public const string QualifiedTableName = "[sys].[dm_exec_trigger_stats]";
    public const string TableName = "dm_exec_trigger_stats";
    public const string ShortName = "dets";
    ...
    public DmExecTriggerStatsReader([DisallowNull] ILoggerFactory loggerFactory, [DisallowNull] SqlDataReader sqlDataReader, bool ownsReader = true)
        : base(loggerFactory, sqlDataReader, ownsReader)
    {
    }

    public DmExecTriggerStatsReader([DisallowNull] SqlDataReader sqlDataReader, bool ownsReader = true)
        : base(sqlDataReader, ownsReader)
    {
    }

    public DmExecTriggerStatsReader([DisallowNull] ILogger logger, [DisallowNull] SqlDataReader sqlDataReader, bool ownsReader = true)
    ...
    public Types.DmExecTriggerStatsDataType ToDataObject()
    {
        return new Types.DmExecTriggerStatsDataType(DatabaseId,
            ObjectId,
            Type,
            TypeDesc,
            SqlHandle,
    ...
    public List<Types.DmExecTriggerStatsDataType> ToList()
    {
        var list = new List<Types.DmExecTriggerStatsDataType>();
        while (Read())
        {
