...
public class DmDbSessionSpaceUsageDataType
{
    ...
    readonly long? _userObjectsDeferredDeallocPageCount;

    public DmDbSessionSpaceUsageDataType( )
    {
    }

    public DmDbSessionSpaceUsageDataType(short? sessionId,
        int? databaseId,
        ...
        long? userObjectsDeferredDeallocPageCount)
    {
        ...
        _userObjectsDeferredDeallocPageCount = userObjectsDeferredDeallocPageCount;
    }
    ...
    public long? UserObjectsDeferredDeallocPageCount => _userObjectsDeferredDeallocPageCount;
}
