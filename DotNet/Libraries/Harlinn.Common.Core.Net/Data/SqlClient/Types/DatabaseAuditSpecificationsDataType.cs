...
public class DatabaseAuditSpecificationsDataType
{
    ...
    public DatabaseAuditSpecificationsDataType( )
    {
    }

    public DatabaseAuditSpecificationsDataType(int databaseSpecificationId,
        string name,
        DateTime createDate,
        DateTime modifyDate,
        Guid? auditGuid,
