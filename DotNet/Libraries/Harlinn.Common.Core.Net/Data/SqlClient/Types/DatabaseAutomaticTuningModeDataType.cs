...
public class DatabaseAutomaticTuningModeDataType
{
    ...
    public DatabaseAutomaticTuningModeDataType( )
    {
    }

    public DatabaseAutomaticTuningModeDataType(short? desiredState,
