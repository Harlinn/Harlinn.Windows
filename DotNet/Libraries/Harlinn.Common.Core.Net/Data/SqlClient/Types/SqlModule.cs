...
namespace Harlinn.Common.Core.Net.Data.SqlClient.Types
{
    public class SqlModule
    {
        ...
        public SqlModule(int objectId, string definition, bool usesAnsiNulls, bool usesQuotedIdentifier, bool isSchemaBound, bool usesDatabaseCollation, bool isRecompiled, bool nullOnNullInput, int? executeAsPrincipalId, bool usesNativeCompilation, bool inlineType)
        {
            _objectId = objectId;
