...
public class AvailabilityGroupsDataType
{
    ...
    readonly bool? _basicFeatures;
    readonly bool? _dtcSupport;
    readonly bool? _dbFailover;
    readonly bool? _isDistributed;
    readonly byte? _clusterType;
    readonly string? _clusterTypeDesc;
    readonly int? _requiredSynchronizedSecondariesToCommit;
    readonly long? _sequenceNumber;
    readonly bool? _isContained;

    public AvailabilityGroupsDataType( )
    {
    }

    public AvailabilityGroupsDataType(Guid groupId,
        string? name,
        string? resourceId,
        ...
        bool? isContained)
    {
        ...
        _version = version;
        _basicFeatures = basicFeatures;
        _dtcSupport = dtcSupport;
        _dbFailover = dbFailover;
        _isDistributed = isDistributed;
        _clusterType = clusterType;
        _clusterTypeDesc = clusterTypeDesc;
        _requiredSynchronizedSecondariesToCommit = requiredSynchronizedSecondariesToCommit;
    ...
    public bool? BasicFeatures => _basicFeatures;
    public bool? DtcSupport => _dtcSupport;
    public bool? DbFailover => _dbFailover;
    public bool? IsDistributed => _isDistributed;
    public byte? ClusterType => _clusterType;
    public string? ClusterTypeDesc => _clusterTypeDesc;
    public int? RequiredSynchronizedSecondariesToCommit => _requiredSynchronizedSecondariesToCommit;
    public long? SequenceNumber => _sequenceNumber;
    public bool? IsContained => _isContained;
}
