...
public class DmResourceGovernorExternalResourcePoolAffinityDataType
{
    readonly int _externalPoolId = 0;
    readonly short _processorGroup = 0;
    readonly long _cpuMask = 0;

    public DmResourceGovernorExternalResourcePoolAffinityDataType( )
    {
    }

    public DmResourceGovernorExternalResourcePoolAffinityDataType(int externalPoolId,
