...
public class DmDbRdaMigrationStatusDataType
{
    readonly int? _tableId;
    readonly int? _databaseId;
    readonly long? _migratedRows;
    ...
    public DmDbRdaMigrationStatusDataType( )
    {
    }

    public DmDbRdaMigrationStatusDataType(int? tableId,
        int? databaseId,
        long? migratedRows,
    ...
    public long? MigratedRows => _migratedRows;
