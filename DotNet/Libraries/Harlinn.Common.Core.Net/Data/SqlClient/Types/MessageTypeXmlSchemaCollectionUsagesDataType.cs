...
public class MessageTypeXmlSchemaCollectionUsagesDataType
{
    readonly int _messageTypeId = 0;
    readonly int _xmlCollectionId = 0;

    public MessageTypeXmlSchemaCollectionUsagesDataType( )
    {
    }

    public MessageTypeXmlSchemaCollectionUsagesDataType(int messageTypeId,
        int xmlCollectionId)
    {
