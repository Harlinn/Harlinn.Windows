...
public class SqlLoginsDataType
{
    ...
    readonly bool? _isPolicyChecked;
    readonly bool? _isExpirationChecked;
    readonly byte[]? _passwordHash;

    public SqlLoginsDataType( )
    {
    }

    public SqlLoginsDataType(string name,
        int principalId,
        byte[]? sid,
        string type,
        string? typeDesc,
        ...
        byte[]? passwordHash)
    {
        ...
        _isPolicyChecked = isPolicyChecked;
        _isExpirationChecked = isExpirationChecked;
    ...
    public bool? IsPolicyChecked => _isPolicyChecked;
    public bool? IsExpirationChecked => _isExpirationChecked;
