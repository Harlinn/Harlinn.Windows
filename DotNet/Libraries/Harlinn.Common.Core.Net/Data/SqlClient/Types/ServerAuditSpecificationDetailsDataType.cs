...
public class ServerAuditSpecificationDetailsDataType
{
    ...
    public ServerAuditSpecificationDetailsDataType( )
    {
    }

    public ServerAuditSpecificationDetailsDataType(int serverSpecificationId,
