...
public class TcpEndpointsDataType
{
    ...
    readonly bool _isDynamicPort = false;
    readonly string? _ipAddress;

    public TcpEndpointsDataType( )
    {
    }

    public TcpEndpointsDataType(string name,
        int endpointId,
        int? principalId,
        byte protocol,
        string? protocolDesc,
    ...
    public bool IsDynamicPort => _isDynamicPort;
