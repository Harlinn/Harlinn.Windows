...
public class DatabaseAutomaticTuningOptionsDataType
{
    readonly string? _name;
    readonly short? _desiredState;
    readonly string? _desiredStateDesc;
    readonly short? _actualState;
    readonly string? _actualStateDesc;
    readonly short? _reason;
    readonly string? _reasonDesc;

    public DatabaseAutomaticTuningOptionsDataType( )
    {
    }

    public DatabaseAutomaticTuningOptionsDataType(string? name,
        short? desiredState,
    ...
    public short? Reason => _reason;
    public string? ReasonDesc => _reasonDesc;
}
