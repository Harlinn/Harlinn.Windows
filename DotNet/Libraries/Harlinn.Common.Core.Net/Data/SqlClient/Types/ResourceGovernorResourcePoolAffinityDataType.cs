...
public class ResourceGovernorResourcePoolAffinityDataType
{
    readonly int _poolId = 0;
    readonly short _processorGroup = 0;
    readonly long _schedulerMask = 0;

    public ResourceGovernorResourcePoolAffinityDataType( )
    {
    }

    public ResourceGovernorResourcePoolAffinityDataType(int poolId,
