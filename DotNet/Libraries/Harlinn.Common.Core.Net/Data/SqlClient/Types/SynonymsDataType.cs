...
public class SynonymsDataType
{
    ...
    readonly string? _baseObjectName;

    public SynonymsDataType( )
    {
    }

    public SynonymsDataType(string name,
        int objectId,
        int? principalId,
        int schemaId,
        int parentObjectId,
    ...
    public string? BaseObjectName => _baseObjectName;
}
