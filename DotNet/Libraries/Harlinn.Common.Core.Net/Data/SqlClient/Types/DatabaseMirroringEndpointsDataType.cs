...
public class DatabaseMirroringEndpointsDataType
{
    ...
    readonly bool _isEncryptionEnabled = false;
    ...
    public DatabaseMirroringEndpointsDataType( )
    {
    }

    public DatabaseMirroringEndpointsDataType(string name,
        int endpointId,
        int? principalId,
        byte protocol,
        string? protocolDesc,
