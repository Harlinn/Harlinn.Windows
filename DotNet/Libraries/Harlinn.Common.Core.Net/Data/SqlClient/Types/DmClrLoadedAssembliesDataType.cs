...
public class DmClrLoadedAssembliesDataType
{
    readonly int? _assemblyId;
    readonly byte[]? _appdomainAddress;
    readonly DateTime? _loadTime;

    public DmClrLoadedAssembliesDataType( )
    {
    }

    public DmClrLoadedAssembliesDataType(int? assemblyId,
