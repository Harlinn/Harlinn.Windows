...
namespace Barrelman.Data.Types
{
    ...
    public enum Kind : int
    {
        Unknown = 0,
        AircraftType = 10000,
        AisDeviceCommand = 10100,
        AisDeviceCommandReply = 10200,
        AisDeviceConfiguration = 10300,
        AisDeviceRawMessage = 10400,
        AisDeviceRawSentence = 10500,
        AisMessage = 10600,
        AidToNavigationReportMessage = 10700,
        AisAddressedSafetyRelatedMessage = 10800,
        AisBaseStationReportMessage = 10900,
        AisBinaryAcknowledgeMessage = 11000,
        AisBinaryAddressedMessage = 11100,
        AisBinaryBroadcastMessage = 11200,
        AisDataLinkManagementMessage = 11300,
        AisExtendedClassBCsPositionReportMessage = 11400,
        AisInterrogationMessage = 11500,
        AisPositionReportClassAMessageBase = 11600,
        AisPositionReportClassAAssignedScheduleMessage = 11700,
        AisPositionReportClassAMessage = 11800,
        AisPositionReportClassAResponseToInterrogationMessage = 11900,
        AisPositionReportForLongRangeApplicationsMessage = 12000,
        AisSafetyRelatedAcknowledgmentMessage = 12100,
        AisStandardClassBCsPositionReportMessage = 12200,
        AisStandardSarAircraftPositionReportMessage = 12300,
        AisStaticAndVoyageRelatedDataMessage = 12400,
        AisStaticDataReportMessage = 12500,
        AisStaticDataReportPartAMessage = 12600,
        AisStaticDataReportPartBMessage = 12700,
        AisUtcAndDateInquiryMessage = 12800,
        AisUtcAndDateResponseMessage = 12900,
        ...
        OilSpillDetectorDevice = 19500,
        RadioDevice = 19600,
        RadomeDevice = 19700,
        TrackerDevice = 19800,
        AisDevice = 19900,
        RadarDevice = 20000,
        WeatherStationDevice = 20100,
        Facility = 20200,
        TrackableItem = 20300,
        Aircraft = 20400,
    ...
    public enum AisDeviceConnectionType : int
    {
        Unknown = 0,
        TCP = 1,
        UDP = 2,
    ...
    public enum CameraControlProtocol : int
    {
        Unknown = 0,
        ONVIF = 1
    }
    ...
    [Flags()]
    public enum CameraFeatures : int
    {
        None = 0,
        ColorMode = 1,
        Washer = 2,
    ...
    public enum CameraFocalLengthMode : int
    {
        Unknown = 0,
        Normalized = 1,
        Millimeter = 2
    ...
    public enum CameraFollowReason : int
    {
        Alarm = 0,
        User = 1
    }

    public enum CameraMoveStatus : int
    {
        Unknown = 0,
        Idle = 1,
        Moving = 2,
    ...
    public enum CameraPanTiltMode : int
    {
        Unknown = 0,
        Normalized = 1,
        Angular = 2
    ...
    public enum DeviceCommandReplyStatus : int
    {
        Unknown = 0,
        Ok = 1,
        NotImplemented = 2,
    ...
    public enum DeviceCommandSourceType : int
    {
        Unknown = 0,
        Session = 1,
        Device = 2,
    ...
    public enum GnssPositionStatus : int
    {
    ...
    public enum LineInputDeviceConnectionType : int
    {
        Unknown = 0,
        TCP = 1,
        UDP = 2,
    ...
    public enum MapElementType : int
    {
        Unknown = 0,
        Svg = 1,
        Png = 2,
    ...
    public enum MediaProxySessionMode : int
    {
        Unknown = 0,
        RTP = 1,
        RTPOverTCP = 2,
    ...
    public enum MediaProxySessionType : int
    {
        Unknown = 0,
        ACCAudio = 1,
        AMRAudio = 2,
    ...
    public enum NavigationalAidType : int
    {
        NotSpecified = 0,
        ReferencePoint = 1,
        Racon = 2,
    ...
    public enum PositionAccuracy : int
    {
        Low = 0,
        High = 1
    }
    ...
    public enum RadarImageType : int
    {
        MaskedProcessed = 0,
        FullRaw = 1,
        MaskedRaw = 2,
    ...
    public enum TrackerFilterModelType : int
    {
        Unknown = 0,
        Damp1 = 1,
        Damp2 = 2
