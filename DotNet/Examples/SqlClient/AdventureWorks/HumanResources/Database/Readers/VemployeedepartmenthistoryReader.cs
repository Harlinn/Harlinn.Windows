...
public class VemployeedepartmenthistoryReader : IDisposable
{
    ...
    public AdventureWorks.HumanResources.Types.VemployeedepartmenthistoryDataType ToDataObject()
    {
        return new AdventureWorks.HumanResources.Types.VemployeedepartmenthistoryDataType(Businessentityid,
            Title,
            Firstname,
            Middlename,
            Lastname,
    ...
    public List<AdventureWorks.HumanResources.Types.VemployeedepartmenthistoryDataType> ToList()
    {
        var list = new List<AdventureWorks.HumanResources.Types.VemployeedepartmenthistoryDataType>();
        while (Read())
        {
