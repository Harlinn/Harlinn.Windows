...
public class EmployeeReader : IDisposable
{
    ...
    public AdventureWorks.HumanResources.Types.EmployeeDataType ToDataObject()
    {
        return new AdventureWorks.HumanResources.Types.EmployeeDataType(Businessentityid,
            Nationalidnumber,
            Loginid,
            Organizationnode,
            Organizationlevel,
    ...
    public List<AdventureWorks.HumanResources.Types.EmployeeDataType> ToList()
    {
        var list = new List<AdventureWorks.HumanResources.Types.EmployeeDataType>();
        while (Read())
        {
