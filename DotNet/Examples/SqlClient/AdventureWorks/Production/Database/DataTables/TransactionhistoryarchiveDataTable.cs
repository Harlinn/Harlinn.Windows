...
public class TransactionhistoryarchiveDataTable
{

    DataTable _dataTable;

    public TransactionhistoryarchiveDataTable(DataTable dataTable)
    {
        _dataTable = dataTable;
    }
    public TransactionhistoryarchiveDataTable()
    {
    ...
    public void AddRow(TransactionhistoryarchiveDataType data)
    {
        var row = _dataTable.NewRow();
    ...
    public static SqlBulkCopy CreateSqlBulkCopy(SqlConnection sqlConnection, string? destinationTableName = null)
    {
        ...
        {
            DestinationTableName = destinationTableName ?? "[Production].[TransactionHistoryArchive]"
        };
