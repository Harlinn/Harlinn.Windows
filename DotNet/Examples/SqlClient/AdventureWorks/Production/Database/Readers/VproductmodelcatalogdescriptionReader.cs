...
public class VproductmodelcatalogdescriptionReader : IDisposable
{
    ...
    public AdventureWorks.Production.Types.VproductmodelcatalogdescriptionDataType ToDataObject()
    {
        return new AdventureWorks.Production.Types.VproductmodelcatalogdescriptionDataType(Productmodelid,
            Name,
            Summary,
            Manufacturer,
            Copyright,
    ...
    public List<AdventureWorks.Production.Types.VproductmodelcatalogdescriptionDataType> ToList()
    {
        var list = new List<AdventureWorks.Production.Types.VproductmodelcatalogdescriptionDataType>();
        while (Read())
        {
