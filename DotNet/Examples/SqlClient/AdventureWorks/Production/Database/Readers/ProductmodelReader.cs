...
public class ProductmodelReader : IDisposable
{
    ...
    public AdventureWorks.Production.Types.ProductmodelDataType ToDataObject()
    {
        return new AdventureWorks.Production.Types.ProductmodelDataType(Productmodelid,
            Name,
            Catalogdescription,
            Instructions,
            Rowguid,
    ...
    public List<AdventureWorks.Production.Types.ProductmodelDataType> ToList()
    {
        var list = new List<AdventureWorks.Production.Types.ProductmodelDataType>();
        while (Read())
        {
