...
public class ProductinventoryReader : IDisposable
{
    ...
    public AdventureWorks.Production.Types.ProductinventoryDataType ToDataObject()
    {
        return new AdventureWorks.Production.Types.ProductinventoryDataType(Productid,
            Locationid,
            Shelf,
            Bin,
            Quantity,
    ...
    public List<AdventureWorks.Production.Types.ProductinventoryDataType> ToList()
    {
        var list = new List<AdventureWorks.Production.Types.ProductinventoryDataType>();
        while (Read())
        {
