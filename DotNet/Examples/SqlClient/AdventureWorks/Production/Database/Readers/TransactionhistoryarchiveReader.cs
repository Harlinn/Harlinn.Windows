...
public class TransactionhistoryarchiveReader : IDisposable
{
    ...
    public AdventureWorks.Production.Types.TransactionhistoryarchiveDataType ToDataObject()
    {
        return new AdventureWorks.Production.Types.TransactionhistoryarchiveDataType(Transactionid,
            Productid,
            Referenceorderid,
    ...
    public List<AdventureWorks.Production.Types.TransactionhistoryarchiveDataType> ToList()
    {
        var list = new List<AdventureWorks.Production.Types.TransactionhistoryarchiveDataType>();
        while (Read())
        {
