...
public class ProductproductphotoReader : IDisposable
{
    ...
    public AdventureWorks.Production.Types.ProductproductphotoDataType ToDataObject()
    {
        return new AdventureWorks.Production.Types.ProductproductphotoDataType(Productid,
            Productphotoid,
            Primary,
            Modifieddate);
    }

    public List<AdventureWorks.Production.Types.ProductproductphotoDataType> ToList()
    {
        var list = new List<AdventureWorks.Production.Types.ProductproductphotoDataType>();
        while (Read())
        {
