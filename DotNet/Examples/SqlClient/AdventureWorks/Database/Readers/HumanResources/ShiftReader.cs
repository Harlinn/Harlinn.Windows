...
public class ShiftReader : IDisposable
{
    ...
    public Types.HumanResources.ShiftDataType ToDataObject()
    {
        return new Types.HumanResources.ShiftDataType(Shiftid,
            Name,
            Starttime,
            Endtime,
            Modifieddate);
    ...
    public List<Types.HumanResources.ShiftDataType> ToList()
    {
        var list = new List<Types.HumanResources.ShiftDataType>();
        while (Read())
        {
