...
public class EmployeedepartmenthistoryReader : IDisposable
{
    ...
    public Types.HumanResources.EmployeedepartmenthistoryDataType ToDataObject()
    {
        return new Types.HumanResources.EmployeedepartmenthistoryDataType(Businessentityid,
            Departmentid,
            Shiftid,
            Startdate,
            Enddate,
    ...
    public List<Types.HumanResources.EmployeedepartmenthistoryDataType> ToList()
    {
        var list = new List<Types.HumanResources.EmployeedepartmenthistoryDataType>();
        while (Read())
        {
