...
public class VjobcandidateemploymentReader : IDisposable
{
    ...
    public Types.HumanResources.VjobcandidateemploymentDataType ToDataObject()
    {
        return new Types.HumanResources.VjobcandidateemploymentDataType(Jobcandidateid,
            Emp_startdate,
            Emp_enddate,
            Emp_orgname,
            Emp_jobtitle,
    ...
    public List<Types.HumanResources.VjobcandidateemploymentDataType> ToList()
    {
        var list = new List<Types.HumanResources.VjobcandidateemploymentDataType>();
        while (Read())
        {
