...
public class VjobcandidateReader : IDisposable
{
    ...
    public Types.HumanResources.VjobcandidateDataType ToDataObject()
    {
        return new Types.HumanResources.VjobcandidateDataType(Jobcandidateid,
            Businessentityid,
            Name_prefix,
            Name_first,
            Name_middle,
    ...
    public List<Types.HumanResources.VjobcandidateDataType> ToList()
    {
        var list = new List<Types.HumanResources.VjobcandidateDataType>();
        while (Read())
        {
