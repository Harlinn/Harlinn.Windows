...
public class VjobcandidateeducationReader : IDisposable
{
    ...
    public Types.HumanResources.VjobcandidateeducationDataType ToDataObject()
    {
        return new Types.HumanResources.VjobcandidateeducationDataType(Jobcandidateid,
            Edu_level,
            Edu_startdate,
            Edu_enddate,
            Edu_degree,
    ...
    public List<Types.HumanResources.VjobcandidateeducationDataType> ToList()
    {
        var list = new List<Types.HumanResources.VjobcandidateeducationDataType>();
        while (Read())
        {
