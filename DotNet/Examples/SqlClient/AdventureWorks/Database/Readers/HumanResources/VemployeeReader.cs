...
public class VemployeeReader : IDisposable
{
    ...
    public Types.HumanResources.VemployeeDataType ToDataObject()
    {
        return new Types.HumanResources.VemployeeDataType(Businessentityid,
            Title,
            Firstname,
            Middlename,
            Lastname,
    ...
    public List<Types.HumanResources.VemployeeDataType> ToList()
    {
        var list = new List<Types.HumanResources.VemployeeDataType>();
        while (Read())
        {
