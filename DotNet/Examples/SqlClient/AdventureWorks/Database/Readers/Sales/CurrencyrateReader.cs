...
public class CurrencyrateReader : IDisposable
{
    ...
    public Types.Sales.CurrencyrateDataType ToDataObject()
    {
        return new Types.Sales.CurrencyrateDataType(Currencyrateid,
            Currencyratedate,
            Fromcurrencycode,
            Tocurrencycode,
            Averagerate,
    ...
    public List<Types.Sales.CurrencyrateDataType> ToList()
    {
        var list = new List<Types.Sales.CurrencyrateDataType>();
        while (Read())
        {
