...
public class CreditcardReader : IDisposable
{
    ...
    public Types.Sales.CreditcardDataType ToDataObject()
    {
        return new Types.Sales.CreditcardDataType(Creditcardid,
            Cardtype,
            Cardnumber,
            Expmonth,
            Expyear,
    ...
    public List<Types.Sales.CreditcardDataType> ToList()
    {
        var list = new List<Types.Sales.CreditcardDataType>();
        while (Read())
        {
