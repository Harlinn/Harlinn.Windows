...
public class SpecialofferReader : IDisposable
{
    ...
    public Types.Sales.SpecialofferDataType ToDataObject()
    {
        return new Types.Sales.SpecialofferDataType(Specialofferid,
            Description,
            Discountpct,
            Type,
            Category,
    ...
    public List<Types.Sales.SpecialofferDataType> ToList()
    {
        var list = new List<Types.Sales.SpecialofferDataType>();
        while (Read())
        {
