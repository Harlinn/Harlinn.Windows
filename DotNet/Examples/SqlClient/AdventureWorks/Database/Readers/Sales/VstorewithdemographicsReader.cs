...
public class VstorewithdemographicsReader : IDisposable
{
    ...
    public Types.Sales.VstorewithdemographicsDataType ToDataObject()
    {
        return new Types.Sales.VstorewithdemographicsDataType(Businessentityid,
            Name,
            Annualsales,
            Annualrevenue,
            Bankname,
    ...
    public List<Types.Sales.VstorewithdemographicsDataType> ToList()
    {
        var list = new List<Types.Sales.VstorewithdemographicsDataType>();
        while (Read())
        {
