...
public class SalesterritoryReader : IDisposable
{
    ...
    public Types.Sales.SalesterritoryDataType ToDataObject()
    {
        return new Types.Sales.SalesterritoryDataType(Territoryid,
            Name,
            Countryregioncode,
            Group,
            Salesytd,
    ...
    public List<Types.Sales.SalesterritoryDataType> ToList()
    {
        var list = new List<Types.Sales.SalesterritoryDataType>();
        while (Read())
        {
