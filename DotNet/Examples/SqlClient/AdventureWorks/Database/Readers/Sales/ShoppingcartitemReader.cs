...
public class ShoppingcartitemReader : IDisposable
{
    ...
    public Types.Sales.ShoppingcartitemDataType ToDataObject()
    {
        return new Types.Sales.ShoppingcartitemDataType(Shoppingcartitemid,
            Shoppingcartid,
            Quantity,
            Productid,
            Datecreated,
    ...
    public List<Types.Sales.ShoppingcartitemDataType> ToList()
    {
        var list = new List<Types.Sales.ShoppingcartitemDataType>();
        while (Read())
        {
