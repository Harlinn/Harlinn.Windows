...
public class VindividualcustomerReader : IDisposable
{
    ...
    public Types.Sales.VindividualcustomerDataType ToDataObject()
    {
        return new Types.Sales.VindividualcustomerDataType(Businessentityid,
            Title,
            Firstname,
            Middlename,
            Lastname,
    ...
    public List<Types.Sales.VindividualcustomerDataType> ToList()
    {
        var list = new List<Types.Sales.VindividualcustomerDataType>();
        while (Read())
        {
