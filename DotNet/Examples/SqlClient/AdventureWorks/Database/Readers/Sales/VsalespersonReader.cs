...
public class VsalespersonReader : IDisposable
{
    ...
    public Types.Sales.VsalespersonDataType ToDataObject()
    {
        return new Types.Sales.VsalespersonDataType(Businessentityid,
            Title,
            Firstname,
            Middlename,
            Lastname,
    ...
    public List<Types.Sales.VsalespersonDataType> ToList()
    {
        var list = new List<Types.Sales.VsalespersonDataType>();
        while (Read())
        {
