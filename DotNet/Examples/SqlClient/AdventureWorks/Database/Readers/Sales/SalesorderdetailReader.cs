...
public class SalesorderdetailReader : IDisposable
{
    ...
    public Types.Sales.SalesorderdetailDataType ToDataObject()
    {
        return new Types.Sales.SalesorderdetailDataType(Salesorderid,
            Salesorderdetailid,
    ...
    public List<Types.Sales.SalesorderdetailDataType> ToList()
    {
        var list = new List<Types.Sales.SalesorderdetailDataType>();
        while (Read())
        {
