...
public class SalespersonquotahistoryReader : IDisposable
{
    ...
    public Types.Sales.SalespersonquotahistoryDataType ToDataObject()
    {
        return new Types.Sales.SalespersonquotahistoryDataType(Businessentityid,
            Quotadate,
            Salesquota,
            Rowguid,
            Modifieddate);
    ...
    public List<Types.Sales.SalespersonquotahistoryDataType> ToList()
    {
        var list = new List<Types.Sales.SalespersonquotahistoryDataType>();
        while (Read())
        {
