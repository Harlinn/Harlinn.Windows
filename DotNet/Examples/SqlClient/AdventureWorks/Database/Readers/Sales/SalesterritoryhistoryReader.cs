...
public class SalesterritoryhistoryReader : IDisposable
{
    ...
    public Types.Sales.SalesterritoryhistoryDataType ToDataObject()
    {
        return new Types.Sales.SalesterritoryhistoryDataType(Businessentityid,
            Territoryid,
            Startdate,
            Enddate,
            Rowguid,
    ...
    public List<Types.Sales.SalesterritoryhistoryDataType> ToList()
    {
        var list = new List<Types.Sales.SalesterritoryhistoryDataType>();
        while (Read())
        {
