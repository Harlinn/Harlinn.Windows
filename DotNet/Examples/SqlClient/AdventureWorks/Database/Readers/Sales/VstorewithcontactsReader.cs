...
public class VstorewithcontactsReader : IDisposable
{
    ...
    public Types.Sales.VstorewithcontactsDataType ToDataObject()
    {
        return new Types.Sales.VstorewithcontactsDataType(Businessentityid,
            Name,
            Contacttype,
            Title,
            Firstname,
    ...
    public List<Types.Sales.VstorewithcontactsDataType> ToList()
    {
        var list = new List<Types.Sales.VstorewithcontactsDataType>();
        while (Read())
        {
