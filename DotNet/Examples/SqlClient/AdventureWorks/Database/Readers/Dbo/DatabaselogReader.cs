...
public class DatabaselogReader : IDisposable
{
    ...
    public Types.Dbo.DatabaselogDataType ToDataObject()
    {
        return new Types.Dbo.DatabaselogDataType(Databaselogid,
            Posttime,
            Databaseuser,
            Event,
            Schema,
    ...
    public List<Types.Dbo.DatabaselogDataType> ToList()
    {
        var list = new List<Types.Dbo.DatabaselogDataType>();
        while (Read())
        {
