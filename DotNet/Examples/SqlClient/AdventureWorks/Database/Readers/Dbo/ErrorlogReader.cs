...
public class ErrorlogReader : IDisposable
{
    ...
    public Types.Dbo.ErrorlogDataType ToDataObject()
    {
        return new Types.Dbo.ErrorlogDataType(Errorlogid,
            Errortime,
            Username,
            Errornumber,
            Errorseverity,
    ...
    public List<Types.Dbo.ErrorlogDataType> ToList()
    {
        var list = new List<Types.Dbo.ErrorlogDataType>();
        while (Read())
        {
