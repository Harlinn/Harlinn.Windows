...
namespace AdventureWorks.Database.Readers.Dbo;
...
public class AwbuildversionReader : IDisposable
{
    ...
    public Types.Dbo.AwbuildversionDataType ToDataObject()
    {
        return new Types.Dbo.AwbuildversionDataType(Systeminformationid,
            DatabaseVersion,
            Versiondate,
            Modifieddate);
    }

    public List<Types.Dbo.AwbuildversionDataType> ToList()
    {
        var list = new List<Types.Dbo.AwbuildversionDataType>();
        while (Read())
        {
