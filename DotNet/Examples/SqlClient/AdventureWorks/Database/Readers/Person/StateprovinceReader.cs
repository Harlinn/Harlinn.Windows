...
public class StateprovinceReader : IDisposable
{
    ...
    public Types.Person.StateprovinceDataType ToDataObject()
    {
        return new Types.Person.StateprovinceDataType(Stateprovinceid,
            Stateprovincecode,
            Countryregioncode,
    ...
    public List<Types.Person.StateprovinceDataType> ToList()
    {
        var list = new List<Types.Person.StateprovinceDataType>();
        while (Read())
        {
