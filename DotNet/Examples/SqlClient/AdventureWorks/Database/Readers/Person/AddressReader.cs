...
public class AddressReader : IDisposable
{
    ...
    public Types.Person.AddressDataType ToDataObject()
    {
        return new Types.Person.AddressDataType(Addressid,
            Addressline1,
            Addressline2,
            City,
            Stateprovinceid,
    ...
    public List<Types.Person.AddressDataType> ToList()
    {
        var list = new List<Types.Person.AddressDataType>();
        while (Read())
        {
