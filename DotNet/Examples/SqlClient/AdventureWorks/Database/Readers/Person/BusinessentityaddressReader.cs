...
public class BusinessentityaddressReader : IDisposable
{
    ...
    public Types.Person.BusinessentityaddressDataType ToDataObject()
    {
        return new Types.Person.BusinessentityaddressDataType(Businessentityid,
            Addressid,
            Addresstypeid,
            Rowguid,
            Modifieddate);
    ...
    public List<Types.Person.BusinessentityaddressDataType> ToList()
    {
        var list = new List<Types.Person.BusinessentityaddressDataType>();
        while (Read())
        {
