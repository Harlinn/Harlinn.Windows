...
public class ProductmodelproductdescriptioncultureReader : IDisposable
{
    ...
    public Types.Production.ProductmodelproductdescriptioncultureDataType ToDataObject()
    {
        return new Types.Production.ProductmodelproductdescriptioncultureDataType(Productmodelid,
            Productdescriptionid,
            Cultureid,
            Modifieddate);
    }

    public List<Types.Production.ProductmodelproductdescriptioncultureDataType> ToList()
    {
        var list = new List<Types.Production.ProductmodelproductdescriptioncultureDataType>();
        while (Read())
        {
