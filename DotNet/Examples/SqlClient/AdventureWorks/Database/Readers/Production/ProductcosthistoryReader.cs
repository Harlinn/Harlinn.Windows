...
public class ProductcosthistoryReader : IDisposable
{
    ...
    public Types.Production.ProductcosthistoryDataType ToDataObject()
    {
        return new Types.Production.ProductcosthistoryDataType(Productid,
            Startdate,
            Enddate,
            Standardcost,
            Modifieddate);
    ...
    public List<Types.Production.ProductcosthistoryDataType> ToList()
    {
        var list = new List<Types.Production.ProductcosthistoryDataType>();
        while (Read())
        {
