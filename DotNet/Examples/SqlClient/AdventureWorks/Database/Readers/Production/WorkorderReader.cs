...
public class WorkorderReader : IDisposable
{
    ...
    public Types.Production.WorkorderDataType ToDataObject()
    {
        return new Types.Production.WorkorderDataType(Workorderid,
            Productid,
            Orderqty,
            Stockedqty,
            Scrappedqty,
    ...
    public List<Types.Production.WorkorderDataType> ToList()
    {
        var list = new List<Types.Production.WorkorderDataType>();
        while (Read())
        {
