...
public class VproductmodelinstructionsReader : IDisposable
{
    ...
    public Types.Production.VproductmodelinstructionsDataType ToDataObject()
    {
        return new Types.Production.VproductmodelinstructionsDataType(Productmodelid,
            Name,
            Instructions,
            Locationid,
            Setuphours,
    ...
    public List<Types.Production.VproductmodelinstructionsDataType> ToList()
    {
        var list = new List<Types.Production.VproductmodelinstructionsDataType>();
        while (Read())
        {
