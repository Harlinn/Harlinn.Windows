...
public class VproductanddescriptionReader : IDisposable
{
    ...
    public Types.Production.VproductanddescriptionDataType ToDataObject()
    {
        return new Types.Production.VproductanddescriptionDataType(Productid,
            Name,
            Productmodel,
            Cultureid,
            Description);
    ...
    public List<Types.Production.VproductanddescriptionDataType> ToList()
    {
        var list = new List<Types.Production.VproductanddescriptionDataType>();
        while (Read())
        {
