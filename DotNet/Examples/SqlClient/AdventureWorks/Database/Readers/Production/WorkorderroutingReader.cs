...
public class WorkorderroutingReader : IDisposable
{
    ...
    public Types.Production.WorkorderroutingDataType ToDataObject()
    {
        return new Types.Production.WorkorderroutingDataType(Workorderid,
            Productid,
            Operationsequence,
            Locationid,
            Scheduledstartdate,
    ...
    public List<Types.Production.WorkorderroutingDataType> ToList()
    {
        var list = new List<Types.Production.WorkorderroutingDataType>();
        while (Read())
        {
