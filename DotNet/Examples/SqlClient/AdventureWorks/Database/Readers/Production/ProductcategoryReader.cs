...
public class ProductcategoryReader : IDisposable
{
    ...
    public Types.Production.ProductcategoryDataType ToDataObject()
    {
        return new Types.Production.ProductcategoryDataType(Productcategoryid,
            Name,
            Rowguid,
            Modifieddate);
    }

    public List<Types.Production.ProductcategoryDataType> ToList()
    {
        var list = new List<Types.Production.ProductcategoryDataType>();
        while (Read())
        {
