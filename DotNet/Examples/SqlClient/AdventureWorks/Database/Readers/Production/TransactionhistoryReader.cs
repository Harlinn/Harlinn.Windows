...
public class TransactionhistoryReader : IDisposable
{
    ...
    public Types.Production.TransactionhistoryDataType ToDataObject()
    {
        return new Types.Production.TransactionhistoryDataType(Transactionid,
            Productid,
            Referenceorderid,
    ...
    public List<Types.Production.TransactionhistoryDataType> ToList()
    {
        var list = new List<Types.Production.TransactionhistoryDataType>();
        while (Read())
        {
