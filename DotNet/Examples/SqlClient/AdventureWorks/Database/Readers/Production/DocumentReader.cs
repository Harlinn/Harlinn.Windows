...
public class DocumentReader : IDisposable
{
    ...
    public Types.Production.DocumentDataType ToDataObject()
    {
        return new Types.Production.DocumentDataType(Documentnode,
            Documentlevel,
            Title,
            Owner,
            Folderflag,
    ...
    public List<Types.Production.DocumentDataType> ToList()
    {
        var list = new List<Types.Production.DocumentDataType>();
        while (Read())
        {
