...
public class ProductReader : IDisposable
{
    ...
    public Types.Production.ProductDataType ToDataObject()
    {
        return new Types.Production.ProductDataType(Productid,
            Name,
            Productnumber,
            Makeflag,
            Finishedgoodsflag,
    ...
    public List<Types.Production.ProductDataType> ToList()
    {
        var list = new List<Types.Production.ProductDataType>();
        while (Read())
        {
