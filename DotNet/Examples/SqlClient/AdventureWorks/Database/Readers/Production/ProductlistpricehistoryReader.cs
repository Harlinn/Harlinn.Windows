...
public class ProductlistpricehistoryReader : IDisposable
{
    ...
    public Types.Production.ProductlistpricehistoryDataType ToDataObject()
    {
        return new Types.Production.ProductlistpricehistoryDataType(Productid,
            Startdate,
            Enddate,
            Listprice,
            Modifieddate);
    ...
    public List<Types.Production.ProductlistpricehistoryDataType> ToList()
    {
        var list = new List<Types.Production.ProductlistpricehistoryDataType>();
        while (Read())
        {
