...
public class BillofmaterialsReader : IDisposable
{
    ...
    public Types.Production.BillofmaterialsDataType ToDataObject()
    {
        return new Types.Production.BillofmaterialsDataType(Billofmaterialsid,
            Productassemblyid,
            Componentid,
            Startdate,
            Enddate,
    ...
    public List<Types.Production.BillofmaterialsDataType> ToList()
    {
        var list = new List<Types.Production.BillofmaterialsDataType>();
        while (Read())
        {
