...
public class ProductphotoReader : IDisposable
{
    ...
    public Types.Production.ProductphotoDataType ToDataObject()
    {
        return new Types.Production.ProductphotoDataType(Productphotoid,
            Thumbnailphoto,
    ...
    public List<Types.Production.ProductphotoDataType> ToList()
    {
        var list = new List<Types.Production.ProductphotoDataType>();
        while (Read())
        {
