...
public class VvendorwithcontactsReader : IDisposable
{
    ...
    public Types.Purchasing.VvendorwithcontactsDataType ToDataObject()
    {
        return new Types.Purchasing.VvendorwithcontactsDataType(Businessentityid,
            Name,
            Contacttype,
            Title,
            Firstname,
    ...
    public List<Types.Purchasing.VvendorwithcontactsDataType> ToList()
    {
        var list = new List<Types.Purchasing.VvendorwithcontactsDataType>();
        while (Read())
        {
