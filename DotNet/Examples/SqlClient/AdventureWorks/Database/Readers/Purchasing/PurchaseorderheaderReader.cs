...
public class PurchaseorderheaderReader : IDisposable
{
    ...
    public Types.Purchasing.PurchaseorderheaderDataType ToDataObject()
    {
        return new Types.Purchasing.PurchaseorderheaderDataType(Purchaseorderid,
            Revisionnumber,
            Status,
            Employeeid,
            Vendorid,
    ...
    public List<Types.Purchasing.PurchaseorderheaderDataType> ToList()
    {
        var list = new List<Types.Purchasing.PurchaseorderheaderDataType>();
        while (Read())
        {
