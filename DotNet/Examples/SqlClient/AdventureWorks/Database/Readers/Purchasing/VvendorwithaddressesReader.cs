...
public class VvendorwithaddressesReader : IDisposable
{
    ...
    public Types.Purchasing.VvendorwithaddressesDataType ToDataObject()
    {
        return new Types.Purchasing.VvendorwithaddressesDataType(Businessentityid,
            Name,
            Addresstype,
            Addressline1,
            Addressline2,
    ...
    public List<Types.Purchasing.VvendorwithaddressesDataType> ToList()
    {
        var list = new List<Types.Purchasing.VvendorwithaddressesDataType>();
        while (Read())
        {
