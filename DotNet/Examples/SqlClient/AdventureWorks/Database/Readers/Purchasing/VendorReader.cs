...
public class VendorReader : IDisposable
{
    ...
    public Types.Purchasing.VendorDataType ToDataObject()
    {
        return new Types.Purchasing.VendorDataType(Businessentityid,
            Accountnumber,
            Name,
            Creditrating,
    ...
    public List<Types.Purchasing.VendorDataType> ToList()
    {
        var list = new List<Types.Purchasing.VendorDataType>();
        while (Read())
        {
