...
public class BusinessentityDataTable
{

    DataTable _dataTable;

    public BusinessentityDataTable(DataTable dataTable)
    {
    ...
    public void AddRow(BusinessentityDataType data)
    {
        var row = _dataTable.NewRow();
    ...
    public static SqlBulkCopy CreateSqlBulkCopy(SqlConnection sqlConnection, string? destinationTableName = null)
    {
        ...
        {
            DestinationTableName = destinationTableName ?? "[Person].[BusinessEntity]"
        };
