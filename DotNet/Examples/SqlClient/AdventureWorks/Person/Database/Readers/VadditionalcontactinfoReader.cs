...
public class VadditionalcontactinfoReader : IDisposable
{
    ...
    public AdventureWorks.Person.Types.VadditionalcontactinfoDataType ToDataObject()
    {
        return new AdventureWorks.Person.Types.VadditionalcontactinfoDataType(Businessentityid,
            Firstname,
            Middlename,
            Lastname,
            Telephonenumber,
    ...
    public List<AdventureWorks.Person.Types.VadditionalcontactinfoDataType> ToList()
    {
        var list = new List<AdventureWorks.Person.Types.VadditionalcontactinfoDataType>();
        while (Read())
        {
