...
public class PersonReader : IDisposable
{
    ...
    public AdventureWorks.Person.Types.PersonDataType ToDataObject()
    {
        return new AdventureWorks.Person.Types.PersonDataType(Businessentityid,
            Persontype,
            Namestyle,
            Title,
            Firstname,
    ...
    public List<AdventureWorks.Person.Types.PersonDataType> ToList()
    {
        var list = new List<AdventureWorks.Person.Types.PersonDataType>();
        while (Read())
        {
