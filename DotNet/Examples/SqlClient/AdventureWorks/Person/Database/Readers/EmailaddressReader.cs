...
public class EmailaddressReader : IDisposable
{
    ...
    public AdventureWorks.Person.Types.EmailaddressDataType ToDataObject()
    {
        return new AdventureWorks.Person.Types.EmailaddressDataType(Businessentityid,
            Emailaddressid,
            Emailaddress,
            Rowguid,
            Modifieddate);
    ...
    public List<AdventureWorks.Person.Types.EmailaddressDataType> ToList()
    {
        var list = new List<AdventureWorks.Person.Types.EmailaddressDataType>();
        while (Read())
        {
