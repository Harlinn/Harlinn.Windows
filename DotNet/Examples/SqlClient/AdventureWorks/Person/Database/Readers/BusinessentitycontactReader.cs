...
public class BusinessentitycontactReader : IDisposable
{
    ...
    public AdventureWorks.Person.Types.BusinessentitycontactDataType ToDataObject()
    {
        return new AdventureWorks.Person.Types.BusinessentitycontactDataType(Businessentityid,
            Personid,
            Contacttypeid,
            Rowguid,
            Modifieddate);
    ...
    public List<AdventureWorks.Person.Types.BusinessentitycontactDataType> ToList()
    {
        var list = new List<AdventureWorks.Person.Types.BusinessentitycontactDataType>();
        while (Read())
        {
