...
public class VpersondemographicsReader : IDisposable
{
    ...
    public AdventureWorks.Sales.Types.VpersondemographicsDataType ToDataObject()
    {
        return new AdventureWorks.Sales.Types.VpersondemographicsDataType(Businessentityid,
            Totalpurchaseytd,
            Datefirstpurchase,
            Birthdate,
            Maritalstatus,
    ...
    public List<AdventureWorks.Sales.Types.VpersondemographicsDataType> ToList()
    {
        var list = new List<AdventureWorks.Sales.Types.VpersondemographicsDataType>();
        while (Read())
        {
