...
public class SalespersonReader : IDisposable
{
    ...
    public AdventureWorks.Sales.Types.SalespersonDataType ToDataObject()
    {
        return new AdventureWorks.Sales.Types.SalespersonDataType(Businessentityid,
            Territoryid,
            Salesquota,
            Bonus,
            Commissionpct,
    ...
    public List<AdventureWorks.Sales.Types.SalespersonDataType> ToList()
    {
        var list = new List<AdventureWorks.Sales.Types.SalespersonDataType>();
        while (Read())
        {
