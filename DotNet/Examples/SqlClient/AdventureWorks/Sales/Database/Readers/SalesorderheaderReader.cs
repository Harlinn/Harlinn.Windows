...
public class SalesorderheaderReader : IDisposable
{
    ...
    public AdventureWorks.Sales.Types.SalesorderheaderDataType ToDataObject()
    {
        return new AdventureWorks.Sales.Types.SalesorderheaderDataType(Salesorderid,
            Revisionnumber,
            Orderdate,
            Duedate,
            Shipdate,
    ...
    public List<AdventureWorks.Sales.Types.SalesorderheaderDataType> ToList()
    {
        var list = new List<AdventureWorks.Sales.Types.SalesorderheaderDataType>();
        while (Read())
        {
