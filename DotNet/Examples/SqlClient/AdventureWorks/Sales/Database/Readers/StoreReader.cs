...
public class StoreReader : IDisposable
{
    ...
    public AdventureWorks.Sales.Types.StoreDataType ToDataObject()
    {
        return new AdventureWorks.Sales.Types.StoreDataType(Businessentityid,
            Name,
            Salespersonid,
            Demographics,
            Rowguid,
    ...
    public List<AdventureWorks.Sales.Types.StoreDataType> ToList()
    {
        var list = new List<AdventureWorks.Sales.Types.StoreDataType>();
        while (Read())
        {
