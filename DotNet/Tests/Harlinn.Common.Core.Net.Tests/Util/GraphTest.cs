...
using Harlinn.Common.Core.Net.Util;

namespace Harlinn.Common.Core.Net.Tests.Util
{
    [TestClass]
...
#region Fixture
        ...
        /*
        private class EntityTypeGraph : Graph<IReadOnlyEntityType, IReadOnlyForeignKey>
        {
        ...
        */
        ...
        public void AddEdge_adds_an_edge()
        {
            ...
            Assert.IsTrue(graph.GetEdges(vertexTwo, vertexOne).Count() == 0);
        ...
        public void AddEdge_updates_incoming_and_outgoing_neighbors()
        {
            ...
            Assert.AreEqual(2, graph.GetOutgoingNeighbors(vertexOne).Count());
            Assert.AreEqual(2, graph.GetOutgoingNeighbors(vertexOne).Intersect(new[] { vertexTwo, vertexThree }).Count());

            Assert.AreEqual(2, graph.GetIncomingNeighbors(vertexThree).Count());
            Assert.AreEqual(2, graph.GetIncomingNeighbors(vertexThree).Intersect(new[] { vertexOne, vertexTwo }).Count());
        }
        ...
        public void TopologicalSort_on_simple_graph_returns_all_vertices_in_order()
        {
            ...
            Assert.IsTrue(
                graph.TopologicalSort().ToArray().SequenceEqual([vertexTwo, vertexOne, vertexThree]));
        }
        ...
        public void TopologicalSort_on_tree_graph_returns_all_vertices_in_order()
        {
            ...
            Assert.IsTrue( graph.TopologicalSort().ToArray().SequenceEqual([vertexOne, vertexThree, vertexTwo]));
        }
            ...
            Assert.IsTrue(
                graph.TopologicalSort(
                    (from, to, edges) =>
                        (from == vertexOne)
                        && (to == vertexOne)
                        && (edges.Intersect(new[] { edgeOne }).Count() == 1)).ToArray().SequenceEqual([vertexOne]));
        }
            ...
            Assert.IsTrue(
                graph.TopologicalSort(
                    (from, to, edges) =>
                        (from == vertexThree)
                        && (to == vertexOne)
                        && (edges.Single() == edgeThree)).ToArray().SequenceEqual([vertexOne, vertexTwo, vertexThree]));
        }
        ...
        public void TopologicalSort_can_break_two_cycles()
        {
            ...
            Assert.IsTrue(
                graph.TopologicalSort(
                    ...
                    }).ToArray().SequenceEqual([vertexTwo, vertexThree, vertexOne, vertexFour, vertexFive]));
        }
        ...
        public void TopologicalSort_with_secondary_sort()
        {
            ...
            var graph = new Graph<Vertex, Edge>((v1, v2) => Comparer<int>.Default.Compare(v1.Id, v2.Id));
            ...
            Assert.IsTrue(graph.TopologicalSort().ToArray().SequenceEqual([vertexOne, vertexTwo, vertexThree, vertexFour]));
        }
        ...
        public void TopologicalSort_without_secondary_sort()
        {
            ...
            Assert.IsTrue(graph.TopologicalSort().ToArray().SequenceEqual([vertexTwo, vertexOne, vertexFour, vertexThree]));
        }
        ...
        */
        ...
        public void BatchingTopologicalSort_without_secondary_sort()
        {
            ...
            Assert.IsTrue(
                graph.BatchingTopologicalSort().Single().ToArray().SequenceEqual([vertexTwo, vertexOne, vertexFour, vertexThree]) );
        }
        ...
        public void BatchingTopologicalSort_with_batching_boundary_edge()
        {
            ...
            Assert.IsTrue(batches[0].ToArray().SequenceEqual([vertexOne, vertexTwo]));
            Assert.IsTrue(batches[1].ToArray().SequenceEqual([vertexThree, vertexFour]));
        }
