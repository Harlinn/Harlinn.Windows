    ...
    public static class ParameterExtensions
    {
        public static ParameterDefinition ToParameterDefinition(this SchemaTypes.Parameter parameter, SqlConnection sqlConnection)
        {
            ...
            switch (systemDataType)
            {
                ...
                {
                    var result = new BinaryParameterDefinition(systemDataType, parameter);
                    return result;
                }
                case SystemDataType.Text:
                {
                    var result = new StringParameterDefinition(systemDataType, parameter);
                    return result;
                }
                case SystemDataType.UniqueIdentifier:
                {
                    var result = new GuidParameterDefinition(parameter);
                    return result;
                }
                case SystemDataType.Date:
                {
                    var result = new DateTimeParameterDefinition(parameter);
                    return result;
                }
                ...
                {
                    var result = new ByteParameterDefinition(parameter);
                    return result;
                }
                case SystemDataType.SmallInt:
                {
                    var result = new Int16ParameterDefinition(parameter);
                    return result;
                }
                case SystemDataType.Int:
                {
                    var result = new Int32ParameterDefinition(parameter);
                    return result;
                }
                ...
                {
                    var result = new SingleParameterDefinition(parameter);
                    return result;
                }
                case SystemDataType.Money:
                {
                    var result = new DecimalParameterDefinition(parameter);
                    return result;
                }
                ...
                {
                    var result = new DoubleParameterDefinition(parameter);
                    return result;
                }
                case SystemDataType.SqlVariant:
                {
                    var result = new SqlVariantParameterDefinition(parameter);
                    return result;
                }
                ...
                {
                    var result = new BooleanParameterDefinition(parameter);
                    return result;
                }
                ...
                {
                    var result = new Int64ParameterDefinition(parameter);
                    return result;
                }
                case SystemDataType.HierarchyId:
                {
                    var result = new HierarchyIdParameterDefinition(parameter);
                    return result;
                }
                case SystemDataType.Geometry:
                {
                    var result = new GeometryParameterDefinition(parameter);
                    return result;
                }
                case SystemDataType.Geography:
                {
                    var result = new GeographyParameterDefinition(parameter);
                    return result;
                }
                ...
                {
                    var result = new XmlParameterDefinition(parameter);
                    return result;
                }
