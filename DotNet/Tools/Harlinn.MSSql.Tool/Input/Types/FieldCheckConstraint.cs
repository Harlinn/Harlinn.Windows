...
{
    public class FieldCheckConstraint : CheckConstraint
    {
        FieldDefinition? _owner;
        ...
        public FieldCheckConstraint(string? name, string? definition, bool isSystemNamed) 
            : base(name, definition, isSystemNamed)
        {
        }

        [XmlIgnore]
        public FieldDefinition? Owner { get => _owner; set => _owner = value; }
    }
