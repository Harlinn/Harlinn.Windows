...
namespace Harlinn.MSSql.Tool.Input.Types
{
    ...
    public class Int16FieldDefinition : IntegerFieldDefinition<short>
    {
        ...
        public Int16FieldDefinition(SystemDataType systemColumnType, Column column, FieldDefaultConstraint? defaultConstraint, FieldComputed? computed, List<FieldCheckConstraint>? checks, string? description)
