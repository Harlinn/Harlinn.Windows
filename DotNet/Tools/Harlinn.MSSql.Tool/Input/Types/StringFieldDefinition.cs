...
namespace Harlinn.MSSql.Tool.Input.Types
{
    ...
    public class StringFieldDefinition : FieldDefinition
    {
        ...
        public StringFieldDefinition(SystemDataType systemColumnType, Column column, FieldDefaultConstraint? defaultConstraint, FieldComputed? computed, List<FieldCheckConstraint>? checks, string? description)
