...
namespace Harlinn.MSSql.Tool.Input.Types
{
    ...
    public class GeometryFieldDefinition : FieldDefinition
    {
        ...
        public GeometryFieldDefinition(SystemDataType systemColumnType, Column column, FieldDefaultConstraint? defaultConstraint, FieldComputed? computed, List<FieldCheckConstraint>? checks, string? description)
