...
namespace Harlinn.MSSql.Tool.Input.Types
{
    ...
    public class BinaryFieldDefinition : FieldDefinition
    {
        ...
        public BinaryFieldDefinition(SystemDataType systemColumnType, Column column, FieldDefaultConstraint? defaultConstraint, FieldComputed? computed, List<FieldCheckConstraint>? checks, string? description)
