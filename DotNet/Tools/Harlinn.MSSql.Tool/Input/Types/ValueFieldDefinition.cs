...
namespace Harlinn.MSSql.Tool.Input.Types
{
    public abstract class ValueFieldDefinition<T> : FieldDefinition where T : struct
    {
        ...
        public ValueFieldDefinition(SystemDataType systemColumnType, Column column, FieldDefaultConstraint? defaultConstraint, FieldComputed? computed, List<FieldCheckConstraint>? checks, string? description)
