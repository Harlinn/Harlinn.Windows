...
namespace Harlinn.MSSql.Tool.Input.Types
{
    ...
    public class UInt32FieldDefinition : IntegerFieldDefinition<uint>
    {
        ...
        public UInt32FieldDefinition(SystemDataType systemColumnType, Column column, FieldDefaultConstraint? defaultConstraint, FieldComputed? computed, List<FieldCheckConstraint>? checks, string? description)
