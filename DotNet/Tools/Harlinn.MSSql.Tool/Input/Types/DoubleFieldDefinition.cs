...
namespace Harlinn.MSSql.Tool.Input.Types
{
    ...
    public class DoubleFieldDefinition : NumericFieldDefinition<double>
    {
        ...
        public DoubleFieldDefinition(SystemDataType systemColumnType, Column column, FieldDefaultConstraint? defaultConstraint, FieldComputed? computed, List<FieldCheckConstraint>? checks, string? description)
