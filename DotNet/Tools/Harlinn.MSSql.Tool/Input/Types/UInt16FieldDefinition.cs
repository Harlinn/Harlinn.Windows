...
namespace Harlinn.MSSql.Tool.Input.Types
{
    ...
    public class UInt16FieldDefinition : IntegerFieldDefinition<ushort>
    {
        ...
        public UInt16FieldDefinition(SystemColumnType systemColumnType, Column column, FieldDefaultConstraint? defaultConstraint, FieldComputed? computed, List<FieldCheckConstraint>? checks)
