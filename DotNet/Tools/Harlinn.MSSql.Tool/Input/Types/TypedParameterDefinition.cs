...
{
    public abstract class TypedParameterDefinition : ParameterDefinition
    {
        TypeDefinition? _type;
        private string? _typeName;

        protected TypedParameterDefinition()
            : base()
        {
        }

        protected TypedParameterDefinition(Parameter parameter, string? description)
