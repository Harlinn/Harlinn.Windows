...
namespace Harlinn.MSSql.Tool.Input.Types
{
    ...
    public class BooleanFieldDefinition : ValueFieldDefinition<bool>
    {
        ...
        public BooleanFieldDefinition(SystemDataType systemColumnType, Column column, FieldDefaultConstraint? defaultConstraint, FieldComputed? computed, List<FieldCheckConstraint>? checks, string? description)
