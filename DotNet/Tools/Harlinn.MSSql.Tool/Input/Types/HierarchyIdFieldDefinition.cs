...
namespace Harlinn.MSSql.Tool.Input.Types
{
    ...
    public class HierarchyIdFieldDefinition : FieldDefinition
    {
        ...
        public HierarchyIdFieldDefinition(SystemDataType systemColumnType, Column column, FieldDefaultConstraint? defaultConstraint, FieldComputed? computed, List<FieldCheckConstraint>? checks, string? description)
