...
namespace Harlinn.MSSql.Tool.Input.Types
{
    ...
    public class TimeSpanFieldDefinition : ValueFieldDefinition<TimeSpan>
    {
        ...
        public TimeSpanFieldDefinition(SystemDataType systemColumnType, Column column, FieldDefaultConstraint? defaultConstraint, FieldComputed? computed, List<FieldCheckConstraint>? checks, string? description)
