...
int main( int /*argc*/, const char** argv )
{
    ...
    /* start the server */
    std::string command =
        absl::StrCat( executableDirectory.c_str(), "fling_server", gpr_subprocess_binary_extension( ) );
    ...
    /* start the client */
    command =
        absl::StrCat( executableDirectory.c_str( ), "fling_client", gpr_subprocess_binary_extension( ) );
    args[0] = const_cast<char*>( command.c_str( ) );
