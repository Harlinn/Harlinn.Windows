...
#define DATA_SIZE 1024
	...
	for (k = 0; k < DATA_SIZE; k++)
	{
		...
		if (correct != test)
		{
			vlog("Error (%zu) - dot3 result error! *{%a, %a, %a, %a} != {%a, %a, %a, %a} \n", k,
...
BOOST_FIXTURE_TEST_SUITE( TestSuite_dot3, LocalFixture )

// --run_test=TestSuite_dot3/RunTest
BOOST_AUTO_TEST_CASE( RunTest )
{
	auto result = Test_dot3( );
