...
constexpr char RFC3339_full[] = "%Y-%m-%d%ET%H:%M:%E*S%Ez";
constexpr char RFC3339_sec[] = "%Y-%m-%d%ET%H:%M:%S%Ez";

constexpr char RFC1123_full[] = "%a, %d %b %Y %H:%M:%S %z";
constexpr char RFC1123_no_wday[] = "%d %b %Y %H:%M:%S %z";
...
TEST(Format, ExtendedYears) {
  const time_zone utc = utc_time_zone();
  constexpr char e4y_fmt[] = "%E4Y%m%d";  // no separators
