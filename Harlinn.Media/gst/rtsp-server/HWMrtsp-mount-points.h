#pragma once
#ifndef HARLINN_MEDIA_GST_RTSP_SERVER_HWMRTSP_MOUNT_POINTS_H_
#define HARLINN_MEDIA_GST_RTSP_SERVER_HWMRTSP_MOUNT_POINTS_H_
...
{
    class RTSPMountPoints : public GLib::Object
    {
    public:
