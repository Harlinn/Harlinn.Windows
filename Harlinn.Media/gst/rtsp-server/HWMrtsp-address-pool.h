#pragma once
#ifndef HARLINN_MEDIA_GST_RTSP_SERVER_HWMRTSP_ADDRESS_POOL_H_
#define HARLINN_MEDIA_GST_RTSP_SERVER_HWMRTSP_ADDRESS_POOL_H_
...
namespace Harlinn::Media::GStreamer::RtspServer
{
    namespace Internal
    {
        ...
        class RTSPAddressPoolImpl : public BaseT
        {
        public:
            using Base = BaseT;
            HWM_GOBJECT_IMPLEMENT_STANDARD_MEMBERS( RTSPAddressPoolImpl, GstRTSPAddressPool )
