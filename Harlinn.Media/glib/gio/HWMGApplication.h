#pragma once 
#ifndef HARLINN_MEDIA_GLIB_GIO_HWMGAPPLICATION_H_
#define HARLINN_MEDIA_GLIB_GIO_HWMGAPPLICATION_H_
/*
...
namespace Harlinn::Media::GLib::GIO
{
    namespace Internal
    {
        ...
        class ApplicationImpl : public BaseT
        {
        public:
            using Base = BaseT;
            HWM_GOBJECT_IMPLEMENT_STANDARD_MEMBERS( ApplicationImpl, GApplication )
        };
    }
