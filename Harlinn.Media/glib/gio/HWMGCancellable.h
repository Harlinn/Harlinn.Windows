#pragma once 
#ifndef HARLINN_MEDIA_GLIB_GIO_HWMGCANCELLABLE_H_
#define HARLINN_MEDIA_GLIB_GIO_HWMGCANCELLABLE_H_
/*
...
namespace Harlinn::Media::GLib::GIO
{
    namespace Internal
    {
        ...
        class CancellableImpl : public BaseT
        {
        public:
            using Base = BaseT;
            HWM_GOBJECT_IMPLEMENT_STANDARD_MEMBERS( CancellableImpl, GCancellable )
        };
    }
