#pragma once 
#ifndef HARLINN_MEDIA_GLIB_GIO_HWMGAPPLICATIONCOMMANDLINE_H_
#define HARLINN_MEDIA_GLIB_GIO_HWMGAPPLICATIONCOMMANDLINE_H_
/*
...
namespace Harlinn::Media::GLib::GIO
{
    namespace Internal
    {
        ...
        class ApplicationCommandLineImpl : public BaseT
        {
        public:
            using Base = BaseT;
            HWM_GOBJECT_IMPLEMENT_STANDARD_MEMBERS( ApplicationCommandLineImpl, GApplicationCommandLine )
        };
    }
