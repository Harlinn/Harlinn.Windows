#pragma once 
#ifndef HARLINN_MEDIA_GLIB_GIO_HWMGIOSTREAM_H_
#define HARLINN_MEDIA_GLIB_GIO_HWMGIOSTREAM_H_
/*
...
namespace Harlinn::Media::GLib::GIO
{
    namespace Internal
    {
        ...
        class IOStreamImpl : public BaseT
        {
        public:
            using Base = BaseT;
            HWM_GOBJECT_IMPLEMENT_STANDARD_MEMBERS( IOStreamImpl, GIOStream )
        };
    }
