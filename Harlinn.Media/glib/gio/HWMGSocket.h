#pragma once //HWMGSocket.h
#ifndef HARLINN_MEDIA_GLIB_GIO_HWMGSOCKET_H_
#define HARLINN_MEDIA_GLIB_GIO_HWMGSOCKET_H_
/*
...
namespace Harlinn::Media::GLib::GIO
{
    namespace Internal
    {
        ...
        class SocketImpl : public BaseT
        {
        public:
            using Base = BaseT;
            HWM_GOBJECT_IMPLEMENT_STANDARD_MEMBERS( SocketImpl, GSocket )
        };
    }
