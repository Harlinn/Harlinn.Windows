...
///
////////////////////////////////////////////////////////////
class OutputSoundFile : NonCopyable
{
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API OutputSoundFile();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API bool openFromFile(const std::string& filename, unsigned int sampleRate, unsigned int channelCount);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void write(const Int16* samples, Uint64 count);
