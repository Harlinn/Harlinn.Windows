...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API virtual ~SoundRecorder();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API bool start(unsigned int sampleRate = 44100);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API static std::vector<std::string> getAvailableDevices();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API static std::string getDefaultDevice();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API const std::string& getDevice() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void setChannelCount(unsigned int channelCount);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API static bool isAvailable();
...
protected:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void setProcessingInterval(Time interval);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API virtual bool onStart();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API virtual bool onProcessSamples(const Int16* samples, std::size_t sampleCount) = 0;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API virtual void onStop();
...
private:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void processCapturedSamples();
