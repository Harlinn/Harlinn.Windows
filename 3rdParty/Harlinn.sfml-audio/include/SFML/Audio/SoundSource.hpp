...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API SoundSource(const SoundSource& copy);

    ////////////////////////////////////////////////////////////
    /// \brief Destructor
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API virtual ~SoundSource();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void setPitch(float pitch);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void setPosition(float x, float y, float z);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void setRelativeToListener(bool relative);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void setMinDistance(float distance);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void setAttenuation(float attenuation);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API float getPitch() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API float getVolume() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API Vector3f getPosition() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API bool isRelativeToListener() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API float getMinDistance() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API float getAttenuation() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API SoundSource& operator =(const SoundSource& right);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API virtual Status getStatus() const;
