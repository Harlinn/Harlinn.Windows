...
///
////////////////////////////////////////////////////////////
class InputSoundFile : NonCopyable
{
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API bool openFromFile(const std::string& filename);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API bool openFromMemory(const void* data, std::size_t sizeInBytes);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API bool openFromStream(InputStream& stream);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API Time getTimeOffset() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API Uint64 getSampleOffset() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void seek(Uint64 sampleOffset);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void seek(Time timeOffset);
