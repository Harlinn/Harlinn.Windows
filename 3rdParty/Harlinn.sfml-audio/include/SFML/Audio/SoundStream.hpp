...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API virtual ~SoundStream();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API Status getStatus() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void setPlayingOffset(Time timeOffset);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API Time getPlayingOffset() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void setLoop(bool loop);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API bool getLoop() const;
...
protected:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void initialize(unsigned int channelCount, unsigned int sampleRate);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API virtual bool onGetData(Chunk& data) = 0;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API virtual void onSeek(Time timeOffset) = 0;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API virtual Int64 onLoop();
...
private:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void streamData();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API bool fillAndPushBuffer(unsigned int bufferNum, bool immediateLoop = false);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void clearQueue();
