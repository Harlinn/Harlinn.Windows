...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API SoundBuffer(const SoundBuffer& copy);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API bool loadFromFile(const std::string& filename);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API bool loadFromMemory(const void* data, std::size_t sizeInBytes);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API bool loadFromStream(InputStream& stream);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API bool loadFromSamples(const Int16* samples, Uint64 sampleCount, unsigned int channelCount, unsigned int sampleRate);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API bool saveToFile(const std::string& filename) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API const Int16* getSamples() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API Uint64 getSampleCount() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API unsigned int getSampleRate() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API unsigned int getChannelCount() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API Time getDuration() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API SoundBuffer& operator =(const SoundBuffer& right);
...
private:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API bool initialize(InputSoundFile& file);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API bool update(unsigned int channelCount, unsigned int sampleRate);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void attachSound(Sound* sound) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API void detachSound(Sound* sound) const;
