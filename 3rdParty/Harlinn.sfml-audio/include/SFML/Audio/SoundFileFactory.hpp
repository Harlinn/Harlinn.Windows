...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API static SoundFileReader* createReaderFromFilename(const std::string& filename);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API static SoundFileReader* createReaderFromMemory(const void* data, std::size_t sizeInBytes);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API static SoundFileReader* createReaderFromStream(InputStream& stream);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_AUDIO_API static SoundFileWriter* createWriterFromFilename(const std::string& filename);
