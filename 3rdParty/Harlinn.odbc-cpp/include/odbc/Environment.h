...
public:
     ...
     */
    ODBC_EXPORT static EnvironmentRef create();

private:
    ODBC_EXPORT Environment();
    ODBC_EXPORT ~Environment();
...
public:
     ...
     */
    ODBC_EXPORT ConnectionRef createConnection();
     ...
     */
    ODBC_EXPORT std::vector<DataSourceInformation> getDataSources();
     ...
     */
    ODBC_EXPORT std::vector<DataSourceInformation> getDataSources(DSNType dsnType);
     ...
     */
    ODBC_EXPORT std::vector<DriverInformation> getDrivers();
     ...
     */
    ODBC_EXPORT bool isDriverInstalled(const char* name);
