...
public:
     ...
     */
    ODBC_EXPORT decimal(std::int64_t value, std::uint8_t precision, std::uint8_t scale = 0);
     ...
     * @param scale      The scale.
     */
    ODBC_EXPORT decimal(std::uint64_t value, std::uint8_t precision,
        std::uint8_t scale = 0);
     ...
     * @param scale      The scale.
     */
    ODBC_EXPORT decimal(const std::string& value, std::uint8_t precision,
        std::uint8_t scale = 0);
     ...
     * @param scale      The scale.
     */
    ODBC_EXPORT decimal(const char* value, std::uint8_t precision, std::uint8_t scale = 0);
     ...
     */
    ODBC_EXPORT std::uint8_t precision() const { return precision_; }
     ...
     */
    ODBC_EXPORT std::uint8_t scale() const { return scale_; }
     ...
     */
    ODBC_EXPORT std::int8_t signum() const;
     ...
     */
    ODBC_EXPORT const char* unscaledValue() const { return value_.c_str(); }
     ...
     */
    ODBC_EXPORT std::string toString() const;
     ...
     *               false otherwise.
     */
    ODBC_EXPORT bool operator==(const decimal& other) const;
...
private:
    ODBC_EXPORT int cmp(const decimal& other) const;
...
public:
     ...
     */
    ODBC_EXPORT date(int year, int month, int day);
...
public:
     ...
     *               otherwise.
     */
    ODBC_EXPORT bool operator==(const date& other) const;
...
private:
    ODBC_EXPORT static int daysInMonth(int year, int month);
    ODBC_EXPORT static int daysInFebruary(int year);
...
public:
     ...
     */
    ODBC_EXPORT time(int hour, int minute, int second);
...
public:
     ...
     *               otherwise.
     */
    ODBC_EXPORT bool operator==(const time& other) const;
...
public:
     ...
     */
    ODBC_EXPORT timestamp(int year, int month, int day, int hour, int minute, int second,
        int milliseconds);
...
public:
     ...
     */
    ODBC_EXPORT bool operator==(const timestamp& other) const;
