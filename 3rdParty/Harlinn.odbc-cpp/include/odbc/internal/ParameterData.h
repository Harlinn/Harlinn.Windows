...
public:
     ...
     */
    ODBC_EXPORT ParameterData(ParameterData&& other);
     ...
     */
    ODBC_EXPORT ParameterData& operator=(ParameterData&& other);
...
public:
     ...
     */
    ODBC_EXPORT void setValue(std::int16_t type, const void* value, std::size_t size);
     ...
     * @param type  The ODBC-C-type of the value.
     */
    ODBC_EXPORT void setNull(std::int16_t type);
     ...
     */
    ODBC_EXPORT const void* getData() const;
     ...
     */
    ODBC_EXPORT bool usesHeapBuffer() const;
     ...
     */
    ODBC_EXPORT void releaseHeapBufferOwnership();
     ...
     * heap buffer again.
     */
    ODBC_EXPORT void restoreHeapBufferOwnership();
