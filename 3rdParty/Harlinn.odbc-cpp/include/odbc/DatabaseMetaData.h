 ...
 * for further details.
 */
class DatabaseMetaData : public DatabaseMetaDataBase
{
    friend class Connection;

private:
    ODBC_EXPORT DatabaseMetaData(Connection* parent);
...
public:
     ...
     */
    ODBC_EXPORT std::string getDataSourceName();
     ...
     */
    ODBC_EXPORT std::string getDatabaseName();
     ...
     */
    ODBC_EXPORT std::string getDBMSName();
     ...
     */
    ODBC_EXPORT std::string getDBMSVersion();
     ...
     */
    ODBC_EXPORT std::string getDriverName();
     ...
     */
    ODBC_EXPORT std::string getDriverVersion();
     ...
     */
    ODBC_EXPORT std::string getServerName();
     ...
     */
    ODBC_EXPORT std::string getUserName();
};
//------------------------------------------------------------------------------
NS_ODBC_END
//------------------------------------------------------------------------------
