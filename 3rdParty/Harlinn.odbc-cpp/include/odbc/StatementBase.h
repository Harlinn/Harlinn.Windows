 ...
 */
class StatementBase : public RefCounted
{
...
private:
    ODBC_EXPORT StatementBase(Connection* parent);
    ODBC_EXPORT ~StatementBase();
...
public:
     ...
     */
    ODBC_EXPORT unsigned long getMaxRows();
     ...
     */
    ODBC_EXPORT void setMaxRows(unsigned long maxRows);
     ...
     */
    ODBC_EXPORT unsigned long getQueryTimeout();
     ...
     */
    ODBC_EXPORT void setQueryTimeout(unsigned long seconds);
};
//------------------------------------------------------------------------------
NS_ODBC_END
//------------------------------------------------------------------------------
