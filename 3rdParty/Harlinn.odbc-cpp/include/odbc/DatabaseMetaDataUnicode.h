 ...
 * for further details.
 */
class DatabaseMetaDataUnicode : public DatabaseMetaDataBase
{
    friend class Connection;

private:
    ODBC_EXPORT DatabaseMetaDataUnicode(Connection* parent);
...
public:
     ...
     *                     table description.
     */
    ODBC_EXPORT ResultSetRef getColumns(
     ...
     */
    ODBC_EXPORT ResultSetRef getColumnPrivileges(
        const char16_t* catalogName,
        const char16_t* schemaName,
        const char16_t* tableName,
        const char16_t* columnName);
     ...
     *                     table description.
     */
    ODBC_EXPORT ResultSetRef getPrimaryKeys(
        const char16_t* catalogName,
        const char16_t* schemaName,
        const char16_t* tableName);
     ...
     */
    ODBC_EXPORT ResultSetRef getSpecialColumns(
    ...
    /**
      ...
      */
    ODBC_EXPORT ResultSetRef getStatistics(
        const char16_t* catalogName,
        const char16_t* schemaName,
        const char16_t* tableName,
        IndexType indexType,
     ...
     *                     table description.
     */
    ODBC_EXPORT ResultSetRef getTables(
        const char16_t* catalogName,
        const char16_t* schemaName,
        const char16_t* tableName,
     ...
     *              type information.
     */
    ODBC_EXPORT ResultSetRef getTypeInfo();
     ...
     *              type information.
     */
    ODBC_EXPORT ResultSetRef getTypeInfo(int type);
     ...
     */
    ODBC_EXPORT std::u16string getDataSourceName();
     ...
     */
    ODBC_EXPORT std::u16string getDatabaseName();
     ...
     */
    ODBC_EXPORT std::u16string getDBMSName();
     ...
     */
    ODBC_EXPORT std::u16string getDBMSVersion();
     ...
     */
    ODBC_EXPORT std::u16string getDriverName();
     ...
     */
    ODBC_EXPORT std::u16string getDriverVersion();
     ...
     */
    ODBC_EXPORT std::u16string getServerName();
     ...
     */
    ODBC_EXPORT std::u16string getUserName();

private:
    ODBC_EXPORT std::u16string getStringTypeInfoW(unsigned short typeInfo);
};
//------------------------------------------------------------------------------
NS_ODBC_END
//------------------------------------------------------------------------------
