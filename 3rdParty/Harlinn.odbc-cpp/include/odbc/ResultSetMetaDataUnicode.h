 ...
 */
class ResultSetMetaDataUnicode : public ResultSetMetaDataBase
{
...
public:
     ...
     */
    ODBC_EXPORT std::u16string getCatalogName(unsigned short columnIndex);
     ...
     */
    ODBC_EXPORT std::u16string getSchemaName(unsigned short columnIndex);
     ...
     */
    ODBC_EXPORT std::u16string getTableName(unsigned short columnIndex);
     ...
     */
    ODBC_EXPORT std::u16string getBaseTableName(unsigned short columnIndex);
     ...
     */
    ODBC_EXPORT std::u16string getBaseColumnName(unsigned short columnIndex);
     ...
     */
    ODBC_EXPORT std::u16string getColumnLabel(unsigned short columnIndex);
     ...
     */
    ODBC_EXPORT std::u16string getColumnName(unsigned short columnIndex);
     ...
     */
    ODBC_EXPORT std::u16string getColumnTypeName(unsigned short columnIndex);

private:
    ODBC_EXPORT std::u16string getStringColAttribute(unsigned short columnIndex,
