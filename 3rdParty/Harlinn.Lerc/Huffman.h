...
public:
  ...
  HLERC_EXPORT bool ComputeCodes(const std::vector<int>& histo);    // input histogram, size < 2^15

  HLERC_EXPORT bool ComputeCompressedSize(const std::vector<int>& histo, int& numBytes, double& avgBpp) const;
  ...
  HLERC_EXPORT bool SetCodes(const std::vector<std::pair<unsigned short, unsigned int> >& codeTable);

  HLERC_EXPORT bool WriteCodeTable(Byte** ppByte, int lerc2Version) const;
  HLERC_EXPORT bool ReadCodeTable(const Byte** ppByte, size_t& nBytesRemaining, int lerc2Version);

  HLERC_EXPORT bool BuildTreeFromCodes(int& numBitsLUT);
...
private:
  ...
  HLERC_EXPORT bool ComputeNumBytesCodeTable(int& numBytes) const;
  HLERC_EXPORT bool GetRange(int& i0, int& i1, int& maxCodeLength) const;
  HLERC_EXPORT bool BitStuffCodes(Byte** ppByte, int i0, int i1) const;
  HLERC_EXPORT bool BitUnStuffCodes(const Byte** ppByte, size_t& nBytesRemaining, int i0, int i1);
  HLERC_EXPORT bool ConvertCodesToCanonical();
  HLERC_EXPORT void ClearTree();
};
