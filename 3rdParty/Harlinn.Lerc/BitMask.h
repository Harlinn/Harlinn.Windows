...
public:
  ...
  HLERC_EXPORT BitMask& operator= (const BitMask& src);
  ...
  HLERC_EXPORT void SetAllValid() const;
  HLERC_EXPORT void SetAllInvalid() const;

  HLERC_EXPORT bool SetSize(int nCols, int nRows);
  ...
  HLERC_EXPORT int CountValidBits() const;
