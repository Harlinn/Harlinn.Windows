...
template unsigned int HLERC_EXPORT Lerc2::ComputeNumBytesNeededToWrite<signed char>(const signed char* arr, double maxZError, bool encodeMask);
template unsigned int HLERC_EXPORT Lerc2::ComputeNumBytesNeededToWrite<Byte>(const Byte* arr, double maxZError, bool encodeMask);
template unsigned int HLERC_EXPORT Lerc2::ComputeNumBytesNeededToWrite<short>(const short* arr, double maxZError, bool encodeMask);
template unsigned int HLERC_EXPORT Lerc2::ComputeNumBytesNeededToWrite<unsigned short>(const unsigned short* arr, double maxZError, bool encodeMask);
template unsigned int HLERC_EXPORT Lerc2::ComputeNumBytesNeededToWrite<int>(const int* arr, double maxZError, bool encodeMask);
template unsigned int HLERC_EXPORT Lerc2::ComputeNumBytesNeededToWrite<unsigned int>(const unsigned int* arr, double maxZError, bool encodeMask);
template unsigned int HLERC_EXPORT Lerc2::ComputeNumBytesNeededToWrite<float>(const float* arr, double maxZError, bool encodeMask);
template unsigned int HLERC_EXPORT Lerc2::ComputeNumBytesNeededToWrite<double>(const double* arr, double maxZError, bool encodeMask);
...
template bool HLERC_EXPORT Lerc2::Encode<signed char>(const signed char* arr, Byte** ppByte);
template bool HLERC_EXPORT Lerc2::Encode<Byte>(const Byte* arr, Byte** ppByte);
template bool HLERC_EXPORT Lerc2::Encode<short>(const short* arr, Byte** ppByte);
template bool HLERC_EXPORT Lerc2::Encode<unsigned short>(const unsigned short* arr, Byte** ppByte);
template bool HLERC_EXPORT Lerc2::Encode<int>(const int* arr, Byte** ppByte);
template bool HLERC_EXPORT Lerc2::Encode<unsigned int>(const unsigned int* arr, Byte** ppByte);
template bool HLERC_EXPORT Lerc2::Encode<float>(const float* arr, Byte** ppByte);
template bool HLERC_EXPORT Lerc2::Encode<double>(const double* arr, Byte** ppByte);
...
template bool HLERC_EXPORT Lerc2::Decode<signed char>(const Byte** ppByte, size_t& nBytesRemaining, signed char* arr, Byte* pMaskBits);
template bool HLERC_EXPORT Lerc2::Decode<Byte>(const Byte** ppByte, size_t& nBytesRemaining, Byte* arr, Byte* pMaskBits);
template bool HLERC_EXPORT Lerc2::Decode<short>(const Byte** ppByte, size_t& nBytesRemaining, short* arr, Byte* pMaskBits);
template bool HLERC_EXPORT Lerc2::Decode<unsigned short>(const Byte** ppByte, size_t& nBytesRemaining, unsigned short* arr, Byte* pMaskBits);
template bool HLERC_EXPORT Lerc2::Decode<int>(const Byte** ppByte, size_t& nBytesRemaining, int* arr, Byte* pMaskBits);
template bool HLERC_EXPORT Lerc2::Decode<unsigned int>(const Byte** ppByte, size_t& nBytesRemaining, unsigned int* arr, Byte* pMaskBits);
template bool HLERC_EXPORT Lerc2::Decode<float>(const Byte** ppByte, size_t& nBytesRemaining, float* arr, Byte* pMaskBits);
template bool HLERC_EXPORT Lerc2::Decode<double>(const Byte** ppByte, size_t& nBytesRemaining, double* arr, Byte* pMaskBits);
