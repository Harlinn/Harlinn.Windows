...
constexpr BoxTag NewTag(const char s[kTagSize + 1]) {
  return BoxTag{static_cast<std::uint8_t>( s[0] ), static_cast<std::uint8_t>( s[1] ), static_cast<std::uint8_t>( s[2] ), static_cast<std::uint8_t>( s[3] )};
}
