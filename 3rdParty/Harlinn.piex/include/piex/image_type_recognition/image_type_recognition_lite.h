...
HPIEX_EXPORT bool IsRaw(const RawImageTypes type);

// Checks if the given source is from given type.
HPIEX_EXPORT bool IsOfType(const binary_parse::RangeCheckedBytePtr& source,
