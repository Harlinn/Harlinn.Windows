...
#include <piex/image_type_recognition/image_type_recognition_lite.h>
#include <piex/piex_types.h>

namespace piex {

// Returns the maximum number of bytes IsRaw() will read from the stream.
HPIEX_EXPORT size_t BytesRequiredForIsRaw();
...
// from the stream.
HPIEX_EXPORT bool IsRaw(StreamInterface* data);
...
HPIEX_EXPORT Error GetPreviewImageData(
