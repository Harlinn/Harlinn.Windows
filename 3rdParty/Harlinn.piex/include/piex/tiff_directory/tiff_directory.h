...
class TiffDirectory {
 public:
  ...
  HPIEX_EXPORT explicit TiffDirectory(Endian endianness);

  // Returns true if the directory contains the specified tag.
  HPIEX_EXPORT bool Has(const Tag tag) const;
  ...
  HPIEX_EXPORT bool Get(const Tag tag, std::vector<std::uint8_t>* value) const;
  ...
  HPIEX_EXPORT bool Get(const Tag tag, std::string* value) const;
  ...
  HPIEX_EXPORT bool Get(const Tag tag, std::uint32_t* value) const;
  HPIEX_EXPORT bool Get(const Tag tag, std::vector<std::uint32_t>* value) const;
  ...
  // - if, for the non-vector version, the number of elements is unequal to 1.
  HPIEX_EXPORT bool Get(const Tag tag, Rational* value) const;
  HPIEX_EXPORT bool Get(const Tag tag, std::vector<Rational>* value) const;
  ...
  // - if, for the non-vector version, the number of elements is unequal to 1.
  HPIEX_EXPORT bool Get(const Tag tag, SRational* value) const;
  HPIEX_EXPORT bool Get(const Tag tag, std::vector<SRational>* value) const;
  ...
  HPIEX_EXPORT bool GetOffsetAndLength(const Tag tag, const Type type, std::uint32_t* offset,
  ...
  // directory.
  HPIEX_EXPORT void AddEntry(const Tag tag, const Type type, const std::uint32_t count,
                const std::uint32_t offset,
                const std::vector<std::uint8_t>& value);

  // Add a subdirectory to the directory.
  HPIEX_EXPORT void AddSubDirectory(const TiffDirectory& sub_directory);

  // Returns a vector of all subdirectories contained in this directory.
  HPIEX_EXPORT const std::vector<TiffDirectory>& GetSubDirectories() const;
 ...
 private:
  ...
  HPIEX_EXPORT const DirectoryEntry* Find(const Tag tag) const;
...
// a nullptr.
HPIEX_EXPORT size_t SizeOfType(const TiffDirectory::Type type, bool* success);
