#define GEOGRAPHICLIB_VERSION_STRING "2.2"
#define GEOGRAPHICLIB_VERSION_MAJOR 2
#define GEOGRAPHICLIB_VERSION_MINOR 2
...
#ifndef GeographicLib_SHARED_EXPORTS
#pragma comment(lib,"Harlinn.geographiclib.lib")
#endif
