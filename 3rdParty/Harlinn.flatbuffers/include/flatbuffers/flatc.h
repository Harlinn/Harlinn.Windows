...
FLATBUFFERS_EXPORT extern void LogCompilerWarn(const std::string &warn);
FLATBUFFERS_EXPORT extern void LogCompilerError(const std::string &err);
FLATBUFFERS_EXPORT extern int Compile( int argc, const char* argv[ ] );
