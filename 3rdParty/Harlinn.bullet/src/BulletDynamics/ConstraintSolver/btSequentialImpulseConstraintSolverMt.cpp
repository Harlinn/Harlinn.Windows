...
BT_EXPORT bool btSequentialImpulseConstraintSolverMt::s_allowNestedParallelForLoops = false;  // some task schedulers don't like nested loops
BT_EXPORT int btSequentialImpulseConstraintSolverMt::s_minimumContactManifoldsForBatching = 250;
BT_EXPORT int btSequentialImpulseConstraintSolverMt::s_minBatchSize = 50;
BT_EXPORT int btSequentialImpulseConstraintSolverMt::s_maxBatchSize = 100;
BT_EXPORT btBatchedConstraints::BatchingMethod btSequentialImpulseConstraintSolverMt::s_contactBatchingMethod = btBatchedConstraints::BATCHING_METHOD_SPATIAL_GRID_2D;
BT_EXPORT btBatchedConstraints::BatchingMethod btSequentialImpulseConstraintSolverMt::s_jointBatchingMethod = btBatchedConstraints::BATCHING_METHOD_SPATIAL_GRID_2D;
