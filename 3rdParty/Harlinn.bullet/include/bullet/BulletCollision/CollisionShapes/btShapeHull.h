...
public:
	...
	BT_EXPORT btShapeHull(const btConvexShape* shape);
	BT_EXPORT ~btShapeHull();

	BT_EXPORT bool buildHull(btScalar margin, int highres = 0);

	BT_EXPORT int numTriangles() const;
	BT_EXPORT int numVertices() const;
	BT_EXPORT int numIndices() const;
