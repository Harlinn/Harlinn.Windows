...
public:
	...
	BT_EXPORT btConeShape(btScalar radius, btScalar height);
	...
	///choose upAxis index
	BT_EXPORT void setConeUpIndex(int upIndex);
...
{
public:
	BT_EXPORT btConeShapeX(btScalar radius, btScalar height);
...
{
public:
	BT_EXPORT btConeShapeZ(btScalar radius, btScalar height);
