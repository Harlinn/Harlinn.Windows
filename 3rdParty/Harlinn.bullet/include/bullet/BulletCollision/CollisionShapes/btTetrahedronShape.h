...
public:
	...
	BT_EXPORT btBU_Simplex1to4();

	BT_EXPORT btBU_Simplex1to4(const btVector3& pt0);
	BT_EXPORT btBU_Simplex1to4(const btVector3& pt0, const btVector3& pt1);
	BT_EXPORT btBU_Simplex1to4(const btVector3& pt0, const btVector3& pt1, const btVector3& pt2);
	BT_EXPORT btBU_Simplex1to4(const btVector3& pt0, const btVector3& pt1, const btVector3& pt2, const btVector3& pt3);
	...
	BT_EXPORT void addVertex(const btVector3& pt);
	...
	BT_EXPORT virtual int getIndex(int i) const;
