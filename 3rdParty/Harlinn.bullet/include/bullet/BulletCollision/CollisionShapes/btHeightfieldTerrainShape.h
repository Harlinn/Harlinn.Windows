...
protected:
	...
	BT_EXPORT virtual btScalar getRawHeightFieldValue(int x, int y) const;
	BT_EXPORT void quantizeWithClamp(int* out, const btVector3& point, int isMax) const;
	 ...
	 */
	BT_EXPORT void initialize(int heightStickWidth, int heightStickLength,
...
public:
	...
	BT_EXPORT btHeightfieldTerrainShape(
	 ...
	 */
	BT_EXPORT btHeightfieldTerrainShape(int heightStickWidth, int heightStickLength,
							  const void* heightfieldData, btScalar heightScale,
	...
	/**
 	 ...
 	 */
	BT_EXPORT btHeightfieldTerrainShape(int heightStickWidth, int heightStickLength, const void* heightfieldData, btScalar maxHeight, int upAxis, bool useFloatData, bool flipQuadEdges);

	BT_EXPORT virtual ~btHeightfieldTerrainShape();
	...
	BT_EXPORT void getVertex(int x, int y, btVector3& vertex) const;

	BT_EXPORT void performRaycast(btTriangleCallback * callback, const btVector3& raySource, const btVector3& rayTarget) const;

	BT_EXPORT void buildAccelerator(int chunkSize = 16);
	BT_EXPORT void clearAccelerator();
