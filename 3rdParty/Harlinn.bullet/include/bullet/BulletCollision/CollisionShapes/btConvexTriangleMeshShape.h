...
public:
	...
	BT_EXPORT btConvexTriangleMeshShape(btStridingMeshInterface * meshInterface, bool calcAabb = true);
	...
	BT_EXPORT void calculatePrincipalAxisTransform(btTransform & principal, btVector3 & inertia, btScalar & volume) const;
};
