...
public:
	...
	BT_EXPORT btCylinderShape(const btVector3& halfExtents);
...
public:
	...
	BT_EXPORT btCylinderShapeX(const btVector3& halfExtents);
...
public:
	...
	BT_EXPORT btCylinderShapeZ(const btVector3& halfExtents);
