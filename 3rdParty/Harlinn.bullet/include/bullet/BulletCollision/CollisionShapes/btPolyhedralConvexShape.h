...
public:
	...
	BT_EXPORT btPolyhedralConvexShape();

	BT_EXPORT virtual ~btPolyhedralConvexShape();

	///optional method mainly used to generate multiple contact points by clipping polyhedral features (faces/edges)
	///experimental/work-in-progress
	BT_EXPORT virtual bool initializePolyhedralFeatures(int shiftVerticesByMargin = 0);

	BT_EXPORT virtual void setPolyhedralFeatures(btConvexPolyhedron & polyhedron);
...
protected:
	BT_EXPORT btPolyhedralConvexAabbCachingShape();
...
public:
	...
	BT_EXPORT void recalcLocalAabb();
};
