...
public:
	...
	BT_EXPORT btCollisionObject();

	BT_EXPORT virtual ~btCollisionObject();
	...
	BT_EXPORT void setActivationState(int newState) const;
	...
	BT_EXPORT void forceActivationState(int newState) const;

	BT_EXPORT void activate(bool forceActivation = false) const;
