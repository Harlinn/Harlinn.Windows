...
public:
	BT_EXPORT btConvexConvexAlgorithm(btPersistentManifold* mf, const btCollisionAlgorithmConstructionInfo& ci, const btCollisionObjectWrapper* body0Wrap, const btCollisionObjectWrapper* body1Wrap, btConvexPenetrationDepthSolver* pdSolver, int numPerturbationIterations, int minimumPointsPerturbationThreshold);

	BT_EXPORT virtual ~btConvexConvexAlgorithm();
	...
	struct CreateFunc : public btCollisionAlgorithmCreateFunc
	{
		...
		BT_EXPORT CreateFunc(btConvexPenetrationDepthSolver* pdSolver);
