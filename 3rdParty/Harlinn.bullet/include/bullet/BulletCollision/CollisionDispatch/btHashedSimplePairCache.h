...
public:
	BT_EXPORT btHashedSimplePairCache();
	BT_EXPORT virtual ~btHashedSimplePairCache();

	BT_EXPORT void removeAllPairs();

	BT_EXPORT virtual void* removeOverlappingPair(int indexA, int indexB);
...
private:
	BT_EXPORT btSimplePair* internalAddPair(int indexA, int indexB);
