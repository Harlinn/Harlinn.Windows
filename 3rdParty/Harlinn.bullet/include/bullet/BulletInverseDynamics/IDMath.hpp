...
BT_EXPORT void setZero(vec3& v);
/// set all elements to zero
BT_EXPORT void setZero(vecx& v);
/// set all elements to zero
BT_EXPORT void setZero(mat33& m);
/// create a skew symmetric matrix from a vector (useful for cross product abstraction, e.g. v x a = V * a)
BT_EXPORT void skew(vec3& v, mat33* result);
/// return maximum absolute value
BT_EXPORT idScalar maxAbs(const vecx& v);
...
BT_EXPORT idScalar maxAbsMat3x(const mat3x& m);
BT_EXPORT void setZero(mat3x& m);
// define math functions on mat3x here to avoid allocations in operators.
BT_EXPORT void mul(const mat33& a, const mat3x& b, mat3x* result);
BT_EXPORT void add(const mat3x& a, const mat3x& b, mat3x* result);
BT_EXPORT void sub(const mat3x& a, const mat3x& b, mat3x* result);
#endif

/// get offset vector & transform matrix from DH parameters
/// TODO: add documentation
BT_EXPORT void getVecMatFromDH(idScalar theta, idScalar d, idScalar a, idScalar alpha, vec3* r, mat33* T);

/// Check if a 3x3 matrix is positive definite
/// @param m a 3x3 matrix
/// @return true if m>0, false otherwise
BT_EXPORT bool isPositiveDefinite(const mat33& m);

/// Check if a 3x3 matrix is positive semi definite
/// @param m a 3x3 matrix
/// @return true if m>=0, false otherwise
BT_EXPORT bool isPositiveSemiDefinite(const mat33& m);
/// Check if a 3x3 matrix is positive semi definite within numeric limits
/// @param m a 3x3 matrix
/// @return true if m>=-eps, false otherwise
BT_EXPORT bool isPositiveSemiDefiniteFuzzy(const mat33& m);
...
/// @param m a 3x3 matrix
/// @return det(m)
BT_EXPORT idScalar determinant(const mat33& m);
...
BT_EXPORT bool isValidInertiaMatrix(const mat33& I, int index, bool has_fixed_joint);

/// Check if a 3x3 matrix is a valid transform (rotation) matrix
/// @param m a 3x3 matrix
/// @return true if m is a rotation matrix, false otherwise
BT_EXPORT bool isValidTransformMatrix(const mat33& m);
