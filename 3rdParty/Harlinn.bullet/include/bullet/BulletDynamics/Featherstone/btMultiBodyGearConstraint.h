...
public:
	...
	BT_EXPORT btMultiBodyGearConstraint(btMultiBody* bodyA, int linkA, btMultiBody* bodyB, int linkB, const btVector3& pivotInA, const btVector3& pivotInB, const btMatrix3x3& frameInA, const btMatrix3x3& frameInB);

	BT_EXPORT virtual ~btMultiBodyGearConstraint();
