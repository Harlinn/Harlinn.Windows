...
public:
	...
	BT_EXPORT static void solveIsland(btConstraintSolver* solver, Island& island, const SolverParams& solverParams);

	typedef void (*IslandDispatchFunc)(btAlignedObjectArray<Island*>* islands, const SolverParams& solverParams);
	BT_EXPORT static void serialIslandDispatch(btAlignedObjectArray<Island*>* islandsPtr, const SolverParams& solverParams);
	BT_EXPORT static void parallelIslandDispatch(btAlignedObjectArray<Island*>* islandsPtr, const SolverParams& solverParams);
...
protected:
	...
	BT_EXPORT Island* getIsland(int id);
	BT_EXPORT virtual Island* allocateIsland(int id, int numBodies);
	BT_EXPORT virtual void initIslandPools();
	BT_EXPORT virtual void addBodiesToIslands(btCollisionWorld* collisionWorld);
	BT_EXPORT virtual void addManifoldsToIslands(btDispatcher* dispatcher);
	BT_EXPORT virtual void addConstraintsToIslands(btAlignedObjectArray<btTypedConstraint*>& constraints);
	BT_EXPORT virtual void mergeIslands();

public:
	BT_EXPORT btSimulationIslandManagerMt();
	BT_EXPORT virtual ~btSimulationIslandManagerMt();

	BT_EXPORT virtual void buildAndProcessIslands(btDispatcher* dispatcher,
										btCollisionWorld* collisionWorld,
										btAlignedObjectArray<btTypedConstraint*>& constraints,
										const SolverParams& solverParams);

	BT_EXPORT virtual void buildIslands(btDispatcher* dispatcher, btCollisionWorld* colWorld);
