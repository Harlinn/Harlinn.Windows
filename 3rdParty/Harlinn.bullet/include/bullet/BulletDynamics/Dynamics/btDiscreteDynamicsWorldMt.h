...
public:
	...
	BT_EXPORT explicit btConstraintSolverPoolMt(int numSolvers);

	// pass in fully constructed solvers (destructor will delete them)
	BT_EXPORT btConstraintSolverPoolMt(btConstraintSolver** solvers, int numSolvers);

	BT_EXPORT virtual ~btConstraintSolverPoolMt();

	///solve a group of constraints
	BT_EXPORT virtual btScalar solveGroup(btCollisionObject** bodies,
								int numBodies,
	...
	BT_EXPORT virtual void reset() BT_OVERRIDE;
...
private:
	...
	BT_EXPORT ThreadSolver* getAndLockThreadSolver();
	BT_EXPORT void init(btConstraintSolver** solvers, int numSolvers);
};
...
protected:
	...
	BT_EXPORT virtual void solveConstraints(btContactSolverInfo & solverInfo) BT_OVERRIDE;

	BT_EXPORT virtual void predictUnconstraintMotion(btScalar timeStep) BT_OVERRIDE;
	...
	BT_EXPORT virtual void createPredictiveContacts(btScalar timeStep) BT_OVERRIDE;
	...
	BT_EXPORT virtual void integrateTransforms(btScalar timeStep) BT_OVERRIDE;

public:
	BT_DECLARE_ALIGNED_ALLOCATOR();

	BT_EXPORT btDiscreteDynamicsWorldMt(btDispatcher * dispatcher,
	...
	BT_EXPORT virtual ~btDiscreteDynamicsWorldMt();

	BT_EXPORT virtual int stepSimulation(btScalar timeStep, int maxSubSteps, btScalar fixedTimeStep) BT_OVERRIDE;
};
