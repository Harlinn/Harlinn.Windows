...
public:
	...
	BT_EXPORT btGeneric6DofSpringConstraint(btRigidBody & rbA, btRigidBody & rbB, const btTransform& frameInA, const btTransform& frameInB, bool useLinearReferenceFrameA);
	BT_EXPORT btGeneric6DofSpringConstraint(btRigidBody & rbB, const btTransform& frameInB, bool useLinearReferenceFrameB);
	BT_EXPORT void enableSpring(int index, bool onOff);
	BT_EXPORT void setStiffness(int index, btScalar stiffness);
	BT_EXPORT void setDamping(int index, btScalar damping);
	...
	BT_EXPORT virtual void setAxis(const btVector3& axis1, const btVector3& axis2);
