...
public:
	...
	BT_EXPORT btPoint2PointConstraint(btRigidBody & rbA, btRigidBody & rbB, const btVector3& pivotInA, const btVector3& pivotInB);

	BT_EXPORT btPoint2PointConstraint(btRigidBody & rbA, const btVector3& pivotInA);
	...
	BT_EXPORT void getInfo2NonVirtual(btConstraintInfo2 * info, const btTransform& body0_trans, const btTransform& body1_trans);
