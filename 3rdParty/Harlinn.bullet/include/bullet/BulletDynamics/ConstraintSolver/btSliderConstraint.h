...
#include "bullet/LinearMath/btScalar.h"  //for BT_USE_DOUBLE_PRECISION
...
public:
	...
	// constructors
	BT_EXPORT btSliderConstraint(btRigidBody & rbA, btRigidBody & rbB, const btTransform& frameInA, const btTransform& frameInB, bool useLinearReferenceFrameA);
	BT_EXPORT btSliderConstraint(btRigidBody & rbB, const btTransform& frameInB, bool useLinearReferenceFrameA);
	...
	BT_EXPORT void getInfo2NonVirtual(btConstraintInfo2 * info, const btTransform& transA, const btTransform& transB, const btVector3& linVelA, const btVector3& linVelB, btScalar rbAinvMass, btScalar rbBinvMass);
	...
	BT_EXPORT void testLinLimits();
	BT_EXPORT void testAngLimits();
	// access for PE Solver
	BT_EXPORT btVector3 getAncorInA();
	BT_EXPORT btVector3 getAncorInB();
