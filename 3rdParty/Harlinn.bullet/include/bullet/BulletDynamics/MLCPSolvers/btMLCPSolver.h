...
protected:
	...
	BT_EXPORT virtual void createMLCP(const btContactSolverInfo& infoGlobal);
...
public:
	BT_EXPORT btMLCPSolver(btMLCPSolverInterface* solver);
	BT_EXPORT virtual ~btMLCPSolver();
