...
#include "bullet/BulletCollision/Gimpact/btGImpactShape.h"  // box tree class
...
protected:
	...
	BT_EXPORT void buildConvexDecomposition(bool transformSubShapes);
...
public:
	...
	BT_EXPORT virtual ~btGImpactConvexDecompositionShape();
