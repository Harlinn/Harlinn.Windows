...
public:
	...
	BT_EXPORT btDeformableNodeAnchorConstraint(const btSoftBody::DeformableNodeRigidAnchor& c, const btContactSolverInfo& infoGlobal);
	BT_EXPORT btDeformableNodeAnchorConstraint(const btDeformableNodeAnchorConstraint& other);
	btDeformableNodeAnchorConstraint() {}
	virtual ~btDeformableNodeAnchorConstraint()
	{
	}
	BT_EXPORT virtual btScalar solveConstraint(const btContactSolverInfo& infoGlobal);

	// object A is the rigid/multi body, and object B is the deformable node/face
	BT_EXPORT virtual btVector3 getVa() const;
	// get the velocity of the deformable node in contact
	BT_EXPORT virtual btVector3 getVb() const;
	BT_EXPORT virtual btVector3 getDv(const btSoftBody::Node* n) const
	{
		return btVector3(0, 0, 0);
	}
	BT_EXPORT virtual void applyImpulse(const btVector3& impulse);
...
public:
	...
	BT_EXPORT btDeformableRigidContactConstraint(const btSoftBody::DeformableRigidContact& c, const btContactSolverInfo& infoGlobal);
	BT_EXPORT btDeformableRigidContactConstraint(const btDeformableRigidContactConstraint& other);
	...
	BT_EXPORT virtual btVector3 getSplitVa() const;
	...
	BT_EXPORT btScalar solveSplitImpulse(const btContactSolverInfo& infoGlobal);

	BT_EXPORT virtual void applySplitImpulse(const btVector3& impulse) = 0;
};
...
public:
	...
	BT_EXPORT btDeformableNodeRigidContactConstraint(const btSoftBody::DeformableNodeRigidContact& contact, const btContactSolverInfo& infoGlobal);
	BT_EXPORT btDeformableNodeRigidContactConstraint(const btDeformableNodeRigidContactConstraint& other);
	...
	// get the split impulse velocity of the deformable face at the contact point
	BT_EXPORT virtual btVector3 getSplitVb() const;

	// get the velocity change of the input soft body node in the constraint
	BT_EXPORT virtual btVector3 getDv(const btSoftBody::Node*) const;
	...
	BT_EXPORT virtual void applySplitImpulse(const btVector3& impulse);
};
...
public:
	...
	BT_EXPORT btDeformableFaceRigidContactConstraint(const btSoftBody::DeformableFaceRigidContact& contact, const btContactSolverInfo& infoGlobal, bool useStrainLimiting);
	BT_EXPORT btDeformableFaceRigidContactConstraint(const btDeformableFaceRigidContactConstraint& other);
...
public:
	...
	BT_EXPORT btDeformableFaceNodeContactConstraint(const btSoftBody::DeformableFaceNodeContact& contact, const btContactSolverInfo& infoGlobal);
