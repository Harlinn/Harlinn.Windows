...
#include "bullet/BulletCollision/BroadphaseCollision/btQuantizedBvh.h"  //for definition of MAX_NUM_PARTS_IN_BITS
...
public:
	...
	BT_EXPORT btSoftBodyTriangleCallback(btDispatcher* dispatcher, const btCollisionObjectWrapper* body0Wrap, const btCollisionObjectWrapper* body1Wrap, bool isSwapped);

	BT_EXPORT void setTimeStepAndCounters(btScalar collisionMarginTriangle, const btCollisionObjectWrapper* triObjWrap, const btDispatcherInfo& dispatchInfo, btManifoldResult* resultOut);

	BT_EXPORT virtual ~btSoftBodyTriangleCallback();

	BT_EXPORT virtual void processTriangle(btVector3* triangle, int partId, int triangleIndex);

	BT_EXPORT void clearCache();
...
public:
	BT_EXPORT btSoftBodyConcaveCollisionAlgorithm(const btCollisionAlgorithmConstructionInfo& ci, const btCollisionObjectWrapper* body0Wrap, const btCollisionObjectWrapper* body1Wrap, bool isSwapped);

	BT_EXPORT virtual ~btSoftBodyConcaveCollisionAlgorithm();
