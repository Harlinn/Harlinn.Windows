...
protected:
	...
	BT_EXPORT int setAngularLimits(b3ConstraintInfo2 * info, int row_offset, const b3Transform& transA, const b3Transform& transB, const b3Vector3& linVelA, const b3Vector3& linVelB, const b3Vector3& angVelA, const b3Vector3& angVelB);

	BT_EXPORT int setLinearLimits(b3ConstraintInfo2 * info, int row, const b3Transform& transA, const b3Transform& transB, const b3Vector3& linVelA, const b3Vector3& linVelB, const b3Vector3& angVelA, const b3Vector3& angVelB);
...
public:
	...
	BT_EXPORT b3Generic6DofConstraint(int rbA, int rbB, const b3Transform& frameInA, const b3Transform& frameInB, bool useLinearReferenceFrameA, const b3RigidBodyData* bodies);
	...
	*/
	BT_EXPORT void calculateTransforms(const b3Transform& transA, const b3Transform& transB, const b3RigidBodyData* bodies);

	BT_EXPORT void calculateTransforms(const b3RigidBodyData* bodies);
    ...
    */
	...
	BT_EXPORT virtual void getInfo1(b3ConstraintInfo1 * info, const b3RigidBodyData* bodies);

	BT_EXPORT void getInfo1NonVirtual(b3ConstraintInfo1 * info, const b3RigidBodyData* bodies);

	BT_EXPORT virtual void getInfo2(b3ConstraintInfo2 * info, const b3RigidBodyData* bodies);

	BT_EXPORT void getInfo2NonVirtual(b3ConstraintInfo2 * info, const b3Transform& transA, const b3Transform& transB, const b3Vector3& linVelA, const b3Vector3& linVelB, const b3Vector3& angVelA, const b3Vector3& angVelB, const b3RigidBodyData* bodies);

	BT_EXPORT void updateRHS(b3Scalar timeStep);

	//! Get the rotation axis in global coordinates
	BT_EXPORT b3Vector3 getAxis(int axis_index) const;

	//! Get the relative Euler angle
	/*!
	\pre b3Generic6DofConstraint::calculateTransforms() must be called previously.
	*/
	BT_EXPORT b3Scalar getAngle(int axis_index) const;

	//! Get the relative position of the constraint pivot
	/*!
	\pre b3Generic6DofConstraint::calculateTransforms() must be called previously.
	*/
	BT_EXPORT b3Scalar getRelativePivotPosition(int axis_index) const;

	BT_EXPORT void setFrames(const b3Transform& frameA, const b3Transform& frameB, const b3RigidBodyData* bodies);
	...
	\pre b3Generic6DofConstraint::calculateTransforms() must be called previously.
	*/
	BT_EXPORT bool testAngularLimitMotor(int axis_index);
    ...
    */
	...
	BT_EXPORT virtual void calcAnchorPos(const b3RigidBodyData* bodies);  // overridable

	BT_EXPORT int get_limit_motor_info2(b3RotationalLimitMotor * limot,
	...
	BT_EXPORT virtual void setParam(int num, b3Scalar value, int axis = -1);
	///return the local value of parameter
	BT_EXPORT virtual b3Scalar getParam(int num, int axis = -1) const;

	BT_EXPORT void setAxis(const b3Vector3& axis1, const b3Vector3& axis2, const b3RigidBodyData* bodies);
};
