...
protected:
	...
	BT_EXPORT b3Scalar getMotorFactor(b3Scalar pos, b3Scalar lowLim, b3Scalar uppLim, b3Scalar vel, b3Scalar timeFact);

public:
	B3_DECLARE_ALIGNED_ALLOCATOR();

	BT_EXPORT virtual ~b3TypedConstraint(){};
	BT_EXPORT b3TypedConstraint(b3TypedConstraintType type, int bodyA, int bodyB);
...
public:
	...
	BT_EXPORT void set(b3Scalar low, b3Scalar high, b3Scalar _softness = 0.9f, b3Scalar _biasFactor = 0.3f, b3Scalar _relaxationFactor = 1.0f);

	/// Checks conastaint angle against limit. If limit is active and the angle violates the limit
	/// correction is calculated.
	BT_EXPORT void test(const b3Scalar angle);
	...
	BT_EXPORT void fit(b3Scalar& angle) const;

	/// Returns correction value multiplied by sign value
	BT_EXPORT b3Scalar getError() const;

	BT_EXPORT b3Scalar getLow() const;

	BT_EXPORT b3Scalar getHigh() const;
};
