...
BT_EXPORT extern CTexFont *g_DefaultSmallFont;
BT_EXPORT extern CTexFont *g_DefaultNormalFont;
BT_EXPORT extern CTexFont *g_DefaultNormalFontAA;
BT_EXPORT extern CTexFont *g_DefaultLargeFont;
BT_EXPORT extern CTexFont *g_DefaultFixed1Font;

BT_EXPORT void TwGenerateDefaultFonts();
BT_EXPORT void TwDeleteDefaultFonts();
