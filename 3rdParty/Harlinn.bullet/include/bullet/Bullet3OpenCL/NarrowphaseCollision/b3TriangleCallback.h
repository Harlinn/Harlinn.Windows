...
{
public:
	BT_EXPORT virtual ~b3TriangleCallback();
	BT_EXPORT virtual void processTriangle(b3Vector3* triangle, int partId, int triangleIndex) = 0;
};

class b3InternalTriangleIndexCallback
{
public:
	BT_EXPORT virtual ~b3InternalTriangleIndexCallback();
	BT_EXPORT virtual void internalProcessTriangleIndex(b3Vector3* triangle, int partId, int triangleIndex) = 0;
};
