...
struct b3GjkEpaSolver2
{
	...
	BT_EXPORT static int StackSizeRequirement();

	BT_EXPORT static bool Distance(const b3Transform& transA, const b3Transform& transB,
	...
	BT_EXPORT static bool Penetration(const b3Transform& transA, const b3Transform& transB,
							const b3ConvexPolyhedronData* hullA, const b3ConvexPolyhedronData* hullB,
							const b3AlignedObjectArray<b3Vector3>& verticesA,
							const b3AlignedObjectArray<b3Vector3>& verticesB,
							const b3Vector3& guess,
