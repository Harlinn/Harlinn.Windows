...
public:
	...
	BT_EXPORT virtual ~b3TriangleIndexVertexArray();

	//just to be backwards compatible
	BT_EXPORT b3TriangleIndexVertexArray(int numTriangles, int* triangleIndexBase, int triangleIndexStride, int numVertices, b3Scalar* vertexBase, int vertexStride);
	...
	BT_EXPORT virtual void getLockedVertexIndexBase(unsigned char** vertexbase, int& numverts, PHY_ScalarType& type, int& vertexStride, unsigned char** indexbase, int& indexstride, int& numfaces, PHY_ScalarType& indicestype, int subpart = 0);

	BT_EXPORT virtual void getLockedReadOnlyVertexIndexBase(const unsigned char** vertexbase, int& numverts, PHY_ScalarType& type, int& vertexStride, const unsigned char** indexbase, int& indexstride, int& numfaces, PHY_ScalarType& indicestype, int subpart = 0) const;
	...
	BT_EXPORT virtual bool hasPremadeAabb() const;
	BT_EXPORT virtual void setPremadeAabb(const b3Vector3& aabbMin, const b3Vector3& aabbMax) const;
	BT_EXPORT virtual void getPremadeAabb(b3Vector3 * aabbMin, b3Vector3 * aabbMax) const;
};
