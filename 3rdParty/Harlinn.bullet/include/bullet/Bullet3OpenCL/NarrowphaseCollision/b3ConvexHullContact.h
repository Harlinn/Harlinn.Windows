...
struct GpuSatCollision
{
	...
	BT_EXPORT GpuSatCollision(cl_context ctx, cl_device_id device, cl_command_queue q);
	BT_EXPORT virtual ~GpuSatCollision();

	BT_EXPORT void computeConvexConvexContactsGPUSAT(b3OpenCLArray<b3Int4>* pairs, int nPairs,
