...
public:
	...
	BT_EXPORT virtual ~b3StridingMeshInterface();

	BT_EXPORT virtual void InternalProcessAllTriangles(b3InternalTriangleIndexCallback * callback, const b3Vector3& aabbMin, const b3Vector3& aabbMax) const;

	///brute force method to calculate aabb
	BT_EXPORT void calculateAabbBruteForce(b3Vector3 & aabbMin, b3Vector3 & aabbMax);
