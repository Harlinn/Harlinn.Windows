...
public:
	...
	BT_EXPORT int addManifoldPoint(const b3Vector3& newPoint);
	...
	*/
	...
	BT_EXPORT static bool validContactDistance(const b3Vector3& pt);

	/// calculated new worldspace coordinates and depth, and reject points that exceed the collision margin
	BT_EXPORT static void refreshContactPoints(const b3Transform& trA, const b3Transform& trB, struct b3Contact4Data& newContactCache);

	BT_EXPORT static void removeContactPoint(struct b3Contact4Data & newContactCache, int i);
};
