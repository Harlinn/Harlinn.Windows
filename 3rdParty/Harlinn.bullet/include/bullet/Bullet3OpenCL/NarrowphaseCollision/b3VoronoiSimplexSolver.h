...
public:
	...
	BT_EXPORT void removeVertex(int index);
	BT_EXPORT void reduceVertices(const b3UsageBitfield& usedVerts);
	BT_EXPORT bool updateClosestVectorAndPoints();

	BT_EXPORT bool closestPtPointTetrahedron(const b3Vector3& p, const b3Vector3& a, const b3Vector3& b, const b3Vector3& c, const b3Vector3& d, b3SubSimplexClosestResult& finalResult);
	BT_EXPORT int pointOutsideOfPlane(const b3Vector3& p, const b3Vector3& a, const b3Vector3& b, const b3Vector3& c, const b3Vector3& d);
	BT_EXPORT bool closestPtPointTriangle(const b3Vector3& p, const b3Vector3& a, const b3Vector3& b, const b3Vector3& c, b3SubSimplexClosestResult& result);
...
public:
	...
	BT_EXPORT void addVertex(const b3Vector3& w, const b3Vector3& p, const b3Vector3& q);
	...
	BT_EXPORT bool closest(b3Vector3 & v);

	BT_EXPORT b3Scalar maxVertex();
	...
	BT_EXPORT int getSimplex(b3Vector3 * pBuf, b3Vector3 * qBuf, b3Vector3 * yBuf) const;

	BT_EXPORT bool inSimplex(const b3Vector3& w);

	BT_EXPORT void backup_closest(b3Vector3 & v);

	BT_EXPORT bool emptySimplex() const;

	BT_EXPORT void compute_points(b3Vector3 & p1, b3Vector3 & p2);
