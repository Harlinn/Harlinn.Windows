...
public:
	...
	BT_EXPORT virtual ~b3ConvexUtility();

	BT_EXPORT bool initializePolyhedralFeatures(const b3Vector3* orgVertices, int numVertices, bool mergeCoplanarTriangles = true);
