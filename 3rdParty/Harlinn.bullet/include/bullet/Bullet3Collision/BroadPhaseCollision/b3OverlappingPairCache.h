...
public:
	BT_EXPORT b3HashedOverlappingPairCache();
	BT_EXPORT virtual ~b3HashedOverlappingPairCache();

	BT_EXPORT virtual void removeOverlappingPairsContainingProxy(int proxy, b3Dispatcher* dispatcher);

	BT_EXPORT virtual void* removeOverlappingPair(int proxy0, int proxy1, b3Dispatcher* dispatcher);
	...
	BT_EXPORT void cleanProxyFromPairs(int proxy, b3Dispatcher* dispatcher);

	BT_EXPORT virtual void processAllOverlappingPairs(b3OverlapCallback*, b3Dispatcher* dispatcher);
	...
	BT_EXPORT void cleanOverlappingPair(b3BroadphasePair& pair, b3Dispatcher* dispatcher);

	BT_EXPORT b3BroadphasePair* findPair(int proxy0, int proxy1);
...
private:
	BT_EXPORT b3BroadphasePair* internalAddPair(int proxy0, int proxy1);

	BT_EXPORT void growTables();
	...
	*/
	...
	BT_EXPORT virtual void sortOverlappingPairs(b3Dispatcher* dispatcher);
...
public:
	BT_EXPORT b3SortedOverlappingPairCache();
	BT_EXPORT virtual ~b3SortedOverlappingPairCache();

	BT_EXPORT virtual void processAllOverlappingPairs(b3OverlapCallback*, b3Dispatcher* dispatcher);

	BT_EXPORT void* removeOverlappingPair(int proxy0, int proxy1, b3Dispatcher* dispatcher);

	BT_EXPORT void cleanOverlappingPair(b3BroadphasePair& pair, b3Dispatcher* dispatcher);

	BT_EXPORT b3BroadphasePair* addOverlappingPair(int proxy0, int proxy1);
