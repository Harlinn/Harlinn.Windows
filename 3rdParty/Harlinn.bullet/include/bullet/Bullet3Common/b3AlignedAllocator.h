...
#else
BT_EXPORT void* b3AlignedAllocInternal(size_t size, int alignment);
BT_EXPORT void b3AlignedFreeInternal(void* ptr);
...
BT_EXPORT void b3AlignedAllocSetCustom(b3AllocFunc* allocFunc, b3FreeFunc* freeFunc);
...
BT_EXPORT void b3AlignedAllocSetCustomAligned(b3AlignedAllocFunc* allocFunc, b3AlignedFreeFunc* freeFunc);
