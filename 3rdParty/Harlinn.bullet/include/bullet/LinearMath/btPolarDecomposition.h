...
public:
     ...
     *                        convergence
     */
	BT_EXPORT btPolarDecomposition(btScalar tolerance = btScalar(0.0001),
     ...
     */
    BT_EXPORT unsigned int decompose(const btMatrix3x3& a, btMatrix3x3& u, btMatrix3x3& h) const;
     ...
     */
    BT_EXPORT unsigned int maxIterations() const;
 ...
 * @return the number of iterations performed by the algorithm.
 */
BT_EXPORT unsigned int polarDecompose(const btMatrix3x3& a, btMatrix3x3& u, btMatrix3x3& h);
