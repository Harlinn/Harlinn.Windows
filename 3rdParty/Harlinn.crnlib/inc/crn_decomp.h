...
namespace crnd
{
   ...
   HCRNLIB_EXPORT void crnd_set_memory_callbacks(crnd_realloc_func pRealloc, crnd_msize_func pMSize, void* pUser_data);
   ...
   HCRNLIB_EXPORT uint32 crnd_crn_format_to_fourcc(crn_format fmt);

   // Returns the fundamental GPU format given a potentially swizzled DXT5 crn_format.
   HCRNLIB_EXPORT crn_format crnd_get_fundamental_dxt_format(crn_format fmt);

   // Returns the size of the crn_format in bits/texel (either 4 or 8).
   HCRNLIB_EXPORT uint32 crnd_get_crn_format_bits_per_texel(crn_format fmt);

   // Returns the number of bytes per DXTn block (8 or 16).
   HCRNLIB_EXPORT uint32 crnd_get_bytes_per_dxt_block(crn_format fmt);
   ...
   HCRNLIB_EXPORT bool crnd_validate_file(const void* pData, uint32 data_size, crn_file_info* pFile_info);
   ...
   HCRNLIB_EXPORT bool crnd_get_texture_info(const void* pData, uint32 data_size, crn_texture_info* pTexture_info);
   ...
   HCRNLIB_EXPORT bool crnd_get_level_info(const void* pData, uint32 data_size, uint32 level_index, crn_level_info* pLevel_info);
   ...
   HCRNLIB_EXPORT crnd_unpack_context crnd_unpack_begin(const void* pData, uint32 data_size);
   ...
   HCRNLIB_EXPORT bool crnd_get_data(crnd_unpack_context pContext, const void** ppData, uint32* pData_size);
   ...
   HCRNLIB_EXPORT bool crnd_unpack_level(
   ...
   HCRNLIB_EXPORT bool crnd_unpack_level_segmented(
      crnd_unpack_context pContext,
   ...
   HCRNLIB_EXPORT bool crnd_unpack_end(crnd_unpack_context pContext);
   ...
   HCRNLIB_EXPORT const void* crnd_get_level_data(const void* pData, uint32 data_size, uint32 level_index, uint32* pSize);

   // Returns the compressed size of the texture's header and compression tables (but no levels).
   HCRNLIB_EXPORT uint32 crnd_get_segmented_file_size(const void* pData, uint32 data_size);
   ...
   HCRNLIB_EXPORT bool crnd_create_segmented_file(const void* pData, uint32 data_size, void* pBase_data, uint base_data_size);
