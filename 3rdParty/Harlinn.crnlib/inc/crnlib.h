...
HCRNLIB_EXPORT const char* crn_get_mip_mode_desc(crn_mip_mode m);
HCRNLIB_EXPORT const char* crn_get_mip_mode_name(crn_mip_mode m);
...
HCRNLIB_EXPORT const char* crn_get_mip_filter_name(crn_mip_filter f);
...
HCRNLIB_EXPORT const char* crn_get_scale_mode_desc(crn_scale_mode sm);
...
HCRNLIB_EXPORT void crn_set_memory_callbacks(crn_realloc_func pRealloc, crn_msize_func pMSize, void* pUser_data);

// Frees memory blocks allocated by crn_compress(), crn_decompress_crn_to_dds(), or crn_decompress_dds_to_images().
HCRNLIB_EXPORT void crn_free_block(void *pBlock);
...
HCRNLIB_EXPORT void *crn_compress(const crn_comp_params &comp_params, crn_uint32 &compressed_size, crn_uint32 *pActual_quality_level = NULL, float *pActual_bitrate = NULL);
...
HCRNLIB_EXPORT void *crn_compress(const crn_comp_params &comp_params, const crn_mipmap_params &mip_params, crn_uint32 &compressed_size, crn_uint32 *pActual_quality_level = NULL, float *pActual_bitrate = NULL);
...
HCRNLIB_EXPORT void *crn_decompress_crn_to_dds(const void *pCRN_file_data, crn_uint32 &file_size);
...
HCRNLIB_EXPORT bool crn_decompress_dds_to_images(const void *pDDS_file_data, crn_uint32 dds_file_size, crn_uint32 **ppImages, crn_texture_desc &tex_desc);

// Frees all images allocated by crn_decompress_dds_to_images().
HCRNLIB_EXPORT void crn_free_all_images(crn_uint32 **ppImages, const crn_texture_desc &desc);

// -------- crn_format related helpers functions.

// Returns the FOURCC format equivalent to the specified crn_format.
HCRNLIB_EXPORT crn_uint32 crn_get_format_fourcc(crn_format fmt);

// Returns the crn_format's bits per texel.
HCRNLIB_EXPORT crn_uint32 crn_get_format_bits_per_texel(crn_format fmt);

// Returns the crn_format's number of bytes per block.
HCRNLIB_EXPORT crn_uint32 crn_get_bytes_per_dxt_block(crn_format fmt);

// Returns the non-swizzled, basic DXTn version of the specified crn_format.
// This is the format you would supply D3D or OpenGL.
HCRNLIB_EXPORT crn_format crn_get_fundamental_dxt_format(crn_format fmt);

// -------- String helpers.

// Converts a crn_file_type to a string.
HCRNLIB_EXPORT const char* crn_get_file_type_ext(crn_file_type file_type);

// Converts a crn_format to a string.
HCRNLIB_EXPORT const char* crn_get_format_string(crn_format fmt);

// Converts a crn_dxt_quality to a string.
HCRNLIB_EXPORT const char* crn_get_dxt_quality_string(crn_dxt_quality q);
...
HCRNLIB_EXPORT crn_block_compressor_context_t crn_create_block_compressor(const crn_comp_params &params);
...
HCRNLIB_EXPORT void crn_compress_block(crn_block_compressor_context_t pContext, const crn_uint32 *pPixels, void *pDst_block);

// Frees a DXTn block compressor.
HCRNLIB_EXPORT void crn_free_block_compressor(crn_block_compressor_context_t pContext);
...
HCRNLIB_EXPORT bool crn_decompress_block(const void *pSrc_block, crn_uint32 *pDst_pixels, crn_format crn_fmt);
