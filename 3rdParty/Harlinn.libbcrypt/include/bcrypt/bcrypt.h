 ...
 *
 */
HW_LIBBCRYPT_EXPORT int bcrypt_gensalt(int workfactor, char salt[BCRYPT_HASHSIZE]);
 ...
 * otherwise.
 */
HW_LIBBCRYPT_EXPORT int bcrypt_hashpw(const char *passwd, const char salt[BCRYPT_HASHSIZE],
 ...
 *
 */
HW_LIBBCRYPT_EXPORT int bcrypt_checkpw(const char *passwd, const char hash[BCRYPT_HASHSIZE]);
