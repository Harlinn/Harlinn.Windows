...
//#define ARMA_SUPERLU_INCLUDE_DIR C:/Src/Harlinn.Windows/3rdParty/Harlinn.superlu/
//// If you're using SuperLU and want to explicitly include the SuperLU headers,
//// uncomment the above define and specify the appropriate include directory.
//// Make sure the directory has a trailing /
#endif

#if !defined(ARMA_USE_SUPERLU_HEADERS)
#define ARMA_USE_SUPERLU_HEADERS
#endif
...
#define ARMA_USE_HDF5_ALT
  ...
  #define ARMA_HDF5_INCLUDE_DIR C:/Src/Harlinn.Windows/3rdParty/Harlinn.hdf5/
#endif
...
#define ARMA_AUX_LIBS C:/Program Files (x86)/IntelSWTools/compilers_and_libraries_2020.1.216/windows/mkl/lib/intel64/mkl_rt.lib;optimized;C:/Src/Harlinn.Windows/x64/Release/Harlinn.hdf5.lib;debug;C:/Src/Harlinn.Windows/x64/Debug/Harlinn.hdf5.lib;C:/Src/Harlinn.Windows/x64/Release/Harlinn.superlu.lib
#define ARMA_AUX_INCDIRS C:/Src/Harlinn.Windows/3rdParty/Harlinn.hdf5;C:/Src/Harlinn.Windows/3rdParty/Harlinn.superlu
