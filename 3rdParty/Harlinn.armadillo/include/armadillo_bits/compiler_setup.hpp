...
#if (defined( _MSC_VER ) && !defined(NO_ARMADILLO_EXPORT))
...
#undef arma_fortran_with_prefix_B
  ...
  #define arma_fortran_sans_prefix_B(function) function##_
    ...
    #define arma_fortran_with_prefix_B(function) ARMADILLO_EXPORT wrapper2_##function##_
  #else
    #define arma_fortran_with_prefix_B(function) ARMADILLO_EXPORT wrapper_##function##_
  #endif
#else
...
#undef arma_wrapper
  ...
  #define arma_wrapper(function) ARMADILLO_EXPORT wrapper_##function
#else
