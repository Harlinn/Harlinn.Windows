...
namespace DirectX
{
    ...
    HDXT_EXPORT bool __cdecl IsPacked(_In_ DXGI_FORMAT fmt) noexcept;
    HDXT_EXPORT bool __cdecl IsVideo(_In_ DXGI_FORMAT fmt) noexcept;
    HDXT_EXPORT bool __cdecl IsPlanar(_In_ DXGI_FORMAT fmt) noexcept;
    bool __cdecl IsPalettized(_In_ DXGI_FORMAT fmt) noexcept;
    HDXT_EXPORT bool __cdecl IsDepthStencil(_In_ DXGI_FORMAT fmt) noexcept;
    bool __cdecl IsSRGB(_In_ DXGI_FORMAT fmt) noexcept;
    HDXT_EXPORT bool __cdecl IsBGR(_In_ DXGI_FORMAT fmt) noexcept;
    HDXT_EXPORT bool __cdecl IsTypeless(_In_ DXGI_FORMAT fmt, _In_ bool partialTypeless = true) noexcept;

    HDXT_EXPORT bool __cdecl HasAlpha(_In_ DXGI_FORMAT fmt) noexcept;

    HDXT_EXPORT size_t __cdecl BitsPerPixel(_In_ DXGI_FORMAT fmt) noexcept;

    HDXT_EXPORT size_t __cdecl BitsPerColor(_In_ DXGI_FORMAT fmt) noexcept;
    ...
    HDXT_EXPORT FORMAT_TYPE __cdecl FormatDataType(_In_ DXGI_FORMAT fmt) noexcept;
    ...
    HDXT_EXPORT HRESULT __cdecl ComputePitch(
    ...
    HDXT_EXPORT size_t __cdecl ComputeScanlines(_In_ DXGI_FORMAT fmt, _In_ size_t height) noexcept;

    HDXT_EXPORT DXGI_FORMAT __cdecl MakeSRGB(_In_ DXGI_FORMAT fmt) noexcept;
    HDXT_EXPORT DXGI_FORMAT __cdecl MakeLinear(_In_ DXGI_FORMAT fmt) noexcept;
    HDXT_EXPORT DXGI_FORMAT __cdecl MakeTypeless(_In_ DXGI_FORMAT fmt) noexcept;
    HDXT_EXPORT DXGI_FORMAT __cdecl MakeTypelessUNORM(_In_ DXGI_FORMAT fmt) noexcept;
    HDXT_EXPORT DXGI_FORMAT __cdecl MakeTypelessFLOAT(_In_ DXGI_FORMAT fmt) noexcept;
    ...
    struct TexMetadata
    {
        ...
        HDXT_EXPORT size_t __cdecl ComputeIndex(_In_ size_t mip, _In_ size_t item, _In_ size_t slice) const noexcept;
    ...
    HDXT_EXPORT HRESULT __cdecl GetMetadataFromDDSMemory(
        _In_reads_bytes_(size) const void* pSource, _In_ size_t size,
        _In_ DDS_FLAGS flags,
        _Out_ TexMetadata& metadata) noexcept;
    HDXT_EXPORT HRESULT __cdecl GetMetadataFromDDSFile(
        _In_z_ const wchar_t* szFile,
        _In_ DDS_FLAGS flags,
        _Out_ TexMetadata& metadata) noexcept;

    HDXT_EXPORT HRESULT __cdecl GetMetadataFromHDRMemory(
        _In_reads_bytes_(size) const void* pSource, _In_ size_t size,
        _Out_ TexMetadata& metadata) noexcept;
    HDXT_EXPORT HRESULT __cdecl GetMetadataFromHDRFile(
        _In_z_ const wchar_t* szFile,
        _Out_ TexMetadata& metadata) noexcept;

    HDXT_EXPORT HRESULT __cdecl GetMetadataFromTGAMemory(
        _In_reads_bytes_(size) const void* pSource, _In_ size_t size,
        _In_ TGA_FLAGS flags,
        _Out_ TexMetadata& metadata) noexcept;
    HDXT_EXPORT HRESULT __cdecl GetMetadataFromTGAFile(
        _In_z_ const wchar_t* szFile,
        _In_ TGA_FLAGS flags,
        _Out_ TexMetadata& metadata) noexcept;

#ifdef _WIN32
    HDXT_EXPORT HRESULT __cdecl GetMetadataFromWICMemory(
        _In_reads_bytes_(size) const void* pSource, _In_ size_t size,
        _In_ WIC_FLAGS flags,
        _Out_ TexMetadata& metadata,
        _In_opt_ std::function<void __cdecl(IWICMetadataQueryReader*)> getMQR = nullptr);

    HDXT_EXPORT HRESULT __cdecl GetMetadataFromWICFile(
        _In_z_ const wchar_t* szFile,
        _In_ WIC_FLAGS flags,
        _Out_ TexMetadata& metadata,
        _In_opt_ std::function<void __cdecl(IWICMetadataQueryReader*)> getMQR = nullptr);
    ...
    public:
        ...
        HDXT_EXPORT ScratchImage& __cdecl operator= (ScratchImage&& moveFrom) noexcept;

        ScratchImage(const ScratchImage&) = delete;
        ScratchImage& operator=(const ScratchImage&) = delete;

        HDXT_EXPORT HRESULT __cdecl Initialize(_In_ const TexMetadata& mdata, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;

        HDXT_EXPORT HRESULT __cdecl Initialize1D(_In_ DXGI_FORMAT fmt, _In_ size_t length, _In_ size_t arraySize, _In_ size_t mipLevels, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;
        HDXT_EXPORT HRESULT __cdecl Initialize2D(_In_ DXGI_FORMAT fmt, _In_ size_t width, _In_ size_t height, _In_ size_t arraySize, _In_ size_t mipLevels, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;
        HDXT_EXPORT HRESULT __cdecl Initialize3D(_In_ DXGI_FORMAT fmt, _In_ size_t width, _In_ size_t height, _In_ size_t depth, _In_ size_t mipLevels, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;
        HDXT_EXPORT HRESULT __cdecl InitializeCube(_In_ DXGI_FORMAT fmt, _In_ size_t width, _In_ size_t height, _In_ size_t nCubes, _In_ size_t mipLevels, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;

        HDXT_EXPORT HRESULT __cdecl InitializeFromImage(_In_ const Image& srcImage, _In_ bool allow1D = false, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;
        HDXT_EXPORT HRESULT __cdecl InitializeArrayFromImages(_In_reads_(nImages) const Image* images, _In_ size_t nImages, _In_ bool allow1D = false, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;
        HDXT_EXPORT HRESULT __cdecl InitializeCubeFromImages(_In_reads_(nImages) const Image* images, _In_ size_t nImages, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;
        HDXT_EXPORT HRESULT __cdecl Initialize3DFromImages(_In_reads_(depth) const Image* images, _In_ size_t depth, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;

        HDXT_EXPORT void __cdecl Release() noexcept;

        HDXT_EXPORT bool __cdecl OverrideFormat(_In_ DXGI_FORMAT f) noexcept;

        const TexMetadata& __cdecl GetMetadata() const noexcept { return m_metadata; }
        HDXT_EXPORT const Image* __cdecl GetImage(_In_ size_t mip, _In_ size_t item, _In_ size_t slice) const noexcept;
        ...
        HDXT_EXPORT bool __cdecl IsAlphaAllOpaque() const noexcept;
    ...
    public:
        ...
        HDXT_EXPORT Blob& __cdecl operator= (Blob&& moveFrom) noexcept;

        Blob(const Blob&) = delete;
        Blob& operator=(const Blob&) = delete;

        HDXT_EXPORT HRESULT __cdecl Initialize(_In_ size_t size) noexcept;
        ...
        HDXT_EXPORT HRESULT __cdecl Resize(size_t size) noexcept;
            // Reallocate for a new size

        HDXT_EXPORT HRESULT __cdecl Trim(size_t size) noexcept;
    ...
    // DDS operations
    HDXT_EXPORT HRESULT __cdecl LoadFromDDSMemory(
        _In_reads_bytes_(size) const void* pSource, _In_ size_t size,
        _In_ DDS_FLAGS flags,
        _Out_opt_ TexMetadata* metadata, _Out_ ScratchImage& image) noexcept;
    HDXT_EXPORT HRESULT __cdecl LoadFromDDSFile(
        _In_z_ const wchar_t* szFile,
        _In_ DDS_FLAGS flags,
        _Out_opt_ TexMetadata* metadata, _Out_ ScratchImage& image) noexcept;
    ...
    HDXT_EXPORT HRESULT __cdecl SaveToDDSMemory(
    ...
    HDXT_EXPORT HRESULT __cdecl SaveToDDSFile(
        _In_reads_(nimages) const Image* images, _In_ size_t nimages, _In_ const TexMetadata& metadata,
        _In_ DDS_FLAGS flags, _In_z_ const wchar_t* szFile) noexcept;

    // HDR operations
    HDXT_EXPORT HRESULT __cdecl LoadFromHDRMemory(
        _In_reads_bytes_(size) const void* pSource, _In_ size_t size,
        _Out_opt_ TexMetadata* metadata, _Out_ ScratchImage& image) noexcept;
    HDXT_EXPORT HRESULT __cdecl LoadFromHDRFile(
        _In_z_ const wchar_t* szFile,
        _Out_opt_ TexMetadata* metadata, _Out_ ScratchImage& image) noexcept;

    HDXT_EXPORT HRESULT __cdecl SaveToHDRMemory(_In_ const Image& image, _Out_ Blob& blob) noexcept;
    HDXT_EXPORT HRESULT __cdecl SaveToHDRFile(_In_ const Image& image, _In_z_ const wchar_t* szFile) noexcept;

    // TGA operations
    HDXT_EXPORT HRESULT __cdecl LoadFromTGAMemory(
        _In_reads_bytes_(size) const void* pSource, _In_ size_t size,
        _In_ TGA_FLAGS flags,
        _Out_opt_ TexMetadata* metadata, _Out_ ScratchImage& image) noexcept;
    HDXT_EXPORT HRESULT __cdecl LoadFromTGAFile(
        _In_z_ const wchar_t* szFile,
        _In_ TGA_FLAGS flags,
        _Out_opt_ TexMetadata* metadata, _Out_ ScratchImage& image) noexcept;

    HDXT_EXPORT HRESULT __cdecl SaveToTGAMemory(_In_ const Image& image,
        _In_ TGA_FLAGS flags,
        _Out_ Blob& blob, _In_opt_ const TexMetadata* metadata = nullptr) noexcept;
    HDXT_EXPORT HRESULT __cdecl SaveToTGAFile(_In_ const Image& image,
        _In_ TGA_FLAGS flags,
        _In_z_ const wchar_t* szFile, _In_opt_ const TexMetadata* metadata = nullptr) noexcept;

    // WIC operations
#ifdef _WIN32
    HDXT_EXPORT HRESULT __cdecl LoadFromWICMemory(
        _In_reads_bytes_(size) const void* pSource, _In_ size_t size,
        _In_ WIC_FLAGS flags,
        _Out_opt_ TexMetadata* metadata, _Out_ ScratchImage& image,
        _In_opt_ std::function<void __cdecl(IWICMetadataQueryReader*)> getMQR = nullptr);
    HDXT_EXPORT HRESULT __cdecl LoadFromWICFile(
        _In_z_ const wchar_t* szFile, _In_ WIC_FLAGS flags,
        _Out_opt_ TexMetadata* metadata, _Out_ ScratchImage& image,
        _In_opt_ std::function<void __cdecl(IWICMetadataQueryReader*)> getMQR = nullptr);

    HDXT_EXPORT HRESULT __cdecl SaveToWICMemory(
    ...
    HDXT_EXPORT HRESULT __cdecl SaveToWICFile(
        _In_ const Image& image, _In_ WIC_FLAGS flags, _In_ REFGUID guidContainerFormat,
...
#ifdef _WIN32
    HDXT_EXPORT HRESULT __cdecl FlipRotate(_In_ const Image& srcImage, _In_ TEX_FR_FLAGS flags, _Out_ ScratchImage& image) noexcept;
    HDXT_EXPORT HRESULT __cdecl FlipRotate(
    ...
    HDXT_EXPORT HRESULT __cdecl Resize(
    ...
    HDXT_EXPORT HRESULT __cdecl Convert(
    ...
    HDXT_EXPORT HRESULT __cdecl ConvertToSinglePlane(_In_ const Image& srcImage, _Out_ ScratchImage& image) noexcept;
    HDXT_EXPORT HRESULT __cdecl ConvertToSinglePlane(
        _In_reads_(nimages) const Image* srcImages, _In_ size_t nimages, _In_ const TexMetadata& metadata,
        _Out_ ScratchImage& image) noexcept;
        // Converts the image from a planar format to an equivalent non-planar format

    HDXT_EXPORT HRESULT __cdecl GenerateMipMaps(
    ...
    HDXT_EXPORT HRESULT __cdecl GenerateMipMaps3D(
    ...
    HDXT_EXPORT HRESULT __cdecl ScaleMipMapsAlphaForCoverage(
    ...
    HDXT_EXPORT HRESULT __cdecl PremultiplyAlpha(_In_ const Image& srcImage, _In_ TEX_PMALPHA_FLAGS flags, _Out_ ScratchImage& image) noexcept;
    HDXT_EXPORT HRESULT __cdecl PremultiplyAlpha(
        _In_reads_(nimages) const Image* srcImages, _In_ size_t nimages, _In_ const TexMetadata& metadata,
    ...
    HDXT_EXPORT HRESULT __cdecl Compress(
    ...
    HDXT_EXPORT HRESULT __cdecl Decompress(_In_ const Image& cImage, _In_ DXGI_FORMAT format, _Out_ ScratchImage& image) noexcept;
    HDXT_EXPORT HRESULT __cdecl Decompress(
    ...
    HDXT_EXPORT HRESULT __cdecl ComputeNormalMap(
    ...
    HDXT_EXPORT HRESULT __cdecl CopyRectangle(
    ...
    HDXT_EXPORT HRESULT __cdecl ComputeMSE(_In_ const Image& image1, _In_ const Image& image2, _Out_ float& mse, _Out_writes_opt_(4) float* mseV, _In_ CMSE_FLAGS flags = CMSE_DEFAULT) noexcept;

    HDXT_EXPORT HRESULT __cdecl EvaluateImage(
        _In_ const Image& image,
    ...
    HDXT_EXPORT HRESULT __cdecl TransformImage(
        _In_ const Image& image,
    ...
    HDXT_EXPORT REFGUID __cdecl GetWICCodec(_In_ WICCodecs codec) noexcept;

    HDXT_EXPORT IWICImagingFactory* __cdecl GetWICFactory(bool& iswic2) noexcept;
    HDXT_EXPORT void __cdecl SetWICFactory(_In_opt_ IWICImagingFactory* pWIC) noexcept;
#endif

    //---------------------------------------------------------------------------------
    // DDS helper functions
    HDXT_EXPORT HRESULT __cdecl EncodeDDSHeader(
...
#if defined(__d3d11_h__) || defined(__d3d11_x_h__)
    HDXT_EXPORT bool __cdecl IsSupportedTexture(_In_ ID3D11Device* pDevice, _In_ const TexMetadata& metadata) noexcept;

    HDXT_EXPORT HRESULT __cdecl CreateTexture(
    ...
    HDXT_EXPORT HRESULT __cdecl CreateShaderResourceView(
        _In_ ID3D11Device* pDevice, _In_reads_(nimages) const Image* srcImages, _In_ size_t nimages, _In_ const TexMetadata& metadata,
        _Outptr_ ID3D11ShaderResourceView** ppSRV) noexcept;

    HDXT_EXPORT HRESULT __cdecl CreateTextureEx(
        _In_ ID3D11Device* pDevice, _In_reads_(nimages) const Image* srcImages, _In_ size_t nimages, _In_ const TexMetadata& metadata,
    ...
    HDXT_EXPORT HRESULT __cdecl CreateShaderResourceViewEx(
        _In_ ID3D11Device* pDevice, _In_reads_(nimages) const Image* srcImages, _In_ size_t nimages, _In_ const TexMetadata& metadata,
        _In_ D3D11_USAGE usage, _In_ unsigned int bindFlags, _In_ unsigned int cpuAccessFlags, _In_ unsigned int miscFlags, _In_ CREATETEX_FLAGS flags,
        _Outptr_ ID3D11ShaderResourceView** ppSRV) noexcept;

    HDXT_EXPORT HRESULT __cdecl CaptureTexture(_In_ ID3D11Device* pDevice, _In_ ID3D11DeviceContext* pContext, _In_ ID3D11Resource* pSource, _Out_ ScratchImage& result) noexcept;
#endif

    // Direct3D 12 functions
#if defined(__d3d12_h__) || defined(__d3d12_x_h__) || defined(__XBOX_D3D12_X__)
    HDXT_EXPORT bool __cdecl IsSupportedTexture(_In_ ID3D12Device* pDevice, _In_ const TexMetadata& metadata) noexcept;
    ...
    HDXT_EXPORT HRESULT __cdecl PrepareUpload(
        _In_ ID3D12Device* pDevice,
        _In_reads_(nimages) const Image* srcImages, _In_ size_t nimages, _In_ const TexMetadata& metadata,
        std::vector<D3D12_SUBRESOURCE_DATA>& subresources);

    HDXT_EXPORT HRESULT __cdecl CaptureTexture(
