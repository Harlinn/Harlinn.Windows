...
LIVE555_EXPORT char const* const liveMediaLibraryVersionStr = LIVEMEDIA_LIBRARY_VERSION_STRING;
LIVE555_EXPORT int const liveMediaLibraryVersionInt = LIVEMEDIA_LIBRARY_VERSION_INT;
