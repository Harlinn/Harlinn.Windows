...
LIVE555_EXPORT char const* const groupsockLibraryVersionStr = GROUPSOCK_LIBRARY_VERSION_STRING;
LIVE555_EXPORT int const groupsockLibraryVersionInt = GROUPSOCK_LIBRARY_VERSION_INT;
