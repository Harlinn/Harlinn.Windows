...
extern "C" void LIVE555_EXPORT our_srandom(int x);
extern "C" long LIVE555_EXPORT our_random();
extern "C" u_int32_t LIVE555_EXPORT our_random32(); // because "our_random()" returns a 31-bit number
