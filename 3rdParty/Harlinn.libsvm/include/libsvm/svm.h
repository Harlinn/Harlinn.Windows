...
extern LIBSVM_EXPORT int libsvm_version;
...
LIBSVM_EXPORT void svm_get_sv_indices(const struct svm_model *model, int *sv_indices);
LIBSVM_EXPORT int svm_get_nr_sv(const struct svm_model *model);
LIBSVM_EXPORT double svm_get_svr_probability(const struct svm_model *model);

LIBSVM_EXPORT double svm_predict_values(const struct svm_model *model, const struct svm_node *x, double* dec_values);
...
LIBSVM_EXPORT void svm_free_model_content(struct svm_model *model_ptr);
LIBSVM_EXPORT void svm_free_and_destroy_model(struct svm_model **model_ptr_ptr);
...
LIBSVM_EXPORT void svm_set_print_string_function(void (*print_func)(const char *));
