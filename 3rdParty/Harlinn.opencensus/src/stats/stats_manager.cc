...
template OPENCENSUS_EXPORT void StatsManager::AddMeasure(MeasureDouble measure);
template OPENCENSUS_EXPORT void StatsManager::AddMeasure(MeasureInt64 measure);
