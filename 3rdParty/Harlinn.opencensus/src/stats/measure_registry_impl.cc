...
template <>
OPENCENSUS_EXPORT MeasureDouble MeasureRegistryImpl::Register(absl::string_view name,
...
template <>
OPENCENSUS_EXPORT MeasureInt64 MeasureRegistryImpl::Register(absl::string_view name,
                                           absl::string_view description,
                                           absl::string_view units) {
