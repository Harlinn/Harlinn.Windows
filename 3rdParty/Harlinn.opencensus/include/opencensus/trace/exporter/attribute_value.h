...
class AttributeValue final {
 public:
  ...
  OPENCENSUS_EXPORT explicit AttributeValue(AttributeValueRef ref);
  OPENCENSUS_EXPORT ~AttributeValue();

  // AttributeValue is copyable and movable.
  OPENCENSUS_EXPORT AttributeValue(const AttributeValue&);
  OPENCENSUS_EXPORT AttributeValue(AttributeValue&&);
  OPENCENSUS_EXPORT AttributeValue& operator=(const AttributeValue&);
  OPENCENSUS_EXPORT AttributeValue& operator=(AttributeValue&&);
  ...
  OPENCENSUS_EXPORT const std::string& string_value() const;
  OPENCENSUS_EXPORT bool bool_value() const;
  OPENCENSUS_EXPORT int64_t int_value() const;

  // Equality of type and value.
  OPENCENSUS_EXPORT bool operator==(const AttributeValue& v) const;
  OPENCENSUS_EXPORT bool operator!=(const AttributeValue& v) const;
