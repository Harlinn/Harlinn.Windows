...
class ProbabilitySampler final : public Sampler {
 public:
  OPENCENSUS_EXPORT explicit ProbabilitySampler(double probability);

  OPENCENSUS_EXPORT bool ShouldSample(const SpanContext* parent_context, bool has_remote_parent,
