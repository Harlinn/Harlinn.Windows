...
OPENCENSUS_EXPORT SpanContext FromCloudTraceContextHeader(absl::string_view header);

// Returns a value for the X-Cloud-Trace-Context header.
OPENCENSUS_EXPORT std::string ToCloudTraceContextHeader(const SpanContext& ctx);
