...
class View {
 public:
  ...
  OPENCENSUS_EXPORT View(const ViewDescriptor& descriptor);

  // Not copyable, since views are RAII handles for resource collection.
  OPENCENSUS_EXPORT View(const View& view) = delete;
  OPENCENSUS_EXPORT View& operator=(const View& view) = delete;

  // Stops data collection.
  OPENCENSUS_EXPORT ~View();
  ...
  OPENCENSUS_EXPORT const ViewData GetData();
