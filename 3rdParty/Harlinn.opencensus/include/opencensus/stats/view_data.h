...
class ViewData {
 public:
  ...
  OPENCENSUS_EXPORT const Aggregation& aggregation() const;
  ...
  OPENCENSUS_EXPORT Type type() const;
  ...
  OPENCENSUS_EXPORT const DataMap<double>& double_data() const;
  OPENCENSUS_EXPORT const DataMap<int64_t>& int_data() const;
  OPENCENSUS_EXPORT const DataMap<Distribution>& distribution_data() const;

  OPENCENSUS_EXPORT absl::Time start_time() const;
  OPENCENSUS_EXPORT absl::Time end_time() const;

  OPENCENSUS_EXPORT ViewData(const ViewData& other);
