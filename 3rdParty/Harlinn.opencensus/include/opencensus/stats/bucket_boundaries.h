...
class BucketBoundaries final {
 public:
  ...
  OPENCENSUS_EXPORT static BucketBoundaries Linear(int num_finite_buckets, double offset,
                                 double width);
  ...
  OPENCENSUS_EXPORT static BucketBoundaries Exponential(int num_finite_buckets, double scale,
  ...
  OPENCENSUS_EXPORT static BucketBoundaries Explicit(std::vector<double> boundaries);
  ...
  OPENCENSUS_EXPORT int BucketForValue(double value) const;
