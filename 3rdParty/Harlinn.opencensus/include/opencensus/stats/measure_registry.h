...
class MeasureRegistry final {
 public:
  ...
  OPENCENSUS_EXPORT static const MeasureDescriptor& GetDescriptorByName(absl::string_view name);
  ...
  OPENCENSUS_EXPORT static MeasureDouble GetMeasureDoubleByName(absl::string_view name);
  OPENCENSUS_EXPORT static MeasureInt64 GetMeasureInt64ByName(absl::string_view name);
};
