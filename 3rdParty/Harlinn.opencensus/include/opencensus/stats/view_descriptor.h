...
class ViewDescriptor final {
 public:
  ...
  OPENCENSUS_EXPORT ViewDescriptor();
  ...
  OPENCENSUS_EXPORT ViewDescriptor& set_name(absl::string_view name);
  const std::string& name() const { return name_; }

  // Sets the measure. If no measure is registered under 'name' any View created
  // with the descriptor will be invalid.
  OPENCENSUS_EXPORT ViewDescriptor& set_measure(absl::string_view name);
  ...
  OPENCENSUS_EXPORT const MeasureDescriptor& measure_descriptor() const;

  // Sets and retrieves the ViewDescriptor's aggregation. See aggregation.h for
  // details of the options.
  OPENCENSUS_EXPORT ViewDescriptor& set_aggregation(const Aggregation& aggregation);
  OPENCENSUS_EXPORT const Aggregation& aggregation() const { return aggregation_; }
  ...
  // view's columns.
  OPENCENSUS_EXPORT ViewDescriptor& add_column(opencensus::tags::TagKey tag_key);
  ...
  OPENCENSUS_EXPORT ViewDescriptor& set_description(absl::string_view description);
  ...
  OPENCENSUS_EXPORT void RegisterForExport() const;
  ...
  OPENCENSUS_EXPORT bool operator==(const ViewDescriptor& other) const;
 ...
 private:
  ...
  OPENCENSUS_EXPORT friend void SetAggregationWindow(const AggregationWindow&, ViewDescriptor*);
