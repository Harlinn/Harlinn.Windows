...
class ViewDataImpl {
 public:
  ...
  OPENCENSUS_EXPORT ViewDataImpl(absl::Time start_time, const ViewDescriptor& descriptor);
  ...
  // kStatsObject).
  OPENCENSUS_EXPORT ViewDataImpl(const ViewDataImpl& other, absl::Time now);

  OPENCENSUS_EXPORT ViewDataImpl(const ViewDataImpl& other);
  OPENCENSUS_EXPORT ~ViewDataImpl();

  // Returns a copy of the present state of the object and resets data() and
  // start_time().
  OPENCENSUS_EXPORT std::unique_ptr<ViewDataImpl> GetDeltaAndReset(absl::Time now);
  ...
  // supported.
  OPENCENSUS_EXPORT void Merge(const std::vector<std::string>& tag_values,
 ...
 private:
  ...
  OPENCENSUS_EXPORT ViewDataImpl(ViewDataImpl* source, absl::Time now);

  OPENCENSUS_EXPORT Type TypeForDescriptor(const ViewDescriptor& descriptor);
