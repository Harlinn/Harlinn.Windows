...
class MeasureData final {
 public:
  OPENCENSUS_EXPORT MeasureData(absl::Span<const BucketBoundaries> boundaries);

  OPENCENSUS_EXPORT void Add(double value);
  ...
  OPENCENSUS_EXPORT void AddToDistribution(Distribution* distribution) const;
