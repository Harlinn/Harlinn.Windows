...
class Measure final {
 public:
  ...
  OPENCENSUS_EXPORT static Measure<MeasureT> Register(absl::string_view name,
                                    absl::string_view description,
                                    absl::string_view units);

  // Retrieves a copy of the Measure's descriptor. This is expensive, requiring
  // a lookup in the MeasureRegistry.
  OPENCENSUS_EXPORT const MeasureDescriptor& GetDescriptor() const;
  ...
  OPENCENSUS_EXPORT bool IsValid() const;
...
using MeasureDouble = Measure<double>;
using MeasureInt64 = Measure<int64_t>;
...
template <>
OPENCENSUS_EXPORT bool Measure<int64_t>::IsValid( ) const;
template <>
