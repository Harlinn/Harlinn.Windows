...
class WithTagMap {
 public:
  OPENCENSUS_EXPORT explicit WithTagMap(const TagMap& tags, bool cond = true);
  OPENCENSUS_EXPORT explicit WithTagMap(TagMap&& tags, bool cond = true);
  OPENCENSUS_EXPORT ~WithTagMap();
