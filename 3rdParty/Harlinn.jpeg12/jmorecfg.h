...
#define jpeg_component_info     jpeg_component_info12
#define J_COLOR_SPACE           J_COLOR_SPACE12
...
#define ENTROPY_OPT_SUPPORTED	    /* Optimization of entropy coding params? */
