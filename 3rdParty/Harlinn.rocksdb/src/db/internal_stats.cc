...
ROCKSDB_LIBRARY_API const std::string DB::Properties::kNumFilesAtLevelPrefix =
    rocksdb_prefix + num_files_at_level_prefix;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kCompressionRatioAtLevelPrefix =
    rocksdb_prefix + compression_ratio_at_level_prefix;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kStats = rocksdb_prefix + allstats;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kSSTables = rocksdb_prefix + sstables;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kCFStats = rocksdb_prefix + cfstats;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kCFStatsNoFileHistogram =
    rocksdb_prefix + cfstats_no_file_histogram;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kCFFileHistogram =
    rocksdb_prefix + cf_file_histogram;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kDBStats = rocksdb_prefix + dbstats;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kLevelStats = rocksdb_prefix + levelstats;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kBlockCacheEntryStats =
    rocksdb_prefix + block_cache_entry_stats;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kNumImmutableMemTable =
    rocksdb_prefix + num_immutable_mem_table;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kNumImmutableMemTableFlushed =
    rocksdb_prefix + num_immutable_mem_table_flushed;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kMemTableFlushPending =
    rocksdb_prefix + mem_table_flush_pending;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kCompactionPending =
    rocksdb_prefix + compaction_pending;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kNumRunningCompactions =
    rocksdb_prefix + num_running_compactions;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kNumRunningFlushes =
    rocksdb_prefix + num_running_flushes;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kBackgroundErrors =
    rocksdb_prefix + background_errors;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kCurSizeActiveMemTable =
    rocksdb_prefix + cur_size_active_mem_table;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kCurSizeAllMemTables =
    rocksdb_prefix + cur_size_all_mem_tables;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kSizeAllMemTables =
    rocksdb_prefix + size_all_mem_tables;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kNumEntriesActiveMemTable =
    rocksdb_prefix + num_entries_active_mem_table;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kNumEntriesImmMemTables =
    rocksdb_prefix + num_entries_imm_mem_tables;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kNumDeletesActiveMemTable =
    rocksdb_prefix + num_deletes_active_mem_table;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kNumDeletesImmMemTables =
    rocksdb_prefix + num_deletes_imm_mem_tables;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kEstimateNumKeys =
    rocksdb_prefix + estimate_num_keys;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kEstimateTableReadersMem =
    rocksdb_prefix + estimate_table_readers_mem;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kIsFileDeletionsEnabled =
    rocksdb_prefix + is_file_deletions_enabled;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kNumSnapshots =
    rocksdb_prefix + num_snapshots;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kOldestSnapshotTime =
    rocksdb_prefix + oldest_snapshot_time;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kOldestSnapshotSequence =
    rocksdb_prefix + oldest_snapshot_sequence;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kNumLiveVersions =
    rocksdb_prefix + num_live_versions;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kCurrentSuperVersionNumber =
    rocksdb_prefix + current_version_number;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kEstimateLiveDataSize =
    rocksdb_prefix + estimate_live_data_size;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kMinLogNumberToKeep =
    rocksdb_prefix + min_log_number_to_keep_str;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kMinObsoleteSstNumberToKeep =
    rocksdb_prefix + min_obsolete_sst_number_to_keep_str;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kTotalSstFilesSize =
    rocksdb_prefix + total_sst_files_size;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kLiveSstFilesSize =
    rocksdb_prefix + live_sst_files_size;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kBaseLevel = rocksdb_prefix + base_level_str;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kEstimatePendingCompactionBytes =
    rocksdb_prefix + estimate_pending_comp_bytes;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kAggregatedTableProperties =
    rocksdb_prefix + aggregated_table_properties;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kAggregatedTablePropertiesAtLevel =
    rocksdb_prefix + aggregated_table_properties_at_level;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kActualDelayedWriteRate =
    rocksdb_prefix + actual_delayed_write_rate;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kIsWriteStopped =
    rocksdb_prefix + is_write_stopped;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kEstimateOldestKeyTime =
    rocksdb_prefix + estimate_oldest_key_time;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kBlockCacheCapacity =
    rocksdb_prefix + block_cache_capacity;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kBlockCacheUsage =
    rocksdb_prefix + block_cache_usage;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kBlockCachePinnedUsage =
    rocksdb_prefix + block_cache_pinned_usage;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kOptionsStatistics =
    rocksdb_prefix + options_statistics;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kLiveSstFilesSizeAtTemperature =
    rocksdb_prefix + live_sst_files_size_at_temperature;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kNumBlobFiles =
    rocksdb_prefix + num_blob_files;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kBlobStats = rocksdb_prefix + blob_stats;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kTotalBlobFileSize =
    rocksdb_prefix + total_blob_file_size;
ROCKSDB_LIBRARY_API const std::string DB::Properties::kLiveBlobFileSize =
