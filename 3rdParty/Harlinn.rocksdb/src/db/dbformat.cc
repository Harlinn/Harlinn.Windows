...
ROCKSDB_LIBRARY_API const ValueType kValueTypeForSeek = kTypeDeletionWithTimestamp;
ROCKSDB_LIBRARY_API const ValueType kValueTypeForSeekForPrev = kTypeDeletion;
