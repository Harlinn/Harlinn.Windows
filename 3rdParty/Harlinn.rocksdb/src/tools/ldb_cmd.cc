...
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_ENV_URI = "env_uri";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_FS_URI = "fs_uri";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_DB = "db";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_PATH = "path";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_SECONDARY_PATH = "secondary_path";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_HEX = "hex";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_KEY_HEX = "key_hex";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_VALUE_HEX = "value_hex";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_CF_NAME = "column_family";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_TTL = "ttl";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_TTL_START = "start_time";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_TTL_END = "end_time";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_TIMESTAMP = "timestamp";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_TRY_LOAD_OPTIONS = "try_load_options";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_DISABLE_CONSISTENCY_CHECKS =
    "disable_consistency_checks";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_IGNORE_UNKNOWN_OPTIONS =
    "ignore_unknown_options";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_FROM = "from";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_TO = "to";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_MAX_KEYS = "max_keys";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_BLOOM_BITS = "bloom_bits";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_FIX_PREFIX_LEN = "fix_prefix_len";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_COMPRESSION_TYPE = "compression_type";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_COMPRESSION_MAX_DICT_BYTES =
    "compression_max_dict_bytes";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_BLOCK_SIZE = "block_size";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_AUTO_COMPACTION = "auto_compaction";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_DB_WRITE_BUFFER_SIZE = "db_write_buffer_size";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_WRITE_BUFFER_SIZE = "write_buffer_size";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_FILE_SIZE = "file_size";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_CREATE_IF_MISSING = "create_if_missing";
ROCKSDB_LIBRARY_API const std::string LDBCommand::ARG_NO_VALUE = "no_value";

ROCKSDB_LIBRARY_API const char* LDBCommand::DELIM = " ==> ";
