...
class IOTraceRecordParser {
 public:
  ROCKSDB_LIBRARY_API explicit IOTraceRecordParser(const std::string& input_file);
  ...
  ROCKSDB_LIBRARY_API int ReadIOTraceRecords();
...
ROCKSDB_LIBRARY_API int io_tracer_parser(int argc, char** argv);
