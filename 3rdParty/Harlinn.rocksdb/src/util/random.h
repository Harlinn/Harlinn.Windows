...
class Random {
 ...
 public:
  ...
  ROCKSDB_LIBRARY_API std::string RandomString(int len);

  // Generates a random string of len bytes using human-readable characters
  ROCKSDB_LIBRARY_API std::string HumanReadableString(int len);

  // Generates a random binary data
  ROCKSDB_LIBRARY_API std::string RandomBinaryString(int len);

  // Returns a Random instance for use by the current thread without
  // additional locking
  ROCKSDB_LIBRARY_API static Random* GetTLSInstance();
};
