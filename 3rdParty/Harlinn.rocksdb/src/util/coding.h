...
constexpr unsigned int kMaxVarint64Length = 10;

// Standard Put... routines append to a string
ROCKSDB_LIBRARY_API extern void PutFixed16(std::string* dst, uint16_t value);
ROCKSDB_LIBRARY_API extern void PutFixed32(std::string* dst, uint32_t value);
ROCKSDB_LIBRARY_API extern void PutFixed64(std::string* dst, uint64_t value);
ROCKSDB_LIBRARY_API extern void PutVarint32(std::string* dst, uint32_t value);
ROCKSDB_LIBRARY_API extern void PutVarint32Varint32(std::string* dst, uint32_t value1,
                                uint32_t value2);
ROCKSDB_LIBRARY_API extern void PutVarint32Varint32Varint32(std::string* dst, uint32_t value1,
                                        uint32_t value2, uint32_t value3);
ROCKSDB_LIBRARY_API extern void PutVarint64(std::string* dst, uint64_t value);
ROCKSDB_LIBRARY_API extern void PutVarint64Varint64(std::string* dst, uint64_t value1,
                                uint64_t value2);
ROCKSDB_LIBRARY_API extern void PutVarint32Varint64(std::string* dst, uint32_t value1,
                                uint64_t value2);
ROCKSDB_LIBRARY_API extern void PutVarint32Varint32Varint64(std::string* dst, uint32_t value1,
                                        uint32_t value2, uint64_t value3);
ROCKSDB_LIBRARY_API extern void PutLengthPrefixedSlice(std::string* dst, const Slice& value);
ROCKSDB_LIBRARY_API extern void PutLengthPrefixedSliceParts(std::string* dst,
                                        const SliceParts& slice_parts);
ROCKSDB_LIBRARY_API extern void PutLengthPrefixedSlicePartsWithPadding(
    std::string* dst, const SliceParts& slice_parts, size_t pad_sz);

// Standard Get... routines parse a value from the beginning of a Slice
// and advance the slice past the parsed value.
ROCKSDB_LIBRARY_API extern bool GetFixed64(Slice* input, uint64_t* value);
ROCKSDB_LIBRARY_API extern bool GetFixed32(Slice* input, uint32_t* value);
ROCKSDB_LIBRARY_API extern bool GetFixed16(Slice* input, uint16_t* value);
ROCKSDB_LIBRARY_API extern bool GetVarint32(Slice* input, uint32_t* value);
ROCKSDB_LIBRARY_API extern bool GetVarint64(Slice* input, uint64_t* value);
ROCKSDB_LIBRARY_API extern bool GetVarsignedint64(Slice* input, int64_t* value);
ROCKSDB_LIBRARY_API extern bool GetLengthPrefixedSlice(Slice* input, Slice* result);
// This function assumes data is well-formed.
ROCKSDB_LIBRARY_API extern Slice GetLengthPrefixedSlice(const char* data);

ROCKSDB_LIBRARY_API extern Slice GetSliceUntil(Slice* slice, char delimiter);
...
// [p..limit-1]
ROCKSDB_LIBRARY_API extern const char* GetVarint32Ptr(const char* p,const char* limit, uint32_t* v);
ROCKSDB_LIBRARY_API extern const char* GetVarint64Ptr(const char* p,const char* limit, uint64_t* v);
...
ROCKSDB_LIBRARY_API extern int VarintLength(uint64_t v);

// Lower-level versions of Put... that write directly into a character buffer
// and return a pointer just past the last byte written.
// REQUIRES: dst has enough space for the value being written
ROCKSDB_LIBRARY_API extern char* EncodeVarint32(char* dst, uint32_t value);
ROCKSDB_LIBRARY_API extern char* EncodeVarint64(char* dst, uint64_t value);

// Internal routine for use by fallback path of GetVarint32Ptr
ROCKSDB_LIBRARY_API extern const char* GetVarint32PtrFallback(const char* p,
                                          const char* limit,
                                          uint32_t* value);
