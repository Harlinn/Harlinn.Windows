...
ROCKSDB_LIBRARY_API extern uint64_t Hash64(const char* data, size_t n, uint64_t seed);

// Specific optimization without seed (same as seed = 0)
ROCKSDB_LIBRARY_API extern uint64_t Hash64(const char* data, size_t n);
...
// scalars
ROCKSDB_LIBRARY_API void Hash2x64(const char* data, size_t n, uint64_t* high64, uint64_t* low64);
ROCKSDB_LIBRARY_API void Hash2x64(const char* data, size_t n, uint64_t seed, uint64_t* high64,
              uint64_t* low64);

// Hash 128 bits to 128 bits, guaranteed not to lose data (equivalent to
// Hash2x64 on 16 bytes little endian)
ROCKSDB_LIBRARY_API void BijectiveHash2x64(uint64_t in_high64, uint64_t in_low64,
                       uint64_t* out_high64, uint64_t* out_low64);
ROCKSDB_LIBRARY_API void BijectiveHash2x64(uint64_t in_high64, uint64_t in_low64, uint64_t seed,
                       uint64_t* out_high64, uint64_t* out_low64);

// Inverse of above (mostly for testing)
ROCKSDB_LIBRARY_API void BijectiveUnhash2x64(uint64_t in_high64, uint64_t in_low64,
                         uint64_t* out_high64, uint64_t* out_low64);
ROCKSDB_LIBRARY_API void BijectiveUnhash2x64(uint64_t in_high64, uint64_t in_low64, uint64_t seed,
                         uint64_t* out_high64, uint64_t* out_low64);
...
ROCKSDB_LIBRARY_API extern uint32_t Hash(const char* data, size_t n, uint32_t seed);
...
ROCKSDB_LIBRARY_API extern uint64_t (*kGetSliceNPHash64UnseededFnPtr)(const Slice&);
...
ROCKSDB_LIBRARY_API extern uint64_t GetSlicePartsNPHash64(const SliceParts& data, uint64_t seed);
