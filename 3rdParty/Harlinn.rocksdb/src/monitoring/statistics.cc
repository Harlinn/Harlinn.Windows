...
ROCKSDB_LIBRARY_API const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
...
ROCKSDB_LIBRARY_API const std::vector<std::pair<Histograms, std::string>> HistogramsNameMap = {
