...
struct HistogramStat {
  ROCKSDB_LIBRARY_API HistogramStat();
  ROCKSDB_LIBRARY_API ~HistogramStat() {}

  HistogramStat(const HistogramStat&) = delete;
  HistogramStat& operator=(const HistogramStat&) = delete;

  ROCKSDB_LIBRARY_API void Clear();
  ROCKSDB_LIBRARY_API bool Empty() const;
  ROCKSDB_LIBRARY_API void Add(uint64_t value);
  ROCKSDB_LIBRARY_API void Merge(const HistogramStat& other);
  ...
  ROCKSDB_LIBRARY_API double Median() const;
  ROCKSDB_LIBRARY_API double Percentile(double p) const;
  ROCKSDB_LIBRARY_API double Average() const;
  ROCKSDB_LIBRARY_API double StandardDeviation() const;
  ROCKSDB_LIBRARY_API void Data(HistogramData* const data) const;
...
class HistogramImpl : public Histogram {
 public:
  ...
  ROCKSDB_LIBRARY_API virtual void Clear() override;
  ROCKSDB_LIBRARY_API virtual bool Empty() const override;
  ROCKSDB_LIBRARY_API virtual void Add(uint64_t value) override;
  ROCKSDB_LIBRARY_API virtual void Merge(const Histogram& other) override;
  ROCKSDB_LIBRARY_API void Merge(const HistogramImpl& other);

  ROCKSDB_LIBRARY_API virtual std::string ToString() const override;
  ...
  ROCKSDB_LIBRARY_API virtual double Median() const override;
  ROCKSDB_LIBRARY_API virtual double Percentile(double p) const override;
  ROCKSDB_LIBRARY_API virtual double Average() const override;
  ROCKSDB_LIBRARY_API virtual double StandardDeviation() const override;
  ROCKSDB_LIBRARY_API virtual void Data(HistogramData* const data) const override;
