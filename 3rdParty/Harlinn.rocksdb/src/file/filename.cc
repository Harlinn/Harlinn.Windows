...
ROCKSDB_LIBRARY_API const std::string kCurrentFileName = "CURRENT";
ROCKSDB_LIBRARY_API const std::string kOptionsFileNamePrefix = "OPTIONS-";
ROCKSDB_LIBRARY_API const std::string kTempFileNameSuffix = "dbtmp";
