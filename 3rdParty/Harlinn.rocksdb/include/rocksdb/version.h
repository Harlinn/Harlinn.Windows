...
// was created.
ROCKSDB_LIBRARY_API const std::unordered_map<std::string, std::string>& GetRocksBuildProperties();
...
ROCKSDB_LIBRARY_API std::string GetRocksVersionAsString(bool with_patch = true);
...
ROCKSDB_LIBRARY_API std::string GetRocksBuildInfoAsString(const std::string& program,
                                      bool verbose = false);
}  // namespace ROCKSDB_NAMESPACE
