...
class Configurable {
 ...
 public:
  ...
  ROCKSDB_LIBRARY_API Status ConfigureFromMap(
  ...
  ROCKSDB_LIBRARY_API Status ConfigureOption(const ConfigOptions& config_options,
  ...
  //       parsed.  This can also be returned if PrepareOptions encounters an
  //       error.
  ROCKSDB_LIBRARY_API Status ConfigureFromString(const ConfigOptions& config_options,
  ...
  // serialized.
  ROCKSDB_LIBRARY_API Status GetOptionString(const ConfigOptions& config_options,
  ...
  ROCKSDB_LIBRARY_API std::string ToString(const ConfigOptions& config_options,
  ...
  ROCKSDB_LIBRARY_API Status GetOptionNames(const ConfigOptions& config_options,
  ...
  ROCKSDB_LIBRARY_API virtual Status GetOption(const ConfigOptions& config_options,
  ...
  ROCKSDB_LIBRARY_API virtual bool AreEquivalent(const ConfigOptions& config_options,
  ...
  // initialized.
  ROCKSDB_LIBRARY_API virtual Status PrepareOptions(const ConfigOptions& config_options);
  ...
  ROCKSDB_LIBRARY_API virtual Status ValidateOptions(const DBOptions& db_opts,
  ...
  ROCKSDB_LIBRARY_API static Status GetOptionsMap(
 ...
 protected:
  ...
  ROCKSDB_LIBRARY_API virtual Status ParseStringOptions(const ConfigOptions& config_options,
  ...
  ROCKSDB_LIBRARY_API virtual Status ConfigureOptions(
      const ConfigOptions& config_options,
  ...
  ROCKSDB_LIBRARY_API virtual Status ParseOption(const ConfigOptions& config_options,
  ...
  // match.
  ROCKSDB_LIBRARY_API virtual bool OptionsAreEqual(const ConfigOptions& config_options,
                               const OptionTypeInfo& opt_info,
  ...
  ROCKSDB_LIBRARY_API virtual std::string SerializeOptions(const ConfigOptions& config_options,
                                       const std::string& header) const;
#endif  // ROCKSDB_LITE

  //  Given a name (e.g. rocksdb.my.type.opt), returns the short name (opt)
  ROCKSDB_LIBRARY_API virtual std::string GetOptionName(const std::string& long_name) const;
  ...
  ROCKSDB_LIBRARY_API void RegisterOptions(
