...
class MemTableRep {
 public:
  ...
  ROCKSDB_LIBRARY_API virtual KeyHandle Allocate(const size_t len, char** buf);
  ...
  // Returns false if MemTableRepFactory::CanHandleDuplicatedKey() is true and
  // the <key, seq> already exists.
  ROCKSDB_LIBRARY_API virtual void InsertConcurrently(KeyHandle handle);
  ...
  ROCKSDB_LIBRARY_API virtual void Get(const LookupKey& k, void* callback_args,
...
class SkipListFactory : public MemTableRepFactory {
 public:
  ROCKSDB_LIBRARY_API explicit SkipListFactory(size_t lookahead = 0);
  ...
  ROCKSDB_LIBRARY_API std::string GetId() const override;

  // Methods for MemTableRepFactory class overrides
  using MemTableRepFactory::CreateMemTableRep;
  ROCKSDB_LIBRARY_API virtual MemTableRep* CreateMemTableRep(const MemTableRep::KeyComparator&,
                                         Allocator*, const SliceTransform*,
...
class VectorRepFactory : public MemTableRepFactory {
 ...
 public:
  ROCKSDB_LIBRARY_API explicit VectorRepFactory(size_t count = 0);
...
ROCKSDB_LIBRARY_API extern MemTableRepFactory* NewHashSkipListRepFactory(
...
ROCKSDB_LIBRARY_API extern MemTableRepFactory* NewHashLinkListRepFactory(
