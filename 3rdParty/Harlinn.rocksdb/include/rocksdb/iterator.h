...
class Iterator : public Cleanable {
 public:
  ...
  //   stopped.
  ROCKSDB_LIBRARY_API virtual Status GetProperty(std::string prop_name, std::string* prop);
...
ROCKSDB_LIBRARY_API extern Iterator* NewEmptyIterator();

// Return an empty iterator with the specified status.
ROCKSDB_LIBRARY_API extern Iterator* NewErrorIterator(const Status& status);
