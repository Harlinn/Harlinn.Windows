...
ROCKSDB_LIBRARY_API Status GetColumnFamilyOptionsFromMap(
...
// @return Status::InvalidArgument means the one of the option values is not
//     valid for this option.
ROCKSDB_LIBRARY_API Status GetDBOptionsFromMap(
...
//     "table_options".
ROCKSDB_LIBRARY_API Status GetBlockBasedTableOptionsFromMap(
    const ConfigOptions& config_options,
...
//     error will be returned, and "new_table_options" will be set to
//     "table_options".
ROCKSDB_LIBRARY_API Status GetPlainTableOptionsFromMap(
...
// functionality can be achieved by setting the corresponding options in
// the ConfigOptions parameter.
ROCKSDB_LIBRARY_API Status GetColumnFamilyOptionsFromString(const ConfigOptions& config_options,
                                        const ColumnFamilyOptions& base_options,
                                        const std::string& opts_str,
                                        ColumnFamilyOptions* new_options);
ROCKSDB_LIBRARY_API Status GetColumnFamilyOptionsFromString(const ColumnFamilyOptions& base_options,
                                        const std::string& opts_str,
                                        ColumnFamilyOptions* new_options);

ROCKSDB_LIBRARY_API Status GetDBOptionsFromString(const ConfigOptions& config_options,
                              const DBOptions& base_options,
                              const std::string& opts_str,
                              DBOptions* new_options);

ROCKSDB_LIBRARY_API Status GetDBOptionsFromString(const DBOptions& base_options,
                              const std::string& opts_str,
                              DBOptions* new_options);

ROCKSDB_LIBRARY_API Status GetStringFromDBOptions(const ConfigOptions& config_options,
                              const DBOptions& db_options,
                              std::string* opts_str);

ROCKSDB_LIBRARY_API Status GetStringFromDBOptions(std::string* opts_str,
                              const DBOptions& db_options,
                              const std::string& delimiter = ";  ");

ROCKSDB_LIBRARY_API Status GetStringFromColumnFamilyOptions(const ConfigOptions& config_options,
                                        const ColumnFamilyOptions& cf_options,
                                        std::string* opts_str);
ROCKSDB_LIBRARY_API Status GetStringFromColumnFamilyOptions(std::string* opts_str,
                                        const ColumnFamilyOptions& cf_options,
                                        const std::string& delimiter = ";  ");
ROCKSDB_LIBRARY_API Status GetStringFromCompressionType(std::string* compression_str,
                                    CompressionType compression_type);

ROCKSDB_LIBRARY_API std::vector<CompressionType> GetSupportedCompressions();

ROCKSDB_LIBRARY_API Status GetBlockBasedTableOptionsFromString(
...
ROCKSDB_LIBRARY_API Status GetPlainTableOptionsFromString(const PlainTableOptions& table_options,
                                      const std::string& opts_str,
                                      PlainTableOptions* new_table_options);
ROCKSDB_LIBRARY_API Status GetPlainTableOptionsFromString(const ConfigOptions& config_options,
                                      const PlainTableOptions& table_options,
                                      const std::string& opts_str,
                                      PlainTableOptions* new_table_options);

ROCKSDB_LIBRARY_API Status GetMemTableRepFactoryFromString(
    const std::string& opts_str,
    std::unique_ptr<MemTableRepFactory>* new_mem_factory);

ROCKSDB_LIBRARY_API Status GetOptionsFromString(const Options& base_options,
                            const std::string& opts_str, Options* new_options);
ROCKSDB_LIBRARY_API Status GetOptionsFromString(const ConfigOptions& config_options,
                            const Options& base_options,
                            const std::string& opts_str, Options* new_options);

ROCKSDB_LIBRARY_API Status StringToMap(const std::string& opts_str,
                   std::unordered_map<std::string, std::string>* opts_map);

// Request stopping background work, if wait is true wait until it's done
ROCKSDB_LIBRARY_API void CancelAllBackgroundWork(DB* db, bool wait = false);
...
ROCKSDB_LIBRARY_API Status DeleteFilesInRange(DB* db, ColumnFamilyHandle* column_family,
...
ROCKSDB_LIBRARY_API Status DeleteFilesInRanges(DB* db, ColumnFamilyHandle* column_family,
                           const RangePtr* ranges, size_t n,
                           bool include_end = true);

// Verify the checksum of file
ROCKSDB_LIBRARY_API Status VerifySstFileChecksum(const Options& options,
