...
class Slice {
 public:
  ...
  ROCKSDB_LIBRARY_API Slice(const struct SliceParts& parts, std::string* buf);
  ...
  ROCKSDB_LIBRARY_API std::string ToString(bool hex = false) const;
  ...
  ROCKSDB_LIBRARY_API bool DecodeHex(std::string* result) const;

  // Three-way comparison.  Returns value:
  //   <  0 iff "*this" <  "b",
  //   == 0 iff "*this" == "b",
  //   >  0 iff "*this" >  "b"
  ROCKSDB_LIBRARY_API int compare(const Slice& b) const;
  ...
  ROCKSDB_LIBRARY_API size_t difference_offset(const Slice& b) const;
...
class PinnableSlice : public Slice, public Cleanable {
 public:
  ...
  ROCKSDB_LIBRARY_API PinnableSlice(PinnableSlice&& other);
  ROCKSDB_LIBRARY_API PinnableSlice& operator=(PinnableSlice&& other);
