...
// read from disk.
ROCKSDB_LIBRARY_API Env* NewEncryptedEnv(Env* base_env,
...
class BlockAccessCipherStream {
 public:
  ...
  ROCKSDB_LIBRARY_API virtual Status Encrypt(uint64_t fileOffset, char* data, size_t dataSize);

  // Decrypt one or more (partial) blocks of data at the file offset.
  // Length of data is given in dataSize.
  ROCKSDB_LIBRARY_API virtual Status Decrypt(uint64_t fileOffset, char* data, size_t dataSize);
...
class BlockCipher : public Customizable {
 public:
  ...
  // production!!!
  ROCKSDB_LIBRARY_API static std::shared_ptr<BlockCipher> NewROT13Cipher(size_t block_size);
...
class EncryptionProvider : public Customizable {
 public:
  ...
  ROCKSDB_LIBRARY_API static std::shared_ptr<EncryptionProvider> NewCTRProvider(
...
class EncryptedSequentialFile : public FSSequentialFile {
 ...
 public:
  ...
  ROCKSDB_LIBRARY_API IOStatus Read(size_t n, const IOOptions& options, Slice* result,
  ...
  //
  // REQUIRES: External synchronization
  ROCKSDB_LIBRARY_API IOStatus Skip(uint64_t n) override;

  // Indicates the upper layers if the current SequentialFile implementation
  // uses direct IO.
  ROCKSDB_LIBRARY_API bool use_direct_io() const override;

  // Use the returned alignment value to allocate
  // aligned buffer for Direct I/O
  ROCKSDB_LIBRARY_API size_t GetRequiredBufferAlignment() const override;

  // Remove any kind of caching of data from the offset to offset+length
  // of this file. If the length is 0, then it refers to the end of file.
  // If the system is not caching the file contents, then this is a noop.
  ROCKSDB_LIBRARY_API IOStatus InvalidateCache(size_t offset, size_t length) override;

  // Positioned Read for direct I/O
  // If Direct I/O enabled, offset, n, and scratch should be properly aligned
  ROCKSDB_LIBRARY_API IOStatus PositionedRead(uint64_t offset, size_t n, const IOOptions& options,
...
class EncryptedRandomAccessFile : public FSRandomAccessFile {
 ...
 public:
  ...
  ROCKSDB_LIBRARY_API IOStatus Read(uint64_t offset, size_t n, const IOOptions& options,
                Slice* result, char* scratch,
                IODebugContext* dbg) const override;

  // Readahead the file starting from offset by n bytes for caching.
  ROCKSDB_LIBRARY_API IOStatus Prefetch(uint64_t offset, size_t n, const IOOptions& options,
                    IODebugContext* dbg) override;
  ...
  ROCKSDB_LIBRARY_API size_t GetUniqueId(char* id, size_t max_size) const override;

  ROCKSDB_LIBRARY_API void Hint(AccessPattern pattern) override;
...
class EncryptedWritableFile : public FSWritableFile {
 ...
 public:
  ...
  ROCKSDB_LIBRARY_API IOStatus Append(const Slice& data, const IOOptions& options,
                  IODebugContext* dbg) override;

  using FSWritableFile::PositionedAppend;
  ROCKSDB_LIBRARY_API IOStatus PositionedAppend(const Slice& data, uint64_t offset,
                            const IOOptions& options,
                            IODebugContext* dbg) override;

  // true if Sync() and Fsync() are safe to call concurrently with Append()
  // and Flush().
  ROCKSDB_LIBRARY_API bool IsSyncThreadSafe() const override;
   ...
   */
  ROCKSDB_LIBRARY_API uint64_t GetFileSize(const IOOptions& options, IODebugContext* dbg) override;

  // Truncate is necessary to trim the file to the correct size
  // before closing. It is not always possible to keep track of the file
  // size due to whole pages writes. The behavior is undefined if called
  // with other writes to follow.
  ROCKSDB_LIBRARY_API IOStatus Truncate(uint64_t size, const IOOptions& options,
                    IODebugContext* dbg) override;
  ...
  ROCKSDB_LIBRARY_API IOStatus RangeSync(uint64_t offset, uint64_t nbytes, const IOOptions& options,
                     IODebugContext* dbg) override;
  ...
  // pre-allocation.
  ROCKSDB_LIBRARY_API void PrepareWrite(size_t offset, size_t len, const IOOptions& options,
                    IODebugContext* dbg) override;

  ROCKSDB_LIBRARY_API void SetPreallocationBlockSize(size_t size) override;

  ROCKSDB_LIBRARY_API void GetPreallocationStatus(size_t* block_size,
                              size_t* last_allocated_block) override;

  // Pre-allocates space for a file.
  ROCKSDB_LIBRARY_API IOStatus Allocate(uint64_t offset, uint64_t len, const IOOptions& options,
                    IODebugContext* dbg) override;

  ROCKSDB_LIBRARY_API IOStatus Flush(const IOOptions& options, IODebugContext* dbg) override;

  ROCKSDB_LIBRARY_API IOStatus Sync(const IOOptions& options, IODebugContext* dbg) override;

  ROCKSDB_LIBRARY_API IOStatus Close(const IOOptions& options, IODebugContext* dbg) override;
};
...
class EncryptedRandomRWFile : public FSRandomRWFile {
 ...
 public:
  ...
  ROCKSDB_LIBRARY_API IOStatus Write(uint64_t offset, const Slice& data, const IOOptions& options,
                 IODebugContext* dbg) override;
  ...
  ROCKSDB_LIBRARY_API IOStatus Fsync(const IOOptions& options, IODebugContext* dbg) override;
