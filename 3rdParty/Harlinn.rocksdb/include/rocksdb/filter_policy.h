...
struct FilterBuildingContext {
  ...
  ROCKSDB_LIBRARY_API FilterBuildingContext(const BlockBasedTableOptions& table_options);
...
class FilterPolicy {
 public:
  ROCKSDB_LIBRARY_API virtual ~FilterPolicy();
...
ROCKSDB_LIBRARY_API extern const FilterPolicy* NewBloomFilterPolicy(
...
// memory.
ROCKSDB_LIBRARY_API extern const FilterPolicy* NewRibbonFilterPolicy(
