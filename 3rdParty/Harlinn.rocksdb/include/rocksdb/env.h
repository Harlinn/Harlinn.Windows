...
struct EnvOptions {
  ...
  ROCKSDB_LIBRARY_API EnvOptions();

  // Construct from Options
  ROCKSDB_LIBRARY_API explicit EnvOptions(const DBOptions& options);
...
class Env {
 public:
  ...
  ROCKSDB_LIBRARY_API Env();
  // Construct an Env with a separate FileSystem and/or SystemClock
  // implementation
  ROCKSDB_LIBRARY_API explicit Env(const std::shared_ptr<FileSystem>& fs);
  ROCKSDB_LIBRARY_API Env(const std::shared_ptr<FileSystem>& fs,
      const std::shared_ptr<SystemClock>& clock);
  // No copying allowed
  Env(const Env&) = delete;
  void operator=(const Env&) = delete;

  ROCKSDB_LIBRARY_API virtual ~Env();
  ...
  ROCKSDB_LIBRARY_API static Status LoadEnv(const std::string& value, Env** result);
  ...
  ROCKSDB_LIBRARY_API static Status CreateFromString(const ConfigOptions& config_options,
  ...
  ROCKSDB_LIBRARY_API static Status CreateFromUri(const ConfigOptions& options,
  ...
  //                  permission to access "dir", or if "dir" is invalid.
  //         IOError if an IO Error was encountered
  ROCKSDB_LIBRARY_API virtual Status GetChildrenFileAttributes(const std::string& dir,
  ...
  ROCKSDB_LIBRARY_API static std::string PriorityToString(Priority priority);
  ...
  // logger.
  ROCKSDB_LIBRARY_API virtual Status NewLogger(const std::string& fname,
  ...
  // long
  ROCKSDB_LIBRARY_API virtual Status GetHostNameString(std::string* result);
  ...
  ROCKSDB_LIBRARY_API virtual std::string GenerateUniqueId();

  // OptimizeForLogWrite will create a new EnvOptions object that is a copy of
  // the EnvOptions in the parameters, but is optimized for reading log files.
  ROCKSDB_LIBRARY_API virtual EnvOptions OptimizeForLogRead(const EnvOptions& env_options) const;
  ...
  // files.
  ROCKSDB_LIBRARY_API virtual EnvOptions OptimizeForManifestRead(
      const EnvOptions& env_options) const;

  // OptimizeForLogWrite will create a new EnvOptions object that is a copy of
  // the EnvOptions in the parameters, but is optimized for writing log files.
  // Default implementation returns the copy of the same object.
  ROCKSDB_LIBRARY_API virtual EnvOptions OptimizeForLogWrite(const EnvOptions& env_options,
                                         const DBOptions& db_options) const;
  // OptimizeForManifestWrite will create a new EnvOptions object that is a copy
  // of the EnvOptions in the parameters, but is optimized for writing manifest
  // files. Default implementation returns the copy of the same object.
  ROCKSDB_LIBRARY_API virtual EnvOptions OptimizeForManifestWrite(
      const EnvOptions& env_options) const;
  ...
  // table files.
  ROCKSDB_LIBRARY_API virtual EnvOptions OptimizeForCompactionTableWrite(
  ...
  // table files.
  ROCKSDB_LIBRARY_API virtual EnvOptions OptimizeForCompactionTableRead(
      const EnvOptions& env_options,
  ...
  // is a copy of the EnvOptions in the parameters, but is optimized for reading
  // blob files.
  ROCKSDB_LIBRARY_API virtual EnvOptions OptimizeForBlobFileRead(
      const EnvOptions& env_options,
      const ImmutableDBOptions& db_options) const;
  ...
  ROCKSDB_LIBRARY_API virtual uint64_t GetThreadID() const;
...
#undef GetFreeSpace
  ...
  ROCKSDB_LIBRARY_API const std::shared_ptr<FileSystem>& GetFileSystem() const;

  // Get the SystemClock implementation this Env was constructed with. It
  // could be a fully implemented one, or a wrapper class around the Env
  ROCKSDB_LIBRARY_API const std::shared_ptr<SystemClock>& GetSystemClock() const;
...
ROCKSDB_LIBRARY_API ThreadStatusUpdater* CreateThreadStatusUpdater();

// A file abstraction for reading sequentially through a file
class SequentialFile {
 public:
  SequentialFile() {}
  ROCKSDB_LIBRARY_API virtual ~SequentialFile();
...
class RandomAccessFile {
 public:
  RandomAccessFile() {}
  ROCKSDB_LIBRARY_API virtual ~RandomAccessFile();
...
class WritableFile {
 public:
  ...
  ROCKSDB_LIBRARY_API virtual ~WritableFile();
...
class Logger {
 public:
  ...
  ROCKSDB_LIBRARY_API virtual ~Logger();
  ...
  // the destructor
  ROCKSDB_LIBRARY_API virtual Status Close();
  ...
  // printed.
  ROCKSDB_LIBRARY_API virtual void Logv(const InfoLogLevel log_level, const char* format,
                    va_list ap);
 ...
 protected:
  ROCKSDB_LIBRARY_API virtual Status CloseImpl();
  bool closed_;
...
class FileLock {
 public:
  FileLock() {}
  ROCKSDB_LIBRARY_API virtual ~FileLock();
...
ROCKSDB_LIBRARY_API extern void LogFlush(const std::shared_ptr<Logger>& info_log);

ROCKSDB_LIBRARY_API extern void Log(const InfoLogLevel log_level,
                const std::shared_ptr<Logger>& info_log, const char* format,
                ...) ROCKSDB_PRINTF_FORMAT_ATTR(3, 4);

// a set of log functions with different log levels.
ROCKSDB_LIBRARY_API extern void Header(const std::shared_ptr<Logger>& info_log, const char* format,
                   ...) ROCKSDB_PRINTF_FORMAT_ATTR(2, 3);
ROCKSDB_LIBRARY_API extern void Debug(const std::shared_ptr<Logger>& info_log, const char* format,
                  ...) ROCKSDB_PRINTF_FORMAT_ATTR(2, 3);
ROCKSDB_LIBRARY_API extern void Info(const std::shared_ptr<Logger>& info_log, const char* format,
                 ...) ROCKSDB_PRINTF_FORMAT_ATTR(2, 3);
ROCKSDB_LIBRARY_API extern void Warn(const std::shared_ptr<Logger>& info_log, const char* format,
                 ...) ROCKSDB_PRINTF_FORMAT_ATTR(2, 3);
ROCKSDB_LIBRARY_API extern void Error(const std::shared_ptr<Logger>& info_log, const char* format,
                  ...) ROCKSDB_PRINTF_FORMAT_ATTR(2, 3);
ROCKSDB_LIBRARY_API extern void Fatal(const std::shared_ptr<Logger>& info_log, const char* format,
                  ...) ROCKSDB_PRINTF_FORMAT_ATTR(2, 3);

// Log the specified data to *info_log if info_log is non-nullptr.
// The default info log level is InfoLogLevel::INFO_LEVEL.
ROCKSDB_LIBRARY_API extern void Log(const std::shared_ptr<Logger>& info_log, const char* format,
                ...) ROCKSDB_PRINTF_FORMAT_ATTR(2, 3);

ROCKSDB_LIBRARY_API extern void LogFlush(Logger* info_log);

ROCKSDB_LIBRARY_API extern void Log(const InfoLogLevel log_level, Logger* info_log,
                const char* format, ...) ROCKSDB_PRINTF_FORMAT_ATTR(3, 4);

// The default info log level is InfoLogLevel::INFO_LEVEL.
ROCKSDB_LIBRARY_API extern void Log(Logger* info_log, const char* format, ...)
    ROCKSDB_PRINTF_FORMAT_ATTR(2, 3);

// a set of log functions with different log levels.
ROCKSDB_LIBRARY_API extern void Header(Logger* info_log, const char* format, ...)
    ROCKSDB_PRINTF_FORMAT_ATTR(2, 3);
ROCKSDB_LIBRARY_API extern void Debug(Logger* info_log, const char* format, ...)
    ROCKSDB_PRINTF_FORMAT_ATTR(2, 3);
ROCKSDB_LIBRARY_API extern void Info(Logger* info_log, const char* format, ...)
    ROCKSDB_PRINTF_FORMAT_ATTR(2, 3);
ROCKSDB_LIBRARY_API extern void Warn(Logger* info_log, const char* format, ...)
    ROCKSDB_PRINTF_FORMAT_ATTR(2, 3);
ROCKSDB_LIBRARY_API extern void Error(Logger* info_log, const char* format, ...)
    ROCKSDB_PRINTF_FORMAT_ATTR(2, 3);
ROCKSDB_LIBRARY_API extern void Fatal(Logger* info_log, const char* format, ...)
    ROCKSDB_PRINTF_FORMAT_ATTR(2, 3);

// A utility routine: write "data" to the named file.
ROCKSDB_LIBRARY_API extern Status WriteStringToFile(Env* env, const Slice& data,
                                const std::string& fname,
                                bool should_sync = false);

// A utility routine: read contents of named file into *data
ROCKSDB_LIBRARY_API extern Status ReadFileToString(Env* env, const std::string& fname,
                               std::string* data);
...
class EnvWrapper : public Env {
 public:
  ...
  ROCKSDB_LIBRARY_API ~EnvWrapper() override;
...
ROCKSDB_LIBRARY_API Env* NewMemEnv(Env* base_env);
...
ROCKSDB_LIBRARY_API Status NewHdfsEnv(Env** hdfs_env, const std::string& fsname);
...
ROCKSDB_LIBRARY_API Env* NewTimedEnv(Env* base_env);
...
ROCKSDB_LIBRARY_API Status NewEnvLogger(const std::string& fname, Env* env,
                    std::shared_ptr<Logger>* result);

// Creates a new Env based on Env::Default() but modified to use the specified
// FileSystem.
ROCKSDB_LIBRARY_API std::unique_ptr<Env> NewCompositeEnv(const std::shared_ptr<FileSystem>& fs);
