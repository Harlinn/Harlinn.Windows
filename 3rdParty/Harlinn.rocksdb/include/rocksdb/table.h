...
ROCKSDB_LIBRARY_API extern TableFactory* NewBlockBasedTableFactory(
...
ROCKSDB_LIBRARY_API extern TableFactory* NewPlainTableFactory(
...
ROCKSDB_LIBRARY_API extern TableFactory* NewCuckooTableFactory(
