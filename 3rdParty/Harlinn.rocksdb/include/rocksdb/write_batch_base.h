...
class WriteBatchBase {
 public:
  ...
  // slices.
  ROCKSDB_LIBRARY_API virtual Status Put(ColumnFamilyHandle* column_family, const SliceParts& key,
                     const SliceParts& value);
  ROCKSDB_LIBRARY_API virtual Status Put(const SliceParts& key, const SliceParts& value);
  ...
  ROCKSDB_LIBRARY_API virtual Status Merge(ColumnFamilyHandle* column_family, const SliceParts& key,
                       const SliceParts& value);
  ROCKSDB_LIBRARY_API virtual Status Merge(const SliceParts& key, const SliceParts& value);
  ...
  // variant that takes SliceParts
  ROCKSDB_LIBRARY_API virtual Status Delete(ColumnFamilyHandle* column_family,
                        const SliceParts& key);
  ROCKSDB_LIBRARY_API virtual Status Delete(const SliceParts& key);
  ...
  // variant that takes SliceParts
  ROCKSDB_LIBRARY_API virtual Status SingleDelete(ColumnFamilyHandle* column_family,
                              const SliceParts& key);
  ROCKSDB_LIBRARY_API virtual Status SingleDelete(const SliceParts& key);
  ...
  // variant that takes SliceParts
  ROCKSDB_LIBRARY_API virtual Status DeleteRange(ColumnFamilyHandle* column_family,
                             const SliceParts& begin_key,
                             const SliceParts& end_key);
  ROCKSDB_LIBRARY_API virtual Status DeleteRange(const SliceParts& begin_key,
                             const SliceParts& end_key);
