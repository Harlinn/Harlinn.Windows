...
class EnvMirror : public EnvWrapper {
 ...
 public:
  ...
  ROCKSDB_LIBRARY_API Status NewSequentialFile(const std::string& f,
                           std::unique_ptr<SequentialFile>* r,
                           const EnvOptions& options) override;
  ROCKSDB_LIBRARY_API Status NewRandomAccessFile(const std::string& f,
                             std::unique_ptr<RandomAccessFile>* r,
                             const EnvOptions& options) override;
  ROCKSDB_LIBRARY_API Status NewWritableFile(const std::string& f, std::unique_ptr<WritableFile>* r,
                         const EnvOptions& options) override;
  ROCKSDB_LIBRARY_API Status ReuseWritableFile(const std::string& fname,
