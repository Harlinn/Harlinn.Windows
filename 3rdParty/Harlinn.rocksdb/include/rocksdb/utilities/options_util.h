...
ROCKSDB_LIBRARY_API Status LoadLatestOptions(const std::string& dbpath, Env* env,
                         DBOptions* db_options,
                         std::vector<ColumnFamilyDescriptor>* cf_descs,
                         bool ignore_unknown_options = false,
                         std::shared_ptr<Cache>* cache = {});
ROCKSDB_LIBRARY_API Status LoadLatestOptions(const ConfigOptions& config_options,
...
ROCKSDB_LIBRARY_API Status LoadOptionsFromFile(const std::string& options_file_name, Env* env,
                           DBOptions* db_options,
                           std::vector<ColumnFamilyDescriptor>* cf_descs,
                           bool ignore_unknown_options = false,
                           std::shared_ptr<Cache>* cache = {});
ROCKSDB_LIBRARY_API Status LoadOptionsFromFile(const ConfigOptions& config_options,
...
ROCKSDB_LIBRARY_API Status GetLatestOptionsFileName(const std::string& dbpath, Env* env,
...
// * table_factory
// * merge_operator
ROCKSDB_LIBRARY_API Status CheckOptionsCompatibility(
