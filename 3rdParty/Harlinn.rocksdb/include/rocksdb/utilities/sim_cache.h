...
// sim_capacity * 2%
ROCKSDB_LIBRARY_API extern std::shared_ptr<SimCache> NewSimCache(std::shared_ptr<Cache> cache,
                                             size_t sim_capacity,
                                             int num_shard_bits);

ROCKSDB_LIBRARY_API extern std::shared_ptr<SimCache> NewSimCache(std::shared_ptr<Cache> sim_cache,
