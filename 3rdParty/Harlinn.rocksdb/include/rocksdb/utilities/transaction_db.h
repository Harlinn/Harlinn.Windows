...
ROCKSDB_LIBRARY_API RangeLockManagerHandle* NewRangeLockManager(
...
class TransactionDB : public StackableDB {
 public:
  ...
  ROCKSDB_LIBRARY_API static Status Open(const Options& options,
                     const TransactionDBOptions& txn_db_options,
                     const std::string& dbname, TransactionDB** dbptr);

  ROCKSDB_LIBRARY_API static Status Open(const DBOptions& db_options,
                     const TransactionDBOptions& txn_db_options,
  ...
  ROCKSDB_LIBRARY_API static void PrepareWrap(DBOptions* db_options,
  ...
  ROCKSDB_LIBRARY_API static Status WrapDB(DB* db, const TransactionDBOptions& txn_db_options,
  ...
  // failure. If it is properly deleted it will be set to nullptr. If the return
  // status is ok, the ownership of db is transferred to dbptr.
  ROCKSDB_LIBRARY_API static Status WrapStackableDB(
