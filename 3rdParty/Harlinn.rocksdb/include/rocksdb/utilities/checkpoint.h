...
class Checkpoint {
 public:
  ...
  ROCKSDB_LIBRARY_API static Status Create(DB* db, Checkpoint** checkpoint_ptr);
  ...
  // than one directory.
  ROCKSDB_LIBRARY_API virtual Status CreateCheckpoint(const std::string& checkpoint_dir,
  ...
  ROCKSDB_LIBRARY_API virtual Status ExportColumnFamily(ColumnFamilyHandle* handle,
