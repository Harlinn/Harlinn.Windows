...
class BackupStatistics {
 public:
  ...
  ROCKSDB_LIBRARY_API void IncrementNumberSuccessBackup();
  ROCKSDB_LIBRARY_API void IncrementNumberFailBackup();

  ROCKSDB_LIBRARY_API uint32_t GetNumberSuccessBackup() const;
  ROCKSDB_LIBRARY_API uint32_t GetNumberFailBackup() const;
...
class BackupEngine : public BackupEngineReadOnlyBase,
 ...
 public:
  ...
  ROCKSDB_LIBRARY_API static IOStatus Open(const BackupEngineOptions& options, Env* db_env,
