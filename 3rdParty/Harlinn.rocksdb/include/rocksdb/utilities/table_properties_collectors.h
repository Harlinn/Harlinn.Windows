...
class CompactOnDeletionCollectorFactory
 ...
 public:
  ...
  ROCKSDB_LIBRARY_API CompactOnDeletionCollectorFactory(size_t sliding_window_size,
                                    size_t deletion_trigger,
                                    double deletion_ratio);

  ~CompactOnDeletionCollectorFactory() {}

  ROCKSDB_LIBRARY_API TablePropertiesCollector* CreateTablePropertiesCollector(
  ...
  ROCKSDB_LIBRARY_API std::string ToString() const override;
...
ROCKSDB_LIBRARY_API extern std::shared_ptr<CompactOnDeletionCollectorFactory>
