...
class OptimisticTransactionDB : public StackableDB {
 public:
  ...
  ROCKSDB_LIBRARY_API static Status Open(const Options& options, const std::string& dbname,
                     OptimisticTransactionDB** dbptr);

  ROCKSDB_LIBRARY_API static Status Open(const DBOptions& db_options, const std::string& dbname,
