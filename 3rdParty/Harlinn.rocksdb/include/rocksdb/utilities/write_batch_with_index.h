...
class WriteBatchWithIndex : public WriteBatchBase {
 public:
  ...
  ROCKSDB_LIBRARY_API explicit WriteBatchWithIndex(
      const Comparator* backup_index_comparator = BytewiseComparator(),
      size_t reserved_bytes = 0, bool overwrite_key = false,
      size_t max_bytes = 0);

  ROCKSDB_LIBRARY_API ~WriteBatchWithIndex() override;
  ROCKSDB_LIBRARY_API WriteBatchWithIndex(WriteBatchWithIndex&&);
  ROCKSDB_LIBRARY_API WriteBatchWithIndex& operator=(WriteBatchWithIndex&&);

  using WriteBatchBase::Put;
  ROCKSDB_LIBRARY_API Status Put(ColumnFamilyHandle* column_family, const Slice& key,
             const Slice& value) override;

  ROCKSDB_LIBRARY_API Status Put(const Slice& key, const Slice& value) override;

  using WriteBatchBase::Merge;
  ROCKSDB_LIBRARY_API Status Merge(ColumnFamilyHandle* column_family, const Slice& key,
               const Slice& value) override;

  ROCKSDB_LIBRARY_API Status Merge(const Slice& key, const Slice& value) override;

  using WriteBatchBase::Delete;
  ROCKSDB_LIBRARY_API Status Delete(ColumnFamilyHandle* column_family, const Slice& key) override;
  ROCKSDB_LIBRARY_API Status Delete(const Slice& key) override;

  using WriteBatchBase::SingleDelete;
  ROCKSDB_LIBRARY_API Status SingleDelete(ColumnFamilyHandle* column_family,
                      const Slice& key) override;
  ROCKSDB_LIBRARY_API Status SingleDelete(const Slice& key) override;
  ...
  ROCKSDB_LIBRARY_API WriteBatch* GetWriteBatch() override;
  ...
  ROCKSDB_LIBRARY_API WBWIIterator* NewIterator(ColumnFamilyHandle* column_family);
  // Create an iterator of the default column family.
  ROCKSDB_LIBRARY_API WBWIIterator* NewIterator();
  ...
  // called.
  ROCKSDB_LIBRARY_API Iterator* NewIteratorWithBase(ColumnFamilyHandle* column_family,
                                Iterator* base_iterator,
                                const ReadOptions* opts = nullptr);
  // default column family
  ROCKSDB_LIBRARY_API Iterator* NewIteratorWithBase(Iterator* base_iterator);
  ...
  ROCKSDB_LIBRARY_API Status GetFromBatch(ColumnFamilyHandle* column_family,
  ...
  // regardless).
  ROCKSDB_LIBRARY_API Status GetFromBatchAndDB(DB* db, const ReadOptions& read_options,
  ...
  ROCKSDB_LIBRARY_API void MultiGetFromBatchAndDB(DB* db, const ReadOptions& read_options,
  ...
  ROCKSDB_LIBRARY_API Status PopSavePoint() override;

  ROCKSDB_LIBRARY_API void SetMaxBytes(size_t max_bytes) override;
  ROCKSDB_LIBRARY_API size_t GetDataSize() const;
 ...
 private:
  ...
  // last sub-batch.
  ROCKSDB_LIBRARY_API size_t SubBatchCnt();
