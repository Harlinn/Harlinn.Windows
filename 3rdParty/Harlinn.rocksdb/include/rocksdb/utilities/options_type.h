...
class OptionTypeInfo {
 public:
  ...
  ROCKSDB_LIBRARY_API Status Parse(const ConfigOptions& config_options, const std::string& opt_name,
  ...
  ROCKSDB_LIBRARY_API Status Serialize(const ConfigOptions& config_options,
  ...
  ROCKSDB_LIBRARY_API bool AreEqual(const ConfigOptions& config_options,
  ...
  ROCKSDB_LIBRARY_API bool AreEqualByName(const ConfigOptions& config_options,
  ...
  // objects.
  ROCKSDB_LIBRARY_API static Status ParseType(
  ...
  // opt_name.
  ROCKSDB_LIBRARY_API static Status ParseStruct(
  ...
  ROCKSDB_LIBRARY_API static Status SerializeType(
      const ConfigOptions& config_options,
      const std::unordered_map<std::string, OptionTypeInfo>& type_map,
  ...
  ROCKSDB_LIBRARY_API static Status SerializeStruct(
      const ConfigOptions& config_options, const std::string& struct_name,
      const std::unordered_map<std::string, OptionTypeInfo>* map,
  ...
  ROCKSDB_LIBRARY_API static bool TypesAreEqual(
      const ConfigOptions& config_options,
      const std::unordered_map<std::string, OptionTypeInfo>& map,
  ...
  // opt_name is the name of the option being evaluated.  This may
  // be the whole struct or a sub-element of it
  ROCKSDB_LIBRARY_API static bool StructsAreEqual(
      const ConfigOptions& config_options, const std::string& struct_name,
      const std::unordered_map<std::string, OptionTypeInfo>* map,
  ...
  ROCKSDB_LIBRARY_API static const OptionTypeInfo* Find(
  ...
  ROCKSDB_LIBRARY_API static Status NextToken(const std::string& opts, char delimiter, size_t start,
