...
ROCKSDB_LIBRARY_API Status GetAllKeyVersions(DB* db, Slice begin_key, Slice end_key,
                         size_t max_num_ikeys,
                         std::vector<KeyVersion>* key_versions);

ROCKSDB_LIBRARY_API Status GetAllKeyVersions(DB* db, ColumnFamilyHandle* cfh, Slice begin_key,
