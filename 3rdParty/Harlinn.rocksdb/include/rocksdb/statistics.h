...
ROCKSDB_LIBRARY_API extern const std::vector<std::pair<Tickers, std::string>> TickersNameMap;
...
ROCKSDB_LIBRARY_API extern const std::vector<std::pair<Histograms, std::string>> HistogramsNameMap;
...
ROCKSDB_LIBRARY_API std::shared_ptr<Statistics> CreateDBStatistics();
