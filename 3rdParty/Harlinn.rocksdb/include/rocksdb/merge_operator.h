...
class MergeOperator : public Customizable {
 public:
  ...
  ROCKSDB_LIBRARY_API static Status CreateFromString(const ConfigOptions& opts,
                                 const std::string& id,
  ...
  ROCKSDB_LIBRARY_API virtual bool FullMergeV2(const MergeOperationInput& merge_in,
  ...
  ROCKSDB_LIBRARY_API virtual bool PartialMergeMulti(const Slice& key,
...
class AssociativeMergeOperator : public MergeOperator {
 ...
 private:
  ...
  ROCKSDB_LIBRARY_API bool FullMergeV2(const MergeOperationInput& merge_in,
                   MergeOperationOutput* merge_out) const override;

  ROCKSDB_LIBRARY_API bool PartialMerge(const Slice& key, const Slice& left_operand,
