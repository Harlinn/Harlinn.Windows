...
class Cleanable {
 public:
  ...
  ROCKSDB_LIBRARY_API Cleanable(Cleanable&&);
  ROCKSDB_LIBRARY_API Cleanable& operator=(Cleanable&&);
  ...
  ROCKSDB_LIBRARY_API void RegisterCleanup(CleanupFunction function, void* arg1, void* arg2);
  ROCKSDB_LIBRARY_API void DelegateCleanupsTo(Cleanable* other);
 ...
 protected:
  ...
  ROCKSDB_LIBRARY_API void RegisterCleanup(Cleanup* c);
