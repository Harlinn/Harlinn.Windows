...
ROCKSDB_LIBRARY_API extern const std::string kDefaultColumnFamilyName;
ROCKSDB_LIBRARY_API extern const std::string kPersistentStatsColumnFamilyName;
...
class DB {
 public:
  ...
  ROCKSDB_LIBRARY_API static Status Open(const Options& options, const std::string& name,
                     DB** dbptr);
  ...
  ROCKSDB_LIBRARY_API static Status OpenForReadOnly(const Options& options, const std::string& name,
                                DB** dbptr,
  ...
  // Not supported in ROCKSDB_LITE, in which case the function will
  // return Status::NotSupported.
  ROCKSDB_LIBRARY_API static Status OpenForReadOnly(
  ...
  ROCKSDB_LIBRARY_API static Status OpenAsSecondary(const Options& options, const std::string& name,
  ...
  ROCKSDB_LIBRARY_API static Status OpenAsSecondary(
      const DBOptions& db_options, const std::string& name,
  ...
  // `CompactionService`.
  ROCKSDB_LIBRARY_API static Status OpenAndCompact(
  ...
  ROCKSDB_LIBRARY_API static Status ListColumnFamilies(const DBOptions& db_options,
  ...
  ROCKSDB_LIBRARY_API virtual ~DB();

  // Create a column_family and return the handle of column family
  // through the argument handle.
  ROCKSDB_LIBRARY_API virtual Status CreateColumnFamily(const ColumnFamilyOptions& options,
  ...
  ROCKSDB_LIBRARY_API virtual Status CreateColumnFamilies(
  ...
  ROCKSDB_LIBRARY_API virtual Status DropColumnFamily(ColumnFamilyHandle* column_family);
  ...
  ROCKSDB_LIBRARY_API virtual Status DropColumnFamilies(
  ...
  ROCKSDB_LIBRARY_API virtual Status DestroyColumnFamilyHandle(ColumnFamilyHandle* column_family);
  ...
  ROCKSDB_LIBRARY_API virtual Status DeleteRange(const WriteOptions& options,
                             ColumnFamilyHandle* column_family,
  ...
  struct Properties {
    ...
    //      level number (e.g., "0").
    ROCKSDB_LIBRARY_API static const std::string kNumFilesAtLevelPrefix;
    ...
    ROCKSDB_LIBRARY_API static const std::string kCompressionRatioAtLevelPrefix;
    ...
    ROCKSDB_LIBRARY_API static const std::string kCFStatsNoFileHistogram;
    ...
    ROCKSDB_LIBRARY_API static const std::string kCFFileHistogram;
    ...
    ROCKSDB_LIBRARY_API static const std::string kEstimateNumKeys;
    ...
    ROCKSDB_LIBRARY_API static const std::string kNumLiveVersions;
    ...
    ROCKSDB_LIBRARY_API static const std::string kCurrentSuperVersionNumber;
    ...
    ROCKSDB_LIBRARY_API static const std::string kEstimateLiveDataSize;

    //  "rocksdb.min-log-number-to-keep" - return the minimum log number of the
    //      log files that should be kept.
    ROCKSDB_LIBRARY_API static const std::string kMinLogNumberToKeep;
    ...
    //      based.
    ROCKSDB_LIBRARY_API static const std::string kEstimatePendingCompactionBytes;
    ...
    //      are included.
    ROCKSDB_LIBRARY_API static const std::string kAggregatedTableProperties;

    //  "rocksdb.aggregated-table-properties-at-level<N>", same as the previous
    //      one but only returns the aggregated table properties of the
    //      specified level "N" at the target column family.
    ROCKSDB_LIBRARY_API static const std::string kAggregatedTablePropertiesAtLevel;

    //  "rocksdb.actual-delayed-write-rate" - returns the current actual delayed
    //      write rate. 0 means no delay.
    ROCKSDB_LIBRARY_API static const std::string kActualDelayedWriteRate;

    //  "rocksdb.is-write-stopped" - Return 1 if write has been stopped.
    ROCKSDB_LIBRARY_API static const std::string kIsWriteStopped;
    ...
    ROCKSDB_LIBRARY_API static const std::string kEstimateOldestKeyTime;

    //  "rocksdb.block-cache-capacity" - returns block cache capacity.
    ROCKSDB_LIBRARY_API static const std::string kBlockCacheCapacity;

    //  "rocksdb.block-cache-usage" - returns the memory size for the entries
    //      residing in block cache.
    ROCKSDB_LIBRARY_API static const std::string kBlockCacheUsage;

    // "rocksdb.block-cache-pinned-usage" - returns the memory size for the
    //      entries being pinned.
    ROCKSDB_LIBRARY_API static const std::string kBlockCachePinnedUsage;

    // "rocksdb.options-statistics" - returns multi-line string
    //      of options.statistics
    ROCKSDB_LIBRARY_API static const std::string kOptionsStatistics;

    // "rocksdb.num-blob-files" - returns number of blob files in the current
    //      version.
    ROCKSDB_LIBRARY_API static const std::string kNumBlobFiles;
    ...
    //      the current version.
    ROCKSDB_LIBRARY_API static const std::string kBlobStats;

    // "rocksdb.total-blob-file-size" - returns the total size of all blob
    //      files over all versions.
    ROCKSDB_LIBRARY_API static const std::string kTotalBlobFileSize;

    // "rocksdb.live-blob-file-size" - returns the total size of all blob
    //      files in the current version.
    ROCKSDB_LIBRARY_API static const std::string kLiveBlobFileSize;
  };
#endif /* ROCKSDB_LITE */
  ...
  ROCKSDB_LIBRARY_API virtual FileSystem* GetFileSystem() const;
...
ROCKSDB_LIBRARY_API Status DestroyDB(const std::string& name, const Options& options,
                 const std::vector<ColumnFamilyDescriptor>& column_families =
...
ROCKSDB_LIBRARY_API Status RepairDB(const std::string& dbname, const DBOptions& db_options,
                const std::vector<ColumnFamilyDescriptor>& column_families);
...
ROCKSDB_LIBRARY_API Status RepairDB(const std::string& dbname, const Options& options);
