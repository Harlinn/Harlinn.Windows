...
class WriteBatch : public WriteBatchBase {
 public:
  ROCKSDB_LIBRARY_API explicit WriteBatch(size_t reserved_bytes = 0, size_t max_bytes = 0);
  ...
  ROCKSDB_LIBRARY_API explicit WriteBatch(size_t reserved_bytes, size_t max_bytes,
                      size_t protection_bytes_per_key);
  ROCKSDB_LIBRARY_API ~WriteBatch() override;
  ...
  ROCKSDB_LIBRARY_API Status Put(ColumnFamilyHandle* column_family, const Slice& key,
  ...
  ROCKSDB_LIBRARY_API Status Put(ColumnFamilyHandle* column_family, const SliceParts& key,
  ...
  ROCKSDB_LIBRARY_API Status Delete(ColumnFamilyHandle* column_family, const Slice& key) override;
  ...
  // Slice in `key`, a SliceParts (array of Slices). The caller is responsible
  // for setting up the `key` SliceParts object.
  ROCKSDB_LIBRARY_API Status Delete(ColumnFamilyHandle* column_family,
                const SliceParts& key) override;
  Status Delete(const SliceParts& key) override { return Delete(nullptr, key); }

  using WriteBatchBase::SingleDelete;
  // WriteBatch implementation of DB::SingleDelete().  See db.h.
  ROCKSDB_LIBRARY_API Status SingleDelete(ColumnFamilyHandle* column_family,
  ...
  ROCKSDB_LIBRARY_API Status DeleteRange(ColumnFamilyHandle* column_family, const Slice& begin_key,
  ...
  // variant that takes SliceParts
  ROCKSDB_LIBRARY_API Status DeleteRange(ColumnFamilyHandle* column_family,
  ...
  ROCKSDB_LIBRARY_API Status Merge(ColumnFamilyHandle* column_family, const Slice& key,
               const Slice& value) override;
  ...
  // variant that takes SliceParts
  ROCKSDB_LIBRARY_API Status Merge(ColumnFamilyHandle* column_family, const SliceParts& key,
               const SliceParts& value) override;
  ...
  // replication.
  ROCKSDB_LIBRARY_API Status PutLogData(const Slice& blob) override;

  using WriteBatchBase::Clear;
  // Clear all updates buffered in this batch.
  ROCKSDB_LIBRARY_API void Clear() override;

  // Records the state of the batch for future calls to RollbackToSavePoint().
  // May be called multiple times to set multiple save points.
  ROCKSDB_LIBRARY_API void SetSavePoint() override;
  ...
  ROCKSDB_LIBRARY_API Status RollbackToSavePoint() override;

  // Pop the most recent save point.
  // If there is no previous call to SetSavePoint(), Status::NotFound()
  // will be returned.
  ROCKSDB_LIBRARY_API // Otherwise returns Status::OK().
  Status PopSavePoint() override;

  // Support for iterating over the contents of a batch.
  class Handler {
   public:
    ROCKSDB_LIBRARY_API virtual ~Handler();
    ...
    ROCKSDB_LIBRARY_API virtual bool Continue();
  ...
  ROCKSDB_LIBRARY_API Status Iterate(Handler* handler) const;
  ...
  ROCKSDB_LIBRARY_API uint32_t Count() const;

  // Returns true if PutCF will be called during Iterate
  ROCKSDB_LIBRARY_API bool HasPut() const;

  // Returns true if DeleteCF will be called during Iterate
  ROCKSDB_LIBRARY_API bool HasDelete() const;

  // Returns true if SingleDeleteCF will be called during Iterate
  ROCKSDB_LIBRARY_API bool HasSingleDelete() const;

  // Returns true if DeleteRangeCF will be called during Iterate
  ROCKSDB_LIBRARY_API bool HasDeleteRange() const;

  // Returns true if MergeCF will be called during Iterate
  ROCKSDB_LIBRARY_API bool HasMerge() const;

  // Returns true if MarkBeginPrepare will be called during Iterate
  ROCKSDB_LIBRARY_API bool HasBeginPrepare() const;

  // Returns true if MarkEndPrepare will be called during Iterate
  ROCKSDB_LIBRARY_API bool HasEndPrepare() const;

  // Returns true if MarkCommit will be called during Iterate
  ROCKSDB_LIBRARY_API bool HasCommit() const;

  // Returns true if MarkRollback will be called during Iterate
  ROCKSDB_LIBRARY_API bool HasRollback() const;
  ...
  ROCKSDB_LIBRARY_API Status AssignTimestamp(const Slice& ts);
  ...
  // a placeholder.
  ROCKSDB_LIBRARY_API Status AssignTimestamps(const std::vector<Slice>& ts_list);

  using WriteBatchBase::GetWriteBatch;
  WriteBatch* GetWriteBatch() override { return this; }

  // Constructor with a serialized string object
  ROCKSDB_LIBRARY_API explicit WriteBatch(const std::string& rep);
  ROCKSDB_LIBRARY_API explicit WriteBatch(std::string&& rep);

  ROCKSDB_LIBRARY_API WriteBatch(const WriteBatch& src);
  ROCKSDB_LIBRARY_API WriteBatch(WriteBatch&& src) noexcept;
  ROCKSDB_LIBRARY_API WriteBatch& operator=(const WriteBatch& src);
  ROCKSDB_LIBRARY_API WriteBatch& operator=(WriteBatch&& src);

  // marks this point in the WriteBatch as the last record to
  // be inserted into the WAL, provided the WAL is enabled
  ROCKSDB_LIBRARY_API void MarkWalTerminationPoint();
  ...
  ROCKSDB_LIBRARY_API size_t GetProtectionBytesPerKey() const;
