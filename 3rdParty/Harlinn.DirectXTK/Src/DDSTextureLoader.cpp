...
HDXTK_EXPORT HRESULT DirectX::CreateDDSTextureFromMemory(
...
_Use_decl_annotations_
HDXTK_EXPORT HRESULT DirectX::CreateDDSTextureFromMemoryEx(
    ID3D11Device* d3dDevice,
    const uint8_t* ddsData,
    size_t ddsDataSize,
    size_t maxsize,
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_
HDXTK_EXPORT HRESULT DirectX::CreateDDSTextureFromFile(
    ID3D11Device* d3dDevice,
...
_Use_decl_annotations_
HDXTK_EXPORT HRESULT DirectX::CreateDDSTextureFromFileEx(
    ID3D11Device* d3dDevice,
    const wchar_t* fileName,
    size_t maxsize,
    D3D11_USAGE usage,
