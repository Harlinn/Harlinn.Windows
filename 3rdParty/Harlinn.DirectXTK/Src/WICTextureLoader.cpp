...
HDXTK_EXPORT HRESULT DirectX::CreateWICTextureFromMemory(
...
_Use_decl_annotations_
HDXTK_EXPORT HRESULT DirectX::CreateWICTextureFromMemoryEx(
    ID3D11Device* d3dDevice,
    const uint8_t* wicData,
    size_t wicDataSize,
    size_t maxsize,
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_
HDXTK_EXPORT HRESULT DirectX::CreateWICTextureFromFile(
    ID3D11Device* d3dDevice,
...
_Use_decl_annotations_
HDXTK_EXPORT HRESULT DirectX::CreateWICTextureFromFileEx(
    ID3D11Device* d3dDevice,
    const wchar_t* fileName,
    size_t maxsize,
    D3D11_USAGE usage,
