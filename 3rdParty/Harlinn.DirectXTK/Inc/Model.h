...
namespace DirectX
{
    inline namespace DX11
    {
        ...
        {
        public:
            HDXTK_EXPORT ModelMeshPart() noexcept;
            ...
            HDXTK_EXPORT virtual ~ModelMeshPart();
            ...
            HDXTK_EXPORT void __cdecl Draw(
            ...
            HDXTK_EXPORT void __cdecl DrawInstanced(
                _In_ ID3D11DeviceContext* deviceContext,
                _In_ IEffect* ieffect,
                _In_ ID3D11InputLayout* iinputLayout,
           ...
           // Create input layout for drawing with a custom effect.
            HDXTK_EXPORT void __cdecl CreateInputLayout(_In_ ID3D11Device* device, _In_ IEffect* ieffect, _Outptr_ ID3D11InputLayout** iinputLayout) const;

            // Change effect used by part and regenerate input layout (be sure to call Model::Modified as well)
            HDXTK_EXPORT void __cdecl ModifyEffect(_In_ ID3D11Device* device, _In_ const std::shared_ptr<IEffect>& ieffect, bool isalpha = false);
        };
        ...
        {
        public:
            HDXTK_EXPORT ModelMesh() noexcept;
            ...
            HDXTK_EXPORT virtual ~ModelMesh();
            ...
            HDXTK_EXPORT void __cdecl PrepareForRendering(
                _In_ ID3D11DeviceContext* deviceContext,
            ...
            // Draw the mesh
            HDXTK_EXPORT void XM_CALLCONV Draw(
                _In_ ID3D11DeviceContext* deviceContext,
            ...
            HDXTK_EXPORT void XM_CALLCONV DrawSkinned(
                _In_ ID3D11DeviceContext* deviceContext,
                size_t nbones, _In_reads_(nbones) const XMMATRIX* boneTransforms,
                FXMMATRIX world, CXMMATRIX view, CXMMATRIX projection,
                bool alpha = false,
        ...
        public:
            ...
            HDXTK_EXPORT Model(Model const& other);
            HDXTK_EXPORT Model& operator= (Model const& rhs);

            HDXTK_EXPORT virtual ~Model();
            ...
            HDXTK_EXPORT void __cdecl CopyAbsoluteBoneTransformsTo(
                size_t nbones,
                _Out_writes_(nbones) XMMATRIX* boneTransforms) const;

            HDXTK_EXPORT void __cdecl CopyAbsoluteBoneTransforms(
                size_t nbones,
            ...
            HDXTK_EXPORT void __cdecl UpdateEffects(_In_ std::function<void __cdecl(IEffect*)> setEffect);

            // Loads a model from a Visual Studio Starter Kit .CMO file
            HDXTK_EXPORT static std::unique_ptr<Model> __cdecl CreateFromCMO(
            ...
            HDXTK_EXPORT static std::unique_ptr<Model> __cdecl CreateFromSDKMESH(
                _In_ ID3D11Device* device,
            ...
            HDXTK_EXPORT static std::unique_ptr<Model> __cdecl CreateFromVBO(
                _In_ ID3D11Device* device,
                _In_reads_bytes_(dataSize) const uint8_t* meshData, _In_ size_t dataSize,
        ...
        private:
            ...
            HDXTK_EXPORT void __cdecl ComputeAbsolute(uint32_t index,
