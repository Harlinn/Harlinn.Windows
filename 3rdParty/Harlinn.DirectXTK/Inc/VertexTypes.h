...
namespace DirectX
{
    ...
    // Vertex struct holding position information.
        struct VertexPosition
        {
            ...
            HDXTK_EXPORT static const D3D11_INPUT_ELEMENT_DESC InputElements[InputElementCount];
        };
        ...
        struct VertexPositionNormalTangentColorTexture
        {
            ...
            HDXTK_EXPORT void XM_CALLCONV SetColor(FXMVECTOR icolor) noexcept;
        ...
        struct VertexPositionNormalTangentColorTextureSkinning : public VertexPositionNormalTangentColorTexture
        {
            ...
            HDXTK_EXPORT void __cdecl SetBlendIndices(XMUINT4 const& iindices) noexcept;

            HDXTK_EXPORT void __cdecl SetBlendWeights(XMFLOAT4 const& iweights) noexcept { SetBlendWeights(XMLoadFloat4(&iweights)); }
            HDXTK_EXPORT void XM_CALLCONV SetBlendWeights(FXMVECTOR iweights) noexcept;
