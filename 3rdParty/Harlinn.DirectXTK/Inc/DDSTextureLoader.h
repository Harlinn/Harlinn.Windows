...
#define DDS_ALPHA_MODE_DEFINED
    ...
    // Standard version
    HDXTK_EXPORT HRESULT __cdecl CreateDDSTextureFromMemory(
    ...
    HDXTK_EXPORT HRESULT __cdecl CreateDDSTextureFromFile(
        _In_ ID3D11Device* d3dDevice,
    ...
    // Extended version
    HDXTK_EXPORT HRESULT __cdecl CreateDDSTextureFromMemoryEx(
        _In_ ID3D11Device* d3dDevice,
        _In_reads_bytes_(ddsDataSize) const uint8_t* ddsData,
        _In_ size_t ddsDataSize,
        _In_ size_t maxsize,
    ...
    HDXTK_EXPORT HRESULT __cdecl CreateDDSTextureFromFileEx(
        _In_ ID3D11Device* d3dDevice,
        _In_z_ const wchar_t* szFileName,
        _In_ size_t maxsize,
        _In_ D3D11_USAGE usage,
