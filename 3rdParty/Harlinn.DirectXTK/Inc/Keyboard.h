...
namespace DirectX
{
    ...
    {
    public:
        HDXTK_EXPORT Keyboard() noexcept(false);

        HDXTK_EXPORT Keyboard(Keyboard&&) noexcept;
        HDXTK_EXPORT Keyboard& operator= (Keyboard&&) noexcept;
...
#pragma clang diagnostic pop
        ...
        // Singleton
        HDXTK_EXPORT static Keyboard& __cdecl Get();
