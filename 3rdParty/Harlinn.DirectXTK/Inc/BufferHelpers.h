...
namespace DirectX
{
    ...
    HDXTK_EXPORT HRESULT __cdecl CreateStaticBuffer(_In_ ID3D11Device* device,
    ...
    HDXTK_EXPORT HRESULT __cdecl CreateTextureFromMemory(_In_ ID3D11Device* device,
        size_t width,
        DXGI_FORMAT format,
    ...
    HDXTK_EXPORT HRESULT __cdecl CreateTextureFromMemory(
    #if defined(_XBOX_ONE) && defined(_TITLE)
