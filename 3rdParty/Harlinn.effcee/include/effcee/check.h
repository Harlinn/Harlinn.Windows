 ...
 public:
  ...
  class Part {
   public:
    ...
    HEFFCEE_EXPORT bool MightMatch(const VarMapping& vars) const;
    ...
    HEFFCEE_EXPORT std::string Regex(const VarMapping& vars) const;
   ...
   private:
    ...
    HEFFCEE_EXPORT int CountCapturingGroups();
  ...
  // of this object.
  HEFFCEE_EXPORT Check(Type type, StringPiece param);
  ...
  HEFFCEE_EXPORT bool Matches(StringPiece* str, StringPiece* captured, VarMapping* vars) const;
...
HEFFCEE_EXPORT std::pair<Result, CheckList> ParseChecks(StringPiece checks_string,
