...
#ifdef BUILDING_HARLINN_EFFCEE
#define HEFFCEE_EXPORT __declspec(dllexport)
#else
#define HEFFCEE_EXPORT __declspec(dllimport)
#pragma comment(lib,"Harlinn.effcee.lib")
#endif
...
HEFFCEE_EXPORT Result Match(StringPiece text, StringPiece checks,
