...
BENCHMARK_EXPORT size_t RunSpecifiedBenchmarks(BenchmarkReporter* display_reporter);
BENCHMARK_EXPORT size_t RunSpecifiedBenchmarks(BenchmarkReporter* display_reporter,
                              BenchmarkReporter* file_reporter);

// Register a MemoryManager instance that will be used to collect and report
// allocation measurements for benchmark runs.
BENCHMARK_EXPORT void RegisterMemoryManager(MemoryManager* memory_manager);

// Add a key-value pair to output as part of the context stanza in the report.
BENCHMARK_EXPORT void AddCustomContext(const std::string& key, const std::string& value);
...
class State {
 public:
  ...
  BENCHMARK_EXPORT void PauseTiming();
  ...
  // heavyweight, and so their use should generally be avoided
  // within each benchmark iteration, if possible.
  BENCHMARK_EXPORT void ResumeTiming();
  ...
  BENCHMARK_EXPORT void SkipWithError(const char* msg);
  ...
  // reported values.
  BENCHMARK_EXPORT void SetIterationTime(double seconds);
  ...
  //
  // REQUIRES: a benchmark has exited its benchmarking loop.
  BENCHMARK_EXPORT void SetLabel(const char* label);
 ...
 private:
  BENCHMARK_EXPORT State(IterationCount max_iters, const std::vector<int64_t>& ranges,
        int thread_i, int n_threads, internal::ThreadTimer* timer,
        internal::ThreadManager* manager,
        internal::PerfCountersMeasurement* perf_counters_measurement);

  BENCHMARK_EXPORT void StartKeepRunning();
  // Implementation of KeepRunning() and KeepRunningBatch().
  // is_batch must be true unless n is 1.
  bool KeepRunningInternal(IterationCount n, bool is_batch);
  BENCHMARK_EXPORT void FinishKeepRunning();
...
class Benchmark {
 public:
  BENCHMARK_EXPORT virtual ~Benchmark();

  // Note: the following methods all return "this" so that multiple
  // method calls can be chained together in one expression.

  // Specify the name of the benchmark
  BENCHMARK_EXPORT Benchmark* Name(const std::string& name);

  // Run this benchmark once with "x" as the extra argument passed
  // to the function.
  // REQUIRES: The function passed to the constructor must accept an arg1.
  BENCHMARK_EXPORT Benchmark* Arg(int64_t x);

  // Run this benchmark with the given time unit for the generated output report
  BENCHMARK_EXPORT Benchmark* Unit(TimeUnit unit);

  // Run this benchmark once for a number of values picked from the
  // range [start..limit].  (start and limit are always picked.)
  // REQUIRES: The function passed to the constructor must accept an arg1.
  BENCHMARK_EXPORT Benchmark* Range(int64_t start, int64_t limit);

  // Run this benchmark once for all values in the range [start..limit] with
  // specific step
  // REQUIRES: The function passed to the constructor must accept an arg1.
  BENCHMARK_EXPORT Benchmark* DenseRange(int64_t start, int64_t limit, int step = 1);

  // Run this benchmark once with "args" as the extra arguments passed
  // to the function.
  // REQUIRES: The function passed to the constructor must accept arg1, arg2 ...
  BENCHMARK_EXPORT Benchmark* Args(const std::vector<int64_t>& args);
  ...
  // REQUIRES: The function passed to the constructor must accept arg1, arg2 ...
  BENCHMARK_EXPORT Benchmark* Ranges(const std::vector<std::pair<int64_t, int64_t> >& ranges);

  // Run this benchmark once for each combination of values in the (cartesian)
  // product of the supplied argument lists.
  // REQUIRES: The function passed to the constructor must accept arg1, arg2 ...
  BENCHMARK_EXPORT Benchmark* ArgsProduct(const std::vector<std::vector<int64_t> >& arglists);

  // Equivalent to ArgNames({name})
  BENCHMARK_EXPORT Benchmark* ArgName(const std::string& name);

  // Set the argument names to display in the benchmark name. If not called,
  // only argument values will be shown.
  BENCHMARK_EXPORT Benchmark* ArgNames(const std::vector<std::string>& names);
  ...
  // Threads, etc.
  BENCHMARK_EXPORT Benchmark* Apply(void (*func)(Benchmark* benchmark));

  // Set the range multiplier for non-dense range. If not called, the range
  // multiplier kRangeMultiplier will be used.
  BENCHMARK_EXPORT Benchmark* RangeMultiplier(int multiplier);

  // Set the minimum amount of time to use when running this benchmark. This
  // option overrides the `benchmark_min_time` flag.
  // REQUIRES: `t > 0` and `Iterations` has not been called on this benchmark.
  BENCHMARK_EXPORT Benchmark* MinTime(double t);
  ...
  BENCHMARK_EXPORT Benchmark* Iterations(IterationCount n);

  // Specify the amount of times to repeat this benchmark. This option overrides
  // the `benchmark_repetitions` flag.
  // REQUIRES: `n > 0`
  BENCHMARK_EXPORT Benchmark* Repetitions(int n);

  // Specify if each repetition of the benchmark should be reported separately
  // or if only the final statistics should be reported. If the benchmark
  // is not repeated then the single result is always reported.
  // Applies to *ALL* reporters (display and file).
  BENCHMARK_EXPORT Benchmark* ReportAggregatesOnly(bool value = true);

  // Same as ReportAggregatesOnly(), but applies to display reporter only.
  BENCHMARK_EXPORT Benchmark* DisplayAggregatesOnly(bool value = true);
  ...
  BENCHMARK_EXPORT Benchmark* MeasureProcessCPUTime();
  ...
  BENCHMARK_EXPORT Benchmark* UseRealTime();
  ...
  // or MB/second values.
  BENCHMARK_EXPORT Benchmark* UseManualTime();

  // Set the asymptotic computational complexity for the benchmark. If called
  // the asymptotic computational complexity will be shown on the output.
  BENCHMARK_EXPORT Benchmark* Complexity(BigO complexity = benchmark::oAuto);

  // Set the asymptotic computational complexity for the benchmark. If called
  // the asymptotic computational complexity will be shown on the output.
  BENCHMARK_EXPORT Benchmark* Complexity(BigOFunc* complexity);

  // Add this statistics to be computed over all the values of benchmark run
  BENCHMARK_EXPORT Benchmark* ComputeStatistics(std::string name, StatisticsFunc* statistics);
  ...
  BENCHMARK_EXPORT Benchmark* Threads(int t);
  ...
  //    Foo in 8 threads
  //    Foo in 16 threads
  BENCHMARK_EXPORT Benchmark* ThreadRange(int min_threads, int max_threads);
  ...
  BENCHMARK_EXPORT Benchmark* DenseThreadRange(int min_threads, int max_threads, int stride = 1);

  // Equivalent to ThreadRange(NumCPUs(), NumCPUs())
  BENCHMARK_EXPORT Benchmark* ThreadPerCpu();

  BENCHMARK_EXPORT virtual void Run(State& state) = 0;

 protected:
  BENCHMARK_EXPORT explicit Benchmark(const char* name);
  BENCHMARK_EXPORT Benchmark(Benchmark const&);
  BENCHMARK_EXPORT void SetName(const char* name);

  BENCHMARK_EXPORT int ArgsCnt() const;
...
class FunctionBenchmark : public Benchmark {
 public:
  ...
  BENCHMARK_EXPORT virtual void Run(State& st) BENCHMARK_OVERRIDE;
...
struct CPUInfo {
  ...
  BENCHMARK_EXPORT static const CPUInfo& Get();

 private:
  BENCHMARK_EXPORT CPUInfo();
...
struct SystemInfo {
  std::string name;
  BENCHMARK_EXPORT static const SystemInfo& Get();

 private:
  BENCHMARK_EXPORT SystemInfo();
...
struct BenchmarkName {
  ...
  BENCHMARK_EXPORT std::string str() const;
};
...
class BenchmarkReporter {
 public:
  ...
  struct Run {
    ...
    BENCHMARK_EXPORT std::string benchmark_name() const;
    ...
    // accumulated time.
    BENCHMARK_EXPORT double GetAdjustedRealTime() const;

    // Return a value representing the cpu time per iteration in the unit
    // specified by 'time_unit'.
    // NOTE: If 'iterations' is zero the returned value represents the
    // accumulated time.
    BENCHMARK_EXPORT double GetAdjustedCPUTime() const;
  ...
  BENCHMARK_EXPORT BenchmarkReporter();
  ...
  BENCHMARK_EXPORT virtual ~BenchmarkReporter();

  // Write a human readable string to 'out' representing the specified
  // 'context'.
  // REQUIRES: 'out' is non-null.
  BENCHMARK_EXPORT static void PrintBasicContext(std::ostream* out, Context const& context);
...
class ConsoleReporter : public BenchmarkReporter {
 public:
  ...
  BENCHMARK_EXPORT virtual bool ReportContext(const Context& context) BENCHMARK_OVERRIDE;
  BENCHMARK_EXPORT virtual void ReportRuns(const std::vector<Run>& reports) BENCHMARK_OVERRIDE;

 protected:
  BENCHMARK_EXPORT virtual void PrintRunData(const Run& report);
  BENCHMARK_EXPORT virtual void PrintHeader(const Run& report);
...
class JSONReporter : public BenchmarkReporter {
 public:
  ...
  BENCHMARK_EXPORT virtual bool ReportContext(const Context& context) BENCHMARK_OVERRIDE;
  BENCHMARK_EXPORT virtual void ReportRuns(const std::vector<Run>& reports) BENCHMARK_OVERRIDE;
  BENCHMARK_EXPORT virtual void Finalize() BENCHMARK_OVERRIDE;

 private:
  BENCHMARK_EXPORT void PrintRunData(const Run& report);
...
// });
BENCHMARK_EXPORT std::vector<int64_t> CreateRange(int64_t lo, int64_t hi, int multi);

// Creates a list of integer values for the given range and step.
BENCHMARK_EXPORT std::vector<int64_t> CreateDenseRange(int64_t start, int64_t limit,
                                      int step);
