...
static void RowDct_SSE2(int16_t* in, const __m128i* table1,
  ...
  m0 = _mm_castps_si128(_mm_shuffle_ps( _mm_castsi128_ps(m0), _mm_castsi128_ps(m2), 0x44));
  // => x7 x6 x5 x4 | x7' x6' x5' x4'
  m4 = _mm_castps_si128(_mm_shuffle_ps( _mm_castsi128_ps(m4), _mm_castsi128_ps(m2), 0xee));
