...
MYSOFA_EXPORT int btreeRead(struct READER *reader, struct BTREE *btree);
MYSOFA_EXPORT void btreeFree(struct BTREE *btree);
...
MYSOFA_EXPORT int fractalheapRead(struct READER *reader, struct DATAOBJECT *dataobject,
                    struct FRACTALHEAP *fractalheap);
MYSOFA_EXPORT void fractalheapFree(struct FRACTALHEAP *fractalheap);
...
MYSOFA_EXPORT int dataobjectRead(struct READER *reader, struct DATAOBJECT *dataobject,
                   char *name);
MYSOFA_EXPORT void dataobjectFree(struct READER *reader, struct DATAOBJECT *dataobject);
...
MYSOFA_EXPORT int superblockRead(struct READER *reader, struct SUPERBLOCK *superblock);
MYSOFA_EXPORT void superblockFree(struct READER *reader, struct SUPERBLOCK *superblock);

MYSOFA_EXPORT int gcolRead(struct READER *reader, uint64_t gcol, int reference,
             uint64_t *dataobject);
MYSOFA_EXPORT void gcolFree(struct GCOL *gcol);

MYSOFA_EXPORT int treeRead(struct READER *reader, struct DATAOBJECT *data);
...
MYSOFA_EXPORT int validAddress(struct READER *reader, uint64_t address);
MYSOFA_EXPORT uint64_t readValue(struct READER *reader, int size);

MYSOFA_EXPORT int gunzip(int inlen, char *in, int *outlen, char *out);

MYSOFA_EXPORT char *mysofa_strdup(const char *s);
