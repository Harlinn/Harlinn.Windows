...
class Context {
 public:
  ...
  SPIRV_TOOLS_EXPORT explicit Context(spv_target_env env);

  // Enables move constructor/assignment operations.
  SPIRV_TOOLS_EXPORT Context(Context&& other);
  SPIRV_TOOLS_EXPORT Context& operator=(Context&& other);
  ...
  SPIRV_TOOLS_EXPORT spv_context& CContext();
  SPIRV_TOOLS_EXPORT const spv_context& CContext() const;
...
class SpirvTools {
 public:
  ...
  SPIRV_TOOLS_EXPORT bool IsValid() const;
