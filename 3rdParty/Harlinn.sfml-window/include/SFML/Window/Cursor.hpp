...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_WINDOW_API bool loadFromPixels(const Uint8* pixels, Vector2u size, Vector2u hotspot);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_WINDOW_API bool loadFromSystem(Type type);
...
private:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_WINDOW_API const priv::CursorImpl& getImpl() const;
