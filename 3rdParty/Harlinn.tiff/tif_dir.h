...
extern "C"
{
    ...
    HTIFF_EXPORT extern const TIFFFieldArray *_TIFFGetFields(void);
    HTIFF_EXPORT extern const TIFFFieldArray *_TIFFGetExifFields(void);
    HTIFF_EXPORT extern const TIFFFieldArray *_TIFFGetGpsFields(void);
    HTIFF_EXPORT extern void _TIFFSetupFields(TIFF *tif, const TIFFFieldArray *infoarray);
    HTIFF_EXPORT extern void _TIFFPrintFieldInfo(TIFF *, FILE *);

    HTIFF_EXPORT extern int _TIFFFillStriles(TIFF *);
    ...
    HTIFF_EXPORT extern int _TIFFMergeFields(TIFF *, const TIFFField[], uint32_t);
    HTIFF_EXPORT extern const TIFFField *_TIFFFindOrRegisterField(TIFF *, uint32_t,
                                                     TIFFDataType);
    HTIFF_EXPORT extern TIFFField *_TIFFCreateAnonField(TIFF *, uint32_t, TIFFDataType);
    HTIFF_EXPORT extern int _TIFFCheckFieldIsValidForCodec(TIFF *tif, ttag_t tag);
    HTIFF_EXPORT extern int _TIFFCheckDirNumberAndOffset(TIFF *tif, tdir_t dirn,
                                            uint64_t diroff);
    HTIFF_EXPORT extern int _TIFFGetDirNumberFromOffset(TIFF *tif, uint64_t diroff,
                                           tdir_t *dirn);
    HTIFF_EXPORT extern int _TIFFGetOffsetFromDirNumber(TIFF *tif, tdir_t dirn,
                                           uint64_t *diroff);
    HTIFF_EXPORT extern int _TIFFRemoveEntryFromDirectoryListByOffset(TIFF *tif,
                                                         uint64_t diroff);
