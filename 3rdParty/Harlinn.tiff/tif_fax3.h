...
extern "C" {
#endif
HTIFF_EXPORT extern void _TIFFFax3fillruns(unsigned char*, uint32_t*, uint32_t*, uint32_t);
#if defined(__cplusplus)
}
#endif
...
HTIFF_EXPORT extern const TIFFFaxTabEnt TIFFFaxMainTable[];
HTIFF_EXPORT extern const TIFFFaxTabEnt TIFFFaxWhiteTable[];
HTIFF_EXPORT extern const TIFFFaxTabEnt TIFFFaxBlackTable[];
