 ...
 */
HTIFF_EXPORT int TIFFWriteDirectory(TIFF *tif)
{
 ...
 */
HTIFF_EXPORT int TIFFDeferStrileArrayWriting(TIFF *tif)
{
 ...
 */
HTIFF_EXPORT int TIFFCheckpointDirectory(TIFF *tif)
{
    int rc;
...
HTIFF_EXPORT int TIFFWriteCustomDirectory(TIFF *tif, uint64_t *pdiroff)
{
 ...
 */
HTIFF_EXPORT int TIFFRewriteDirectory(TIFF *tif)
{
...
HTIFF_EXPORT int _TIFFRewriteField(TIFF *tif, uint16_t tag, TIFFDataType in_datatype,
