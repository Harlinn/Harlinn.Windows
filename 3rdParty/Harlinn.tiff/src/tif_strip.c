 ...
 */
HTIFF_EXPORT uint32_t TIFFComputeStrip(TIFF *tif, uint32_t row, uint16_t sample)
{
 ...
 */
HTIFF_EXPORT uint32_t TIFFNumberOfStrips(TIFF *tif)
{
    TIFFDirectory *td = &tif->tif_dir;
    uint32_t nstrips;
 ...
 */
HTIFF_EXPORT uint64_t TIFFVStripSize64(TIFF *tif, uint32_t nrows)
{
...
HTIFF_EXPORT tmsize_t TIFFVStripSize(TIFF *tif, uint32_t nrows)
{
 ...
 */
HTIFF_EXPORT uint64_t TIFFRawStripSize64(TIFF *tif, uint32_t strip)
{
...
HTIFF_EXPORT tmsize_t TIFFRawStripSize(TIFF *tif, uint32_t strip)
{
 ...
 * to hold the strip.
 */
HTIFF_EXPORT uint64_t TIFFStripSize64(TIFF *tif)
{
    TIFFDirectory *td = &tif->tif_dir;
...
HTIFF_EXPORT tmsize_t TIFFStripSize(TIFF *tif)
{
 ...
 */
HTIFF_EXPORT uint32_t TIFFDefaultStripSize(TIFF *tif, uint32_t request)
{
    return (*tif->tif_defstripsize)(tif, request);
}

HTIFF_EXPORT uint32_t _TIFFDefaultStripSize(TIFF *tif, uint32_t s)
{
    if ((int32_t)s < 1)
    {
        /*
 ...
 */
HTIFF_EXPORT uint64_t TIFFScanlineSize64(TIFF *tif)
{
...
HTIFF_EXPORT tmsize_t TIFFScanlineSize(TIFF *tif)
{
 ...
 */
HTIFF_EXPORT uint64_t TIFFRasterScanlineSize64(TIFF *tif)
{
...
HTIFF_EXPORT tmsize_t TIFFRasterScanlineSize(TIFF *tif)
{
