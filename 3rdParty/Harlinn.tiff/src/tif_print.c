 ...
 */
HTIFF_EXPORT void TIFFPrintDirectory(TIFF *tif, FILE *fd, long flags)
{
...
HTIFF_EXPORT void _TIFFprintAscii(FILE *fd, const char *cp)
{
...
HTIFF_EXPORT void _TIFFprintAsciiTag(FILE *fd, const char *name, const char *value)
{
    fprintf(fd, "  %s: \"", name);
