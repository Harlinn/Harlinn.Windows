...
HTIFF_EXPORT void _TIFFsetByteArray(void **vpp, const void *vp, uint32_t n)
{
    setByteArray(NULL, vpp, vp, n, 1);
}
HTIFF_EXPORT void _TIFFsetByteArrayExt(TIFF *tif, void **vpp, const void *vp, uint32_t n)
{
...
HTIFF_EXPORT void _TIFFsetShortArray(uint16_t **wpp, const uint16_t *wp, uint32_t n)
{
    setByteArray(NULL, (void **)wpp, wp, n, sizeof(uint16_t));
}
HTIFF_EXPORT void _TIFFsetShortArrayExt(TIFF *tif, uint16_t **wpp, const uint16_t *wp,
                           uint32_t n)
{
    setByteArray(tif, (void **)wpp, wp, n, sizeof(uint16_t));
}

HTIFF_EXPORT void _TIFFsetLongArray(uint32_t **lpp, const uint32_t *lp, uint32_t n)
{
    setByteArray(NULL, (void **)lpp, lp, n, sizeof(uint32_t));
}
HTIFF_EXPORT void _TIFFsetLongArrayExt(TIFF *tif, uint32_t **lpp, const uint32_t *lp,
                          uint32_t n)
{
...
HTIFF_EXPORT void _TIFFsetFloatArray(float **fpp, const float *fp, uint32_t n)
{
    setByteArray(NULL, (void **)fpp, fp, n, sizeof(float));
}
HTIFF_EXPORT void _TIFFsetFloatArrayExt(TIFF *tif, float **fpp, const float *fp, uint32_t n)
{
    setByteArray(tif, (void **)fpp, fp, n, sizeof(float));
}

HTIFF_EXPORT void _TIFFsetDoubleArray(double **dpp, const double *dp, uint32_t n)
{
    setByteArray(NULL, (void **)dpp, dp, n, sizeof(double));
}
HTIFF_EXPORT void _TIFFsetDoubleArrayExt(TIFF *tif, double **dpp, const double *dp,
                            uint32_t n)
{
 ...
 * updated.
 */
HTIFF_EXPORT int TIFFSetField(TIFF *tif, uint32_t tag, ...)
{
    va_list ap;
    int status;
 ...
 * top of the library.
 */
HTIFF_EXPORT int TIFFVSetField(TIFF *tif, uint32_t tag, va_list ap)
{
 ...
 */
HTIFF_EXPORT int TIFFGetField(TIFF *tif, uint32_t tag, ...)
{
    int status;
    va_list ap;
 ...
 * top of the library.
 */
HTIFF_EXPORT int TIFFVGetField(TIFF *tif, uint32_t tag, va_list ap)
{
    const TIFFField *fip = TIFFFindField(tif, tag, TIFF_ANY);
 ...
 */
HTIFF_EXPORT void TIFFFreeDirectory(TIFF *tif)
{
    TIFFDirectory *td = &tif->tif_dir;
    int i;
...
HTIFF_EXPORT TIFFExtendProc TIFFSetTagExtender(TIFFExtendProc extender)
{
 ...
 */
HTIFF_EXPORT int TIFFCreateDirectory(TIFF *tif)
{
...
HTIFF_EXPORT int TIFFCreateCustomDirectory(TIFF *tif, const TIFFFieldArray *infoarray)
{
    /* Free previously allocated memory and setup default values. */
    TIFFFreeDirectory(tif);
    TIFFDefaultDirectory(tif);
...
HTIFF_EXPORT int TIFFCreateEXIFDirectory(TIFF *tif)
{
 ...
 */
HTIFF_EXPORT int TIFFCreateGPSDirectory(TIFF *tif)
{
 ...
 */
HTIFF_EXPORT int TIFFDefaultDirectory(TIFF *tif)
{
 ...
 */
HTIFF_EXPORT tdir_t TIFFNumberOfDirectories(TIFF *tif)
{
    uint64_t nextdiroff;
    tdir_t nextdirnum;
    tdir_t n;
 ...
 */
HTIFF_EXPORT int TIFFSetDirectory(TIFF *tif, tdir_t dirn)
{
    uint64_t nextdiroff;
    tdir_t nextdirnum = 0;
    tdir_t n;
 ...
 */
HTIFF_EXPORT int TIFFSetSubDirectory(TIFF *tif, uint64_t diroff)
{
 ...
 */
HTIFF_EXPORT uint64_t TIFFCurrentDirOffset(TIFF *tif) { return (tif->tif_diroff); }

/*
 * Return an indication of whether or not we are
 * at the last directory in the file.
 */
HTIFF_EXPORT int TIFFLastDirectory(TIFF *tif) { return (tif->tif_nextdiroff == 0); }
 ...
 * zero.
 */
HTIFF_EXPORT int TIFFUnlinkDirectory(TIFF *tif, tdir_t dirn)
{
