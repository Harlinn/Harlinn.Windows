...
HTIFF_EXPORT const TIFFFieldArray *_TIFFGetFields(void) { return (&tiffFieldArray); }

HTIFF_EXPORT const TIFFFieldArray *_TIFFGetExifFields(void) { return (&exifFieldArray); }

HTIFF_EXPORT const TIFFFieldArray *_TIFFGetGpsFields(void) { return (&gpsFieldArray); }

HTIFF_EXPORT void _TIFFSetupFields(TIFF *tif, const TIFFFieldArray *fieldarray)
{
...
HTIFF_EXPORT int _TIFFMergeFields(TIFF *tif, const TIFFField info[], uint32_t n)
{
...
HTIFF_EXPORT void _TIFFPrintFieldInfo(TIFF *tif, FILE *fd)
{
    uint32_t i;
 ...
 */
HTIFF_EXPORT int TIFFDataWidth(TIFFDataType type)
{
    switch (type)
    {
        case 0: /* nothing */
 ...
 */
HTIFF_EXPORT int TIFFFieldSetGetSize(const TIFFField *fip)
{
    /*
 ...
 */
HTIFF_EXPORT int TIFFFieldSetGetCountSize(const TIFFField *fip)
{
    if (fip == NULL)
        return 0;
...
HTIFF_EXPORT const TIFFField *TIFFFindField(TIFF *tif, uint32_t tag, TIFFDataType dt)
{
...
HTIFF_EXPORT const TIFFField *TIFFFieldWithTag(TIFF *tif, uint32_t tag)
{
...
HTIFF_EXPORT const TIFFField *TIFFFieldWithName(TIFF *tif, const char *field_name)
{
...
HTIFF_EXPORT uint32_t TIFFFieldTag(const TIFFField *fip) { return fip->field_tag; }

HTIFF_EXPORT const char *TIFFFieldName(const TIFFField *fip) { return fip->field_name; }

HTIFF_EXPORT TIFFDataType TIFFFieldDataType(const TIFFField *fip) { return fip->field_type; }

HTIFF_EXPORT int TIFFFieldPassCount(const TIFFField *fip) { return fip->field_passcount; }

HTIFF_EXPORT int TIFFFieldReadCount(const TIFFField *fip) { return fip->field_readcount; }

HTIFF_EXPORT int TIFFFieldWriteCount(const TIFFField *fip) { return fip->field_writecount; }

HTIFF_EXPORT int TIFFFieldIsAnonymous(const TIFFField *fip) { return fip->field_anonymous; }

HTIFF_EXPORT const TIFFField *_TIFFFindOrRegisterField(TIFF *tif, uint32_t tag,
                                          TIFFDataType dt)
...
HTIFF_EXPORT TIFFField *_TIFFCreateAnonField(TIFF *tif, uint32_t tag,
...
HTIFF_EXPORT int TIFFMergeFieldInfo(TIFF *tif, const TIFFFieldInfo info[], uint32_t n)
{
...
HTIFF_EXPORT int _TIFFCheckFieldIsValidForCodec(TIFF *tif, ttag_t tag)
{
