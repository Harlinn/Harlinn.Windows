...
HTIFF_EXPORT void TIFFSwabShort(uint16_t *wp)
{
...
HTIFF_EXPORT void TIFFSwabLong(uint32_t *lp)
{
...
HTIFF_EXPORT void TIFFSwabLong8(uint64_t *lp)
{
    register unsigned char *cp = (unsigned char *)lp;
    unsigned char t;
...
HTIFF_EXPORT void TIFFSwabArrayOfShort(register uint16_t *wp, tmsize_t n)
{
...
HTIFF_EXPORT void TIFFSwabArrayOfTriples(register uint8_t *tp, tmsize_t n)
{
    unsigned char *cp;
    unsigned char t;
...
HTIFF_EXPORT void TIFFSwabArrayOfLong(register uint32_t *lp, tmsize_t n)
{
    register unsigned char *cp;
    register unsigned char t;
    assert(sizeof(uint32_t) == 4);
...
HTIFF_EXPORT void TIFFSwabArrayOfLong8(register uint64_t *lp, tmsize_t n)
{
    register unsigned char *cp;
    register unsigned char t;
    assert(sizeof(uint64_t) == 8);
...
HTIFF_EXPORT void TIFFSwabFloat(float *fp)
{
...
HTIFF_EXPORT void TIFFSwabArrayOfFloat(register float *fp, tmsize_t n)
{
    register unsigned char *cp;
    register unsigned char t;
    assert(sizeof(float) == 4);
...
HTIFF_EXPORT void TIFFSwabDouble(double *dp)
{
...
HTIFF_EXPORT void TIFFSwabArrayOfDouble(double *dp, tmsize_t n)
{
    register unsigned char *cp;
    register unsigned char t;
    assert(sizeof(double) == 8);
...
HTIFF_EXPORT const unsigned char *TIFFGetBitRevTable(int reversed)
{
    return (reversed ? TIFFBitRevTable : TIFFNoBitRevTable);
}

HTIFF_EXPORT void TIFFReverseBits(uint8_t *cp, tmsize_t n)
{
    for (; n > 8; n -= 8)
    {
