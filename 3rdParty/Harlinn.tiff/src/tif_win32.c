 ...
 */
HTIFF_EXPORT TIFF *TIFFFdOpen(int ifd, const char *name, const char *mode)
{
    return TIFFFdOpenExt(ifd, name, mode, NULL);
}

HTIFF_EXPORT TIFF *TIFFFdOpenExt(int ifd, const char *name, const char *mode,
 ...
 */
HTIFF_EXPORT TIFF *TIFFOpen(const char *name, const char *mode)
{
    return TIFFOpenExt(name, mode, NULL);
}

HTIFF_EXPORT TIFF *TIFFOpenExt(const char *name, const char *mode, TIFFOpenOptions *opts)
{
 ...
 */
HTIFF_EXPORT TIFF *TIFFOpenW(const wchar_t *name, const char *mode)
{
    return TIFFOpenWExt(name, mode, NULL);
}

HTIFF_EXPORT TIFF *TIFFOpenWExt(const wchar_t *name, const char *mode, TIFFOpenOptions *opts)
{
...
HTIFF_EXPORT void *_TIFFmalloc(tmsize_t s)
{
    if (s == 0)
        return ((void *)NULL);
...
HTIFF_EXPORT void *_TIFFcalloc(tmsize_t nmemb, tmsize_t siz)
{
    if (nmemb == 0 || siz == 0)
        return ((void *)NULL);
...
HTIFF_EXPORT void _TIFFfree(void *p) { free(p); }

HTIFF_EXPORT void *_TIFFrealloc(void *p, tmsize_t s) { return (realloc(p, (size_t)s)); }

HTIFF_EXPORT void _TIFFmemset(void *p, int v, tmsize_t c) { memset(p, v, (size_t)c); }

HTIFF_EXPORT void _TIFFmemcpy(void *d, const void *s, tmsize_t c)
{
    memcpy(d, s, (size_t)c);
}

HTIFF_EXPORT int _TIFFmemcmp(const void *p1, const void *p2, tmsize_t c)
{
...
HTIFF_EXPORT TIFFErrorHandler _TIFFwarningHandler = Win32WarningHandler;
...
HTIFF_EXPORT TIFFErrorHandler _TIFFerrorHandler = Win32ErrorHandler;
