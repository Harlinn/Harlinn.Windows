 ...
 */
HTIFF_EXPORT void _TIFFFax3fillruns(unsigned char *buf, uint32_t *runs, uint32_t *erun,
                       uint32_t lastx)
{
...
HTIFF_EXPORT int TIFFInitCCITTFax3(TIFF *tif, int scheme)
{
    (void)scheme;
...
HTIFF_EXPORT int TIFFInitCCITTRLE(TIFF *tif, int scheme)
{
    (void)scheme;
    if (InitCCITTFax3(tif))
    { /* reuse G3 support */
