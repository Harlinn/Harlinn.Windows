...
HTIFF_EXPORT int _TIFFgetMode(TIFFOpenOptions *opts, thandle_t clientdata, const char *mode,
                 const char *module)
{
    int m = -1;
...
HTIFF_EXPORT TIFFOpenOptions *TIFFOpenOptionsAlloc()
{
...
HTIFF_EXPORT void TIFFOpenOptionsFree(TIFFOpenOptions *opts) { _TIFFfree(opts); }
 ...
 */
HTIFF_EXPORT void TIFFOpenOptionsSetMaxSingleMemAlloc(TIFFOpenOptions *opts,
 ...
 */
HTIFF_EXPORT void TIFFOpenOptionsSetMaxCumulatedMemAlloc(TIFFOpenOptions *opts,
                                            tmsize_t max_cumulated_mem_alloc)
{
    opts->max_cumulated_mem_alloc = max_cumulated_mem_alloc;
}

HTIFF_EXPORT void TIFFOpenOptionsSetErrorHandlerExtR(TIFFOpenOptions *opts,
...
HTIFF_EXPORT void TIFFOpenOptionsSetWarningHandlerExtR(TIFFOpenOptions *opts,
                                          TIFFErrorHandlerExtR handler,
...
HTIFF_EXPORT void *_TIFFmallocExt(TIFF *tif, tmsize_t s)
{
...
HTIFF_EXPORT void *_TIFFcallocExt(TIFF *tif, tmsize_t nmemb, tmsize_t siz)
{
...
HTIFF_EXPORT void *_TIFFreallocExt(TIFF *tif, void *p, tmsize_t s)
{
    if (tif != NULL && tif->tif_max_single_mem_alloc > 0 &&
        s > tif->tif_max_single_mem_alloc)
    {
...
HTIFF_EXPORT void _TIFFfreeExt(TIFF *tif, void *p)
{
...
HTIFF_EXPORT TIFF *TIFFClientOpen(const char *name, const char *mode, thandle_t clientdata,
...
HTIFF_EXPORT TIFF *TIFFClientOpenExt(const char *name, const char *mode,
 ...
 */
HTIFF_EXPORT const char *TIFFFileName(TIFF *tif) { return (tif->tif_name); }

/*
 * Set the file name.
 */
HTIFF_EXPORT const char *TIFFSetFileName(TIFF *tif, const char *name)
{
 ...
 */
HTIFF_EXPORT int TIFFFileno(TIFF *tif) { return (tif->tif_fd); }

/*
 * Set open file's I/O descriptor, and return previous value.
 */
HTIFF_EXPORT int TIFFSetFileno(TIFF *tif, int fd)
{
 ...
 */
HTIFF_EXPORT thandle_t TIFFClientdata(TIFF *tif) { return (tif->tif_clientdata); }

/*
 * Set open file's clientdata, and return previous value.
 */
HTIFF_EXPORT thandle_t TIFFSetClientdata(TIFF *tif, thandle_t newvalue)
{
 ...
 */
HTIFF_EXPORT int TIFFGetMode(TIFF *tif) { return (tif->tif_mode); }

/*
 * Return read/write mode.
 */
HTIFF_EXPORT int TIFFSetMode(TIFF *tif, int mode)
{
 ...
 */
HTIFF_EXPORT int TIFFIsTiled(TIFF *tif) { return (isTiled(tif)); }

/*
 * Return current row being read/written.
 */
HTIFF_EXPORT uint32_t TIFFCurrentRow(TIFF *tif) { return (tif->tif_row); }

/*
 * Return index of the current directory.
 */
HTIFF_EXPORT tdir_t TIFFCurrentDirectory(TIFF *tif) { return (tif->tif_curdir); }

/*
 * Return current strip.
 */
HTIFF_EXPORT uint32_t TIFFCurrentStrip(TIFF *tif) { return (tif->tif_curstrip); }

/*
 * Return current tile.
 */
HTIFF_EXPORT uint32_t TIFFCurrentTile(TIFF *tif) { return (tif->tif_curtile); }

/*
 * Return nonzero if the file has byte-swapped data.
 */
HTIFF_EXPORT int TIFFIsByteSwapped(TIFF *tif) { return ((tif->tif_flags & TIFF_SWAB) != 0); }

/*
 * Return nonzero if the data is returned up-sampled.
 */
HTIFF_EXPORT int TIFFIsUpSampled(TIFF *tif) { return (isUpSampled(tif)); }

/*
 * Return nonzero if the data is returned in MSB-to-LSB bit order.
 */
HTIFF_EXPORT int TIFFIsMSB2LSB(TIFF *tif) { return (isFillOrder(tif, FILLORDER_MSB2LSB)); }

/*
 * Return nonzero if given file was written in big-endian order.
 */
HTIFF_EXPORT int TIFFIsBigEndian(TIFF *tif)
{
 ...
 */
HTIFF_EXPORT int TIFFIsBigTIFF(TIFF *tif) { return ((tif->tif_flags & TIFF_BIGTIFF) != 0); }

/*
 * Return pointer to file read method.
 */
HTIFF_EXPORT TIFFReadWriteProc TIFFGetReadProc(TIFF *tif) { return (tif->tif_readproc); }

/*
 * Return pointer to file write method.
 */
HTIFF_EXPORT TIFFReadWriteProc TIFFGetWriteProc(TIFF *tif) { return (tif->tif_writeproc); }

/*
 * Return pointer to file seek method.
 */
HTIFF_EXPORT TIFFSeekProc TIFFGetSeekProc(TIFF *tif) { return (tif->tif_seekproc); }

/*
 * Return pointer to file close method.
 */
HTIFF_EXPORT TIFFCloseProc TIFFGetCloseProc(TIFF *tif) { return (tif->tif_closeproc); }

/*
 * Return pointer to file size requesting method.
 */
HTIFF_EXPORT TIFFSizeProc TIFFGetSizeProc(TIFF *tif) { return (tif->tif_sizeproc); }

/*
 * Return pointer to memory mapping method.
 */
HTIFF_EXPORT TIFFMapFileProc TIFFGetMapFileProc(TIFF *tif) { return (tif->tif_mapproc); }

/*
 * Return pointer to memory unmapping method.
 */
HTIFF_EXPORT TIFFUnmapFileProc TIFFGetUnmapFileProc(TIFF *tif)
{
