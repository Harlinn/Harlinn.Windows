 ...
 */
HTIFF_EXPORT void TIFFCIELabToXYZ(TIFFCIELabToRGB *cielab, uint32_t l, int32_t a, int32_t b,
 ...
 * values
 */
HTIFF_EXPORT void TIFFCIELab16ToXYZ(TIFFCIELabToRGB *cielab, uint32_t l, int32_t a,
 ...
 */
HTIFF_EXPORT void TIFFXYZToRGB(TIFFCIELabToRGB *cielab, float X, float Y, float Z,
 ...
 */
HTIFF_EXPORT int TIFFCIELabToRGBInit(TIFFCIELabToRGB *cielab, const TIFFDisplay *display,
                        float *refWhite)
{
    int i;
    double dfGamma;
...
HTIFF_EXPORT void TIFFYCbCrtoRGB(TIFFYCbCrToRGB *ycbcr, uint32_t Y, int32_t Cb, int32_t Cr,
                    uint32_t *r, uint32_t *g, uint32_t *b)
{
    int32_t i;
 ...
 */
HTIFF_EXPORT int TIFFYCbCrToRGBInit(TIFFYCbCrToRGB *ycbcr, float *luma, float *refBlackWhite)
{
