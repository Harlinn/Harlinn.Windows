...
#define FIELD_CUSTOM 65
    ...
    HTIFF_EXPORT extern int TIFFReadCustomDirectory(TIFF *tif, toff_t diroff,
    ...
    HTIFF_EXPORT extern int TIFFIsBigTIFF(TIFF *);
    ...
    HTIFF_EXPORT extern tdir_t TIFFCurrentDirectory(TIFF *);
    HTIFF_EXPORT extern tdir_t TIFFNumberOfDirectories(TIFF *);
    ...
    HTIFF_EXPORT extern int TIFFSetDirectory(TIFF *, tdir_t);
    HTIFF_EXPORT extern int TIFFSetSubDirectory(TIFF *, uint64_t);
    HTIFF_EXPORT extern int TIFFUnlinkDirectory(TIFF *, tdir_t);
    ...
    HTIFF_EXPORT extern int TIFFReadScanline(TIFF *tif, void *buf, uint32_t row,
                                uint16_t sample = 0);
    HTIFF_EXPORT extern int TIFFWriteScanline(TIFF *tif, void *buf, uint32_t row,
                                 uint16_t sample = 0);
    HTIFF_EXPORT extern int TIFFReadRGBAImage(TIFF *, uint32_t, uint32_t, uint32_t *,
                                 int = 0);
    ...
    HTIFF_EXPORT extern int TIFFReadRGBAStripExt(TIFF *, uint32_t, uint32_t *,
                                        int stop_on_error);
    HTIFF_EXPORT extern int TIFFReadRGBATileExt(TIFF *, uint32_t, uint32_t, uint32_t *,
                                       int stop_on_error);
    ...
    HTIFF_EXPORT extern int TIFFRGBAImageGet(TIFFRGBAImage *, uint32_t *, uint32_t,
                                uint32_t);
    ...
    HTIFF_EXPORT extern void TIFFError(const char *, const char *, ...)
        TIFF_ATTRIBUTE((__format__(__printf__, 2, 3)));
    HTIFF_EXPORT extern void TIFFErrorExt(thandle_t, const char *, const char *, ...)
        TIFF_ATTRIBUTE((__format__(__printf__, 3, 4)));
    HTIFF_EXPORT extern void TIFFWarning(const char *, const char *, ...)
        TIFF_ATTRIBUTE((__format__(__printf__, 2, 3)));
    HTIFF_EXPORT extern void TIFFWarningExt(thandle_t, const char *, const char *, ...)
        TIFF_ATTRIBUTE((__format__(__printf__, 3, 4)));
    ...
    HTIFF_EXPORT extern void TIFFWarningExtR(TIFF *, const char *, const char *, ...)
        TIFF_ATTRIBUTE((__format__(__printf__, 3, 4)));
    HTIFF_EXPORT extern void TIFFErrorExtR(TIFF *, const char *, const char *, ...)
        TIFF_ATTRIBUTE((__format__(__printf__, 3, 4)));

    typedef struct TIFFOpenOptions TIFFOpenOptions;
    HTIFF_EXPORT extern TIFFOpenOptions *TIFFOpenOptionsAlloc(void);
    HTIFF_EXPORT extern void TIFFOpenOptionsFree(TIFFOpenOptions *);
    HTIFF_EXPORT extern void
    ...
    HTIFF_EXPORT extern TIFF *TIFFOpenExt(const char *, const char *, TIFFOpenOptions *opts);
#ifdef _WIN32
    HTIFF_EXPORT extern TIFF *TIFFOpenW(const wchar_t *, const char *);
    HTIFF_EXPORT extern TIFF *TIFFOpenWExt(const wchar_t *, const char *,
                              TIFFOpenOptions *opts);
#endif /* _WIN32 */
    HTIFF_EXPORT extern TIFF *TIFFFdOpen(int, const char *, const char *);
    HTIFF_EXPORT extern TIFF *TIFFFdOpenExt(int, const char *, const char *,
                               TIFFOpenOptions *opts);
    HTIFF_EXPORT extern TIFF *TIFFClientOpen(const char *, const char *, thandle_t,
                                TIFFReadWriteProc, TIFFReadWriteProc,
                                TIFFSeekProc, TIFFCloseProc, TIFFSizeProc,
                                TIFFMapFileProc, TIFFUnmapFileProc);
    HTIFF_EXPORT extern TIFF *TIFFClientOpenExt(const char *, const char *, thandle_t,
                                   TIFFReadWriteProc, TIFFReadWriteProc,
                                   TIFFSeekProc, TIFFCloseProc, TIFFSizeProc,
                                   TIFFMapFileProc, TIFFUnmapFileProc,
                                   TIFFOpenOptions *opts);
    HTIFF_EXPORT extern TIFFExtendProc TIFFSetTagExtender(TIFFExtendProc);
    HTIFF_EXPORT extern uint32_t TIFFComputeTile(TIFF *tif, uint32_t x, uint32_t y,
                                    uint32_t z, uint16_t s);
    HTIFF_EXPORT extern int TIFFCheckTile(TIFF *tif, uint32_t x, uint32_t y, uint32_t z,
                             uint16_t s);
    HTIFF_EXPORT extern uint32_t TIFFNumberOfTiles(TIFF *);
    HTIFF_EXPORT extern tmsize_t TIFFReadTile(TIFF *tif, void *buf, uint32_t x, uint32_t y,
                                 uint32_t z, uint16_t s);
    HTIFF_EXPORT extern tmsize_t TIFFWriteTile(TIFF *tif, void *buf, uint32_t x, uint32_t y,
                                  uint32_t z, uint16_t s);
    HTIFF_EXPORT extern uint32_t TIFFComputeStrip(TIFF *, uint32_t, uint16_t);
    HTIFF_EXPORT extern uint32_t TIFFNumberOfStrips(TIFF *);
    HTIFF_EXPORT extern tmsize_t TIFFReadEncodedStrip(TIFF *tif, uint32_t strip, void *buf,
                                         tmsize_t size);
    HTIFF_EXPORT extern tmsize_t TIFFReadRawStrip(TIFF *tif, uint32_t strip, void *buf,
                                     tmsize_t size);
    HTIFF_EXPORT extern tmsize_t TIFFReadEncodedTile(TIFF *tif, uint32_t tile, void *buf,
                                        tmsize_t size);
    HTIFF_EXPORT extern tmsize_t TIFFReadRawTile(TIFF *tif, uint32_t tile, void *buf,
                                    tmsize_t size);
    HTIFF_EXPORT extern int TIFFReadFromUserBuffer(TIFF *tif, uint32_t strile, void *inbuf,
                                      tmsize_t insize, void *outbuf,
                                      tmsize_t outsize);
    HTIFF_EXPORT extern tmsize_t TIFFWriteEncodedStrip(TIFF *tif, uint32_t strip, void *data,
                                          tmsize_t cc);
    HTIFF_EXPORT extern tmsize_t TIFFWriteRawStrip(TIFF *tif, uint32_t strip, void *data,
                                      tmsize_t cc);
    HTIFF_EXPORT extern tmsize_t TIFFWriteEncodedTile(TIFF *tif, uint32_t tile, void *data,
                                         tmsize_t cc);
    HTIFF_EXPORT extern tmsize_t TIFFWriteRawTile(TIFF *tif, uint32_t tile, void *data,
                                     tmsize_t cc);
    HTIFF_EXPORT extern int TIFFDataWidth(
    ...
    HTIFF_EXPORT extern uint64_t TIFFGetStrileOffsetWithErr(TIFF *tif, uint32_t strile,
                                               int *pbErr);
    HTIFF_EXPORT extern uint64_t TIFFGetStrileByteCountWithErr(TIFF *tif, uint32_t strile,
                                                  int *pbErr);
...
#define UVSCALE 410.
    ...
    HTIFF_EXPORT extern int TIFFCIELabToRGBInit(TIFFCIELabToRGB *, const TIFFDisplay *,
                                   float *);
    HTIFF_EXPORT extern void TIFFCIELabToXYZ(TIFFCIELabToRGB *, uint32_t, int32_t, int32_t,
                                float *, float *, float *);
    HTIFF_EXPORT extern void TIFFXYZToRGB(TIFFCIELabToRGB *, float, float, float, uint32_t *,
                             uint32_t *, uint32_t *);
