...
extern "C" {
#endif
HTIFF_EXPORT extern int _TIFFgetMode(const char* mode, const char* module);
HTIFF_EXPORT extern int _TIFFNoRowEncode(TIFF* tif, uint8_t* pp, tmsize_t cc, uint16_t s);
HTIFF_EXPORT extern int _TIFFNoStripEncode(TIFF* tif, uint8_t* pp, tmsize_t cc, uint16_t s);
HTIFF_EXPORT extern int _TIFFNoTileEncode(TIFF*, uint8_t* pp, tmsize_t cc, uint16_t s);
HTIFF_EXPORT extern int _TIFFNoRowDecode(TIFF* tif, uint8_t* pp, tmsize_t cc, uint16_t s);
HTIFF_EXPORT extern int _TIFFNoStripDecode(TIFF* tif, uint8_t* pp, tmsize_t cc, uint16_t s);
...
HTIFF_EXPORT extern int _TIFFRewriteField(TIFF *, uint16_t, TIFFDataType, tmsize_t, void *);
...
HTIFF_EXPORT extern int _TIFFDataSize(TIFFDataType type);

/*--: Rational2Double: Return size of TIFFSetGetFieldType in bytes. */
HTIFF_EXPORT extern int _TIFFSetGetFieldSize(TIFFSetGetFieldType setgettype);

HTIFF_EXPORT extern void _TIFFsetByteArray(void**, void*, uint32_t);
HTIFF_EXPORT extern void _TIFFsetString(char**, char*);
HTIFF_EXPORT extern void _TIFFsetShortArray(uint16_t**, uint16_t*, uint32_t);
HTIFF_EXPORT extern void _TIFFsetLongArray(uint32_t**, uint32_t*, uint32_t);
HTIFF_EXPORT extern void _TIFFsetFloatArray(float**, float*, uint32_t);
HTIFF_EXPORT extern void _TIFFsetDoubleArray(double**, double*, uint32_t);
...
HTIFF_EXPORT extern tmsize_t _TIFFMultiplySSize(TIFF*, tmsize_t, tmsize_t, const char*);
...
HTIFF_EXPORT extern void* _TIFFCheckRealloc(TIFF*, void*, tmsize_t, tmsize_t, const char*);

HTIFF_EXPORT extern double _TIFFUInt64ToDouble(uint64_t);
HTIFF_EXPORT extern float _TIFFUInt64ToFloat(uint64_t);

HTIFF_EXPORT extern float _TIFFClampDoubleToFloat(double);

HTIFF_EXPORT extern tmsize_t
...
HTIFF_EXPORT extern int TIFFJPEGIsFullStripRequired(TIFF*);
#endif
#ifdef JBIG_SUPPORT
