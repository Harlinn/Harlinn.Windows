...
{
#endif
    HTIFF_EXPORT extern int _TIFFgetMode(TIFFOpenOptions *opts, thandle_t clientdata,
                            const char *mode, const char *module);
    HTIFF_EXPORT extern int _TIFFNoRowEncode(TIFF *tif, uint8_t *pp, tmsize_t cc,
                                uint16_t s);
    HTIFF_EXPORT extern int _TIFFNoStripEncode(TIFF *tif, uint8_t *pp, tmsize_t cc,
                                  uint16_t s);
    HTIFF_EXPORT extern int _TIFFNoTileEncode(TIFF *, uint8_t *pp, tmsize_t cc, uint16_t s);
    HTIFF_EXPORT extern int _TIFFNoRowDecode(TIFF *tif, uint8_t *pp, tmsize_t cc,
                                uint16_t s);
    HTIFF_EXPORT extern int _TIFFNoStripDecode(TIFF *tif, uint8_t *pp, tmsize_t cc,
                                  uint16_t s);
    HTIFF_EXPORT extern int _TIFFNoTileDecode(TIFF *, uint8_t *pp, tmsize_t cc, uint16_t s);
    HTIFF_EXPORT extern void _TIFFNoPostDecode(TIFF *tif, uint8_t *buf, tmsize_t cc);
    HTIFF_EXPORT extern int _TIFFNoPreCode(TIFF *tif, uint16_t s);
    HTIFF_EXPORT extern int _TIFFNoSeek(TIFF *tif, uint32_t off);
    HTIFF_EXPORT extern void _TIFFSwab16BitData(TIFF *tif, uint8_t *buf, tmsize_t cc);
    HTIFF_EXPORT extern void _TIFFSwab24BitData(TIFF *tif, uint8_t *buf, tmsize_t cc);
    HTIFF_EXPORT extern void _TIFFSwab32BitData(TIFF *tif, uint8_t *buf, tmsize_t cc);
    HTIFF_EXPORT extern void _TIFFSwab64BitData(TIFF *tif, uint8_t *buf, tmsize_t cc);
    HTIFF_EXPORT extern int TIFFFlushData1(TIFF *tif);
    HTIFF_EXPORT extern int TIFFDefaultDirectory(TIFF *tif);
    HTIFF_EXPORT extern void _TIFFSetDefaultCompressionState(TIFF *tif);
    HTIFF_EXPORT extern int _TIFFRewriteField(TIFF *, uint16_t, TIFFDataType, tmsize_t,
                                 void *);
    HTIFF_EXPORT extern int TIFFSetCompressionScheme(TIFF *tif, int scheme);
    HTIFF_EXPORT extern int TIFFSetDefaultCompressionState(TIFF *tif);
    HTIFF_EXPORT extern uint32_t _TIFFDefaultStripSize(TIFF *tif, uint32_t s);
    HTIFF_EXPORT extern void _TIFFDefaultTileSize(TIFF *tif, uint32_t *tw, uint32_t *th);

    HTIFF_EXPORT extern void _TIFFsetByteArray(void **, const void *, uint32_t);
    HTIFF_EXPORT extern void _TIFFsetByteArrayExt(TIFF *, void **, const void *, uint32_t);
    HTIFF_EXPORT extern void _TIFFsetShortArray(uint16_t **, const uint16_t *, uint32_t);
    HTIFF_EXPORT extern void _TIFFsetShortArrayExt(TIFF *, uint16_t **, const uint16_t *,
                                      uint32_t);
    HTIFF_EXPORT extern void _TIFFsetLongArray(uint32_t **, const uint32_t *, uint32_t);
    HTIFF_EXPORT extern void _TIFFsetLongArrayExt(TIFF *, uint32_t **, const uint32_t *,
                                     uint32_t);
    HTIFF_EXPORT extern void _TIFFsetFloatArray(float **, const float *, uint32_t);
    HTIFF_EXPORT extern void _TIFFsetFloatArrayExt(TIFF *, float **, const float *,
                                      uint32_t);
    HTIFF_EXPORT extern void _TIFFsetDoubleArray(double **, const double *, uint32_t);
    HTIFF_EXPORT extern void _TIFFsetDoubleArrayExt(TIFF *, double **, const double *,
                                       uint32_t);

    HTIFF_EXPORT extern void _TIFFprintAscii(FILE *, const char *);
    HTIFF_EXPORT extern void _TIFFprintAsciiTag(FILE *, const char *, const char *);

    HTIFF_EXPORT extern TIFFErrorHandler _TIFFwarningHandler;
    HTIFF_EXPORT extern TIFFErrorHandler _TIFFerrorHandler;
    HTIFF_EXPORT extern TIFFErrorHandlerExt _TIFFwarningHandlerExt;
    HTIFF_EXPORT extern TIFFErrorHandlerExt _TIFFerrorHandlerExt;
    HTIFF_EXPORT void _TIFFErrorEarly(TIFFOpenOptions *opts, thandle_t clientdata,
                         const char *module, const char *fmt, ...)
        TIFF_ATTRIBUTE((__format__(__printf__, 4, 5)));

    HTIFF_EXPORT extern uint32_t _TIFFMultiply32(TIFF *, uint32_t, uint32_t, const char *);
    HTIFF_EXPORT extern uint64_t _TIFFMultiply64(TIFF *, uint64_t, uint64_t, const char *);
    HTIFF_EXPORT extern tmsize_t _TIFFMultiplySSize(TIFF *, tmsize_t, tmsize_t,
                                       const char *);
    HTIFF_EXPORT extern tmsize_t _TIFFCastUInt64ToSSize(TIFF *, uint64_t, const char *);
    HTIFF_EXPORT extern void *_TIFFCheckMalloc(TIFF *, tmsize_t, tmsize_t, const char *);
    HTIFF_EXPORT extern void *_TIFFCheckRealloc(TIFF *, void *, tmsize_t, tmsize_t,
                                   const char *);

    HTIFF_EXPORT extern float _TIFFClampDoubleToFloat(double);
    HTIFF_EXPORT extern uint32_t _TIFFClampDoubleToUInt32(double);

    HTIFF_EXPORT extern void _TIFFCleanupIFDOffsetAndNumberMaps(TIFF *tif);

    HTIFF_EXPORT extern tmsize_t _TIFFReadEncodedStripAndAllocBuffer(TIFF *tif,
                                                        uint32_t strip,
                                                        void **buf,
                                                        tmsize_t bufsizetoalloc,
                                                        tmsize_t size_to_read);
    HTIFF_EXPORT extern tmsize_t _TIFFReadEncodedTileAndAllocBuffer(TIFF *tif, uint32_t tile,
                                                       void **buf,
                                                       tmsize_t bufsizetoalloc,
                                                       tmsize_t size_to_read);
    HTIFF_EXPORT extern tmsize_t _TIFFReadTileAndAllocBuffer(TIFF *tif, void **buf,
                                                tmsize_t bufsizetoalloc,
                                                uint32_t x, uint32_t y,
                                                uint32_t z, uint16_t s);
    HTIFF_EXPORT extern int _TIFFSeekOK(TIFF *tif, toff_t off);

    HTIFF_EXPORT extern int TIFFInitDumpMode(TIFF *, int);
#ifdef PACKBITS_SUPPORT
    HTIFF_EXPORT extern int TIFFInitPackBits(TIFF *, int);
#endif
#ifdef CCITT_SUPPORT
    HTIFF_EXPORT extern int TIFFInitCCITTRLE(TIFF *, int), TIFFInitCCITTRLEW(TIFF *, int);
    HTIFF_EXPORT extern int TIFFInitCCITTFax3(TIFF *, int), TIFFInitCCITTFax4(TIFF *, int);
#endif
#ifdef THUNDER_SUPPORT
    HTIFF_EXPORT extern int TIFFInitThunderScan(TIFF *, int);
#endif
#ifdef NEXT_SUPPORT
    HTIFF_EXPORT extern int TIFFInitNeXT(TIFF *, int);
#endif
#ifdef LZW_SUPPORT
    HTIFF_EXPORT extern int TIFFInitLZW(TIFF *, int);
#endif
#ifdef OJPEG_SUPPORT
    HTIFF_EXPORT extern int TIFFInitOJPEG(TIFF *, int);
#endif
#ifdef JPEG_SUPPORT
    HTIFF_EXPORT extern int TIFFInitJPEG(TIFF *, int);
    extern int TIFFJPEGIsFullStripRequired(TIFF *);
#endif
#ifdef JBIG_SUPPORT
    HTIFF_EXPORT extern int TIFFInitJBIG(TIFF *, int);
#endif
#ifdef ZIP_SUPPORT
    HTIFF_EXPORT extern int TIFFInitZIP(TIFF *, int);
#endif
#ifdef PIXARLOG_SUPPORT
    HTIFF_EXPORT extern int TIFFInitPixarLog(TIFF *, int);
#endif
#ifdef LOGLUV_SUPPORT
    HTIFF_EXPORT extern int TIFFInitSGILog(TIFF *, int);
#endif
#ifdef LERC_SUPPORT
    HTIFF_EXPORT extern int TIFFInitLERC(TIFF *tif, int);
#endif
#ifdef LZMA_SUPPORT
    HTIFF_EXPORT extern int TIFFInitLZMA(TIFF *, int);
#endif
#ifdef ZSTD_SUPPORT
    HTIFF_EXPORT extern int TIFFInitZSTD(TIFF *, int);
#endif
#ifdef WEBP_SUPPORT
    HTIFF_EXPORT extern int TIFFInitWebP(TIFF *, int);
#endif
    HTIFF_EXPORT extern const TIFFCodec _TIFFBuiltinCODECS[];
    HTIFF_EXPORT extern void TIFFCIELab16ToXYZ(TIFFCIELabToRGB *, uint32_t l, int32_t a,
                                  int32_t b, float *, float *, float *);

    HTIFF_EXPORT extern void *_TIFFmallocExt(TIFF *tif, tmsize_t s);
    HTIFF_EXPORT extern void *_TIFFcallocExt(TIFF *tif, tmsize_t nmemb, tmsize_t siz);
    HTIFF_EXPORT extern void *_TIFFreallocExt(TIFF *tif, void *p, tmsize_t s);
    HTIFF_EXPORT extern void _TIFFfreeExt(TIFF *tif, void *p);
