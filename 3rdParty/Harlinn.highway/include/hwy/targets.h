...
HIGHWAY_EXPORT uint32_t SupportedTargets();
...
HIGHWAY_EXPORT void DisableTargets(uint32_t disabled_targets);
...
HIGHWAY_EXPORT void SetSupportedTargetsForTest(uint32_t targets);

// Returns whether the SupportedTargets() function was called since the last
// SetSupportedTargetsForTest() call.
HIGHWAY_EXPORT bool SupportedTargetsCalledForTest();
...
extern HIGHWAY_EXPORT ChosenTarget chosen_target;
