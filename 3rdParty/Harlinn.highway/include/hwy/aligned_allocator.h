...
HIGHWAY_EXPORT void* AllocateAlignedBytes(size_t payload_size, AllocPtr alloc_ptr,
                           void* opaque_ptr);
...
HIGHWAY_EXPORT void FreeAlignedBytes(const void* aligned_pointer, FreePtr free_ptr,
                      void* opaque_ptr);
...
class AlignedDeleter {
 ...
 private:
  ...
  HIGHWAY_EXPORT static void DeleteAlignedArray(void* aligned_pointer, FreePtr free_ptr,
