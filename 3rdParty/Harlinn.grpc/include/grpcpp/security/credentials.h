...
GRPC_EXPORT std::shared_ptr<Channel> CreateCustomChannel(
    const grpc::string& target,
    const std::shared_ptr<grpc::ChannelCredentials>& creds,
    const grpc::ChannelArguments& args);

namespace experimental {
GRPC_EXPORT std::shared_ptr<grpc::Channel> CreateCustomChannelWithInterceptors(
    const grpc::string& target,
    const std::shared_ptr<grpc::ChannelCredentials>& creds,
    const grpc::ChannelArguments& args,
    std::vector<
...
GRPC_EXPORT std::shared_ptr<ChannelCredentials> XdsCredentials(
...
class ChannelCredentials : private grpc::GrpcLibraryCodegen {
 public:
  GRPC_EXPORT ChannelCredentials();
  GRPC_EXPORT ~ChannelCredentials() override;

 protected:
  friend GRPC_EXPORT std::shared_ptr<ChannelCredentials> CompositeChannelCredentials(
  ...
  friend GRPC_EXPORT std::shared_ptr<ChannelCredentials> grpc::XdsCredentials(
      const std::shared_ptr<ChannelCredentials>& fallback_creds);

  virtual SecureChannelCredentials* AsSecureCredentials() = 0;

 private:
  friend GRPC_EXPORT std::shared_ptr<grpc::Channel> CreateCustomChannel(
      const grpc::string& target,
      const std::shared_ptr<grpc::ChannelCredentials>& creds,
      const grpc::ChannelArguments& args);

  friend GRPC_EXPORT std::shared_ptr<grpc::Channel>
...
class CallCredentials : private grpc::GrpcLibraryCodegen {
 public:
  GRPC_EXPORT CallCredentials();
  GRPC_EXPORT ~CallCredentials() override;
 ...
 protected:
  ...
  friend GRPC_EXPORT std::shared_ptr<CallCredentials> CompositeCallCredentials(
...
/// services.
GRPC_EXPORT std::shared_ptr<ChannelCredentials> GoogleDefaultCredentials();

/// Builds SSL Credentials given SSL specific options
GRPC_EXPORT std::shared_ptr<ChannelCredentials> SslCredentials(
...
/// service being able to impersonate your client for requests to Google
/// services.
GRPC_EXPORT std::shared_ptr<CallCredentials> GoogleComputeEngineCredentials();
...
GRPC_EXPORT std::shared_ptr<CallCredentials> ServiceAccountJWTAccessCredentials(
...
/// service being able to impersonate your client for requests to Google
/// services.
GRPC_EXPORT std::shared_ptr<CallCredentials> GoogleRefreshTokenCredentials(
...
/// service being able to impersonate your client for requests to Google
/// services.
GRPC_EXPORT std::shared_ptr<CallCredentials> AccessTokenCredentials(
...
/// service being able to impersonate your client for requests to Google
/// services.
GRPC_EXPORT std::shared_ptr<CallCredentials> GoogleIAMCredentials(
    const grpc::string& authorization_token,
    const grpc::string& authority_selector);

/// Combines a channel credentials and a call credentials into a composite
/// channel credentials.
GRPC_EXPORT std::shared_ptr<ChannelCredentials> CompositeChannelCredentials(
    const std::shared_ptr<ChannelCredentials>& channel_creds,
    const std::shared_ptr<CallCredentials>& call_creds);

/// Combines two call credentials objects into a composite call credentials.
GRPC_EXPORT std::shared_ptr<CallCredentials> CompositeCallCredentials(
    const std::shared_ptr<CallCredentials>& creds1,
    const std::shared_ptr<CallCredentials>& creds2);

/// Credentials for an unencrypted, unauthenticated channel
GRPC_EXPORT std::shared_ptr<ChannelCredentials> InsecureChannelCredentials();
...
GRPC_EXPORT std::shared_ptr<CallCredentials> MetadataCredentialsFromPlugin(
    std::unique_ptr<MetadataCredentialsPlugin> plugin);

/// Builds External Account credentials.
/// json_string is the JSON string containing the credentials options.
/// scopes contains the scopes to be binded with the credentials.
GRPC_EXPORT std::shared_ptr<CallCredentials> ExternalAccountCredentials(
...
GRPC_EXPORT grpc::Status StsCredentialsOptionsFromJson(const std::string& json_string,
...
GRPC_EXPORT grpc::Status StsCredentialsOptionsFromEnv(StsCredentialsOptions* options);

GRPC_EXPORT std::shared_ptr<CallCredentials> StsCredentials(
...
GRPC_EXPORT std::shared_ptr<ChannelCredentials> AltsCredentials(
    const AltsCredentialsOptions& options);

/// Builds Local Credentials.
GRPC_EXPORT std::shared_ptr<ChannelCredentials> LocalCredentials(
    grpc_local_connect_type type);

/// Builds TLS Credentials given TLS options.
GRPC_EXPORT std::shared_ptr<ChannelCredentials> TlsCredentials(
