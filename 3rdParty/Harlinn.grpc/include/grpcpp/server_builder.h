...
class ServerBuilder {
 public:
  GRPC_EXPORT ServerBuilder();
  GRPC_EXPORT virtual ~ServerBuilder();
  ...
  GRPC_EXPORT virtual std::unique_ptr<grpc::Server> BuildAndStart();

  /// Register a service. This call does not take ownership of the service.
  /// The service must exist for the lifetime of the \a Server instance returned
  /// by \a BuildAndStart().
  /// Matches requests with any :authority
  GRPC_EXPORT ServerBuilder& RegisterService(grpc::Service* service);
  ...
  GRPC_EXPORT ServerBuilder& AddListeningPort(
  ...
  /// use cases.
  GRPC_EXPORT std::unique_ptr<grpc::ServerCompletionQueue> AddCompletionQueue(
  ...
  /// host
  GRPC_EXPORT ServerBuilder& RegisterService(const std::string& host,
  ...
  GRPC_EXPORT ServerBuilder& RegisterAsyncGenericService(
  ...
  GRPC_EXPORT ServerBuilder& SetCompressionAlgorithmSupportStatus(
      grpc_compression_algorithm algorithm, bool enabled);

  /// The default compression level to use for all channel calls in the
  /// absence of a call-specific level.
  GRPC_EXPORT ServerBuilder& SetDefaultCompressionLevel(grpc_compression_level level);
  ...
  GRPC_EXPORT ServerBuilder& SetDefaultCompressionAlgorithm(
      grpc_compression_algorithm algorithm);

  /// Set the attached buffer pool for this server
  GRPC_EXPORT ServerBuilder& SetResourceQuota(const grpc::ResourceQuota& resource_quota);

  GRPC_EXPORT ServerBuilder& SetOption(std::unique_ptr<grpc::ServerBuilderOption> option);
  ...
  GRPC_EXPORT ServerBuilder& SetSyncServerOption(SyncServerOption option, int value);
  ...
  GRPC_EXPORT static void InternalAddPluginFactory(
  ...
  /// doc/workarounds.md.
  GRPC_EXPORT ServerBuilder& EnableWorkaround(grpc_workaround_list id);
  ...
  class experimental_type {
   public:
    ...
    /// server credentials.
    GRPC_EXPORT std::unique_ptr<grpc::experimental::ExternalConnectionAcceptor>
    ...
    GRPC_EXPORT void SetAuthorizationPolicyProvider(
  ...
  GRPC_EXPORT ServerBuilder& SetContextAllocator(
  ...
  /// This is mostly useful for writing generic gRPC Proxies where the exact
  /// serialization format is unknown
  GRPC_EXPORT ServerBuilder& RegisterCallbackGenericService(
 ...
 protected:
  ...
  /// Experimental API, subject to change.
  GRPC_EXPORT virtual ChannelArguments BuildChannelArgs();
