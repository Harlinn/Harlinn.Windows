...
class ClientContext {
 public:
  ...
  GRPC_EXPORT static std::unique_ptr<ClientContext> FromServerContext(
      const grpc::ServerContextBase& server_context,
      PropagationOptions options = PropagationOptions());
  GRPC_EXPORT static std::unique_ptr<ClientContext> FromCallbackServerContext(
  ...
  \endverbatim
  **/
  GRPC_EXPORT void AddMetadata(const std::string& meta_key, const std::string& meta_value);
 ...
 private:
  ...
  GRPC_EXPORT ClientContext(const ClientContext&);
  GRPC_EXPORT ClientContext& operator=(const ClientContext&);
  ...
  GRPC_EXPORT void SendCancelToInterceptors();

  GRPC_EXPORT static std::unique_ptr<ClientContext> FromInternalServerContext(
      const grpc::ServerContextBase& server_context,
