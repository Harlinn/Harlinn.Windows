...
class AuthPropertyIterator
 ...
 public:
  GRPC_EXPORT ~AuthPropertyIterator();
  GRPC_EXPORT AuthPropertyIterator& operator++();
  GRPC_EXPORT AuthPropertyIterator operator++(int);
  GRPC_EXPORT bool operator==(const AuthPropertyIterator& rhs) const;
  GRPC_EXPORT bool operator!=(const AuthPropertyIterator& rhs) const;
  GRPC_EXPORT AuthProperty operator*();

 protected:
  GRPC_EXPORT AuthPropertyIterator();
  GRPC_EXPORT AuthPropertyIterator(const grpc_auth_property* property,
