...
class ByteBuffer final {
 public:
  ...
  GRPC_EXPORT Status TrySingleSlice(Slice* slice) const;

  /// Dump (read) the buffer contents into \a slics.
  GRPC_EXPORT Status DumpToSingleSlice(Slice* slice) const;

  /// Dump (read) the buffer contents into \a slices.
  GRPC_EXPORT Status Dump(std::vector<Slice>* slices) const;
