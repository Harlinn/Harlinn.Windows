 ...
 public:
  ...
  class ResolvedAddress {
   public:
    ...
    GRPC_EXPORT ResolvedAddress(const sockaddr* address, socklen_t size);
    ResolvedAddress() = default;
    ResolvedAddress(const ResolvedAddress&) = default;
    GRPC_EXPORT const struct sockaddr* address() const;
    GRPC_EXPORT socklen_t size() const;
...
GRPC_EXPORT std::shared_ptr<EventEngine> DefaultEventEngineFactory();
