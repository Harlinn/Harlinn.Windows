...
GRPC_EXPORT bool grpc_channel_stack_type_is_client(grpc_channel_stack_type type);

GRPC_EXPORT const char* grpc_channel_stack_type_string(grpc_channel_stack_type type);
