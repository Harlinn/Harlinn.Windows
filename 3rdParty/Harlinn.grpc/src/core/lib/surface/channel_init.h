...
GRPC_EXPORT void grpc_channel_init_init(void);
...
GRPC_EXPORT void grpc_channel_init_register_stage(grpc_channel_stack_type type,
                                      int priority,
...
/// allowed.
GRPC_EXPORT void grpc_channel_init_finalize(void);
/// Shutdown the channel init system
GRPC_EXPORT void grpc_channel_init_shutdown(void);
...
GRPC_EXPORT bool grpc_channel_init_create_stack(grpc_channel_stack_builder* builder,
