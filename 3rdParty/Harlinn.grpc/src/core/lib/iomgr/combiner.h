...
class Combiner {
 public:
  GRPC_EXPORT void Run(grpc_closure* closure, grpc_error_handle error);
  // TODO(yashkt) : Remove this method
  GRPC_EXPORT void FinallyRun(grpc_closure* closure, grpc_error_handle error);
...
// necessary
GRPC_EXPORT grpc_core::Combiner* grpc_combiner_create(void);
...
GRPC_EXPORT grpc_core::Combiner* grpc_combiner_ref(
    grpc_core::Combiner* lock GRPC_COMBINER_DEBUG_ARGS);
GRPC_EXPORT void grpc_combiner_unref(grpc_core::Combiner* lock GRPC_COMBINER_DEBUG_ARGS);

GRPC_EXPORT bool grpc_combiner_continue_exec_ctx();

GRPC_EXPORT extern grpc_core::DebugOnlyTraceFlag grpc_combiner_trace;
