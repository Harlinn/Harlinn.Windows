...
GRPC_EXPORT const char* grpc_error_string(grpc_error_handle error);
GRPC_EXPORT std::string grpc_error_std_string(grpc_error_handle error);

// debug only toggles that allow for a sanity to check that ensures we will
// never create any errors in the per-RPC hotpath.
GRPC_EXPORT void grpc_disable_error_creation();
GRPC_EXPORT void grpc_enable_error_creation();
...
GRPC_EXPORT absl::Status grpc_status_create(absl::StatusCode code, absl::string_view msg,
...
#ifndef NDEBUG
GRPC_EXPORT grpc_error_handle grpc_error_do_ref(grpc_error_handle err, const char* file,
                                    int line);
GRPC_EXPORT void grpc_error_do_unref(grpc_error_handle err, const char* file, int line);
...
#else
GRPC_EXPORT grpc_error_handle grpc_error_do_ref(grpc_error_handle err);
GRPC_EXPORT void grpc_error_do_unref(grpc_error_handle err);
...
GRPC_EXPORT grpc_error_handle grpc_error_create(const char* file, int line,
...
GRPC_EXPORT grpc_error_handle grpc_os_error(const char* file, int line, int err,
                                const char* call_name) GRPC_MUST_USE_RESULT;
...
GRPC_EXPORT grpc_error_handle grpc_error_set_int(grpc_error_handle src,
...
GRPC_EXPORT bool grpc_error_get_int(grpc_error_handle error, grpc_error_ints which,
                        intptr_t* p);
/// This call takes ownership of the slice; the error is responsible for
/// eventually unref-ing it.
GRPC_EXPORT grpc_error_handle grpc_error_set_str(
...
GRPC_EXPORT bool grpc_error_get_str(grpc_error_handle error, grpc_error_strs which,
                        grpc_slice* s);
...
GRPC_EXPORT grpc_error_handle grpc_error_add_child(
    grpc_error_handle src, grpc_error_handle child) GRPC_MUST_USE_RESULT;

GRPC_EXPORT bool grpc_log_error(const char* what, grpc_error_handle error, const char* file,
                    int line);
