...
class InfLenFIFOQueue : public MPMCQueueInterface {
 public:
  ...
  GRPC_EXPORT void Put(void* elem) override;
  ...
  GRPC_EXPORT void* Get(gpr_timespec* wait_time) override;
 ...
 private:
  ...
  // manually afterward.
  GRPC_EXPORT Node* AllocateNodes(int num);
};
