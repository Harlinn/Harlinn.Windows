...
GRPC_EXPORT void grpc_timer_init(grpc_timer* timer, grpc_millis deadline,
                     grpc_closure* closure);

/* Initialize *timer without setting it. This can later be passed through
   the regular init or cancel */
GRPC_EXPORT void grpc_timer_init_unset(grpc_timer* timer);
...
GRPC_EXPORT void grpc_timer_cancel(grpc_timer* timer);
...
/* Check for timers to be run, and run them.
   ...
   *next is never guaranteed to be updated on any given execution; however,
   ...
   at any time slice. */
GRPC_EXPORT grpc_timer_check_result grpc_timer_check(grpc_millis* next);
GRPC_EXPORT void grpc_timer_list_init();
GRPC_EXPORT void grpc_timer_list_shutdown();

/* Consume a kick issued by grpc_kick_poller */
GRPC_EXPORT void grpc_timer_consume_kick(void);

/* the following must be implemented by each iomgr implementation */
GRPC_EXPORT void grpc_kick_poller(void);

/* Sets the timer implementation */
GRPC_EXPORT void grpc_set_timer_impl(grpc_timer_vtable* vtable);
