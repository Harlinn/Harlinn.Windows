...
GRPC_EXPORT void grpc_set_pollset_set_vtable(grpc_pollset_set_vtable* vtable);

GRPC_EXPORT grpc_pollset_set* grpc_pollset_set_create(void);
GRPC_EXPORT void grpc_pollset_set_destroy(grpc_pollset_set* pollset_set);
GRPC_EXPORT void grpc_pollset_set_add_pollset(grpc_pollset_set* pollset_set,
                                  grpc_pollset* pollset);
GRPC_EXPORT void grpc_pollset_set_del_pollset(grpc_pollset_set* pollset_set,
                                  grpc_pollset* pollset);
GRPC_EXPORT void grpc_pollset_set_add_pollset_set(grpc_pollset_set* bag,
                                      grpc_pollset_set* item);
GRPC_EXPORT void grpc_pollset_set_del_pollset_set(grpc_pollset_set* bag,
                                      grpc_pollset_set* item);
