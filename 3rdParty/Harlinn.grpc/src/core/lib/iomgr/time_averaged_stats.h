...
GRPC_EXPORT void grpc_time_averaged_stats_init(grpc_time_averaged_stats* stats,
                                   double init_avg, double regress_weight,
                                   double persistence_factor);
/* Add a sample to the current batch. */
GRPC_EXPORT void grpc_time_averaged_stats_add_sample(grpc_time_averaged_stats* stats,
                                         double value);
/* Complete a batch and compute the new estimate of the average sample
   value. */
GRPC_EXPORT double grpc_time_averaged_stats_update_average(grpc_time_averaged_stats* stats);
