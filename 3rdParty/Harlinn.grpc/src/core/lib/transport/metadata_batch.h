...
GRPC_EXPORT void grpc_metadata_batch_init(grpc_metadata_batch* batch);
GRPC_EXPORT void grpc_metadata_batch_destroy(grpc_metadata_batch* batch);
GRPC_EXPORT void grpc_metadata_batch_clear(grpc_metadata_batch* batch);
GRPC_EXPORT bool grpc_metadata_batch_is_empty(grpc_metadata_batch* batch);

/* Returns the transport size of the batch. */
GRPC_EXPORT size_t grpc_metadata_batch_size(grpc_metadata_batch* batch);

/** Remove \a storage from the batch, unreffing the mdelem contained */
GRPC_EXPORT void grpc_metadata_batch_remove(grpc_metadata_batch* batch,
                                grpc_linked_mdelem* storage);
GRPC_EXPORT void grpc_metadata_batch_remove(grpc_metadata_batch* batch,
                                grpc_metadata_batch_callouts_index idx);

/** Substitute a new mdelem for an old value */
GRPC_EXPORT grpc_error_handle grpc_metadata_batch_substitute(grpc_metadata_batch* batch,
                                                 grpc_linked_mdelem* storage,
                                                 grpc_mdelem new_mdelem);

GRPC_EXPORT void grpc_metadata_batch_set_value(grpc_linked_mdelem* storage,
...
GRPC_EXPORT absl::optional<absl::string_view> grpc_metadata_batch_get_value(
...
GRPC_EXPORT grpc_error_handle grpc_metadata_batch_link_head(grpc_metadata_batch* batch,
                                                grpc_linked_mdelem* storage)
    GRPC_MUST_USE_RESULT;
GRPC_EXPORT grpc_error_handle grpc_metadata_batch_link_head(
...
/** Add \a storage to the end of \a batch. storage->md is
    ...
    lifetime of batch. This usually means it should be around
    for the lifetime of the call. */
GRPC_EXPORT grpc_error_handle grpc_metadata_batch_link_tail(grpc_metadata_batch* batch,
                                                grpc_linked_mdelem* storage)
    GRPC_MUST_USE_RESULT;
GRPC_EXPORT grpc_error_handle grpc_metadata_batch_link_tail(
    grpc_metadata_batch* batch, grpc_linked_mdelem* storage,
    grpc_metadata_batch_callouts_index idx) GRPC_MUST_USE_RESULT;
...
GRPC_EXPORT grpc_error_handle grpc_metadata_batch_add_head(
    grpc_metadata_batch* batch, grpc_linked_mdelem* storage,
...
/** Add \a elem_to_add as the last element in \a batch, using
    ...
    for the lifetime of the call.
    Takes ownership of \a elem_to_add */
GRPC_EXPORT grpc_error_handle grpc_metadata_batch_add_tail(
    grpc_metadata_batch* batch, grpc_linked_mdelem* storage,
    grpc_mdelem elem_to_add) GRPC_MUST_USE_RESULT;
...
GRPC_EXPORT grpc_error_handle grpc_attach_md_to_error(grpc_error_handle src,
                                          grpc_mdelem md);
...
GRPC_EXPORT grpc_error_handle grpc_metadata_batch_filter(
...
#ifndef NDEBUG
GRPC_EXPORT void grpc_metadata_batch_assert_ok(grpc_metadata_batch* batch);
#else
...
GRPC_EXPORT void grpc_metadata_batch_copy(grpc_metadata_batch* src,
                              grpc_metadata_batch* dst,
                              grpc_linked_mdelem* storage);

GRPC_EXPORT void grpc_metadata_batch_move(grpc_metadata_batch* src,
                              grpc_metadata_batch* dst);
