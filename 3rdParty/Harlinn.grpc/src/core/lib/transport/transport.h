...
GRPC_EXPORT extern grpc_core::DebugOnlyTraceFlag grpc_trace_stream_refcount;
...
#ifndef NDEBUG
GRPC_EXPORT void grpc_stream_ref_init(grpc_stream_refcount* refcount, int initial_refs,
...
GRPC_EXPORT void grpc_stream_destroy(grpc_stream_refcount* refcount);
...
/* Wrap a buffer that is owned by some stream object into a slice that shares
   the same refcount */
GRPC_EXPORT grpc_slice grpc_slice_from_stream_owned_buffer(grpc_stream_refcount* refcount,
...
GRPC_EXPORT void grpc_transport_move_one_way_stats(grpc_transport_one_way_stats* from,
                                       grpc_transport_one_way_stats* to);

GRPC_EXPORT void grpc_transport_move_stats(grpc_transport_stream_stats* from,
...
/* Returns the amount of memory required to store a grpc_stream for this
   transport */
GRPC_EXPORT size_t grpc_transport_stream_size(grpc_transport* transport);
...
GRPC_EXPORT int grpc_transport_init_stream(grpc_transport* transport, grpc_stream* stream,
                               grpc_stream_refcount* refcount,
                               const void* server_data,
                               grpc_core::Arena* arena);

GRPC_EXPORT void grpc_transport_set_pops(grpc_transport* transport, grpc_stream* stream,
...
GRPC_EXPORT void grpc_transport_destroy_stream(grpc_transport* transport,
                                   grpc_stream* stream,
                                   grpc_closure* then_schedule_closure);

GRPC_EXPORT void grpc_transport_stream_op_batch_finish_with_failure(
    grpc_transport_stream_op_batch* batch, grpc_error_handle error,
    grpc_core::CallCombiner* call_combiner);

GRPC_EXPORT std::string grpc_transport_stream_op_batch_string(
    grpc_transport_stream_op_batch* op);
GRPC_EXPORT std::string grpc_transport_op_string(grpc_transport_op* op);
...
/* Send a batch of operations on a transport
   ...
   */
GRPC_EXPORT void grpc_transport_perform_stream_op(grpc_transport* transport,
                                      grpc_stream* stream,
                                      grpc_transport_stream_op_batch* op);

GRPC_EXPORT void grpc_transport_perform_op(grpc_transport* transport,
                               grpc_transport_op* op);

/* Send a ping on a transport

   Calls cb with user data when a response is received. */
GRPC_EXPORT void grpc_transport_ping(grpc_transport* transport, grpc_closure* cb);

/* Advise peer of pending connection termination. */
GRPC_EXPORT void grpc_transport_goaway(grpc_transport* transport, grpc_status_code status,
                           grpc_slice debug_data);

/* Destroy the transport */
GRPC_EXPORT void grpc_transport_destroy(grpc_transport* transport);

/* Get the endpoint used by \a transport */
GRPC_EXPORT grpc_endpoint* grpc_transport_get_endpoint(grpc_transport* transport);
...
GRPC_EXPORT grpc_transport_op* grpc_make_transport_op(grpc_closure* on_complete);
...
GRPC_EXPORT grpc_transport_stream_op_batch* grpc_make_transport_stream_op(
