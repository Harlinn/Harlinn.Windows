...
GRPC_EXPORT void grpc_init_static_metadata_ctx(void);
GRPC_EXPORT void grpc_destroy_static_metadata_ctx(void);
namespace grpc_core {
#ifndef NDEBUG
constexpr uint64_t kGrpcStaticMetadataInitCanary = 0xCAFEF00DC0FFEE11L;
GRPC_EXPORT uint64_t StaticMetadataInitCanary();
#endif
GRPC_EXPORT extern const StaticMetadataSlice* g_static_metadata_slice_table;
}  // namespace grpc_core
...
GRPC_EXPORT extern StaticSliceRefcount* g_static_metadata_slice_refcounts;
}  // namespace grpc_core
...
namespace grpc_core {
GRPC_EXPORT extern StaticMetadata* g_static_mdelem_table;
GRPC_EXPORT extern grpc_mdelem* g_static_mdelem_manifested;
}  // namespace grpc_core
...
GRPC_EXPORT extern uintptr_t grpc_static_mdelem_user_data[GRPC_STATIC_MDELEM_COUNT];
/* ":authority": "" */
...
GRPC_EXPORT grpc_mdelem grpc_static_mdelem_for_static_strings(intptr_t a, intptr_t b);
typedef enum {
  GRPC_BATCH_PATH,
  GRPC_BATCH_METHOD,
  GRPC_BATCH_STATUS,
