...
GRPC_EXPORT extern const int grpc_stats_histo_buckets[13];
GRPC_EXPORT extern const int grpc_stats_histo_start[13];
GRPC_EXPORT extern const int* const grpc_stats_histo_bucket_boundaries[13];
GRPC_EXPORT extern void (*const grpc_stats_inc_histogram[13])(int x);
