...
GRPC_EXPORT void grpc_tracer_init(const char* env_var_name);

GRPC_EXPORT void grpc_tracer_init();
GRPC_EXPORT void grpc_tracer_shutdown(void);
...
class TraceFlagList {
 public:
  GRPC_EXPORT static bool Set(const char* name, bool enabled);
  GRPC_EXPORT static void Add(TraceFlag* flag);
...
class TraceFlag {
 public:
  GRPC_EXPORT TraceFlag(bool default_enabled, const char* name);
