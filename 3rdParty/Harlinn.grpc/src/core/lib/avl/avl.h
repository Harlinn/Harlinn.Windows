...
GRPC_EXPORT int grpc_avl_maybe_get(grpc_avl avl, void* key, void** value, void* user_data);
/** Return 1 if avl is empty, 0 otherwise */
GRPC_EXPORT int grpc_avl_is_empty(grpc_avl avl);
