...
GRPC_EXPORT grpc_channel_stack_builder* grpc_channel_stack_builder_create(void);

/// Assign a name to the channel stack: \a name must be statically allocated
GRPC_EXPORT void grpc_channel_stack_builder_set_name(grpc_channel_stack_builder* builder,
                                         const char* name);

/// Set the target uri
GRPC_EXPORT void grpc_channel_stack_builder_set_target(grpc_channel_stack_builder* b,
                                           const char* target);

GRPC_EXPORT const char* grpc_channel_stack_builder_get_target(
    grpc_channel_stack_builder* b);

/// Attach \a transport to the builder (does not take ownership)
GRPC_EXPORT void grpc_channel_stack_builder_set_transport(
    grpc_channel_stack_builder* builder, grpc_transport* transport);

/// Fetch attached transport
GRPC_EXPORT grpc_transport* grpc_channel_stack_builder_get_transport(
    grpc_channel_stack_builder* builder);

/// Set channel arguments: copies args
GRPC_EXPORT void grpc_channel_stack_builder_set_channel_arguments(
    grpc_channel_stack_builder* builder, const grpc_channel_args* args);

/// Return a borrowed pointer to the channel arguments
GRPC_EXPORT const grpc_channel_args* grpc_channel_stack_builder_get_channel_arguments(
    grpc_channel_stack_builder* builder);

/// Begin iterating over already defined filters in the builder at the beginning
GRPC_EXPORT grpc_channel_stack_builder_iterator*
...
GRPC_EXPORT bool grpc_channel_stack_builder_iterator_is_first(
    grpc_channel_stack_builder_iterator* iterator);

/// Is an iterator at the end?
GRPC_EXPORT bool grpc_channel_stack_builder_iterator_is_end(
    grpc_channel_stack_builder_iterator* iterator);

/// What is the name of the filter at this iterator position?
GRPC_EXPORT const char* grpc_channel_stack_builder_iterator_filter_name(
    grpc_channel_stack_builder_iterator* iterator);

/// Move an iterator to the next item
GRPC_EXPORT bool grpc_channel_stack_builder_move_next(
    grpc_channel_stack_builder_iterator* iterator);

/// Move an iterator to the previous item
GRPC_EXPORT bool grpc_channel_stack_builder_move_prev(
    grpc_channel_stack_builder_iterator* iterator);

/// Return an iterator at \a filter_name, or at the end of the list if not
/// found.
GRPC_EXPORT grpc_channel_stack_builder_iterator* grpc_channel_stack_builder_iterator_find(
...
/// created.
GRPC_EXPORT bool grpc_channel_stack_builder_add_filter_after(
    grpc_channel_stack_builder_iterator* iterator,
...
/// Call \a post_init_func(..., \a user_data) once the channel stack is
/// created.
GRPC_EXPORT bool grpc_channel_stack_builder_add_filter_before(
    grpc_channel_stack_builder_iterator* iterator,
    const grpc_channel_filter* filter,
    grpc_post_filter_create_init_func post_init_func,
    void* user_data) GRPC_MUST_USE_RESULT;
...
/// Call \a post_init_func(..., \a user_data) once the channel stack is
/// created.
GRPC_EXPORT bool grpc_channel_stack_builder_prepend_filter(
...
/// Call \a post_init_func(..., \a user_data) once the channel stack is
/// created.
GRPC_EXPORT bool grpc_channel_stack_builder_append_filter(
    grpc_channel_stack_builder* builder, const grpc_channel_filter* filter,
    grpc_post_filter_create_init_func post_init_func,
    void* user_data) GRPC_MUST_USE_RESULT;
...
GRPC_EXPORT bool grpc_channel_stack_builder_remove_filter(
    grpc_channel_stack_builder* builder, const char* filter_name);

/// Terminate iteration and destroy \a iterator
GRPC_EXPORT void grpc_channel_stack_builder_iterator_destroy(
    grpc_channel_stack_builder_iterator* iterator);
...
GRPC_EXPORT grpc_error_handle grpc_channel_stack_builder_finish(
...
GRPC_EXPORT void grpc_channel_stack_builder_destroy(grpc_channel_stack_builder* builder);
