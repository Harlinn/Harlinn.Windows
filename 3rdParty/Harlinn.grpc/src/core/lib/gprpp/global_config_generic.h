...
#define GPR_GLOBAL_CONFIG_DECLARE_BOOL(name)  \
  GRPC_EXPORT extern bool gpr_global_config_get_##name(); \
  GRPC_EXPORT extern void gpr_global_config_set_##name(bool value)

#define GPR_GLOBAL_CONFIG_DECLARE_INT32(name)    \
  GRPC_EXPORT extern int32_t gpr_global_config_get_##name(); \
  GRPC_EXPORT extern void gpr_global_config_set_##name(int32_t value)

#define GPR_GLOBAL_CONFIG_DECLARE_STRING(name)                      \
  GRPC_EXPORT extern grpc_core::UniquePtr<char> gpr_global_config_get_##name(); \
  GRPC_EXPORT extern void gpr_global_config_set_##name(const char* value)
