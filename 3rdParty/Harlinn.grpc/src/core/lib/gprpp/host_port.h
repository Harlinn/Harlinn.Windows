...
GRPC_EXPORT std::string JoinHostPort(absl::string_view host, int port);
...
/** Given a name in the form "host:port" or "[ho:st]:port", split into hostname
   ...
   cleared on failure. */
GRPC_EXPORT bool SplitHostPort(absl::string_view name, absl::string_view* host,
                   absl::string_view* port);
GRPC_EXPORT bool SplitHostPort(absl::string_view name, std::string* host,
                   std::string* port);
