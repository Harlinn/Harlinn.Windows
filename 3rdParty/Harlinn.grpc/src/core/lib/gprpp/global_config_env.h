 ...
 */
GRPC_EXPORT void SetGlobalConfigEnvErrorFunction(GlobalConfigEnvErrorFunctionType func);
...
class GlobalConfigEnv {
 ...
 public:
  ...
  GRPC_EXPORT grpc_core::UniquePtr<char> GetValue();

  // Sets the value of `name` variable.
  GRPC_EXPORT void SetValue(const char* value);

  // Unsets `name` variable.
  GRPC_EXPORT void Unset();

 protected:
  GRPC_EXPORT char* GetName();
...
class GlobalConfigEnvBool : public GlobalConfigEnv {
 public:
  ...
  GRPC_EXPORT bool Get();
  GRPC_EXPORT void Set(bool value);
...
class GlobalConfigEnvInt32 : public GlobalConfigEnv {
 public:
  ...
  GRPC_EXPORT int32_t Get();
  GRPC_EXPORT void Set(int32_t value);
...
class GlobalConfigEnvString : public GlobalConfigEnv {
 public:
  ...
  GRPC_EXPORT grpc_core::UniquePtr<char> Get();
  GRPC_EXPORT void Set(const char* value);
