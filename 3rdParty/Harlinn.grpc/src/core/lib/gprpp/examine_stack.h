...
GRPC_EXPORT gpr_current_stack_trace_func GetCurrentStackTraceProvider();

// Sets current_stack_trace_provider which provides a current-stack trace.
GRPC_EXPORT void SetCurrentStackTraceProvider(
...
GRPC_EXPORT absl::optional<std::string> GetCurrentStackTrace();
