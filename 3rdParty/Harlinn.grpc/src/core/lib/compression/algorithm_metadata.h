...
GRPC_EXPORT grpc_slice grpc_compression_algorithm_slice(
    grpc_compression_algorithm algorithm);

/** Find compression algorithm based on passed in mdstr - returns
 *  GRPC_COMPRESS_ALGORITHM_COUNT on failure */
GRPC_EXPORT grpc_compression_algorithm grpc_compression_algorithm_from_slice(
    const grpc_slice& str);

/** Return compression algorithm based metadata element */
GRPC_EXPORT grpc_mdelem grpc_compression_encoding_mdelem(
    grpc_compression_algorithm algorithm);

/** Return message compression algorithm based metadata element (grpc-encoding:
 * xxx) */
GRPC_EXPORT grpc_mdelem grpc_message_compression_encoding_mdelem(
    grpc_message_compression_algorithm algorithm);

/** Return stream compression algorithm based metadata element
 * (content-encoding: xxx) */
GRPC_EXPORT grpc_mdelem grpc_stream_compression_encoding_mdelem(
    grpc_stream_compression_algorithm algorithm);

/** Find compression algorithm based on passed in mdstr - returns
 * GRPC_COMPRESS_ALGORITHM_COUNT on failure */
GRPC_EXPORT grpc_message_compression_algorithm
...
GRPC_EXPORT grpc_stream_compression_algorithm grpc_stream_compression_algorithm_from_slice(
    const grpc_slice& str);
