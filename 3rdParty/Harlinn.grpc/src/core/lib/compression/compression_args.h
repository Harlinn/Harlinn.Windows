...
GRPC_EXPORT grpc_compression_algorithm
 ...
 * for the channel. */
GRPC_EXPORT grpc_channel_args* grpc_channel_args_set_channel_default_compression_algorithm(
 ...
 * input value of \a a). */
GRPC_EXPORT grpc_channel_args* grpc_channel_args_compression_algorithm_set_state(
...
GRPC_EXPORT uint32_t grpc_channel_args_compression_algorithm_get_states(
    const grpc_channel_args* a);
