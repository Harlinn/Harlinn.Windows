...
GRPC_EXPORT uint32_t grpc_compression_bitset_to_message_bitset(uint32_t bitset);

GRPC_EXPORT uint32_t grpc_compression_bitset_to_stream_bitset(uint32_t bitset);

GRPC_EXPORT uint32_t grpc_compression_bitset_from_message_stream_compression_bitset(
    uint32_t message_bitset, uint32_t stream_bitset);

GRPC_EXPORT int grpc_compression_algorithm_from_message_stream_compression_algorithm(
...
GRPC_EXPORT int grpc_message_compression_algorithm_name(
    grpc_message_compression_algorithm algorithm, const char** name);

GRPC_EXPORT grpc_message_compression_algorithm grpc_message_compression_algorithm_for_level(
    grpc_compression_level level, uint32_t accepted_encodings);

GRPC_EXPORT int grpc_message_compression_algorithm_parse(
    grpc_slice value, grpc_message_compression_algorithm* algorithm);

/* Interfaces for stream compression. */

GRPC_EXPORT int grpc_stream_compression_algorithm_parse(
