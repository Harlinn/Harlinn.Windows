...
class CoreConfiguration {
 public:
  ...
  class Builder {
   ...
   private:
    ...
    GRPC_EXPORT Builder();
    GRPC_EXPORT CoreConfiguration* Build();
  };
 ...
 private:
  GRPC_EXPORT explicit CoreConfiguration(Builder* builder);
  ...
  GRPC_EXPORT static const CoreConfiguration& BuildNewAndMaybeSet();

  // The configuration
  GRPC_EXPORT static std::atomic<CoreConfiguration*> config_;
