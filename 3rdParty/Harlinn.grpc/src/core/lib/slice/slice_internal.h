...
GRPC_EXPORT extern uint32_t grpc_static_metadata_hash_values[GRPC_STATIC_MDSTR_COUNT];
...
GRPC_EXPORT extern grpc_slice_refcount kNoopRefcount;
...
struct InternedSliceRefcount {
  ...
  GRPC_EXPORT ~InternedSliceRefcount();
...
GRPC_EXPORT void grpc_slice_buffer_reset_and_unref_internal(grpc_slice_buffer* sb);
GRPC_EXPORT void grpc_slice_buffer_partial_unref_internal(grpc_slice_buffer* sb,
                                              size_t idx);
GRPC_EXPORT void grpc_slice_buffer_destroy_internal(grpc_slice_buffer* sb);
...
GRPC_EXPORT void grpc_slice_buffer_remove_first(grpc_slice_buffer* sb);

// Calls grpc_slice_sub with the given parameters on the first slice.
GRPC_EXPORT void grpc_slice_buffer_sub_first(grpc_slice_buffer* sb, size_t begin,
                                 size_t end);

/* Check if a slice is interned */
GRPC_EXPORT bool grpc_slice_is_interned(const grpc_slice& slice);
...
GRPC_EXPORT void grpc_slice_intern_init(void);
GRPC_EXPORT void grpc_slice_intern_shutdown(void);
GRPC_EXPORT void grpc_test_only_set_slice_hash_seed(uint32_t seed);
...
// string
GRPC_EXPORT grpc_slice grpc_slice_maybe_static_intern(grpc_slice slice,
                                          bool* returned_slice_is_different);
GRPC_EXPORT uint32_t grpc_static_slice_hash(grpc_slice s);
GRPC_EXPORT int grpc_static_slice_eq(grpc_slice a, grpc_slice b);
...
GRPC_EXPORT grpc_slice grpc_slice_from_moved_buffer(grpc_core::UniquePtr<char> p,
                                        size_t len);
GRPC_EXPORT grpc_slice grpc_slice_from_moved_string(grpc_core::UniquePtr<char> p);
GRPC_EXPORT grpc_slice grpc_slice_from_cpp_string(std::string str);
...
GRPC_EXPORT size_t grpc_slice_memory_usage(grpc_slice s);

GRPC_EXPORT grpc_core::UnmanagedMemorySlice grpc_slice_sub_no_ref(
