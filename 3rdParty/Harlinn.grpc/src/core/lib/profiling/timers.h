...
GRPC_EXPORT void gpr_timers_global_init(void);
GRPC_EXPORT void gpr_timers_global_destroy(void);

GRPC_EXPORT void gpr_timer_add_mark(const char* tagstr, int important, const char* file,
                        int line);
GRPC_EXPORT void gpr_timer_begin(const char* tagstr, int important, const char* file,
                     int line);
GRPC_EXPORT void gpr_timer_end(const char* tagstr, int important, const char* file,
                   int line);

GRPC_EXPORT void gpr_timers_set_log_filename(const char* filename);

GRPC_EXPORT void gpr_timer_set_enabled(int enabled);
