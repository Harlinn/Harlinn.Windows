...
GRPC_EXPORT extern const grpc_httpcli_handshaker grpc_httpcli_plaintext;
GRPC_EXPORT extern const grpc_httpcli_handshaker grpc_httpcli_ssl;
...
GRPC_EXPORT void grpc_httpcli_context_init(grpc_httpcli_context* context);
GRPC_EXPORT void grpc_httpcli_context_destroy(grpc_httpcli_context* context);
...
GRPC_EXPORT void grpc_httpcli_get(grpc_httpcli_context* context,
...
GRPC_EXPORT void grpc_httpcli_post(grpc_httpcli_context* context,
                       grpc_polling_entity* pollent,
                       grpc_resource_quota* resource_quota,
...
GRPC_EXPORT void grpc_httpcli_set_override(grpc_httpcli_get_override get,
