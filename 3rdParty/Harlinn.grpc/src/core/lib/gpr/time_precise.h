...
GRPC_EXPORT gpr_cycle_counter gpr_get_cycle_counter();
...
GRPC_EXPORT void gpr_precise_clock_init(void);
GRPC_EXPORT void gpr_precise_clock_now(gpr_timespec* clk);
GRPC_EXPORT gpr_timespec gpr_cycle_counter_to_time(gpr_cycle_counter cycles);
GRPC_EXPORT gpr_timespec gpr_cycle_counter_sub(gpr_cycle_counter a, gpr_cycle_counter b);
