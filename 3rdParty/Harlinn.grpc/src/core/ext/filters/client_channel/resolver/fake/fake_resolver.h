...
class FakeResolverResponseGenerator
 ...
 public:
  GRPC_EXPORT static const grpc_arg_pointer_vtable kChannelArgPointerVtable;

  GRPC_EXPORT FakeResolverResponseGenerator();
  GRPC_EXPORT ~FakeResolverResponseGenerator() override;
  ...
  GRPC_EXPORT void SetResponse(Resolver::Result result);
  ...
  GRPC_EXPORT void SetReresolutionResponse(Resolver::Result result);
