...
GRPC_EXPORT grpc_core::TraceFlag grpc_trace_cares_address_sorting(false,
                                                      "cares_address_sorting");

GRPC_EXPORT grpc_core::TraceFlag grpc_trace_cares_resolver(false, "cares_resolver");
...
GRPC_EXPORT void (*grpc_ares_test_only_inject_config)(ares_channel channel) =
...
GRPC_EXPORT grpc_ares_request* (*grpc_dns_lookup_ares_locked)(
    const char* dns_server, const char* name, const char* default_port,
    grpc_pollset_set* interested_parties, grpc_closure* on_done,
    std::unique_ptr<grpc_core::ServerAddressList>* addrs,
    std::unique_ptr<grpc_core::ServerAddressList>* balancer_addrs,
...
GRPC_EXPORT void (*grpc_cancel_ares_request_locked)(grpc_ares_request* r) =
...
GRPC_EXPORT void (*grpc_resolve_address_ares)(
    const char* name, const char* default_port,
    grpc_pollset_set* interested_parties, grpc_closure* on_done,
