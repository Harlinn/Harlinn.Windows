...
GRPC_EXPORT grpc_core::TraceFlag grpc_http_trace(false, "http");
GRPC_EXPORT grpc_core::TraceFlag grpc_keepalive_trace(false, "http_keepalive");
GRPC_EXPORT grpc_core::DebugOnlyTraceFlag grpc_trace_chttp2_refcount(false,
                                                         "chttp2_refcount");
...
GRPC_EXPORT bool g_flow_control_enabled = true;
