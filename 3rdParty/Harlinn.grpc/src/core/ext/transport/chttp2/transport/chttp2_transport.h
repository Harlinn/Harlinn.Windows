...
GRPC_EXPORT extern grpc_core::TraceFlag grpc_http_trace;
GRPC_EXPORT extern grpc_core::TraceFlag grpc_keepalive_trace;
GRPC_EXPORT extern grpc_core::TraceFlag grpc_trace_http2_stream_state;
GRPC_EXPORT extern grpc_core::DebugOnlyTraceFlag grpc_trace_chttp2_refcount;
GRPC_EXPORT extern grpc_core::DebugOnlyTraceFlag grpc_trace_chttp2_hpack_parser;

GRPC_EXPORT extern bool g_flow_control_enabled;
...
GRPC_EXPORT grpc_transport* grpc_create_chttp2_transport(
...
GRPC_EXPORT void grpc_chttp2_transport_start_reading(
...
GRPC_EXPORT void TestOnlySetGlobalHttp2TransportInitCallback(
    TestOnlyGlobalHttp2TransportInitCallback callback);

GRPC_EXPORT void TestOnlySetGlobalHttp2TransportDestructCallback(
