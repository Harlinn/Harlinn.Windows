...
class StringPiece {
 public:
  ...
  HRE2_EXPORT size_type copy(char* buf, size_type n, size_type pos = 0) const;
  HRE2_EXPORT StringPiece substr(size_type pos = 0, size_type n = npos) const;
  ...
  HRE2_EXPORT size_type find(const StringPiece& s, size_type pos = 0) const;
  HRE2_EXPORT size_type find(char c, size_type pos = 0) const;
  HRE2_EXPORT size_type rfind(const StringPiece& s, size_type pos = npos) const;
  HRE2_EXPORT size_type rfind(char c, size_type pos = npos) const;
...
HRE2_EXPORT std::ostream& operator<<(std::ostream& o, const StringPiece& p);
