...
namespace AdobeXMPCore_Int {
	...
	public:
		...
		//!
		virtual spINode ParseAsNode( const char * buffer, sizet bufferLength ) = 0;
		...
		virtual pIDOMParser GetActualIDOMParser() __NOTHROW__ { return this; }
		virtual pISharedObject_I GetISharedObject_I() __NOTHROW__{ return this; }
		virtual pIDOMParser_I GetIDOMParser_I() __NOTHROW__ { return this; }
	...
	protected:
		...
		virtual pIDOMParser_base clone( pcIError_base & error ) const __NOTHROW__;
		virtual pIMetadata_base parse( const char * buffer, sizet bufferLength, pcIError_base & error ) __NOTHROW__;
		virtual void parseWithSpecificAction( const char * buffer, sizet bufferLength, uint32 actionType, pINode_base node, pcIError_base & error ) __NOTHROW__;
