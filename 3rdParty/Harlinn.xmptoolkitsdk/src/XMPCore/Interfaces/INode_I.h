...
namespace AdobeXMPCore_Int {
	...
	public:
		...
		//! tree.
		//!
		virtual void ChangeParent( pINode parent ) = 0;
		...
		virtual spINode GetQualifier( const spcIUTF8String & nameSpace, const spcIUTF8String & name ) = 0;
		//!
		//! @}
		...
		virtual spINode RemoveQualifier( const spcIUTF8String & nameSpace, const spcIUTF8String & name ) = 0;
		...
		virtual pINode GetRawParentPointer() = 0;
		//! @}


		virtual pINode GetActualINode() __NOTHROW__ { return this; }
		virtual pINode_I GetINode_I() __NOTHROW__ { return this; }
	...
	protected:
		...
		virtual pINode_base getParent( pcIError_base & error ) __NOTHROW__;
		virtual uint32 getParentNodeType( pcIError_base & error ) const __NOTHROW__;
		virtual void setName( const char * name, sizet nameLength, pcIError_base & error ) __NOTHROW__;
		virtual pcIUTF8String_base getName( pcIError_base & error ) const __NOTHROW__;
		virtual void setNameSpace( const char * nameSpace, sizet nameSpaceLength, pcIError_base & error ) __NOTHROW__;
		virtual pcIUTF8String_base getNameSpace( pcIError_base & error ) const __NOTHROW__;
		virtual pIPath_base getPath( pcIError_base & error ) const __NOTHROW__;
		virtual pINodeIterator_base qualifiersIterator( pcIError_base & error ) __NOTHROW__;
		virtual uint32 getQualifierNodeType( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, pcIError_base & error ) const __NOTHROW__;
		virtual pINode_base getQualifier( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, pcIError_base & error ) __NOTHROW__;
		virtual void insertQualifier( pINode_base base, pcIError_base & error ) __NOTHROW__;
		virtual pINode_base replaceQualifier( pINode_base node, pcIError_base & error ) __NOTHROW__;
		virtual pINode_base removeQualifier( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, pcIError_base & error ) __NOTHROW__;
		virtual uint32 getNodeType( pcIError_base & error ) const __NOTHROW__;
		virtual uint32 isArrayItem( pcIError_base & error ) const __NOTHROW__;
		virtual uint32 isQualifierNode( pcIError_base & error ) const __NOTHROW__;
		virtual sizet getIndex( pcIError_base & error ) const __NOTHROW__;
		virtual uint32 hasQualifiers( pcIError_base & error ) const __NOTHROW__;
		virtual uint32 hasContent( pcIError_base & error ) const __NOTHROW__;
		virtual uint32 isEmpty( pcIError_base & error ) const __NOTHROW__;
		virtual uint32 hasChanged( pcIError_base & error ) const __NOTHROW__;
		virtual void clear( uint32 contents, uint32 qualifiers, pcIError_base & error ) __NOTHROW__;
		virtual pINode_base clone( uint32 igoreEmptyNodes, uint32 ignoreNodesWithOnlyQualifiers, pcIError_base & error ) const __NOTHROW__;
		virtual pISimpleNode_base convertToSimpleNode( pcIError_base & error ) __NOTHROW__;
		virtual pIStructureNode_base convertToStructureNode( pcIError_base & error ) __NOTHROW__;
		virtual pIArrayNode_base convertToArrayNode( pcIError_base & error ) __NOTHROW__;
		virtual pIMetadata_base convertToMetadata( pcIError_base & error ) __NOTHROW__;
