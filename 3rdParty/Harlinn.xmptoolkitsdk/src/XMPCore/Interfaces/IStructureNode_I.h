...
namespace AdobeXMPCore_Int {
	...
	public:
		...
		virtual spINode GetNode( const spcIUTF8String & nameSpace, const spcIUTF8String & name ) = 0;
		//! @}
		...
		virtual spINode RemoveNode( const spcIUTF8String & nameSpace, const spcIUTF8String & name ) = 0;
		...
		virtual pIStructureNode GetActualIStructureNode() __NOTHROW__ { return this; }
		virtual pIStructureNode_I GetIStructureNode_I() __NOTHROW__ { return this; }
	...
	protected:
		...
		virtual pINode_base getNode( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, pcIError_base & error ) __NOTHROW__;
		virtual uint32 getChildNodeType( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, pcIError_base & error ) const __NOTHROW__;
		virtual void insertNode( pINode_base node, pcIError_base & error ) __NOTHROW__;
		virtual pINode_base removeNode( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, pcIError_base & error ) __NOTHROW__;
		virtual pINode_base replaceNode( pINode_base node, pcIError_base & error ) __NOTHROW__;
