...
namespace AdobeXMPCore_Int {
	...
	public:
		...
		virtual pICompositeNode GetActualICompositeNode() __NOTHROW__ { return this; }
		virtual pICompositeNode_I GetICompositeNode_I() __NOTHROW__ { return this; }
	...
	protected:
		...
		virtual uint32 getNodeTypeAtPath( pcIPath_base path, pcIError_base & error ) const __NOTHROW__;
		virtual pINode_base getNodeAtPath( pcIPath_base path, pcIError_base & error ) __NOTHROW__;
		virtual void appendNode( pINode_base node, pcIError_base & error ) __NOTHROW__;
		virtual void insertNodeAtPath( pINode_base node, pcIPath_base path, pcIError_base & error ) __NOTHROW__;
		virtual pINode_base replaceNodeAtPath( pINode_base node, pcIPath_base path, pcIError_base & error ) __NOTHROW__;
		virtual pINode_base removeNodeAtPath( pcIPath_base path, pcIError_base & error ) __NOTHROW__;
		virtual pINodeIterator_base iterator( pcIError_base & error ) __NOTHROW__;
