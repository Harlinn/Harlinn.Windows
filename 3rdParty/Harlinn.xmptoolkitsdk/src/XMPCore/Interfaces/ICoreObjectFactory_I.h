...
namespace AdobeXMPCore_Int {
	...
	public:
		...
		virtual pICoreObjectFactory GetActualICoreObjectFactory() __NOTHROW__ { return this; }
		virtual pICoreObjectFactory_I GetICoreObjectFactory_I() __NOTHROW__ { return this; }
