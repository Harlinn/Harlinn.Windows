...
namespace AdobeXMPCore_Int {
	...
	public:
		...
		virtual pIArrayNode GetActualIArrayNode() __NOTHROW__ { return this; }
		virtual pISharedObject_I GetISharedObject_I() __NOTHROW__{ return this; }
		virtual pIArrayNode_I GetIArrayNode_I() __NOTHROW__ { return this; }
	...
	protected:
		...
		virtual uint32 getArrayForm( pcIError_base & error ) const __NOTHROW__;
		virtual uint32 getChildNodeType( pcIError_base & error ) const __NOTHROW__;
		virtual pINode_base getNodeAtIndex( sizet index, pcIError_base & error ) __NOTHROW__;
		virtual void insertNodeAtIndex( pINode_base node, sizet index, pcIError_base & error ) __NOTHROW__;
		virtual pINode_base removeNodeAtIndex( sizet index, pcIError_base & error ) __NOTHROW__;
		virtual pINode_base replaceNodeAtIndex( pINode_base node, sizet index, pcIError_base & error ) __NOTHROW__;
