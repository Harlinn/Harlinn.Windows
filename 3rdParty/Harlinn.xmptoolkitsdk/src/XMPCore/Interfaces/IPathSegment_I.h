...
namespace AdobeXMPCore_Int {
	...
	public:
		...
		virtual spcIPathSegment Clone() const = 0;
		virtual pIPathSegment GetActualIPathSegment() __NOTHROW__ { return this; }
		virtual pIPathSegment_I GetIPathSegment_I() __NOTHROW__ { return this; }
	...
	protected:
		...
		virtual uint32 getType( pcIError_base & error ) const __NOTHROW__;
		virtual pcIUTF8String_base getValue( pcIError_base & error ) const __NOTHROW__;
