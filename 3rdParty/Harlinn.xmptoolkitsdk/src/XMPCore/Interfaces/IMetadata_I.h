...
namespace AdobeXMPCore_Int {
	...
	public:
		...
		virtual pIMetadata GetActualIMetadata() __NOTHROW__ { return this; }
		virtual pISharedObject_I GetISharedObject_I() __NOTHROW__{ return this; }
		virtual pIMetadata_I GetIMetadata_I() __NOTHROW__ { return this; }
	...
	protected:
		...
		virtual pcIUTF8String_base getAboutURI( pcIError_base & error ) const __NOTHROW__;
