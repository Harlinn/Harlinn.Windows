...
namespace AdobeXMPCore_Int {
	...
	public:
		...
		//!
		virtual bool RegisterParser( const char * key, const spcIDOMParser & parser ) = 0;
		virtual bool RegisterParser( const char * key, pIClientDOMParser_base parser );
		...
		//! \attention currently it is unimplemented.
		//!
		virtual bool RegisterSerializer( const char * key, const spcIDOMSerializer & serializer ) = 0;
		virtual bool RegisterSerializer( const char * key, pIClientDOMSerializer_base serializer );
		...
		virtual pIDOMImplementationRegistry GetActualIDOMImplementationRegistry() __NOTHROW__ { return this; }
		virtual pISharedObject_I GetISharedObject_I() __NOTHROW__{ return this; }
		virtual pIDOMImplementationRegistry_I GetIDOMImplementationRegistry_I() __NOTHROW__ { return this; }
	...
	protected:
		...
		virtual pIDOMParser_base getParser( const char * key, pcIError_base & error ) const __NOTHROW__;
		virtual pIDOMSerializer_base getSerializer( const char * key, pcIError_base & error ) const __NOTHROW__;
		virtual uint32 registerParser( const char * key, pIClientDOMParser_base parser, pcIError_base & error ) __NOTHROW__;
		virtual uint32 registerSerializer( const char * key, pIClientDOMSerializer_base serializer, pcIError_base & error ) __NOTHROW__;
