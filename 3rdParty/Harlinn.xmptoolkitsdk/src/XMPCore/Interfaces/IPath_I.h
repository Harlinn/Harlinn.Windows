...
namespace AdobeXMPCore_Int {
	...
	public:
		...
		virtual pIPath GetActualIPath() __NOTHROW__ { return this; }
		virtual pIPath_I GetIPath_I() __NOTHROW__ { return this; }
	...
	protected:
		...
		virtual pcINameSpacePrefixMap_base registerNameSpacePrefixMap( pcINameSpacePrefixMap_base map, pcIError_base & error ) __NOTHROW__;
		virtual pIUTF8String_base serialize( pcINameSpacePrefixMap_base map, pcIError_base & error ) const __NOTHROW__;
		virtual void appendPathSegment( pcIPathSegment_base segment, pcIError_base & error ) __NOTHROW__;
		virtual pcIPathSegment_base removePathSegment( sizet index, pcIError_base & error ) __NOTHROW__;
		virtual pcIPathSegment_base getPathSegment( sizet index, pcIError_base & error ) const __NOTHROW__;
		virtual pIPath_base clone( sizet startingIndex, sizet countOfSegemetns, pcIError_base & error ) const __NOTHROW__;
