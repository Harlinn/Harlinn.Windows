...
namespace AdobeXMPCore_Int {
	...
	{
	public:
		virtual pINodeIterator GetActualINodeIterator() __NOTHROW__ { return this;  }
		virtual pINodeIterator_I GetINodeIterator_I() __NOTHROW__ { return this;  }
	...
	protected:
		...
		virtual pINode_base getNode( pcIError_base & error ) __NOTHROW__;
		virtual uint32 getNodeType( pcIError_base & error ) const __NOTHROW__;
		virtual pINodeIterator_base next( pcIError_base & error ) __NOTHROW__;
