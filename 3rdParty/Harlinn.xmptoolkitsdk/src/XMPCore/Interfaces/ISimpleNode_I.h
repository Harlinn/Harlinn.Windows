...
namespace AdobeXMPCore_Int {
	...
	public:
		...
		virtual pISimpleNode GetActualISimpleNode() __NOTHROW__ { return this; }
		virtual pISimpleNode_I GetISimpleNode_I() __NOTHROW__ { return this; }
	...
	protected:
		...
		virtual void setValue( const char * value, sizet valueLength, pcIError_base & error ) __NOTHROW__;
		virtual uint32 isURIType( pcIError_base & error ) const __NOTHROW__;
		virtual void setURIType( uint32 isURI, pcIError_base & error ) __NOTHROW__;
