...
namespace AdobeXMPCore_Int {
	...
	public:
		...
		virtual spIDOMParser Clone() const;
		virtual spIMetadata Parse( const char * buffer, sizet bufferLength );
		virtual void ParseWithSpecificAction( const char * buffer, sizet bufferLength, eActionType actionType, spINode & node );
	...
	protected:
		...
		virtual DOMParserImpl * clone() const = 0;
