...
namespace AdobeXMPCore_Int {
	...
	public:
		...
		virtual bool RegisterParser( const char * key, const spcIDOMParser & parser );
		virtual bool RegisterSerializer( const char * key, const spcIDOMSerializer & serializer );
		virtual spIDOMParser GetParser( const char * key ) const;
		virtual spIDOMSerializer GetSerializer( const char * key ) const;
