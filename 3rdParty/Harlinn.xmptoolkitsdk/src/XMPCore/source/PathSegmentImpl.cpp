...
namespace AdobeXMPCore_Int {
	...
	spcIUTF8String PathSegmentImpl::GetNameSpace() const {
		return mNameSpace;
	}

	spcIUTF8String PathSegmentImpl::GetName() const {
		return mName;
	}

	IPathSegment_v1::ePathSegmentType PathSegmentImpl::GetType() const {
		return mType;
	}

	sizet PathSegmentImpl::GetIndex() const __NOTHROW__ {
		return mIndex;
	}

	spcIUTF8String PathSegmentImpl::GetValue() const {
		return mValue;
	}
