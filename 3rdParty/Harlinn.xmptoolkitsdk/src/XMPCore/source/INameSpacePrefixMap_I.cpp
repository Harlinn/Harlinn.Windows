...
namespace AdobeXMPCore_Int {
	...
	pvoid INameSpacePrefixMap_I::GetInterfacePointer( uint64 interfaceID, uint32 interfaceVersion ) {
		return GetInterfacePointerInternal( interfaceID, interfaceVersion, true );
	}

	pvoid INameSpacePrefixMap_I::getInterfacePointer( uint64 interfaceID, uint32 interfaceVersion, pcIError_base & error ) __NOTHROW__ {
	...
	pvoid INameSpacePrefixMap_I::GetInterfacePointerInternal( uint64 interfaceID, uint32 interfaceVersion, bool isTopLevel ) {
	...
	uint32 INameSpacePrefixMap_I::insert( const char * prefix, sizet prefixLength, const char * nameSpace, sizet nameSpaceLength, pcIError_base & error ) __NOTHROW__ {
	...
	uint32 INameSpacePrefixMap_I::remove( uint32 keyType, const char * key, sizet keyLength, pcIError_base & error ) __NOTHROW__ {
		typedef bool ( INameSpacePrefixMap_v1::*Func )( const char *, sizet );
	...
	uint32 INameSpacePrefixMap_I::isPresent( uint32 keyType, const char * key, sizet keyLength, pcIError_base & error ) const __NOTHROW__ {
		typedef bool ( INameSpacePrefixMap_v1::*Func )( const char *, sizet ) const;
	...
	pcIUTF8String_base INameSpacePrefixMap_I::get( uint32 keyType, const char * key, sizet keyLength, pcIError_base & error ) const __NOTHROW__ {
		typedef spcIUTF8String ( INameSpacePrefixMap_v1::*Func )( const char *, sizet ) const;
	...
	pINameSpacePrefixMap_base INameSpacePrefixMap_I::clone( pcIError_base & error ) const __NOTHROW__ {
