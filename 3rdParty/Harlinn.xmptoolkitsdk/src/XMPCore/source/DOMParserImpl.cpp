...
namespace AdobeXMPCore_Int {
	...
	spIDOMParser DOMParserImpl::Clone() const {
	...
	spIMetadata DOMParserImpl::Parse( const char * buffer, sizet bufferLength ) {
	...
	void DOMParserImpl::ParseWithSpecificAction( const char * buffer, sizet bufferLength, eActionType actionType, spINode & node ) {
	...
	spISharedMutex DOMParserImpl::GetMutex() const {
		return mSharedMutex;
	}
