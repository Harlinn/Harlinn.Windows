...
namespace AdobeXMPCore_Int {
	...
	pcIPathSegment_base CoreObjectFactoryImpl::CreateArrayIndexPathSegment( const char * nameSpace, sizet nameSpaceLength, sizet index, pcIError_base & error ) __NOTHROW__ {
	...
	pIArrayNode_base CoreObjectFactoryImpl::CreateArrayNode( uint32 arrayForm, const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, pcIError_base & error ) __NOTHROW__ {
	...
	pIMetadata_base CoreObjectFactoryImpl::CreateMetadata( pcIError_base & error ) __NOTHROW__ {
		return ReturnRawPointerFromSharedPointer< IMetadata, pIMetadata_base >(
			&IMetadata::CreateMetadata, error, __FILE__, __LINE__ );
	}

	pINameSpacePrefixMap_base CoreObjectFactoryImpl::CreateNameSpacePrefixMap( pcIError_base & error ) __NOTHROW__ {
	...
	pIPath_base CoreObjectFactoryImpl::CreatePath( pcIError_base & error ) __NOTHROW__ {
		return ReturnRawPointerFromSharedPointer< IPath, pIPath_base >(
			&IPath::CreatePath, error, __FILE__, __LINE__ );
	}

	pcIPathSegment_base CoreObjectFactoryImpl::CreatePropertyPathSegment( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, pcIError_base & error ) __NOTHROW__ {
		return ReturnRawPointerFromSharedPointer< const IPathSegment, pcIPathSegment_base >(
			&IPathSegment::CreatePropertyPathSegment, error, __FILE__, __LINE__, nameSpace, nameSpaceLength, name, nameLength );
	}

	pcIPathSegment_base CoreObjectFactoryImpl::CreateQualifierPathSegment( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, pcIError_base & error ) __NOTHROW__ {
		return ReturnRawPointerFromSharedPointer< const IPathSegment, pcIPathSegment_base >(
			&IPathSegment::CreateQualifierPathSegment, error, __FILE__, __LINE__, nameSpace, nameSpaceLength, name, nameLength );
	}

	pcIPathSegment_base CoreObjectFactoryImpl::CreateQualifierSelectorPathSegment( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, const char * value, sizet valueLength, pcIError_base & error ) __NOTHROW__ {
		return ReturnRawPointerFromSharedPointer< const IPathSegment, pcIPathSegment_base >(
	...
	pISimpleNode_base CoreObjectFactoryImpl::CreateSimpleNode( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, const char * value, sizet valueLength, pcIError_base & error ) __NOTHROW__ {
	...
	pIStructureNode_base CoreObjectFactoryImpl::CreateStructureNode( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, pcIError_base & error ) __NOTHROW__ {
	...
	pICoreConfigurationManager_base CoreObjectFactoryImpl::GetCoreConfigurationManager( pcIError_base & error ) __NOTHROW__ {
