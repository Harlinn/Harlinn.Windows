...
#include "xmp/XMP_Environment.h"	// ! This must be the first include!
...
using namespace std;
	...
	#pragma warning ( disable : 4996 )	// '...' was declared deprecated
		...
		{
		public:
			virtual void * allocate( AdobeXMPCommon::sizet size ) __NOTHROW__ {
			...
			virtual void * reallocate( void * ptr, AdobeXMPCommon::sizet size ) __NOTHROW__ {
				return NULL;
			}
