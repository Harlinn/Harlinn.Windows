...
namespace AdobeXMPCore_Int {
	...
	pvoid INodeIterator_I::GetInterfacePointer(uint64 interfaceID, uint32 interfaceVersion) {
		return GetInterfacePointerInternal(interfaceID, interfaceVersion, true);
	}

	pvoid INodeIterator_I::getInterfacePointer(uint64 interfaceID, uint32 interfaceVersion, pcIError_base & error) __NOTHROW__{
	...
	pvoid INodeIterator_I::GetInterfacePointerInternal(uint64 interfaceID, uint32 interfaceVersion, bool isTopLevel) {
	...
	pINode_base INodeIterator_I::getNode( pcIError_base & error ) __NOTHROW__ {
	...
	uint32 INodeIterator_I::getNodeType( pcIError_base & error ) const __NOTHROW__ {
	...
	pINodeIterator_base INodeIterator_I::next( pcIError_base & error ) __NOTHROW__ {
