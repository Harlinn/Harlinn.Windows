...
namespace XMP_COMPONENT_INT_NAMESPACE {
	...
	{
	public:
		virtual eMultiThreadingErrorCode Lock() __NOTHROW__;
		virtual eMultiThreadingErrorCode TryLock() __NOTHROW__;
		virtual eMultiThreadingErrorCode Unlock() __NOTHROW__;

		virtual eMultiThreadingErrorCode LockShared() __NOTHROW__;
		virtual eMultiThreadingErrorCode TryLockShared() __NOTHROW__;
		virtual eMultiThreadingErrorCode UnlockShared() __NOTHROW__;
