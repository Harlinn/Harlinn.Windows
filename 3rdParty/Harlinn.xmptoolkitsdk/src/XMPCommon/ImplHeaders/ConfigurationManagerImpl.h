...
namespace XMP_COMPONENT_INT_NAMESPACE {
	...
	public:
		...
		virtual bool RegisterMemoryAllocator( pIMemoryAllocator memoryAllocator );
		virtual bool RegisterErrorNotifier( pIErrorNotifier_base clientErrorNotifier );
		virtual bool DisableMultiThreading();
		virtual bool IsMultiThreaded() const;
