...
namespace XMP_COMPONENT_INT_NAMESPACE {
	...
	pIUTF8String_base IUTF8String_I::assign( const char * buffer, sizet count, pcIError_base & error ) __NOTHROW__ {
	...
	pIUTF8String_base IUTF8String_I::assign( pcIUTF8String_base str, sizet srcPos, sizet count, pcIError_base & error ) __NOTHROW__ {
	...
	pIUTF8String_base IUTF8String_I::append( const char * buffer, sizet count, pcIError_base & error ) __NOTHROW__ {
		return CallUnSafeFunctionReturningSharedPointer< IUTF8String_v1, pIUTF8String_base, IUTF8String, const char *, sizet >(
			error, this, &IUTF8String_v1::append, __FILE__, __LINE__, buffer, count );
	}

	pIUTF8String_base IUTF8String_I::append( pcIUTF8String_base str, sizet srcPos, sizet count, pcIError_base & error ) __NOTHROW__ {
		return CallUnSafeFunctionReturningSharedPointer< IUTF8String_v1, pIUTF8String_base, IUTF8String, const spcIUTF8String &, sizet, sizet >(
			error, this, &IUTF8String_v1::append, __FILE__, __LINE__, IUTF8String::MakeShared( str ), srcPos, count );
	}

	pIUTF8String_base IUTF8String_I::insert( sizet pos, const char * buf, sizet count, pcIError_base & error ) __NOTHROW__ {
	...
	pIUTF8String_base IUTF8String_I::insert( sizet pos, pcIUTF8String_base src, sizet srcPos, sizet count, pcIError_base & error ) __NOTHROW__ {
	...
	pIUTF8String_base IUTF8String_I::erase( sizet pos, sizet count, pcIError_base & error ) __NOTHROW__ {
	...
	void IUTF8String_I::resize( sizet n, pcIError_base & error ) __NOTHROW__ {
		typedef void( IUTF8String_v1::*Func )( sizet );
	...
	pIUTF8String_base IUTF8String_I::replace( sizet pos, sizet count, const char * buf, sizet srcCount, pcIError_base & error ) __NOTHROW__{
	...
	pIUTF8String_base IUTF8String_I::replace( sizet pos, sizet count, pcIUTF8String_base src, sizet srcPos, sizet srcCount, pcIError_base & error ) __NOTHROW__ {
	...
	sizet IUTF8String_I::copy( char * buf, sizet len, sizet pos, pcIError_base & error ) const __NOTHROW__ {
		typedef sizet ( IUTF8String_v1::*Func )( char *, sizet, sizet ) const;
	...
	sizet IUTF8String_I::find( const char * buf, sizet pos, sizet count, pcIError_base & error ) const __NOTHROW__ {
		typedef sizet ( IUTF8String_v1::*Func )( const char *, sizet, sizet ) const;
	...
	sizet IUTF8String_I::find( pcIUTF8String_base src, sizet pos, sizet count, pcIError_base & error ) const __NOTHROW__ {
		typedef sizet ( IUTF8String_v1::*Func )( const spcIUTF8String &, sizet, sizet ) const;
		Func fnPtr = &IUTF8String_v1::find;
	...
	sizet IUTF8String_I::rfind( const char * buf, sizet pos, sizet count, pcIError_base & error ) const __NOTHROW__ {
		typedef sizet ( IUTF8String_v1::*Func )( const char *, sizet, sizet ) const;
	...
	sizet IUTF8String_I::rfind( pcIUTF8String_base src, sizet pos, sizet count, pcIError_base & error ) const __NOTHROW__ {
		typedef sizet( IUTF8String_v1::*Func )( const spcIUTF8String &, sizet, sizet ) const;
		Func fnPtr = &IUTF8String_v1::rfind;
		return CallConstUnSafeFunction< IUTF8String_v1, sizet, sizet, const spcIUTF8String &, sizet, sizet >(
			error, this, 0, fnPtr, __FILE__, __LINE__, IUTF8String::MakeShared( src ), pos, count );
	...
	int32 IUTF8String_I::compare( sizet pos, sizet len, const char * buf, sizet count, pcIError_base & error ) const __NOTHROW__ {
		typedef int32 ( IUTF8String_v1::*Func )( sizet, sizet, const char *, sizet ) const;
	...
	int32 IUTF8String_I::compare( sizet pos, sizet len, pcIUTF8String_base str, sizet strPos, sizet strLen, pcIError_base & error ) const __NOTHROW__ {
		typedef int32( IUTF8String_v1::*Func )( sizet, sizet, const spcIUTF8String &, sizet, sizet ) const;
		Func fnPtr = &IUTF8String_v1::compare;
	...
	pIUTF8String_base IUTF8String_I::substr( sizet pos, sizet count, pcIError_base & error ) const __NOTHROW__ {
	...
	uint32 IUTF8String_I::empty( pcIError_base & error ) const __NOTHROW__ {
		return CallConstUnSafeFunction< IUTF8String_v1, uint32, bool >(
			error, this, 0, &IUTF8String_v1::empty, __FILE__, __LINE__ );
	}

	pvoid IUTF8String_I::GetInterfacePointer( uint64 interfaceID, uint32 interfaceVersion ) {
		return GetInterfacePointerInternal( interfaceID, interfaceVersion, true );
	}

	pvoid IUTF8String_I::getInterfacePointer( uint64 interfaceID, uint32 interfaceVersion, pcIError_base & error ) __NOTHROW__ {
		typedef pvoid ( IUTF8String_I::*Func )( uint64, uint32 );
	...
	pvoid IUTF8String_I::GetInterfacePointerInternal( uint64 interfaceID, uint32 interfaceVersion, bool isTopLevel ) {
