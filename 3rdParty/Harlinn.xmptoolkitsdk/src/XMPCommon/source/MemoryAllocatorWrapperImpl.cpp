...
namespace XMP_COMPONENT_INT_NAMESPACE {
	...
	void * MemoryAllocatorWrapperImpl::allocate( sizet size ) __NOTHROW__ {
	...
	void MemoryAllocatorWrapperImpl::deallocate( void * ptr ) __NOTHROW__ {
	...
	void * MemoryAllocatorWrapperImpl::reallocate( void * ptr, sizet size ) __NOTHROW__ {
		size_t actualSize = size + kOFFSET;
		void * actualMemPtr = ( XMP_Uns8 * ) ptr - kOFFSET;
		void * memPtr( NULL );
		if ( mpMemoryAllocator )
