...
namespace XMP_COMPONENT_INT_NAMESPACE {
	...
	void CallUnSafeFunctionReturningVoid( pcIError_base & error, className * ptr,
		void ( className::*Func )(), const char * fileName, uint32 lineNumber )
	{
		error = NULL;
		try {
			(ptr->*Func)();
	...
	void CallUnSafeFunctionReturningVoid( pcIError_base & error, className * ptr,
		void ( className::*Func )( Ts ... ), const char * fileName, uint32 lineNumber, Ts ... Vs )
	{
		error = NULL;
		try {
			( ptr->*Func )( Vs ... );
	...
	void CallConstUnSafeFunctionReturningVoid( pcIError_base & error, const className * const ptr,
		void ( className::*Func )() const, const char * fileName, uint32 lineNumber )
	{
		error = NULL;
		try {
			(ptr->*Func)();
	...
	template < typename className, typename ... Ts >
	void CallConstUnSafeFunctionReturningVoid( pcIError_base & error, const className * const ptr,
		void ( className::*Func )( Ts ... ) const, const char * fileName, uint32 lineNumber, Ts ... Vs )
	{
		error = NULL;
		try {
			( ptr->*Func )( Vs ... );
	...
	returnType CallUnSafeFunction( pcIError_base & error, className * ptr, returnType dRV,
		internalReturnType( className::*Func )( ), const char * fileName, uint32 lineNumber )
	{
		error = NULL;
		try {
	...
	returnType CallUnSafeFunction( pcIError_base & error, className * ptr, returnType dRV,
		internalReturnType ( className::*Func )( Ts ... ), const char * fileName, uint32 lineNumber, Ts ... Vs )
	{
		error = NULL;
		try {
	...
	returnType CallConstUnSafeFunction( pcIError_base & error, const className * ptr, returnType dRV,
		internalReturnType( className::*Func )( ) const, const char * fileName, uint32 lineNumber )
	{
		error = NULL;
		try {
			internalReturnType returnValue = (ptr->*Func)();
	...
	template < typename className, typename returnType, typename internalReturnType, typename ... Ts >
	returnType CallConstUnSafeFunction( pcIError_base & error, const className * ptr, returnType dRV,
		internalReturnType ( className::*Func )( Ts ... ) const, const char * fileName, uint32 lineNumber, Ts ... Vs )
	{
		error = NULL;
		try {
			internalReturnType returnValue = (ptr->*Func)( Vs ... );
	...
	returnType CallUnSafeFunctionReturningSharedPointer( pcIError_base & error, className * ptr,
		shared_ptr< sharedPointerType >( className::*Func )( ), const char * fileName, uint32 lineNumber )
	{
		error = NULL;
		try {
	...
	returnType CallUnSafeFunctionReturningSharedPointer(pcIError_base & error, className * ptr,
		shared_ptr< sharedPointerType >(className::*Func)(Ts ...), const char * fileName, uint32 lineNumber, Ts ... Vs)
	{
		error = NULL;
		try {
	...
	returnType CallConstUnSafeFunctionReturningSharedPointer(pcIError_base & error, const className * ptr,
		shared_ptr< sharedPointerType >(className::*Func)() const, const char * fileName, uint32 lineNumber)
	{
		error = NULL;
		try {
			shared_ptr< sharedPointerType > returnValue = ( ptr->*Func )( );
	...
	template < typename className, typename returnType, typename sharedPointerType, typename ... Ts >
	returnType CallConstUnSafeFunctionReturningSharedPointer( pcIError_base & error, const className * ptr,
		shared_ptr< sharedPointerType >( className::*Func )( Ts ... ) const, const char * fileName, uint32 lineNumber, Ts ... Vs )
	{
		error = NULL;
		try {
			shared_ptr< sharedPointerType > returnValue = ( ptr->*Func )( Vs ... );
