...
namespace XMP_COMPONENT_INT_NAMESPACE {
	...
	public:
		...
		virtual pIUTF8String GetActualIUTF8String() __NOTHROW__ { return this; }

		virtual pIUTF8String_base assign( const char * buffer, sizet count, pcIError_base & error ) __NOTHROW__;
		virtual pIUTF8String_base assign( pcIUTF8String_base str, sizet srcPos, sizet count, pcIError_base & error ) __NOTHROW__;
		virtual pIUTF8String_base append( const char * buffer, sizet count, pcIError_base & error ) __NOTHROW__;
		virtual pIUTF8String_base append( pcIUTF8String_base str, sizet srcPos, sizet count, pcIError_base & error ) __NOTHROW__;
		virtual pIUTF8String_base insert( sizet pos, const char * buf, sizet count, pcIError_base & error ) __NOTHROW__;
		virtual pIUTF8String_base insert( sizet pos, pcIUTF8String_base src, sizet srcPos, sizet count, pcIError_base & error ) __NOTHROW__;
		virtual pIUTF8String_base erase( sizet pos, sizet count, pcIError_base & error ) __NOTHROW__;
		virtual void resize( sizet n, pcIError_base & error ) __NOTHROW__;
		virtual pIUTF8String_base replace( sizet pos, sizet count, const char * buf, sizet srcCount, pcIError_base & error ) __NOTHROW__;
		virtual pIUTF8String_base replace( sizet pos, sizet count, pcIUTF8String_base src, sizet srcPos, sizet srcCount, pcIError_base & error ) __NOTHROW__;
		virtual sizet copy( char * buf, sizet len, sizet pos, pcIError_base & error ) const __NOTHROW__;
		virtual sizet find( const char * buf, sizet pos, sizet count, pcIError_base & error ) const __NOTHROW__;
		virtual sizet find( pcIUTF8String_base src, sizet pos, sizet count, pcIError_base & error ) const __NOTHROW__;
		virtual sizet rfind( const char * buf, sizet pos, sizet count, pcIError_base & error ) const __NOTHROW__;
		virtual sizet rfind( pcIUTF8String_base src, sizet pos, sizet count, pcIError_base & error ) const __NOTHROW__;
		virtual int32 compare( sizet pos, sizet len, const char * buf, sizet count, pcIError_base & error ) const __NOTHROW__;
		virtual int32 compare( sizet pos, sizet len, pcIUTF8String_base str, sizet strPos, sizet strLen, pcIError_base & error ) const __NOTHROW__;
		virtual pIUTF8String_base substr( sizet pos, sizet count, pcIError_base & error ) const __NOTHROW__;
		virtual uint32 empty( pcIError_base & error ) const __NOTHROW__;
