...
namespace AdobeXMPCommon_Int {
	...
	public:
		...
		//!
		virtual void ShareMutex( const XMP_COMPONENT_INT_NAMESPACE::spISharedMutex & mutex ) = 0;
		virtual void UnShareMutex() = 0;

		virtual pIThreadSafe_I GetIThreadSafe_I() __NOTHROW__ { return this; }

		virtual uint32 isThreadSafe() const __NOTHROW__ { 
