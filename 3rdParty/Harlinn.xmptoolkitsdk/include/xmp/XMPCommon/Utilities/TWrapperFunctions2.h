...
namespace AdobeXMPCommon {
	...
	void CallSafeFunctionReturningVoid( className * ptr,
		void ( className::*Func )( pcIError_base & ) )
	{
	...
	void CallSafeFunctionReturningVoid( className * ptr,
		void ( className::*Func )( t1, pcIError_base & ), t1 v1 )
	{
		pcIError_base error( NULL );
		( ptr->*Func )( v1, error );
		if ( error ) throw IError::MakeShared( error );
	...
	void CallSafeFunctionReturningVoid( className * ptr,
		void ( className::*Func )( t1, t2, pcIError_base & ), t1 v1, t2 v2 )
	{
		pcIError_base error( NULL );
	...
	void CallSafeFunctionReturningVoid( className * ptr,
		void ( className::*Func )( t1, t2, t3, pcIError_base & ), t1 v1, t2 v2, t3 v3 )
	{
		pcIError_base error( NULL );
	...
	void CallSafeFunctionReturningVoid( className * ptr,
		void ( className::*Func )( t1, t2, t3, t4, pcIError_base & ), t1 v1, t2 v2, t3 v3, t4 v4 )
	{
		pcIError_base error( NULL );
	...
	void CallSafeFunctionReturningVoid( className * ptr,
		void ( className::*Func )( t1, t2, t3, t4, t5, pcIError_base & ), t1 v1, t2 v2, t3 v3, t4 v4, t5 v5 )
	{
		pcIError_base error( NULL );
	...
	void CallSafeFunctionReturningVoid( className * ptr,
		void ( className::*Func )( t1, t2, t3, t4, t5, t6, pcIError_base & ), t1 v1, t2 v2, t3 v3, t4 v4, t5 v5, t6 v6 )
	{
		pcIError_base error( NULL );
		( ptr->*Func )( v1, v2, v3, v4, v5, error );
		if ( error ) throw IError::MakeShared( error );
	...
	void CallConstSafeFunctionReturningVoid( const className * const ptr,
		void ( className::*Func )( pcIError_base & ) const )
	{
		pcIError_base error( NULL );
		( ptr->*Func )( error );
		if ( error ) throw IError::MakeShared( error );
	...
	template < typename className, typename t1 >
	void CallConstSafeFunctionReturningVoid( const className * const ptr,
		void ( className::*Func )( t1, pcIError_base & ) const, t1 v1 )
	{
		pcIError_base error( NULL );
		( ptr->*Func )( v1, error );
		if ( error ) throw IError::MakeShared( error );
	...
	template < typename className, typename t1, typename t2 >
	void CallConstSafeFunctionReturningVoid( const className * const ptr,
		void ( className::*Func )( t1, t2, pcIError_base & ) const, t1 v1, t2 v2 )
	{
		pcIError_base error( NULL );
		( ptr->*Func )( v1, v2, error );
		if ( error ) throw IError::MakeShared( error );
	...
	template < typename className, typename t1, typename t2, typename t3 >
	void CallConstSafeFunctionReturningVoid( const className * const ptr,
		void ( className::*Func )( t1, t2, t3, pcIError_base & ) const, t1 v1, t2 v2, t3 v3 )
	{
		pcIError_base error( NULL );
		( ptr->*Func )( v1, v2, v3, error );
		if ( error ) throw IError::MakeShared( error );
	...
	template < typename className, typename t1, typename t2, typename t3, typename t4 >
	void CallConstSafeFunctionReturningVoid( const className * const ptr,
		void ( className::*Func )( t1, t2, t3, t4, pcIError_base & ) const, t1 v1, t2 v2, t3 v3, t4 v4 )
	{
		pcIError_base error( NULL );
		( ptr->*Func )( v1, v2, v3, v4, error );
		if ( error ) throw IError::MakeShared( error );
	...
	template < typename className, typename t1, typename t2, typename t3, typename t4, typename t5 >
	void CallConstSafeFunctionReturningVoid( const className * const ptr,
		void ( className::*Func )( t1, t2, t3, t4, t5, pcIError_base & ) const, t1 v1, t2 v2, t3 v3, t4 v4, t5 v5 )
	{
		pcIError_base error( NULL );
		( ptr->*Func )( v1, v2, v3, v4, v5, error );
		if ( error ) throw IError::MakeShared( error );
	...
	returnType CallSafeFunction( className * ptr,
		internalReturnType ( className::*Func )( pcIError_base & ) )
	{
		pcIError_base error( NULL );
	...
	returnType CallSafeFunction( className * ptr,
		internalReturnType ( className::*Func )( t1, pcIError_base & ), t1 v1 )
	{
		pcIError_base error( NULL );
	...
	returnType CallSafeFunction( className * ptr,
		internalReturnType ( className::*Func )( t1, t2, pcIError_base & ), t1 v1, t2 v2 )
	{
		pcIError_base error( NULL );
	...
	returnType CallSafeFunction( className * ptr,
		internalReturnType( className::*Func )( t1, t2, t3, pcIError_base & ), t1 v1, t2 v2, t3 v3 )
	{
		pcIError_base error( NULL );
	...
	returnType CallSafeFunction( className * ptr,
		internalReturnType( className::*Func )( t1, t2, t3, t4, pcIError_base & ), t1 v1, t2 v2, t3 v3, t4 v4 )
	{
		pcIError_base error( NULL );
	...
	returnType CallSafeFunction( className * ptr,
		internalReturnType( className::*Func )( t1, t2, t3, t4, t5, pcIError_base & ), t1 v1, t2 v2, t3 v3, t4 v4, t5 v5 )
	{
		pcIError_base error( NULL );
    ...
    returnType CallSafeFunction( className * ptr,
                                internalReturnType( className::*Func )( t1, t2, t3, t4, t5, t6, pcIError_base & ), t1 v1, t2 v2, t3 v3, t4 v4, t5 v5, t6 v6 )
    {
        pcIError_base error( NULL );
	...
	returnType CallConstSafeFunction( const className * const ptr,
		internalReturnType ( className::*Func )( pcIError_base & ) const )
	{
		pcIError_base error( NULL );
		internalReturnType returnValue = (ptr->*Func)( error );
		if ( error ) throw IError::MakeShared( error );
	...
	template < typename className, typename returnType, typename internalReturnType, typename t1 >
	returnType CallConstSafeFunction( const className * const ptr,
		internalReturnType ( className::*Func )( t1, pcIError_base & ) const, t1 v1 )
	{
		pcIError_base error( NULL );
		internalReturnType returnValue = (ptr->*Func)( v1, error );
		if ( error ) throw IError::MakeShared( error );
	...
	template < typename className, typename returnType, typename internalReturnType, typename t1, typename t2 >
	returnType CallConstSafeFunction( const className * const ptr,
		internalReturnType ( className::*Func )( t1, t2, pcIError_base & ) const, t1 v1, t2 v2 )
	{
		pcIError_base error( NULL );
		internalReturnType returnValue = (ptr->*Func)( v1, v2, error );
		if ( error ) throw IError::MakeShared( error );
	...
	template < typename className, typename returnType, typename internalReturnType, typename t1, typename t2, typename t3 >
	returnType CallConstSafeFunction( const className * const ptr,
		internalReturnType ( className::*Func )( t1, t2, t3, pcIError_base & ) const, t1 v1, t2 v2, t3 v3 )
	{
		pcIError_base error( NULL );
		internalReturnType returnValue = (ptr->*Func)( v1, v2, v3, error );
		if ( error ) throw IError::MakeShared( error );
	...
	template < typename className, typename returnType, typename internalReturnType, typename t1, typename t2, typename t3, typename t4 >
	returnType CallConstSafeFunction( const className * const ptr,
		internalReturnType ( className::*Func )( t1, t2, t3, t4, pcIError_base & ) const, t1 v1, t2 v2, t3 v3, t4 v4 )
	{
		pcIError_base error( NULL );
		internalReturnType returnValue = (ptr->*Func)( v1, v2, v3, v4, error );
		if ( error ) throw IError::MakeShared( error );
	...
	template < typename className, typename returnType, typename internalReturnType, typename t1, typename t2, typename t3, typename t4, typename t5 >
	returnType CallConstSafeFunction( const className * const ptr,
		internalReturnType ( className::*Func )( t1, t2, t3, t4, t5, pcIError_base & ) const, t1 v1, t2 v2, t3 v3, t4 v4, t5 v5 )
	{
		pcIError_base error( NULL );
		internalReturnType returnValue = (ptr->*Func)( v1, v2, v3, v4, v5, error );
		if ( error ) throw IError::MakeShared( error );
    ...
    template < typename className, typename returnType, typename internalReturnType, typename t1, typename t2, typename t3, typename t4, typename t5, typename t6 >
    returnType CallConstSafeFunction( const className * const ptr,
                                     internalReturnType ( className::*Func )( t1, t2, t3, t4, t5, t6, pcIError_base & ) const, t1 v1, t2 v2, t3 v3, t4 v4, t5 v5, t6 v6 )
    {
        pcIError_base error( NULL );
        internalReturnType returnValue = (ptr->*Func)( v1, v2, v3, v4, v5, v6, error );
        if ( error ) throw IError::MakeShared( error );
    ...
    returnType CallConstSafeFunction( const className * const ptr,
                                     internalReturnType ( className::*Func )( t1, t2, t3, t4, t5, t6, t7, pcIError_base & ) const, t1 v1, t2 v2, t3 v3, t4 v4, t5 v5, t6 v6, t7 v7 )
    {
        pcIError_base error( NULL );
    ...
    returnType CallConstSafeFunction( const className * const ptr,
                                     internalReturnType ( className::*Func )( t1, t2, t3, t4, t5, t6, t7, t8, t9, pcIError_base & ) const, t1 v1, t2 v2, t3 v3, t4 v4, t5 v5, t6 v6, t7 v7, t8 v8, t9 v9 )
    {
        pcIError_base error( NULL );
	...
	shared_ptr< sharedPointerType > CallConstSafeFunctionReturningPointer ( const className * const ptr ,
		internalReturnType ( className::*Func )(t1 , t2 , t3 , t4 , t5 , t6 , t7, t8 , pcIError_base &) const , t1 v1 , t2 v2 , t3 v3 , t4 v4 , t5 v5 , t6 v6 , t7 v7 , t8 v8 )
	{
		pcIError_base error ( NULL );
