...
namespace AdobeXMPCommon {
	...
	public:
		...
		//!
		virtual spIUTF8String append( const char * buf, sizet count ) = 0;
		...
		//!
		virtual spIUTF8String append( const spcIUTF8String & src, sizet srcPos = 0, sizet count = npos ) = 0;
		...
		//! \return The shared pointer to itself of type \#AdobeXMPCommon::IUTF8String.
		//!
		virtual spIUTF8String assign( const char * buf, sizet count ) = 0;
		...
		//!		- srcPos is greater than length of src.
		//!
		virtual spIUTF8String assign( const spcIUTF8String & src, sizet srcPos = 0, sizet count = npos ) = 0;
		...
		//!
		virtual spIUTF8String insert( sizet pos, const char * buf, sizet count ) = 0;
		...
		//!		- pos is greater than the object's length.
		//!
		virtual spIUTF8String insert( sizet pos, const spcIUTF8String & src, sizet srcPos = 0, sizet count = npos ) = 0;
		...
		//!		- pos is greater than the object's length.
		//!
		virtual spIUTF8String erase( sizet pos = 0, sizet count = npos ) = 0;
		...
		//!		- pos is greater than the object's length.
		//!
		virtual spIUTF8String replace( sizet pos, sizet count, const char * buf, sizet srcCount ) = 0;
		...
		//!		- pos is greater than the object's length.
		//!
		virtual spIUTF8String replace( sizet pos, sizet count, const spcIUTF8String & src, sizet srcPos = 0, sizet srcCount = npos ) = 0;
		...
		//!		- pos is greater than the object's length.
		//!
		virtual sizet copy( char * buf, sizet len, sizet pos = 0 ) const = 0;
		...
		//! returns npos.
		//!
		virtual sizet find( const char * buf, sizet pos, sizet count ) const = 0;
		...
		//! returns npos.
		//!
		virtual sizet find( const spcIUTF8String & src, sizet pos = 0, sizet count = npos ) const = 0;
		...
		virtual sizet rfind( const char * buf, sizet pos, sizet count ) const = 0;
		//@}
		//!
		...
		//! returns npos.
		//!
		virtual sizet rfind( const spcIUTF8String & src, sizet pos = npos, sizet count = npos ) const = 0;
		...
		//!		- pos is greater than the object's length.
		//!
		virtual int32 compare( sizet pos, sizet len, const char * buf, sizet count ) const = 0;
		...
		//!		- pos is greater than the object's length.
		//!
		virtual int32 compare( sizet pos, sizet len, const spcIUTF8String & str, sizet strPos = 0, sizet strLen = npos ) const = 0;
		...
		//!		- allocation fails
		//!
		virtual spIUTF8String substr( sizet pos = 0, sizet count = npos ) const = 0;
		...
		//!
		virtual pIUTF8String GetActualIUTF8String() __NOTHROW__ = 0;
		...
		//!
		HXMP_EXPORT static spIUTF8String MakeShared( pIUTF8String_base ptr );
		...
		//!
		HXMP_EXPORT static spIUTF8String CreateUTF8String( pIObjectFactory objFactory );
		...
		//!
		HXMP_EXPORT static spIUTF8String CreateUTF8String( pIObjectFactory objFactory, const char * buf, sizet count );
	...
	protected:
		...
		virtual pIUTF8String_base assign( pcIUTF8String_base str, sizet srcPos, sizet count, pcIError_base & error ) __NOTHROW__ = 0;
		virtual pIUTF8String_base append( const char * buffer, sizet count, pcIError_base & error ) __NOTHROW__ = 0;
		virtual pIUTF8String_base append( pcIUTF8String_base str, sizet srcPos, sizet count, pcIError_base & error ) __NOTHROW__ = 0;
		...
		virtual void resize( sizet n, pcIError_base & error ) __NOTHROW__ = 0;
		virtual pIUTF8String_base replace( sizet pos, sizet count, const char * buf, sizet srcCount, pcIError_base & error ) __NOTHROW__ = 0;
		virtual pIUTF8String_base replace( sizet pos, sizet count, pcIUTF8String_base src, sizet srcPos, sizet srcCount, pcIError_base & error ) __NOTHROW__ = 0;
		virtual sizet copy( char * buf, sizet len, sizet pos, pcIError_base & error ) const __NOTHROW__ = 0;
		...
		virtual int32 compare( sizet pos, sizet len, const char * buf, sizet count, pcIError_base & error ) const __NOTHROW__ = 0;
		virtual int32 compare( sizet pos, sizet len, pcIUTF8String_base str, sizet strPos, sizet strLen, pcIError_base & error ) const __NOTHROW__ = 0;
		virtual pIUTF8String_base substr( sizet pos, sizet count, pcIError_base & error ) const __NOTHROW__ = 0;
	...
	public:
		HXMP_INLINE_DECL IUTF8StringProxy( pIUTF8String ptr );

		HXMP_INLINE_DECL ~IUTF8StringProxy( ) __NOTHROW__;

		pIUTF8String GetActualIUTF8String( ) __NOTHROW__ { return mRawPtr; }

		HXMP_INLINE_DECL void Acquire( ) const __NOTHROW__;

		HXMP_INLINE_DECL void Release( ) const __NOTHROW__;

		HXMP_INLINE_DECL spIUTF8String append( const char* buf, sizet count );

		HXMP_INLINE_DECL spIUTF8String append( const spcIUTF8String& src, sizet srcPos, sizet count );

		HXMP_INLINE_DECL pIUTF8String_base append( const char* buffer, sizet count, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL pIUTF8String_base append( pcIUTF8String_base str, sizet srcPos, sizet count, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL spIUTF8String assign( const char* buf, sizet count );

		HXMP_INLINE_DECL spIUTF8String assign( const spcIUTF8String& src, sizet srcPos, sizet count );

		HXMP_INLINE_DECL pIUTF8String_base assign( const char* buffer, sizet count, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL pIUTF8String_base assign( pcIUTF8String_base str, sizet srcPos, sizet count, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL spIUTF8String insert( sizet pos, const char* buf, sizet count );

		HXMP_INLINE_DECL spIUTF8String insert( sizet pos, const spcIUTF8String& src, sizet srcPos, sizet count );

		HXMP_INLINE_DECL pIUTF8String_base insert( sizet pos, const char* buf, sizet count, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL pIUTF8String_base insert( sizet pos, pcIUTF8String_base src, sizet srcPos, sizet count, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL spIUTF8String erase( sizet pos, sizet count );

		HXMP_INLINE_DECL pIUTF8String_base erase( sizet pos, sizet count, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL void resize( sizet n );

		HXMP_INLINE_DECL virtual void resize( sizet n, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL spIUTF8String replace( sizet pos, sizet count, const char* buf, sizet srcCount );

		HXMP_INLINE_DECL spIUTF8String replace( sizet pos, sizet count, const spcIUTF8String& src, sizet srcPos, sizet srcCount );

		HXMP_INLINE_DECL pIUTF8String_base replace( sizet pos, sizet count, const char* buf, sizet srcCount, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL pIUTF8String_base replace( sizet pos, sizet count, pcIUTF8String_base src, sizet srcPos, sizet srcCount, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL sizet copy( char* buf, sizet len, sizet pos ) const;

		HXMP_INLINE_DECL sizet copy( char* buf, sizet len, sizet pos, pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL sizet find( const char* buf, sizet pos, sizet count ) const;

		HXMP_INLINE_DECL sizet find( const spcIUTF8String& src, sizet pos, sizet count ) const;

		HXMP_INLINE_DECL sizet find( const char* buf, sizet pos, sizet count, pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL sizet find( pcIUTF8String_base src, sizet pos, sizet count, pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL sizet rfind( const char* buf, sizet pos, sizet count ) const;

		HXMP_INLINE_DECL sizet rfind( const spcIUTF8String& src, sizet pos, sizet count ) const;

		HXMP_INLINE_DECL sizet rfind( const char* buf, sizet pos, sizet count, pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL sizet rfind( pcIUTF8String_base src, sizet pos, sizet count, pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL int32 compare( sizet pos, sizet len, const char* buf, sizet count ) const;

		HXMP_INLINE_DECL int32 compare( sizet pos, sizet len, const spcIUTF8String& str, sizet strPos, sizet strLen ) const;

		HXMP_INLINE_DECL int32 compare( sizet pos, sizet len, const char* buf, sizet count, pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL int32 compare( sizet pos, sizet len, pcIUTF8String_base str, sizet strPos, sizet strLen, pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL spIUTF8String substr( sizet pos, sizet count ) const;

		HXMP_INLINE_DECL pIUTF8String_base substr( sizet pos, sizet count, pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL bool empty( ) const;

		HXMP_INLINE_DECL uint32 empty( pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL const char* c_str( ) const __NOTHROW__;

		HXMP_INLINE_DECL void clear( ) __NOTHROW__;

		HXMP_INLINE_DECL sizet size( ) const __NOTHROW__;
