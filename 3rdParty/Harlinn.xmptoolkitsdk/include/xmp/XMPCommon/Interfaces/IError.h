...
namespace AdobeXMPCommon {
	...
	public:
		...
		//!
		virtual spcIUTF8String GetMessage() const = 0;
		...
		//!
		virtual spcIUTF8String GetLocation() const = 0;
		...
		//! \note For debugging use only.
		//!
		virtual spcIUTF8String GetParameter( sizet index ) const = 0;
		...
		//!
		virtual spIError GetNextError() = 0;
		...
		//!
		virtual spIError SetNextError( const spIError & error ) = 0;
		...
		//!
		virtual void SetMessage( const char * message, sizet len = npos ) __NOTHROW__  = 0;
		...
		//! originated.
		//!
		virtual void SetLocation( const char * fileName, sizet lineNumber ) __NOTHROW__ = 0;
		...
		//!
		virtual void AppendParameter( const char * parameter, sizet len = npos ) __NOTHROW__ = 0;
		...
		//!
		virtual void AppendParameter( void * addressParameter ) __NOTHROW__ = 0;
		...
		//!
		virtual void AppendParameter( const uint32 & integerValue ) __NOTHROW__ = 0;
		...
		//!
		virtual void AppendParameter( const uint64 & integerValue ) __NOTHROW__ = 0;
		...
		//!
		virtual void AppendParameter( const int32 & integerValue ) __NOTHROW__ = 0;

		//!
		//! @brief Appends a 64 bit integer value as a string to the list of parameters.
		//! \param[in] integerValue A value of AdobeXMPCommon::uint64 type containing the integral value to be used as parameter.
		//!
		virtual void AppendParameter( const int64 & integerValue ) __NOTHROW__ = 0;
		...
		//!
		virtual void AppendParameter( const float & floatValue ) __NOTHROW__ = 0;
		...
		//!
		virtual void AppendParameter( const double & doubleValue ) __NOTHROW__ = 0;
		...
		//!
		virtual void AppendParameter( bool booleanValue ) __NOTHROW__ = 0;
		...
		//!
		HXMP_EXPORT static spIError CreateError( pIObjectFactory objFactory, eErrorDomain errDomain,
		...
		//!
		virtual pIError GetActualIError() __NOTHROW__ = 0;
		...
		//!
		HXMP_EXPORT static spIError MakeShared( pIError_base ptr );
	...
	protected:
		...
		virtual pIError_base getNextError( pcIError_base & error ) __NOTHROW__ = 0;
		virtual pIError_base setNextError( pIError_base nextError, pcIError_base & error ) __NOTHROW__ = 0;
	...
	public:
		...
		pIError GetActualIError( ) __NOTHROW__ { return mRawPtr; }
		...
		HXMP_INLINE_DECL eErrorCode GetCode( ) const;

		HXMP_INLINE_DECL uint32 getCode( pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL eErrorDomain GetDomain( ) const;

		HXMP_INLINE_DECL uint32 getDomain( pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL eErrorSeverity GetSeverity( ) const;

		HXMP_INLINE_DECL uint32 getSeverity( pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL spcIUTF8String GetMessage( ) const;

		HXMP_INLINE_DECL pcIUTF8String_base getMessage( pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL spcIUTF8String GetLocation( ) const;

		HXMP_INLINE_DECL pcIUTF8String_base getLocation( pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL spcIUTF8String GetParameter( sizet index ) const;

		HXMP_INLINE_DECL pcIUTF8String_base getParameter( sizet index, pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL sizet GetParametersCount( ) const __NOTHROW__;

		HXMP_INLINE_DECL spIError GetNextError( );

		HXMP_INLINE_DECL pIError_base getNextError( pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL spIError SetNextError( const spIError& nextError );

		HXMP_INLINE_DECL pIError_base setNextError( pIError_base nextError, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL void SetMessage( const char* message, sizet len ) __NOTHROW__;

		HXMP_INLINE_DECL void SetLocation( const char* fileName, sizet lineNumber ) __NOTHROW__;

		HXMP_INLINE_DECL void AppendParameter( const char* parameter, sizet len ) __NOTHROW__;

		HXMP_INLINE_DECL void AppendParameter( void* addressParameter ) __NOTHROW__;

		HXMP_INLINE_DECL void AppendParameter( const uint32& integerValue ) __NOTHROW__;

		HXMP_INLINE_DECL void AppendParameter( const uint64& integerValue ) __NOTHROW__;

		HXMP_INLINE_DECL void AppendParameter( const int32& integerValue ) __NOTHROW__;

		HXMP_INLINE_DECL void AppendParameter( const int64& integerValue ) __NOTHROW__;

		HXMP_INLINE_DECL void AppendParameter( const float& floatValue ) __NOTHROW__;

		HXMP_INLINE_DECL void AppendParameter( const double& doubleValue ) __NOTHROW__;

		HXMP_INLINE_DECL void AppendParameter( bool booleanValue ) __NOTHROW__;
