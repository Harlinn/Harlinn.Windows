...
namespace AdobeXMPCommon {
	...
	public:
		...
		//!
		virtual void EnableThreadSafety() const __NOTHROW__ = 0;
		...
		//!
		virtual void DisableThreadSafety() const __NOTHROW__ = 0;
		...
		virtual AdobeXMPCommon_Int::pIThreadSafe_I GetIThreadSafe_I() __NOTHROW__ = 0;
	...
	protected:
		...
		virtual uint32 isThreadSafe() const __NOTHROW__ = 0;
		//! \endcond
