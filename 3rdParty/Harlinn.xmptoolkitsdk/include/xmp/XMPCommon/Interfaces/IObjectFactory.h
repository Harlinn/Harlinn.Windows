...
namespace AdobeXMPCommon {
	...
	public:
		...
		//!
		virtual pIUTF8String_base CreateUTF8String( const char * buf, sizet count, pcIError_base & error ) __NOTHROW__ = 0;
		...
		//! They should call Release once they no longer need this object.
		//!
		virtual pIError_base CreateError( uint32 domain, uint32 code, uint32 severity, pcIError_base & error ) __NOTHROW__ = 0;
