...
namespace AdobeXMPCore {
	...
	public:
		...
		//!
		virtual pINameSpacePrefixMap_base CreateNameSpacePrefixMap( pcIError_base & error ) __NOTHROW__ = 0;
		...
		//!
		virtual pcINameSpacePrefixMap_base GetDefaultNameSpacePrefixMap( pcIError_base & error ) __NOTHROW__ = 0;
		...
		//!
		virtual pcIPathSegment_base CreatePropertyPathSegment( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, pcIError_base & error ) __NOTHROW__ = 0;
		...
		//!
		virtual pcIPathSegment_base CreateArrayIndexPathSegment( const char * nameSpace, sizet nameSpaceLength, sizet index, pcIError_base & error ) __NOTHROW__ = 0;
		...
		//! \return A pointer to const \#IPathSegment_v1.
		//!
		virtual pcIPathSegment_base CreateQualifierPathSegment( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, pcIError_base & error ) __NOTHROW__ = 0;
		...
		//! \return A pointer to const \#IPathSegment_v1.
		//!
		virtual pcIPathSegment_base CreateQualifierSelectorPathSegment( const char * nameSpace, sizet nameSpaceLength, const char * name,
		...
		//!
		virtual pIPath_base CreatePath( pcIError_base & error ) __NOTHROW__ = 0;
		...
		//!
		virtual pIPath_base ParsePath( const char * path, sizet pathLength, pcINameSpacePrefixMap_base map, pcIError_base & error ) __NOTHROW__ = 0;
		...
		//!
		virtual pISimpleNode_base CreateSimpleNode( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength,
		...
		//!
		virtual pIArrayNode_base CreateArrayNode( uint32 arrayForm, const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, pcIError_base & error ) __NOTHROW__ = 0;
		...
		virtual pIStructureNode_base CreateStructureNode( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, pcIError_base & error ) __NOTHROW__ = 0;
		...
		//!
		virtual pIMetadata_base CreateMetadata( pcIError_base & error ) __NOTHROW__ = 0;
		...
		//!
		virtual pIDOMImplementationRegistry_base GetDOMImplementationRegistry( pcIError_base & error ) __NOTHROW__ = 0;
		...
		//!
		virtual pICoreConfigurationManager_base GetCoreConfigurationManager( pcIError_base & error ) __NOTHROW__ = 0;
        ...
        //!
        virtual pIMetadata_base ConvertXMPMetatoIMetadata( XMPMetaRef xmpref, pcIError_base & error ) __NOTHROW__ = 0;
        ...
        //! \return XMPMetaRef.
        //!
        virtual XMPMetaRef ConvertIMetadatatoXMPMeta( pIMetadata iMeta, pcIError_base & error ) __NOTHROW__ = 0;
		...
		//!
		virtual pICoreObjectFactory GetActualICoreObjectFactory() __NOTHROW__ = 0;
		...
		//!
		virtual AdobeXMPCore_Int::pICoreObjectFactory_I GetICoreObjectFactory_I() __NOTHROW__ = 0;
		...
		//!
		HXMP_EXPORT static pICoreObjectFactory MakeCoreObjectFactory( pICoreObjectFactory_base ptr );
		...
		//!
		HXMP_EXPORT static pICoreObjectFactory GetCoreObjectFactory();
	...
	//#if LINKING_XMPCORE_LIB
		HXMP_EXPORT static void SetupCoreObjectFactory();
	//#else
	...
	//#endif
		...
		//!
		HXMP_EXPORT static void DestroyCoreObjectFactory();
	...
	HXMP_EXPORT pICoreObjectFactory ManageCoreObjectFactory( bool destroy = false );
