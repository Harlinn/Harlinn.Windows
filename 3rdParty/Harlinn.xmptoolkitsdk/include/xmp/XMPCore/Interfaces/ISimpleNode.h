...
namespace AdobeXMPCore {
	...
	public:
		...
		//!
		virtual void SetValue( const char * value, sizet valueLength ) = 0;
		...
		//!
		virtual bool IsURIType() const = 0;
		...
		//!
		virtual void SetURIType( bool isURI ) = 0;
		...
		//!
		virtual pISimpleNode GetActualISimpleNode() __NOTHROW__ = 0;
		...
		//!
		virtual AdobeXMPCore_Int::pISimpleNode_I GetISimpleNode_I() __NOTHROW__ = 0;
	...
	protected:
		...
		virtual void setValue( const char * value, sizet valueLength, pcIError_base & error ) __NOTHROW__ = 0;
		virtual uint32 isURIType( pcIError_base & error ) const __NOTHROW__ = 0;
		virtual void setURIType( uint32 isURI, pcIError_base & error ) __NOTHROW__ = 0;
...
#pragma warning( disable : 4250 )
	...
	public:
		HXMP_INLINE_DECL ISimpleNodeProxy( pISimpleNode ptr );

		HXMP_INLINE_DECL ~ISimpleNodeProxy( ) __NOTHROW__;

		pISimpleNode GetActualISimpleNode( ) __NOTHROW__ { return mRawPtr; }

		HXMP_INLINE_DECL AdobeXMPCore_Int::pISimpleNode_I GetISimpleNode_I( ) __NOTHROW__;

		HXMP_INLINE_DECL virtual spcIUTF8String GetValue( ) const;

		HXMP_INLINE_DECL virtual void SetValue( const char* value, sizet valueLength );

		HXMP_INLINE_DECL virtual bool IsURIType( ) const;

		HXMP_INLINE_DECL virtual void SetURIType( bool isURI );

		HXMP_INLINE_DECL virtual pcIUTF8String_base getValue( pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL virtual void setValue( const char* value, sizet valueLength, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL virtual uint32 isURIType( pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL virtual void setURIType( uint32 isURI, pcIError_base& error ) __NOTHROW__;
