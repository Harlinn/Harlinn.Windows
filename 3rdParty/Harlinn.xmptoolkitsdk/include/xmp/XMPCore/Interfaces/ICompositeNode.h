...
namespace AdobeXMPCore {
	...
	{
		friend class AdobeXMPCore::ICompositeNodeProxy;
	public:
		...
		//!
		virtual eNodeType GetNodeTypeAtPath( const spcIPath & path ) const = 0;
		...
		virtual spINode GetNodeAtPath( const spcIPath & path ) = 0;
		//! @}
		...
		//!
		virtual void AppendNode( const spINode & node ) = 0;
		...
		//!
		virtual void InsertNodeAtPath( const spINode & node, const spcIPath & path ) = 0;
		...
		//!
		virtual spINode ReplaceNodeAtPath( const spINode & node, const spcIPath & path ) = 0;
		...
		//! \note In case no node exists at the given path an invalid shared pointer is returned.
		//!
		virtual spINode RemoveNodeAtPath( const spcIPath & path ) = 0;
		...
		//!
		virtual spINodeIterator Iterator() = 0;
		...
		//!
		virtual sizet ChildCount() const __NOTHROW__ = 0;
		...
		//!
		virtual pICompositeNode GetActualICompositeNode() __NOTHROW__ = 0;
		...
		//!
		virtual AdobeXMPCore_Int::pICompositeNode_I GetICompositeNode_I() __NOTHROW__ = 0;
		...
		//!
		HXMP_EXPORT static spICompositeNode MakeShared( pICompositeNode_base ptr );
	...
	protected:
		...
		//! \cond XMP_INTERNAL_DOCUMENTATION
		virtual uint32 getNodeTypeAtPath( pcIPath_base path, pcIError_base & error ) const __NOTHROW__ = 0;
		virtual pINode_base getNodeAtPath( pcIPath_base path, pcIError_base & error ) __NOTHROW__ = 0;
		virtual void appendNode( pINode_base node, pcIError_base & error ) __NOTHROW__ = 0;
		virtual void insertNodeAtPath( pINode_base node, pcIPath_base path, pcIError_base & error ) __NOTHROW__ = 0;
		virtual pINode_base replaceNodeAtPath( pINode_base node, pcIPath_base path, pcIError_base & error ) __NOTHROW__ = 0;
		virtual pINode_base removeNodeAtPath( pcIPath_base path, pcIError_base & error ) __NOTHROW__ = 0;
		virtual pINodeIterator_base iterator( pcIError_base & error ) __NOTHROW__ = 0;
...
namespace AdobeXMPCore {
	...
	public:
		HXMP_INLINE_DECL ICompositeNodeProxy( pICompositeNode ptr );
		HXMP_INLINE_DECL ~ICompositeNodeProxy() __NOTHROW__ ;

		HXMP_INLINE_DECL pICompositeNode GetActualICompositeNode() __NOTHROW__;
		HXMP_INLINE_DECL AdobeXMPCore_Int::pICompositeNode_I GetICompositeNode_I() __NOTHROW__;

		HXMP_INLINE_DECL virtual eNodeType GetNodeTypeAtPath( const spcIPath & path ) const;
		HXMP_INLINE_DECL virtual spINode GetNodeAtPath( const spcIPath & path );
		HXMP_INLINE_DECL virtual void AppendNode( const spINode & node );
		HXMP_INLINE_DECL virtual void InsertNodeAtPath( const spINode & node, const spcIPath & path );
		HXMP_INLINE_DECL virtual spINode ReplaceNodeAtPath( const spINode & node, const spcIPath & path );
		HXMP_INLINE_DECL virtual spINode RemoveNodeAtPath( const spcIPath & path );
		HXMP_INLINE_DECL virtual spINodeIterator Iterator();
		HXMP_INLINE_DECL virtual sizet ChildCount() const __NOTHROW__;

	protected:
		HXMP_INLINE_DECL virtual uint32 getNodeTypeAtPath( pcIPath_base path, pcIError_base & error ) const __NOTHROW__;
		HXMP_INLINE_DECL virtual pINode_base getNodeAtPath( pcIPath_base path, pcIError_base & error ) __NOTHROW__;
		HXMP_INLINE_DECL virtual void appendNode( pINode_base node, pcIError_base & error ) __NOTHROW__;
		HXMP_INLINE_DECL virtual void insertNodeAtPath( pINode_base node, pcIPath_base path, pcIError_base & error ) __NOTHROW__;
		HXMP_INLINE_DECL virtual pINode_base replaceNodeAtPath( pINode_base node, pcIPath_base path, pcIError_base & error ) __NOTHROW__;
		HXMP_INLINE_DECL virtual pINode_base removeNodeAtPath( pcIPath_base path, pcIError_base & error ) __NOTHROW__;
		HXMP_INLINE_DECL virtual pINodeIterator_base iterator( pcIError_base & error ) __NOTHROW__;
