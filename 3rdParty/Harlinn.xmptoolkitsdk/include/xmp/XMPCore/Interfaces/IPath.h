...
namespace AdobeXMPCore {
	...
	{
		friend class AdobeXMPCore::IPathProxy;
	public:
		...
		//!
		virtual spcINameSpacePrefixMap RegisterNameSpacePrefixMap( const spcINameSpacePrefixMap & map ) = 0;
		...
		//!
		virtual spIUTF8String Serialize( const spcINameSpacePrefixMap & map = spcINameSpacePrefixMap() ) const = 0;
		...
		//!
		virtual void AppendPathSegment( const spcIPathSegment & segment ) = 0;
		...
		//!
		virtual spcIPathSegment RemovePathSegment( sizet index ) = 0;
		...
		//!		-index is out of bounds.
		//!
		virtual spcIPathSegment GetPathSegment( sizet index ) const = 0;
		...
		//!
		virtual spIPath Clone( sizet startingIndex = 1, sizet countOfSegments = kMaxSize ) const = 0;
		...
		//!
		virtual pIPath GetActualIPath() __NOTHROW__ = 0;
		...
		//!
		virtual AdobeXMPCore_Int::pIPath_I GetIPath_I() __NOTHROW__ = 0;
		...
		//!
		HXMP_EXPORT static spIPath MakeShared( pIPath_base ptr );
		...
		//!
		HXMP_EXPORT static spIPath CreatePath();
		...
		//!
		HXMP_EXPORT static spIPath ParsePath( const char * path, sizet pathLength, const spcINameSpacePrefixMap & map );
	...
	protected:
		...
		//! \cond XMP_INTERNAL_DOCUMENTATION
		virtual pcINameSpacePrefixMap_base registerNameSpacePrefixMap( pcINameSpacePrefixMap_base map, pcIError_base & error ) __NOTHROW__ = 0;
		virtual pIUTF8String_base serialize( pcINameSpacePrefixMap_base map, pcIError_base & error ) const __NOTHROW__ = 0;
		virtual void appendPathSegment( pcIPathSegment_base segment, pcIError_base & error ) __NOTHROW__ = 0;
		virtual pcIPathSegment_base removePathSegment( sizet index, pcIError_base & error ) __NOTHROW__ = 0;
		virtual pcIPathSegment_base getPathSegment( sizet index, pcIError_base & error ) const __NOTHROW__ = 0;
		virtual pIPath_base clone( sizet startingIndex, sizet countOfSegemetns, pcIError_base & error ) const __NOTHROW__ = 0;
	...
	public:
		HXMP_INLINE_DECL IPathProxy( pIPath ptr );

		HXMP_INLINE_DECL ~IPathProxy( ) __NOTHROW__;

		pIPath GetActualIPath( ) __NOTHROW__ { return mRawPtr; }
		...
		HXMP_INLINE_DECL AdobeXMPCore_Int::pIPath_I GetIPath_I( ) __NOTHROW__;
		...
		HXMP_INLINE_DECL virtual spcINameSpacePrefixMap RegisterNameSpacePrefixMap( const spcINameSpacePrefixMap& map );

		HXMP_INLINE_DECL virtual pcINameSpacePrefixMap_base registerNameSpacePrefixMap( pcINameSpacePrefixMap_base map, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL virtual spIUTF8String Serialize( const spcINameSpacePrefixMap& map ) const;

		HXMP_INLINE_DECL virtual pIUTF8String_base serialize( pcINameSpacePrefixMap_base map, pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL virtual void AppendPathSegment( const spcIPathSegment& segment );

		HXMP_INLINE_DECL virtual void appendPathSegment( pcIPathSegment_base segment, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL virtual spcIPathSegment RemovePathSegment( sizet index );

		HXMP_INLINE_DECL virtual pcIPathSegment_base removePathSegment( sizet index, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL virtual spcIPathSegment GetPathSegment( sizet index ) const;

		HXMP_INLINE_DECL virtual pcIPathSegment_base getPathSegment( sizet index, pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL virtual sizet Size( ) const __NOTHROW__;

		HXMP_INLINE_DECL virtual void Clear( ) __NOTHROW__;

		HXMP_INLINE_DECL virtual spIPath Clone( sizet startingIndex, sizet countOfSegments ) const;

		HXMP_INLINE_DECL virtual pIPath_base clone( sizet startingIndex, sizet countOfSegemetns, pcIError_base& error ) const __NOTHROW__;
