...
namespace AdobeXMPCore {
	...
	public:
		...
		//!
		virtual eArrayForm GetArrayForm() const  = 0;
		...
		//!
		virtual eNodeType GetChildNodeType() const = 0;
		...
		//!
		virtual spINode GetNodeAtIndex( sizet index ) = 0;
		...
		//!
		virtual void InsertNodeAtIndex( const spINode & node, sizet index ) = 0;
		...
		//!
		virtual spINode ReplaceNodeAtIndex( const spINode & node, sizet index ) = 0;
		...
		//! \note In case no node exists at the given index an invalid shared pointer is returned.
		//!
		virtual spINode RemoveNodeAtIndex( sizet index ) = 0;
		...
		//!
		virtual pIArrayNode GetActualIArrayNode() __NOTHROW__ = 0;
		...
		//!
		virtual AdobeXMPCore_Int::pIArrayNode_I GetIArrayNode_I() __NOTHROW__ = 0;
		...
		//!
		HXMP_EXPORT static spIArrayNode MakeShared( pIArrayNode_base ptr );
		...
		//!
		HXMP_EXPORT static spIArrayNode CreateUnorderedArrayNode( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength );
		...
		//!		-# name is NULL or its contents are empty.
		//!
		HXMP_EXPORT static spIArrayNode CreateOrderedArrayNode( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength );
		...
		//!		-# name is NULL or its contents are empty.
		//!
		HXMP_EXPORT static spIArrayNode CreateAlternativeArrayNode( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength );
	...
	protected:
		...
		virtual uint32 getChildNodeType( pcIError_base & error ) const __NOTHROW__ = 0;
		virtual pINode_base getNodeAtIndex( sizet index, pcIError_base & error ) __NOTHROW__ = 0;
		virtual void insertNodeAtIndex( pINode_base node, sizet index, pcIError_base & error ) __NOTHROW__ = 0;
		virtual pINode_base replaceNodeAtIndex( pINode_base node, sizet index, pcIError_base & error ) __NOTHROW__ = 0;
		virtual pINode_base removeNodeAtIndex( sizet index, pcIError_base & error ) __NOTHROW__ = 0;
...
#pragma warning( disable : 4250 )
	...
	public:
		HXMP_INLINE_DECL IArrayNodeProxy( pIArrayNode ptr );

		~IArrayNodeProxy( ) __NOTHROW__ {}

		pIArrayNode GetActualIArrayNode( ) __NOTHROW__ { return mRawPtr; }
		...
		HXMP_INLINE_DECL AdobeXMPCore_Int::pIArrayNode_I GetIArrayNode_I( ) __NOTHROW__;
		...
		HXMP_INLINE_DECL virtual IArrayNode::eArrayForm GetArrayForm( ) const;

		HXMP_INLINE_DECL virtual eNodeType GetChildNodeType( ) const;

		HXMP_INLINE_DECL virtual spINode GetNodeAtIndex( sizet index );

		HXMP_INLINE_DECL virtual void InsertNodeAtIndex( const spINode& node, sizet index );

		HXMP_INLINE_DECL virtual spINode RemoveNodeAtIndex( sizet index );

		HXMP_INLINE_DECL virtual spINode ReplaceNodeAtIndex( const spINode& node, sizet index );

		HXMP_INLINE_DECL virtual uint32 getArrayForm( pcIError_base& error ) const __NOTHROW__;

		HXMP_INLINE_DECL virtual pINode_base getNodeAtIndex( sizet index, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL virtual void insertNodeAtIndex( pINode_base node, sizet index, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL virtual pINode_base removeNodeAtIndex( sizet index, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL virtual pINode_base replaceNodeAtIndex( pINode_base node, sizet index, pcIError_base& error ) __NOTHROW__;

		HXMP_INLINE_DECL virtual uint32 getChildNodeType( pcIError_base& error ) const __NOTHROW__;
