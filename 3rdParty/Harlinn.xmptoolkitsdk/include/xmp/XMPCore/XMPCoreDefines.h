...
// ===========================
#include <xmp/XMPCommon/XMPCommonDefines.h>

namespace AdobeXMPCore
{
	using int64 = AdobeXMPCommon::int64;
	using uint64 = AdobeXMPCommon::uint64;
	using int32 = AdobeXMPCommon::int32;
	using uint32 = AdobeXMPCommon::uint32;
	using sizet = AdobeXMPCommon::sizet;
}
