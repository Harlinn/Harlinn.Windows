...
class dng_spline_solver: public dng_1d_function
	...
	public:
		...
		DNG_EXPORT dng_spline_solver ();
		
		DNG_EXPORT virtual ~dng_spline_solver ();
			
		DNG_EXPORT void Reset ();

		DNG_EXPORT void Add (real64 x, real64 y);

		DNG_EXPORT virtual void Solve ();
