...
class dng_mosaic_info
	...
	public:
		...
		DNG_EXPORT dng_mosaic_info ();
		
		DNG_EXPORT virtual ~dng_mosaic_info ();
		...
		DNG_EXPORT virtual dng_point FullScale () const;
		...
		DNG_EXPORT virtual dng_point DownScale (uint32 minSize,
									 uint32 prefSize,
		...
		DNG_EXPORT virtual dng_point DstSize (const dng_point &downScale) const;
		...
		DNG_EXPORT virtual void InterpolateGeneric (dng_host &host,
										 dng_negative &negative,
		...
		DNG_EXPORT virtual void InterpolateFast (dng_host &host,
									  dng_negative &negative,
							  	   	  const dng_image &srcImage,
								   	  dng_image &dstImage,
		...
		DNG_EXPORT virtual void Interpolate (dng_host &host,
								  dng_negative &negative,
								  const dng_image &srcImage,
								  dng_image &dstImage,
								  const dng_point &downScale,
		...
		DNG_EXPORT virtual bool SupportsPreservedBlackLevels () const;
								  
	protected:
	
		DNG_EXPORT virtual bool IsSafeDownScale (const dng_point &downScale) const;

		DNG_EXPORT uint32 SizeForDownScale (const dng_point &downScale) const;
		
		DNG_EXPORT virtual bool ValidSizeDownScale (const dng_point &downScale,
