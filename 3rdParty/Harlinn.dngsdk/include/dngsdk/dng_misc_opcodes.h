...
class dng_opcode_TrimBounds: public dng_opcode
	...
	public:
		...
		DNG_EXPORT dng_opcode_TrimBounds (const dng_rect &bounds);
		
		DNG_EXPORT dng_opcode_TrimBounds (dng_stream &stream);
...
class dng_area_spec
	...
	public:
		...
		DNG_EXPORT void GetData (dng_stream &stream);
		
		/// Write area data to the specified stream.
			
		DNG_EXPORT void PutData (dng_stream &stream) const;

		/// Compute and return pixel area overlap (i.e., intersection) between this
		/// area and the specified tile.
		
		DNG_EXPORT dng_rect Overlap (const dng_rect &tile) const;
...
class dng_opcode_MapTable: public dng_inplace_opcode
	...
	public:
		...
		DNG_EXPORT dng_opcode_MapTable (dng_host &host,
		...
		DNG_EXPORT virtual uint32 BufferPixelType (uint32 imagePixelType);
			
		DNG_EXPORT virtual dng_rect ModifiedBounds (const dng_rect &imageBounds);
	...
	private:
		...
		DNG_EXPORT void ReplicateLastEntry ();
...
class dng_opcode_MapPolynomial: public dng_inplace_opcode
	...
	public:
		...
		DNG_EXPORT dng_opcode_MapPolynomial (const dng_area_spec &areaSpec,
								  uint32 degree,
								  const real64 *coefficient);
	
		DNG_EXPORT dng_opcode_MapPolynomial (dng_stream &stream);
	...
	protected:
		...
		DNG_EXPORT virtual void DoProcess (dng_pixel_buffer &buffer,
								const dng_rect &area,
								const uint32 plane,
...
class dng_opcode_DeltaPerRow: public dng_inplace_opcode
	...
	public:
		...
		DNG_EXPORT dng_opcode_DeltaPerRow (const dng_area_spec &areaSpec,
								AutoPtr<dng_memory_block> &table);
	
		DNG_EXPORT dng_opcode_DeltaPerRow (dng_host &host,
								dng_stream &stream);
...
class dng_opcode_DeltaPerColumn: public dng_inplace_opcode
	...
	public:
		...
		DNG_EXPORT dng_opcode_DeltaPerColumn (const dng_area_spec &areaSpec,
								   AutoPtr<dng_memory_block> &table);
	
		DNG_EXPORT dng_opcode_DeltaPerColumn (dng_host &host,
								   dng_stream &stream);
...
class dng_opcode_ScalePerRow: public dng_inplace_opcode
	...
	public:
		...
		DNG_EXPORT dng_opcode_ScalePerRow (const dng_area_spec &areaSpec,
								AutoPtr<dng_memory_block> &table);
	
		DNG_EXPORT dng_opcode_ScalePerRow (dng_host &host,
								dng_stream &stream);
...
class dng_opcode_ScalePerColumn: public dng_inplace_opcode
	...
	public:
		...
		DNG_EXPORT dng_opcode_ScalePerColumn (const dng_area_spec &areaSpec,
								   AutoPtr<dng_memory_block> &table);
	
		DNG_EXPORT dng_opcode_ScalePerColumn (dng_host &host,
								   dng_stream &stream);
