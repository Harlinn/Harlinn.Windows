...
class dng_srational
	...
	public:
		...
		DNG_EXPORT real64 As_real64 () const;
		
		DNG_EXPORT void Set_real64 (real64 x, int32 dd = 0);

		DNG_EXPORT void ReduceByFactor (int32 factor);
...
class dng_urational
	...
	public:
		...
		DNG_EXPORT void Set_real64 (real64 x, uint32 dd = 0);

		DNG_EXPORT void ReduceByFactor (uint32 factor);
