...
DNG_EXPORT bool SafeInt32Add(int32 arg1, int32 arg2, int32 *result);
...
// dng_error_unknown.
DNG_EXPORT int32 SafeInt32Add(int32 arg1, int32 arg2);
DNG_EXPORT int64 SafeInt64Add(int64 arg1, int64 arg2);
...
// returns false and leaves *result unchanged.
DNG_EXPORT bool SafeUint32Add(uint32 arg1, uint32 arg2,
				   uint32 *result);
...
// dng_error_unknown.
DNG_EXPORT uint32 SafeUint32Add(uint32 arg1, uint32 arg2);
...
// returns false and leaves *result unchanged.
DNG_EXPORT bool SafeInt32Sub(int32 arg1, int32 arg2, int32 *result);
...
DNG_EXPORT int32 SafeInt32Sub(int32 arg1, int32 arg2);

// If the result of multiplying arg1, ..., argn will fit in a uint32_t (without
// wraparound), stores this result in *result and returns true. Otherwise,
// returns false and leaves *result unchanged.
DNG_EXPORT bool SafeUint32Mult(uint32 arg1, uint32 arg2,
					uint32 *result);
DNG_EXPORT bool SafeUint32Mult(uint32 arg1, uint32 arg2, uint32 arg3,
					uint32 *result);
DNG_EXPORT bool SafeUint32Mult(uint32 arg1, uint32 arg2, uint32 arg3,
...
DNG_EXPORT uint32 SafeUint32Mult(uint32 arg1, uint32 arg2);
DNG_EXPORT uint32 SafeUint32Mult(uint32 arg1, uint32 arg2,
							 uint32 arg3);
DNG_EXPORT uint32 SafeUint32Mult(uint32 arg1, uint32 arg2,
...
// dng_error_unknown.
DNG_EXPORT std::size_t SafeSizetMult(std::size_t arg1, std::size_t arg2);

// Returns the result of multiplying arg1 and arg2 if it will fit in an int64_t
// (without overflow). Otherwise, throws a dng_exception with error code
// dng_error_unknown.
DNG_EXPORT int64 SafeInt64Mult(int64 arg1, int64 arg2);
...
DNG_EXPORT uint32 SafeUint32DivideUp(uint32 arg1, uint32 arg2);
...
DNG_EXPORT bool RoundUpUint32ToMultiple(uint32 val, uint32 multiple_of,
							 uint32 *result);
...
DNG_EXPORT bool ConvertUint32ToInt32(uint32 val, int32 *result);
...
class dng_safe_uint32
	...
	public:
		...
		DNG_EXPORT explicit dng_safe_uint32 (const dng_safe_int32 &x);
...
class dng_safe_int32
	...
	public:
		...
		DNG_EXPORT explicit dng_safe_int32 (const dng_safe_uint32 &x);
