...
constexpr int64 kFixed64_One  = (((int64) 1) << 32);
constexpr int64 kFixed64_Half = (((int64) 1) << 31);
...
DNG_EXPORT real64 TickTimeInSeconds ();

// Lower resolution timer, but more stable.

DNG_EXPORT real64 TickCountInSeconds ();

/******************************************************************************/

DNG_EXPORT void DNGIncrementTimerLevel ();

DNG_EXPORT int32 DNGDecrementTimerLevel ();
...
class dng_timer: private dng_uncopyable
	...
	public:
		...
		DNG_EXPORT dng_timer (const char *message);

		DNG_EXPORT ~dng_timer ();
...
DNG_EXPORT real64 MaxSquaredDistancePointToRect (const dng_point_real64 &point,
...
DNG_EXPORT real64 MaxDistancePointToRect (const dng_point_real64 &point,
							   const dng_rect_real64 &rect);
...
class dng_dither: private dng_uncopyable
	...
	private:
		...
		DNG_EXPORT dng_dither ();

	public:

		DNG_EXPORT static const dng_dither & Get ();
...
DNG_EXPORT void HistogramArea (dng_host &host,
...
DNG_EXPORT void LimitFloatBitDepth (dng_host &host,
