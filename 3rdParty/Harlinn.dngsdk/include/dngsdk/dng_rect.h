...
class dng_rect
	...
	public:
		...
		DNG_EXPORT bool operator== (const dng_rect &rect) const;
...
class dng_rect_real64
	...
	public:
		...
		DNG_EXPORT bool operator== (const dng_rect_real64 &rect) const;
...
DNG_EXPORT dng_rect operator& (const dng_rect &a,
					const dng_rect &b);
...
DNG_EXPORT dng_rect_real64 operator& (const dng_rect_real64 &a,
...
DNG_EXPORT dng_rect_real64 Bounds (const dng_point_real64 &a,
						const dng_point_real64 &b,
