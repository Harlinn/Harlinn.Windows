...
class dng_linearization_info
	...
	public:
		...
		DNG_EXPORT dng_linearization_info ();
		
		DNG_EXPORT virtual ~dng_linearization_info ();
		
		DNG_EXPORT void RoundBlacks ();
		...
		DNG_EXPORT real64 MaxBlackLevel (uint32 plane) const;
		...
		DNG_EXPORT virtual void Linearize (dng_host &host,
                                dng_negative &negative,
		...
		DNG_EXPORT dng_srational ColumnBlack (uint32 col) const;
