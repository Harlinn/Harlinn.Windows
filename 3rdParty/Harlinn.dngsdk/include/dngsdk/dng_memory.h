...
class dng_memory_data: private dng_uncopyable
	...
	public:
		...
		DNG_EXPORT dng_memory_data ();
		
		/// Construct memory buffer of size bytes using malloc.
		/// \param size Number of bytes of memory needed.
		/// \exception dng_memory_full with fErrorCode equal to dng_error_memory.

		DNG_EXPORT dng_memory_data (uint32 size);
		
		DNG_EXPORT dng_memory_data (const dng_safe_uint32 &size);
		...
		DNG_EXPORT dng_memory_data (uint32 count,
		...
		DNG_EXPORT void Allocate (uint32 size);

		DNG_EXPORT void Allocate (const dng_safe_uint32 &size);
		...
		DNG_EXPORT void Allocate (uint32 count,
					   std::size_t elementSize);

		DNG_EXPORT void Allocate (const dng_safe_uint32 &count,
					   std::size_t elementSize);
...
class dng_memory_allocator
	...
	public:
		...
		DNG_EXPORT virtual dng_memory_block * Allocate (uint32 size);
		...
		DNG_EXPORT virtual void * Malloc (size_t size);
		...
		DNG_EXPORT virtual void Free (void *ptr);
...
class dng_malloc_block : public dng_memory_block
	...
	public:
		...
		DNG_EXPORT dng_malloc_block (uint32 logicalSize);
		
		DNG_EXPORT virtual ~dng_malloc_block ();
...
DNG_EXPORT extern dng_memory_allocator gDefaultDNGMemoryAllocator;
