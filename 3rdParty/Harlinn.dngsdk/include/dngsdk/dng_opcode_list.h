...
class dng_opcode_list: private dng_uncopyable
	...
	public:
		...
		DNG_EXPORT dng_opcode_list (uint32 stage);
		
		DNG_EXPORT ~dng_opcode_list ();
		...
		DNG_EXPORT void Swap (dng_opcode_list &otherList);
