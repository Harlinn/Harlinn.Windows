...
class dng_camera_profile
	...
	public:
		...
		DNG_EXPORT dng_camera_profile ();
		
		DNG_EXPORT virtual ~dng_camera_profile ();
		...
		DNG_EXPORT static void NormalizeColorMatrix (dng_matrix &m);
		...
		DNG_EXPORT void SetColorMatrix1 (const dng_matrix &m);
		...
		DNG_EXPORT void SetColorMatrix2 (const dng_matrix &m);
						    		    
		/// Predicate to test if first camera matrix is set

		DNG_EXPORT bool HasColorMatrix1 () const;

		/// Predicate to test if second camera matrix is set

		DNG_EXPORT bool HasColorMatrix2 () const;
		...
		DNG_EXPORT static void NormalizeForwardMatrix (dng_matrix &m);
		
		/// Setter for first of up to two forward matrices used for calibrations.

		DNG_EXPORT void SetForwardMatrix1 (const dng_matrix &m);

		/// Setter for second of up to two forward matrices used for calibrations.

		DNG_EXPORT void SetForwardMatrix2 (const dng_matrix &m);
		...
		DNG_EXPORT void SetReductionMatrix1 (const dng_matrix &m);

		/// Setter for second of up to two dimensionality reduction hints for four-color cameras.
		/// This is an optional matrix that maps four components to three.
		/// See Appendix 6 of the \ref spec_dng "DNG 1.1.0 specification."

		DNG_EXPORT void SetReductionMatrix2 (const dng_matrix &m);
		...
		DNG_EXPORT dng_fingerprint UniqueID () const;
		...
		DNG_EXPORT void SetHueSatDeltas1 (const dng_hue_sat_map &deltas1);
		...
		DNG_EXPORT void SetHueSatDeltas2 (const dng_hue_sat_map &deltas2);
		...
		DNG_EXPORT void SetLookTable (const dng_hue_sat_map &table);
	...
	protected:
		...
		DNG_EXPORT static real64 IlluminantToTemperature (uint32 light);
		...
		DNG_EXPORT void CalculateFingerprint () const;

		DNG_EXPORT static bool ValidForwardMatrix (const dng_matrix &m);

		DNG_EXPORT static void ReadHueSatMap (dng_stream &stream,
...
DNG_EXPORT void SplitCameraProfileName (const dng_string &name,
							 dng_string &baseName,
							 int32 &version);

/*****************************************************************************/

DNG_EXPORT void BuildHueSatMapEncodingTable (dng_memory_allocator &allocator,
								  uint32 encoding,
