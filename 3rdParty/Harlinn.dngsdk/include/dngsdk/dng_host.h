...
class dng_host: private dng_uncopyable
	...
	public:
		...
		DNG_EXPORT dng_host (dng_memory_allocator *allocator = NULL,
		...
		DNG_EXPORT virtual ~dng_host ();
		
		/// Getter for host's memory allocator.

		DNG_EXPORT dng_memory_allocator & Allocator ();
		...
		DNG_EXPORT virtual dng_memory_block * Allocate (uint32 logicalSize);
		...
		DNG_EXPORT virtual void SniffForAbort ();
		...
		DNG_EXPORT virtual uint32 SaveDNGVersion () const;
		...
		DNG_EXPORT virtual bool SaveLinearDNG (const dng_negative &negative) const;
		...
		DNG_EXPORT virtual bool IsTransientError (dng_error_code code);
		...
		DNG_EXPORT virtual void PerformAreaTask (dng_area_task &task,
									  const dng_rect &area,
		...
		DNG_EXPORT virtual uint32 PerformAreaTaskThreads ();
		...
		DNG_EXPORT virtual dng_exif * Make_dng_exif ();
		...
		DNG_EXPORT virtual dng_xmp * Make_dng_xmp ();
		...
		DNG_EXPORT virtual dng_shared * Make_dng_shared ();
		...
		DNG_EXPORT virtual dng_ifd * Make_dng_ifd ();
		...
		DNG_EXPORT virtual dng_negative * Make_dng_negative ();
		...
		DNG_EXPORT virtual dng_image * Make_dng_image (const dng_rect &bounds,
											uint32 planes,
											uint32 pixelType);
		...
		DNG_EXPORT virtual dng_opcode * Make_dng_opcode (uint32 opcodeID,
											  dng_stream &stream);
											  
		/// Factory method to apply a dng_opcode_list. Can be used to override
		/// opcode list applications.
		
		DNG_EXPORT virtual void ApplyOpcodeList (dng_opcode_list &list,
		...
		DNG_EXPORT virtual void ResampleImage (const dng_image &srcImage,
									dng_image &dstImage);
