...
class dng_big_table
    ...
    protected:
        ...
        DNG_EXPORT dng_big_table (dng_big_table_cache *cache);

        DNG_EXPORT dng_big_table (const dng_big_table &table);

        DNG_EXPORT dng_big_table & operator= (const dng_big_table &table);

    public:

        DNG_EXPORT virtual ~dng_big_table ();
        ...
        DNG_EXPORT const dng_fingerprint & Fingerprint () const;

        DNG_EXPORT bool DecodeFromBinary (const uint8 * compressedData,
                               uint32 compressedSize,
                               dng_memory_allocator &allocator);
        
        DNG_EXPORT bool DecodeFromString (const dng_string &block1,
                               dng_memory_allocator &allocator);
        
        DNG_EXPORT dng_memory_block * EncodeAsBinary (dng_memory_allocator &allocator,
                                           uint32 &compressedSize) const;
        
        DNG_EXPORT dng_memory_block * EncodeAsString (dng_memory_allocator &allocator) const;

        DNG_EXPORT bool ExtractFromCache (const dng_fingerprint &fingerprint);

        DNG_EXPORT bool ReadTableFromXMP (const dng_xmp &xmp,
							   const char *ns,
                               const dng_fingerprint &fingerprint);
        
        DNG_EXPORT bool ReadFromXMP (const dng_xmp &xmp,
                          const char *ns,
                          const char *path,
                          dng_big_table_storage &storage);

        DNG_EXPORT void WriteToXMP (dng_xmp &xmp,
                         const char *ns,
                         const char *path,
    ...
    protected:
        ...
        DNG_EXPORT void RecomputeFingerprint ();
...
class dng_big_table_storage
    ...
    public:
        ...
        DNG_EXPORT dng_big_table_storage ();
        
        DNG_EXPORT virtual ~dng_big_table_storage ();
        
        DNG_EXPORT virtual bool ReadTable (dng_big_table &table,
                                const dng_fingerprint &fingerprint,
                                dng_memory_allocator &allocator);
    
        DNG_EXPORT virtual bool WriteTable (const dng_big_table &table,
                                 const dng_fingerprint &fingerprint,
                                 dng_memory_allocator &allocator);
        
        DNG_EXPORT virtual void MissingTable (const dng_fingerprint &fingerprint);
...
class dng_look_table : public dng_big_table
    ...
    public:
        ...
        DNG_EXPORT dng_look_table ();

        DNG_EXPORT dng_look_table (const dng_look_table &table);

        DNG_EXPORT dng_look_table & operator= (const dng_look_table &table);

        DNG_EXPORT virtual ~dng_look_table ();
        ...
        DNG_EXPORT void Set (const dng_hue_sat_map &map,
                  uint32 encoding);
    ...
    protected:
        ...
        DNG_EXPORT virtual void GetStream (dng_stream &stream);

        DNG_EXPORT virtual void PutStream (dng_stream &stream,
...
class dng_rgb_table : public dng_big_table
    ...
    public:
        ...
        DNG_EXPORT dng_rgb_table ();

        DNG_EXPORT dng_rgb_table (const dng_rgb_table &table);

        DNG_EXPORT dng_rgb_table & operator= (const dng_rgb_table &table);

        DNG_EXPORT virtual ~dng_rgb_table ();
        ...
        DNG_EXPORT void Set (uint32 dimensions,
                  uint32 divisions,
