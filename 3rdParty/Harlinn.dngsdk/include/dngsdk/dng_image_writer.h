...
class tag_data_ptr: public tiff_tag
	...
	public:
		...
		DNG_EXPORT virtual void Put (dng_stream &stream) const;
...
class tag_string: public tiff_tag
	...
	public:
		...
		DNG_EXPORT tag_string (uint16 code,
				    const dng_string &s,
...
class tag_encoded_text: public tiff_tag
	...
	public:
		...
		DNG_EXPORT tag_encoded_text (uint16 code,
...
class tag_matrix: public tag_srational_ptr
	...
	public:
		...
		DNG_EXPORT tag_matrix (uint16 code,
				    const dng_matrix &m);
...
class tag_icc_profile: public tag_data_ptr
	...
	public:
		...
		DNG_EXPORT tag_icc_profile (const void *profileData, uint32 profileSize);
...
class tag_exif_date_time: public tag_data_ptr
	...
	public:
		...
		DNG_EXPORT tag_exif_date_time (uint16 code,
...
class tag_iptc: public tiff_tag
	...
	public:
		...
		DNG_EXPORT tag_iptc (const void *data,
				  uint32 length);
...
class tag_xmp: public tag_uint8_ptr
	...
	public:
		...
		DNG_EXPORT tag_xmp (const dng_xmp *xmp);
...
class dng_tiff_directory: private dng_uncopyable
	...
	public:
		...
		DNG_EXPORT void Add (const tiff_tag *tag);
		...
		DNG_EXPORT void Put (dng_stream &stream,
...
class dng_basic_tag_set: private dng_uncopyable
	...
	public:
		...
		DNG_EXPORT dng_basic_tag_set (dng_tiff_directory &directory,
					       const dng_ifd &info);
...
class exif_tag_set: private dng_uncopyable
	...
	public:
		...
		DNG_EXPORT exif_tag_set (dng_tiff_directory &directory,
					  const dng_exif &exif,
	...
	protected:
		...
		DNG_EXPORT void AddLinks (dng_tiff_directory &directory);
...
class tiff_dng_extended_color_profile: private dng_tiff_directory
	...
	public:
		...
		DNG_EXPORT tiff_dng_extended_color_profile (const dng_camera_profile &profile);
...
class tag_dng_noise_profile: public tag_data_ptr
	...
	public:
		...
		DNG_EXPORT explicit tag_dng_noise_profile (const dng_noise_profile &profile);
...
class dng_image_writer
	...
	public:
		...
		DNG_EXPORT dng_image_writer ();
		
		DNG_EXPORT virtual ~dng_image_writer ();
		
		DNG_EXPORT virtual void EncodeJPEGPreview (dng_host &host,
							            const dng_image &image,
							            dng_jpeg_preview &preview,
							            int32 quality = -1);

		DNG_EXPORT virtual void WriteImage (dng_host &host,
						         const dng_ifd &ifd,
		...
		DNG_EXPORT void WriteTIFF (dng_host &host,
						dng_stream &stream,
						const dng_image &image,
		...
		DNG_EXPORT void WriteTIFFWithProfile (dng_host &host,
								   dng_stream &stream,
								   const dng_image &image,
								   uint32 photometricInterpretation,
								   uint32 compression,
		...
		DNG_EXPORT virtual void WriteTIFFWithProfile (dng_host &host,
										   dng_stream &stream,
										   const dng_image &image,
										   uint32 photometricInterpretation = piBlackIsZero,
										   uint32 compression = ccUncompressed,
		...
		DNG_EXPORT void WriteDNG (dng_host &host,
					   dng_stream &stream,
					   dng_negative &negative,
		...
		DNG_EXPORT virtual void WriteDNGWithMetadata (dng_host &host,
										   dng_stream &stream,
		...
		DNG_EXPORT virtual void CleanUpMetadata (dng_host &host,
	...
	protected:
		...
		DNG_EXPORT virtual void UpdateExifColorSpaceTag (dng_metadata &metadata,
											  const void *profileData,
											  const uint32 profileSize);
	
		DNG_EXPORT virtual uint32 CompressedBufferSize (const dng_ifd &ifd,
											 uint32 uncompressedSize);
											 
		DNG_EXPORT virtual void EncodePredictor (dng_host &host,
									  const dng_ifd &ifd,
						        	  dng_pixel_buffer &buffer,
									  AutoPtr<dng_memory_block> &tempBuffer);
						        	  
		DNG_EXPORT virtual void ByteSwapBuffer (dng_host &host,
									 dng_pixel_buffer &buffer);
									 
		DNG_EXPORT void ReorderSubTileBlocks (const dng_ifd &ifd,
								   dng_pixel_buffer &buffer,
		...
		DNG_EXPORT virtual void WriteTile (dng_host &host,
						        const dng_ifd &ifd,
						        dng_stream &stream,
						        const dng_image &image,
		...
		DNG_EXPORT virtual void DoWriteTiles (dng_host &host,
								   const dng_ifd &ifd,
								   dng_basic_tag_set &basic,
								   dng_stream &stream,
								   const dng_image &image,
...
class dng_write_tiles_task : public dng_area_task,
	...
	public:
		...
		DNG_EXPORT dng_write_tiles_task (dng_image_writer &imageWriter,
							  dng_host &host,
							  const dng_ifd &ifd,
							  dng_basic_tag_set &basic,
							  dng_stream &stream,
		...
		DNG_EXPORT void Process (uint32 threadIndex,
					  const dng_rect &tile,
					  dng_abort_sniffer *sniffer);

	protected:

		DNG_EXPORT void ProcessTask (uint32 tileIndex,
						  AutoPtr<dng_memory_block> &compressedBuffer,
						  AutoPtr<dng_memory_block> &uncompressedBuffer,
						  AutoPtr<dng_memory_block> &subTileBlockBuffer,
						  AutoPtr<dng_memory_block> &tempBuffer,
		...
		DNG_EXPORT void WriteTask (uint32 tileIndex,
