...
class dng_set_minimum_priority
	...
	public:
		...
		DNG_EXPORT dng_set_minimum_priority (dng_priority priority,
								  const char *name);
		
		DNG_EXPORT ~dng_set_minimum_priority ();
...
class dng_abort_sniffer
	...
	public:
		...
		DNG_EXPORT dng_abort_sniffer ();

		DNG_EXPORT virtual ~dng_abort_sniffer ();
		...
		DNG_EXPORT void SetPriority (dng_priority priority);
		...
		DNG_EXPORT static void SniffForAbort (dng_abort_sniffer *sniffer);
		...
		DNG_EXPORT virtual bool SupportsPriorityWait () const;
