...
class dng_fingerprint
	...
	public:
		...
		DNG_EXPORT dng_fingerprint ();
        
		DNG_EXPORT dng_fingerprint (const char *hex);
		...
		DNG_EXPORT bool operator== (const dng_fingerprint &print) const;
		...
		DNG_EXPORT uint32 Collapse32 () const;
		...
		DNG_EXPORT void ToUtf8HexString (char resultStr [2 * kDNGFingerprintSize + 1]) const;
		...
		DNG_EXPORT bool FromUtf8HexString (const char inputStr [2 * kDNGFingerprintSize + 1]);
...
class dng_md5_printer
	...
	public:
		...
		DNG_EXPORT void Process (const void *data,
					  uint32 inputLen);
		...
		DNG_EXPORT const dng_fingerprint & Result ();
		
	private:
	
		DNG_EXPORT static void Encode (uint8 *output,
							const uint32 *input,
							uint32 len);

		DNG_EXPORT static void Decode (uint32 *output,
							const uint8 *input,
							uint32 len);
