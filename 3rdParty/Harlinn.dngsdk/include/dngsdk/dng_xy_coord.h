...
DNG_EXPORT dng_xy_coord XYZtoXY (const dng_vector_3 &coord);

DNG_EXPORT dng_vector_3 XYtoXYZ (const dng_xy_coord &coord);

/*****************************************************************************/

// Returns the ICC XYZ profile connection space white point.

DNG_EXPORT dng_xy_coord PCStoXY ();

DNG_EXPORT dng_vector_3 PCStoXYZ ();
