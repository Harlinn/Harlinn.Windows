...
class dng_stream: private dng_uncopyable
	...
	protected:
		...
		DNG_EXPORT dng_stream (dng_abort_sniffer *sniffer = NULL,
	...
	public:
		...
		DNG_EXPORT dng_stream (const void *data,
					uint32 count,
					uint64 offsetInOriginalFile = kDNGStreamInvalidOffset);
		
		DNG_EXPORT virtual ~dng_stream ();
		...
		DNG_EXPORT uint64 PositionInOriginalFile () const;
		...
		DNG_EXPORT dng_memory_block * AsMemoryBlock (dng_memory_allocator &allocator);

		/// Seek to a new position in stream for reading.

		DNG_EXPORT void SetReadPosition (uint64 offset);
		...
		DNG_EXPORT void Put_uint32 (uint32 x);
		...
		DNG_EXPORT void Put_real32 (real32 x);
		...
		DNG_EXPORT void Get_CString (char *data,
						  uint32 maxLength);
		...
		DNG_EXPORT uint32 TagValue_uint32 (uint32 tagType);
		...
		DNG_EXPORT int32 TagValue_int32 (uint32 tagType);
		...
		DNG_EXPORT dng_urational TagValue_urational (uint32 tagType);
		...
		DNG_EXPORT dng_srational TagValue_srational (uint32 tagType);
		...
		DNG_EXPORT real64 TagValue_real64 (uint32 tagType);
		...
		DNG_EXPORT void DuplicateStream (dng_stream &dstStream);
...
class dng_stream_contiguous_read_hint
    ...
    public:
		...
		DNG_EXPORT dng_stream_contiguous_read_hint (dng_stream &stream,
                                         dng_memory_allocator &allocator,
                                         uint64 offset,
                                         uint64 count);
        
		DNG_EXPORT ~dng_stream_contiguous_read_hint ();
...
class TempBigEndian
	...
	public:
		...
		DNG_EXPORT TempBigEndian (dng_stream &stream,
					   bool bigEndian = true);
						 
		DNG_EXPORT virtual ~TempBigEndian ();
...
class TempStreamSniffer: private dng_uncopyable
	...
	public:
		...
		DNG_EXPORT TempStreamSniffer (dng_stream &stream,
					       dng_abort_sniffer *sniffer);
						 
		DNG_EXPORT ~TempStreamSniffer ();
