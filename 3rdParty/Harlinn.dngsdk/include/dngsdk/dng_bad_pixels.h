...
class dng_opcode_FixBadPixelsConstant: public dng_filter_opcode
	...
	public:
		...
		DNG_EXPORT dng_opcode_FixBadPixelsConstant (uint32 constant,
										 uint32 bayerPhase);

		DNG_EXPORT dng_opcode_FixBadPixelsConstant (dng_stream &stream);
	
		DNG_EXPORT virtual void PutData (dng_stream &stream) const;

		DNG_EXPORT virtual dng_point SrcRepeat ();
	
		DNG_EXPORT virtual dng_rect SrcArea (const dng_rect &dstArea,
...
class dng_bad_pixel_list
	...
	public:
		...
		DNG_EXPORT bool IsPointIsolated (uint32 index,
							  uint32 radius) const;
		...
		DNG_EXPORT bool IsRectIsolated (uint32 index,
							 uint32 radius) const;
		...
		DNG_EXPORT bool IsPointValid (const dng_point &pt,
						   const dng_rect &imageBounds,
...
class dng_opcode_FixBadPixelsList: public dng_filter_opcode
	...
	public:
		...
		DNG_EXPORT dng_opcode_FixBadPixelsList (AutoPtr<dng_bad_pixel_list> &list,
									 uint32 bayerPhase);
		
		DNG_EXPORT dng_opcode_FixBadPixelsList (dng_stream &stream);
	...
	protected:
		...
		DNG_EXPORT virtual void FixIsolatedPixel (dng_pixel_buffer &buffer,
									   dng_point &badPoint);
	
		DNG_EXPORT virtual void FixClusteredPixel (dng_pixel_buffer &buffer,
								        uint32 pointIndex,
										const dng_rect &imageBounds);

		DNG_EXPORT virtual void FixSingleColumn (dng_pixel_buffer &buffer,
									  const dng_rect &badRect);

		DNG_EXPORT virtual void FixSingleRow (dng_pixel_buffer &buffer,
								   const dng_rect &badRect);

		DNG_EXPORT virtual void FixClusteredRect (dng_pixel_buffer &buffer,
									   const dng_rect &badRect,
									   const dng_rect &imageBounds);
