...
class dng_function_zero_offset: public dng_1d_function
    ...
    public:
		...
		DNG_EXPORT dng_function_zero_offset (real64 zeroOffset);
...
class dng_function_exposure_ramp: public dng_1d_function
	...
	public:
		...
		DNG_EXPORT dng_function_exposure_ramp (real64 white,
				   					real64 black,
				   					real64 minBlack);
...
class dng_function_exposure_tone: public dng_1d_function
	...
	public:
		...
		DNG_EXPORT dng_function_exposure_tone (real64 exposure);
...
class dng_tone_curve_acr3_default: public dng_1d_function
	...
	public:
		...
		DNG_EXPORT virtual real64 EvaluateInverse (real64 x) const;
...
class dng_function_gamma_encode: public dng_1d_function
	...
	public:
		...
		DNG_EXPORT dng_function_gamma_encode (const dng_color_space &space);
...
class dng_render: private dng_uncopyable
	...
	public:
		...
		DNG_EXPORT dng_render (dng_host &host,
		...
		DNG_EXPORT virtual dng_image * Render ();
