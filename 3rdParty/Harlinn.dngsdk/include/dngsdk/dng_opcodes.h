...
class dng_opcode
	...
	protected:
		...
		DNG_EXPORT dng_opcode (uint32 opcodeID,
					uint32 minVersion,
					uint32 flags);
	...
	public:
		...
		DNG_EXPORT bool AboutToApply (dng_host &host,
						   dng_negative &negative,
						   const dng_rect &imageBounds,
						   uint32 imagePlanes);
...
class dng_opcode_Unknown: public dng_opcode
	...
	public:
		...
		DNG_EXPORT dng_opcode_Unknown (dng_host &host,
							uint32 opcodeID,
							dng_stream &stream);
...
class dng_filter_opcode: public dng_opcode
	...
	protected:
		...
		DNG_EXPORT dng_filter_opcode (uint32 opcodeID,
						   uint32 minVersion,
						   uint32 flags);
...
class dng_inplace_opcode: public dng_opcode
	...
	protected:
		...
		DNG_EXPORT dng_inplace_opcode (uint32 opcodeID,
						    uint32 minVersion,
						    uint32 flags);
