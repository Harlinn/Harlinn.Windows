...
DNG_EXPORT int dng_pthread_attr_init(dng_pthread_attr_t *attr);
DNG_EXPORT int dng_pthread_attr_destroy(dng_pthread_attr_t *attr);

DNG_EXPORT int dng_pthread_attr_setstacksize(dng_pthread_attr_t *attr, size_t stacksize);
DNG_EXPORT int dng_pthread_attr_getstacksize(const dng_pthread_attr_t *attr, size_t *stacksize);

DNG_EXPORT int dng_pthread_create(dng_pthread_t *thread, const dng_pthread_attr_t * /* attrs */, void * (*func)(void *), void *arg);
DNG_EXPORT int dng_pthread_detach(dng_pthread_t thread);
DNG_EXPORT int dng_pthread_join(dng_pthread_t thread, void **result);
DNG_EXPORT dng_pthread_t dng_pthread_self();
DNG_EXPORT void dng_pthread_exit(void *result);

#define DNG_PTHREAD_MUTEX_RECURSIVE 0
typedef unsigned long dng_pthread_mutexattr_t;

DNG_EXPORT int dng_pthread_mutexattr_init(dng_pthread_mutexattr_t *mutexattr);
DNG_EXPORT int dng_pthread_mutexattr_settype(dng_pthread_mutexattr_t *mutexattr, int /*the options*/);

DNG_EXPORT int dng_pthread_mutex_init(dng_pthread_mutex_t *mutex, void * /* attrs */);
DNG_EXPORT int dng_pthread_mutex_destroy(dng_pthread_mutex_t *mutex);
DNG_EXPORT int dng_pthread_mutex_lock(dng_pthread_mutex_t *mutex);
DNG_EXPORT int dng_pthread_mutex_unlock(dng_pthread_mutex_t *mutex);

DNG_EXPORT int dng_pthread_cond_init(dng_pthread_cond_t *cond, void * /* attrs */);
DNG_EXPORT int dng_pthread_cond_destroy(dng_pthread_cond_t *cond);
DNG_EXPORT int dng_pthread_cond_wait(dng_pthread_cond_t *cond, dng_pthread_mutex_t *mutex);
DNG_EXPORT int dng_pthread_cond_timedwait(dng_pthread_cond_t *cond, dng_pthread_mutex_t *mutex, struct dng_timespec *latest_time);
DNG_EXPORT int dng_pthread_cond_signal(dng_pthread_cond_t *cond);
DNG_EXPORT int dng_pthread_cond_broadcast(dng_pthread_cond_t *cond);

DNG_EXPORT int dng_pthread_once(dng_pthread_once_t *once, void (*init_func)());

DNG_EXPORT int dng_pthread_key_create(dng_pthread_key_t * key, void (*destructor) (void *));
DNG_EXPORT int dng_pthread_key_delete(dng_pthread_key_t key);
DNG_EXPORT int dng_pthread_setspecific(dng_pthread_key_t key, const void *value);
DNG_EXPORT void *dng_pthread_getspecific(dng_pthread_key_t key);

typedef struct dng_pthread_rwlock_impl *dng_pthread_rwlock_t;
typedef void *pthread_rwlockattr_t;

DNG_EXPORT int dng_pthread_rwlock_destroy(dng_pthread_rwlock_t * rwlock);
DNG_EXPORT int dng_pthread_rwlock_init(dng_pthread_rwlock_t * rwlock, const pthread_rwlockattr_t * attrs);
DNG_EXPORT int dng_pthread_rwlock_rdlock(dng_pthread_rwlock_t * rwlock);
DNG_EXPORT int dng_pthread_rwlock_tryrdlock(dng_pthread_rwlock_t * rwlock);
DNG_EXPORT int dng_pthread_rwlock_trywrlock(dng_pthread_rwlock_t * rwlock);
DNG_EXPORT int dng_pthread_rwlock_unlock(dng_pthread_rwlock_t * rwlock);
DNG_EXPORT int dng_pthread_rwlock_wrlock(dng_pthread_rwlock_t * rwlock);
...
DNG_EXPORT void dng_pthread_disassociate();

DNG_EXPORT void dng_pthread_terminate();
...
DNG_EXPORT int dng_pthread_now (struct timespec *now);
