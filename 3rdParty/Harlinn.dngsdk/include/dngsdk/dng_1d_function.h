...
class dng_1d_function
	...
	public:
		...
		DNG_EXPORT virtual real64 Evaluate (real64 x) const = 0;
...
class dng_1d_concatenate: public dng_1d_function
	...
	public:
		...
		DNG_EXPORT dng_1d_concatenate (const dng_1d_function &function1,
...
class dng_1d_inverse: public dng_1d_function
	...
	public:
		...
		DNG_EXPORT dng_1d_inverse (const dng_1d_function &f);
