...
class dng_area_task
	...
	public:
		...
		DNG_EXPORT explicit dng_area_task (const char *name = "unnamed dng_area_task");
		
		DNG_EXPORT virtual ~dng_area_task ();
		...
		DNG_EXPORT virtual dng_rect RepeatingTile1 () const;
		...
		DNG_EXPORT virtual dng_rect RepeatingTile2 () const;
		...
		DNG_EXPORT virtual dng_rect RepeatingTile3 () const;
		...
		DNG_EXPORT virtual void Start (uint32 threadCount,
		...
		DNG_EXPORT virtual void Process (uint32 threadIndex,
							  const dng_rect &tile,
		...
		DNG_EXPORT virtual void Finish (uint32 threadCount);
		...
		DNG_EXPORT dng_point FindTileSize (const dng_rect &area) const;
		...
		DNG_EXPORT void ProcessOnThread (uint32 threadIndex,
							  const dng_rect &area,
							  const dng_point &tileSize,
							  dng_abort_sniffer *sniffer,
		...
		DNG_EXPORT virtual dng_base_tile_iterator * MakeTileIterator (uint32 threadIndex,
														   const dng_rect &tile,
		...
		DNG_EXPORT static void Perform (dng_area_task &task,
				  			 const dng_rect &area,
				  			 dng_memory_allocator *allocator,
				  			 dng_abort_sniffer *sniffer,
                             dng_area_task_progress *progress);
