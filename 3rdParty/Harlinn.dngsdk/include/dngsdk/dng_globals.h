...
DNG_EXPORT extern bool gVerbose;
...
DNG_EXPORT extern uint32 gDumpLineLimit;
...
DNG_EXPORT extern bool gDNGShowTimers;
...
DNG_EXPORT extern bool gDNGUseFakeTimeZonesInXMP;
...
DNG_EXPORT extern uint32 gDNGStreamBlockSize;

// Maximum stream buffer size to use on large reads and writes.

DNG_EXPORT extern uint32 gDNGMaxStreamBufferSize;

/*****************************************************************************/

// Are we running as part of the imagecore library?

DNG_EXPORT extern bool gImagecore;

// Print out timing info for area tasks?

DNG_EXPORT extern bool gPrintTimings;

// Print assert messages?

DNG_EXPORT extern bool gPrintAsserts;

// Break into debugger on asserts?

DNG_EXPORT extern bool gBreakOnAsserts;
