...
class EBML_DLL_API EbmlBinary : public EbmlElement {
  public:
    EBML_EXPORT EbmlBinary();
    EBML_EXPORT EbmlBinary(const EbmlBinary & ElementToClone);
    EBML_EXPORT ~EbmlBinary() override;
    ...
    EBML_EXPORT operator const binary &() const;

    bool IsDefaultValue() const override {
      return false;
    }

    EBML_EXPORT bool operator==(const EbmlBinary & ElementToCompare) const;
