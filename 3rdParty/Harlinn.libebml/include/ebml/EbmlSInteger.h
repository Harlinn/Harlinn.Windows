...
class EBML_DLL_API EbmlSInteger : public EbmlElement {
  public:
    EBML_EXPORT EbmlSInteger();
    EBML_EXPORT EbmlSInteger(int64 DefaultValue);
    ...
    */
    EBML_EXPORT void SetDefaultSize(uint64 nDefaultSize = DEFAULT_INT_SIZE) override {EbmlElement::SetDefaultSize(nDefaultSize); SetSize_(nDefaultSize);}
    ...
    EBML_EXPORT operator int8() const;
    EBML_EXPORT operator int16() const;
    EBML_EXPORT operator int32() const;
    EBML_EXPORT operator int64() const;

    EBML_EXPORT EbmlSInteger &SetValue(int64 NewValue);
    EBML_EXPORT int64 GetValue() const;

    EBML_EXPORT void SetDefaultValue(int64 aValue) {assert(!DefaultISset()); DefaultValue = aValue; SetDefaultIsSet();}
