...
UPB_EXPORT extern const upb_msglayout google_protobuf_FileDescriptorSet_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_FileDescriptorProto_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_DescriptorProto_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_DescriptorProto_ExtensionRange_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_DescriptorProto_ReservedRange_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_ExtensionRangeOptions_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_FieldDescriptorProto_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_OneofDescriptorProto_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_EnumDescriptorProto_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_EnumDescriptorProto_EnumReservedRange_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_EnumValueDescriptorProto_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_ServiceDescriptorProto_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_MethodDescriptorProto_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_FileOptions_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_MessageOptions_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_FieldOptions_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_OneofOptions_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_EnumOptions_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_EnumValueOptions_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_ServiceOptions_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_MethodOptions_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_UninterpretedOption_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_UninterpretedOption_NamePart_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_SourceCodeInfo_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_SourceCodeInfo_Location_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_GeneratedCodeInfo_msginit;
UPB_EXPORT extern const upb_msglayout google_protobuf_GeneratedCodeInfo_Annotation_msginit;
...
UPB_EXPORT extern const upb_enumlayout google_protobuf_FieldDescriptorProto_Label_enuminit;
UPB_EXPORT extern const upb_enumlayout google_protobuf_FieldDescriptorProto_Type_enuminit;
UPB_EXPORT extern const upb_enumlayout google_protobuf_FieldOptions_CType_enuminit;
UPB_EXPORT extern const upb_enumlayout google_protobuf_FieldOptions_JSType_enuminit;
UPB_EXPORT extern const upb_enumlayout google_protobuf_FileOptions_OptimizeMode_enuminit;
UPB_EXPORT extern const upb_enumlayout google_protobuf_MethodOptions_IdempotencyLevel_enuminit;
...
UPB_EXPORT extern const upb_msglayout_file google_protobuf_descriptor_proto_upb_file_layout;
