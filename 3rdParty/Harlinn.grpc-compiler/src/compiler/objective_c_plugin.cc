...
#include <memory>
#include "grpc/compiler/plugins.h"
#include <google/protobuf/compiler/objectivec/objectivec_helpers.h>

#include "grpc/compiler/config.h"
#include "grpc/compiler/objective_c_generator.h"
#include "grpc/compiler/objective_c_generator_helpers.h"
...
int RunObjectiveCPlugin( int argc, char* argv[] )
{
