...
HDXTK12_EXPORT HRESULT DirectX::LoadDDSTextureFromMemory(
...
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::LoadDDSTextureFromMemoryEx(
    ID3D12Device* d3dDevice,
    const uint8_t* ddsData,
    size_t ddsDataSize,
    size_t maxsize,
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::LoadDDSTextureFromFile(
    ID3D12Device* d3dDevice,
...
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::LoadDDSTextureFromFileEx(
    ID3D12Device* d3dDevice,
    const wchar_t* fileName,
    size_t maxsize,
    D3D12_RESOURCE_FLAGS resFlags,
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::CreateDDSTextureFromMemory(
    ID3D12Device* d3dDevice,
...
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::CreateDDSTextureFromMemoryEx(
    ID3D12Device* d3dDevice,
    ResourceUploadBatch& resourceUpload,
    const uint8_t* ddsData,
    size_t ddsDataSize,
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::CreateDDSTextureFromFile(
    ID3D12Device* d3dDevice,
    ResourceUploadBatch& resourceUpload,
    const wchar_t* fileName,
    ID3D12Resource** texture,
...
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::CreateDDSTextureFromFileEx(
    ID3D12Device* d3dDevice,
    ResourceUploadBatch& resourceUpload,
    const wchar_t* fileName,
    size_t maxsize,
