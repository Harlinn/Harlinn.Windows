...
HDXTK12_EXPORT HRESULT DirectX::LoadWICTextureFromMemory(
...
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::CreateWICTextureFromMemory(
    ID3D12Device* d3dDevice,
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::LoadWICTextureFromMemoryEx(
    ID3D12Device* d3dDevice,
    const uint8_t* wicData,
    size_t wicDataSize,
    size_t maxsize,
...
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::CreateWICTextureFromMemoryEx(
    ID3D12Device* d3dDevice,
    ResourceUploadBatch& resourceUpload,
    const uint8_t* wicData,
    size_t wicDataSize,
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::LoadWICTextureFromFile(
    ID3D12Device* d3dDevice,
...
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::CreateWICTextureFromFile(
    ID3D12Device* d3dDevice,
    ResourceUploadBatch& resourceUpload,
    const wchar_t* fileName,
    ID3D12Resource** texture,
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::LoadWICTextureFromFileEx(
    ID3D12Device* d3dDevice,
    const wchar_t* fileName,
    size_t maxsize,
    D3D12_RESOURCE_FLAGS resFlags,
...
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::CreateWICTextureFromFileEx(
    ID3D12Device* d3dDevice,
    ResourceUploadBatch& resourceUpload,
    const wchar_t* fileName,
    size_t maxsize,
