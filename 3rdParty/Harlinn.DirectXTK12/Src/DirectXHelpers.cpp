...
HDXTK12_EXPORT void DirectX::CreateShaderResourceView(
    ID3D12Device* device,
    ID3D12Resource* tex,
...
_Use_decl_annotations_
HDXTK12_EXPORT void DirectX::CreateUnorderedAccessView(
    ID3D12Device* device,
    ID3D12Resource* tex,
...
_Use_decl_annotations_
HDXTK12_EXPORT void DirectX::CreateRenderTargetView(
    ID3D12Device* device,
    ID3D12Resource* tex,
...
_Use_decl_annotations_
HDXTK12_EXPORT void DirectX::CreateBufferShaderResourceView(
    ID3D12Device* device,
...
_Use_decl_annotations_
HDXTK12_EXPORT void DirectX::CreateBufferUnorderedAccessView(
    ID3D12Device* device,
    ID3D12Resource* buffer,
    D3D12_CPU_DESCRIPTOR_HANDLE uavDescriptor,
    uint32_t stride,
