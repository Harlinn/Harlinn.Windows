...
HDXTK12_EXPORT HRESULT DirectX::CreateStaticBuffer(
    ID3D12Device* device,
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::CreateUAVBuffer(
    ID3D12Device* device,
    uint64_t bufferSize,
    ID3D12Resource** pBuffer,
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::CreateUploadBuffer(
    ID3D12Device* device,
    const void* ptr,
    size_t count,
    size_t stride,
...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::CreateTextureFromMemory(
    ID3D12Device* device,
    ResourceUploadBatch& resourceUpload,
    size_t width,
    DXGI_FORMAT format,
