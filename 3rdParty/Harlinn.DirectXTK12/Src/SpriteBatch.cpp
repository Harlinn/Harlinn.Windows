...
// Constants.
HDXTK12_EXPORT const XMMATRIX SpriteBatch::MatrixIdentity = XMMatrixIdentity();
HDXTK12_EXPORT const XMFLOAT2 SpriteBatch::Float2Zero(0, 0);
...
HDXTK12_EXPORT const D3D12_BLEND_DESC SpriteBatchPipelineStateDescription::s_DefaultBlendDesc =
{
...
HDXTK12_EXPORT const D3D12_RASTERIZER_DESC SpriteBatchPipelineStateDescription::s_DefaultRasterizerDesc =
{
...
HDXTK12_EXPORT const D3D12_DEPTH_STENCIL_DESC SpriteBatchPipelineStateDescription::s_DefaultDepthStencilDesc =
{
    FALSE, // DepthEnable
