...
namespace DirectX
{
    ...
    HDXTK12_EXPORT void __cdecl CreateShaderResourceView(
    ...
    HDXTK12_EXPORT void __cdecl CreateUnorderedAccessView(
        _In_ ID3D12Device* device,
        _In_ ID3D12Resource* tex,
    ...
    HDXTK12_EXPORT void __cdecl CreateRenderTargetView(
        _In_ ID3D12Device* device,
        _In_ ID3D12Resource* tex,
    ...
    HDXTK12_EXPORT void __cdecl CreateBufferShaderResourceView(
        _In_ ID3D12Device* device,
    ...
    HDXTK12_EXPORT void __cdecl CreateBufferUnorderedAccessView(
        _In_ ID3D12Device* device,
        _In_ ID3D12Resource* buffer,
        D3D12_CPU_DESCRIPTOR_HANDLE uavDescriptor,
        uint32_t stride,
