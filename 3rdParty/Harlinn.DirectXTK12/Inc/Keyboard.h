...
namespace DirectX
{
    ...
    {
    public:
        HDXTK12_EXPORT Keyboard() noexcept(false);

        HDXTK12_EXPORT Keyboard(Keyboard&&) noexcept;
        HDXTK12_EXPORT Keyboard& operator= (Keyboard&&) noexcept;

        Keyboard(Keyboard const&) = delete;
        Keyboard& operator=(Keyboard const&) = delete;

        HDXTK12_EXPORT virtual ~Keyboard();
...
#pragma clang diagnostic pop
        ...
        // Singleton
        HDXTK12_EXPORT static Keyboard& __cdecl Get();
