...
namespace DirectX
{
    inline namespace DX12
    {
        ...
        {
        public:
            HDXTK12_EXPORT ModelMeshPart(uint32_t partIndex) noexcept;
            ...
            HDXTK12_EXPORT virtual ~ModelMeshPart();
            ...
            HDXTK12_EXPORT void __cdecl DrawInstanced(_In_ ID3D12GraphicsCommandList* commandList, uint32_t instanceCount, uint32_t startInstance = 0) const;
            ...
            // Draw the mesh
            HDXTK12_EXPORT static void __cdecl DrawMeshParts(_In_ ID3D12GraphicsCommandList* commandList, const Collection& meshParts);

            // Draw the mesh with an effect
            HDXTK12_EXPORT static void __cdecl DrawMeshParts(_In_ ID3D12GraphicsCommandList* commandList, const Collection& meshParts, _In_ IEffect* effect);

            // Draw the mesh with a callback for each mesh part
            HDXTK12_EXPORT static void __cdecl DrawMeshParts(_In_ ID3D12GraphicsCommandList* commandList, const Collection& meshParts, DrawCallback callback);
        ...
        {
        public:
            HDXTK12_EXPORT ModelMesh() noexcept;
            ...
            HDXTK12_EXPORT virtual ~ModelMesh();
            ...
            // Draw the mesh
            HDXTK12_EXPORT void __cdecl DrawOpaque(_In_ ID3D12GraphicsCommandList* commandList) const;
            HDXTK12_EXPORT void __cdecl DrawAlpha(_In_ ID3D12GraphicsCommandList* commandList) const;

            // Draw the mesh with an effect
            HDXTK12_EXPORT void __cdecl DrawOpaque(_In_ ID3D12GraphicsCommandList* commandList, _In_ IEffect* effect) const;
            HDXTK12_EXPORT void __cdecl DrawAlpha(_In_ ID3D12GraphicsCommandList* commandList, _In_ IEffect* effect) const;

            // Draw the mesh with a callback for each mesh part
            HDXTK12_EXPORT void __cdecl DrawOpaque(_In_ ID3D12GraphicsCommandList* commandList, ModelMeshPart::DrawCallback callback) const;
            HDXTK12_EXPORT void __cdecl DrawAlpha(_In_ ID3D12GraphicsCommandList* commandList, ModelMeshPart::DrawCallback callback) const;
        ...
        public:
            ...
            HDXTK12_EXPORT int __cdecl LoadTextures(IEffectTextureFactory& texFactory, int destinationDescriptorOffset = 0) const;

            // Load texture resources into a new Effect Texture Factory
            HDXTK12_EXPORT std::unique_ptr<EffectTextureFactory> __cdecl LoadTextures(
            ...
            HDXTK12_EXPORT EffectCollection __cdecl CreateEffects(
            ...
            HDXTK12_EXPORT void __cdecl CopyAbsoluteBoneTransformsTo(
                size_t nbones,
                _Out_writes_(nbones) XMMATRIX* boneTransforms) const;

            HDXTK12_EXPORT void __cdecl CopyAbsoluteBoneTransforms(
                size_t nbones,
            ...
            HDXTK12_EXPORT void __cdecl CopyBoneTransformsFrom(
                size_t nbones,
                _In_reads_(nbones) const XMMATRIX* boneTransforms);

            // Copies the relative bone matrices to a transform array
            HDXTK12_EXPORT void __cdecl CopyBoneTransformsTo(
                size_t nbones,
                _Out_writes_(nbones) XMMATRIX* boneTransforms) const;

            // Loads a model from a Visual Studio Starter Kit .CMO file
            HDXTK12_EXPORT static std::unique_ptr<Model> __cdecl CreateFromCMO(
            ...
            HDXTK12_EXPORT static std::unique_ptr<Model> __cdecl CreateFromSDKMESH(
                _In_opt_ ID3D12Device* device,
                _In_reads_bytes_(dataSize) const uint8_t* meshData, _In_ size_t dataSize,
                ModelLoaderFlags flags = ModelLoader_Default);
            HDXTK12_EXPORT static std::unique_ptr<Model> __cdecl CreateFromSDKMESH(
            ...
            HDXTK12_EXPORT static std::unique_ptr<Model> __cdecl CreateFromVBO(
                _In_opt_ ID3D12Device* device,
                _In_reads_bytes_(dataSize) const uint8_t* meshData, _In_ size_t dataSize,
                ModelLoaderFlags flags = ModelLoader_Default);
            HDXTK12_EXPORT static std::unique_ptr<Model> __cdecl CreateFromVBO(
            ...
            HDXTK12_EXPORT static void XM_CALLCONV UpdateEffectMatrices(
        ...
        private:
            HDXTK12_EXPORT std::shared_ptr<IEffect> __cdecl CreateEffectForMeshPart(
                IEffectFactory& fxFactory,
                const EffectPipelineStateDescription& opaquePipelineState,
                const EffectPipelineStateDescription& alphaPipelineState,
            ...
            HDXTK12_EXPORT void __cdecl ComputeAbsolute(uint32_t index,
