...
namespace DirectX
{
    ...
    public:
        ...
        HDXTK12_EXPORT D3D12_GPU_DESCRIPTOR_HANDLE __cdecl WriteDescriptors(
            _In_ ID3D12Device* device,
        ...
        HDXTK12_EXPORT static void __cdecl DefaultDesc(
            _In_ D3D12_DESCRIPTOR_HEAP_TYPE type,
            _Out_ D3D12_DESCRIPTOR_HEAP_DESC* pDesc) noexcept;

    private:
        HDXTK12_EXPORT void Create(_In_ ID3D12Device* pDevice, _In_ const D3D12_DESCRIPTOR_HEAP_DESC* pDesc);
    ...
    public:
        ...
        HDXTK12_EXPORT void AllocateRange(size_t numDescriptors, _Out_ IndexType& start, _Out_ IndexType& end);
