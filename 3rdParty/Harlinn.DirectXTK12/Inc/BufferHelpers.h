...
namespace DirectX
{
    ...
    HDXTK12_EXPORT HRESULT __cdecl CreateStaticBuffer(_In_ ID3D12Device* device,
    ...
    HDXTK12_EXPORT HRESULT __cdecl CreateUAVBuffer(_In_ ID3D12Device* device,
        uint64_t bufferSize,
        _COM_Outptr_ ID3D12Resource** pBuffer,
        D3D12_RESOURCE_STATES initialState = D3D12_RESOURCE_STATE_COMMON,
        D3D12_RESOURCE_FLAGS additionalResFlags = D3D12_RESOURCE_FLAG_NONE) noexcept;

    HDXTK12_EXPORT HRESULT __cdecl CreateUploadBuffer(_In_ ID3D12Device* device,
    ...
    HDXTK12_EXPORT HRESULT __cdecl CreateTextureFromMemory(_In_ ID3D12Device* device,
        ResourceUploadBatch& resourceUpload,
        size_t width,
        DXGI_FORMAT format,
