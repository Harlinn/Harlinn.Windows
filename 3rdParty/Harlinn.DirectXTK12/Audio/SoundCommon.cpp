...
HDXTK12_EXPORT bool DirectX::IsValid(_In_ const WAVEFORMATEX* wfx) noexcept
{
    if (!wfx)
        return false;
...
HDXTK12_EXPORT uint32_t DirectX::GetDefaultChannelMask(int channels) noexcept
{
    switch (channels)
    {
...
HDXTK12_EXPORT void DirectX::CreateIntegerPCM(
    WAVEFORMATEX* wfx,
    int sampleRate,
    int channels,
...
_Use_decl_annotations_
HDXTK12_EXPORT void DirectX::CreateFloatPCM(
    WAVEFORMATEX* wfx,
    int sampleRate,
...
_Use_decl_annotations_
HDXTK12_EXPORT void DirectX::CreateADPCM(
    WAVEFORMATEX* wfx,
    size_t wfxSize,
    int sampleRate,
    int channels,
...
#ifdef DIRECTX_ENABLE_XWMA
_Use_decl_annotations_
HDXTK12_EXPORT void DirectX::CreateXWMA(
    WAVEFORMATEX* wfx,
    int sampleRate,
    int channels,
    int blockAlign,
...
_Use_decl_annotations_
HDXTK12_EXPORT bool DirectX::ComputePan(float pan, unsigned int channels, float* matrix) noexcept
{
