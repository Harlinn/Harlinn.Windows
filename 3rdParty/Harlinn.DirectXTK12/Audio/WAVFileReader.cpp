...
HDXTK12_EXPORT HRESULT DirectX::LoadWAVAudioInMemory(
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::LoadWAVAudioFromFile(
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::LoadWAVAudioInMemoryEx(
    const uint8_t* wavData,
    size_t wavDataSize,
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_
HDXTK12_EXPORT HRESULT DirectX::LoadWAVAudioFromFileEx(
    const wchar_t* szFileName,
    std::unique_ptr<uint8_t[]>& wavData,
    DirectX::WAVData& result) noexcept
{
