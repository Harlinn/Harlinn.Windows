...
HW_RTSPSERVER_EXPORT uint32_t ReadUint32BE(char* data);
HW_RTSPSERVER_EXPORT uint32_t ReadUint32LE(char* data);
HW_RTSPSERVER_EXPORT uint32_t ReadUint24BE(char* data);
HW_RTSPSERVER_EXPORT uint32_t ReadUint24LE(char* data);
HW_RTSPSERVER_EXPORT uint16_t ReadUint16BE(char* data);
HW_RTSPSERVER_EXPORT uint16_t ReadUint16LE(char* data);
    
class BufferReader
{
public:	
	HW_RTSPSERVER_EXPORT BufferReader(uint32_t initial_size = 2048);
	HW_RTSPSERVER_EXPORT virtual ~BufferReader();
	...
	HW_RTSPSERVER_EXPORT uint32_t ReadAll(std::string& data);
	HW_RTSPSERVER_EXPORT uint32_t ReadUntilCrlf(std::string& data);
