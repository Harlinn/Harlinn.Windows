...
HGDAL_EXPORT extern zipFile cpl_zipOpen (const char *pathname, int append);
/*
  Create a zipfile.
...
HGDAL_EXPORT extern zipFile cpl_zipOpen2 (const char *pathname,
                                     int append,
                                     zipcharpc* globalcomment,
                                     zlib_filefunc_def* pzlib_filefunc_def);

HGDAL_EXPORT extern int cpl_zipOpenNewFileInZip (zipFile file,
                                            const char* filename,
...
HGDAL_EXPORT extern int cpl_zipOpenNewFileInZip2 (zipFile file,
                                             const char* filename,
                                             const zip_fileinfo* zipfi,
                                             const void* extrafield_local,
                                             uInt size_extrafield_local,
...
HGDAL_EXPORT extern int cpl_zipOpenNewFileInZip3 (zipFile file,
                                             const char* filename,
                                             const zip_fileinfo* zipfi,
                                             const void* extrafield_local,
                                             uInt size_extrafield_local,
...
HGDAL_EXPORT extern int cpl_zipWriteInFileInZip (zipFile file,
                                            const void* buf,
                                            unsigned len);
/*
...
HGDAL_EXPORT extern int cpl_zipCloseFileInZip (zipFile file);
/*
  Close the current file in the zipfile
*/

HGDAL_EXPORT extern int cpl_zipCloseFileInZipRaw (zipFile file,
...
HGDAL_EXPORT extern int cpl_zipClose (zipFile file,
