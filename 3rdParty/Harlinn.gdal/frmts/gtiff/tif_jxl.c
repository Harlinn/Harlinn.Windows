                                   ...
                                   const char* module)
{
    ...
    {
        _TIFFfree(sp->uncompressed_buffer);
        sp->uncompressed_buffer = (uint8_t*) _TIFFmalloc( new_alloc );
...
JXLPreDecode(TIFF* tif, uint16_t s)
{
        ...
        format.data_type = static_cast<JxlDataType>(jxlDataType);
...
JXLPostEncode(TIFF* tif)
{
        ...
        JxlPixelFormat format = {};
        format.data_type = static_cast<JxlDataType>( GetJXLDataType(tif) );
        format.endianness = JXL_NATIVE_ENDIAN;
        format.align = 0;
...
static const char* Lossyness = "Lossyness";
static const char* Effort = "Effort";
...
static const TIFFField JXLFields[] = {
        { TIFFTAG_JXL_LOSSYNESS, 0, 0, TIFF_ANY, 0, TIFF_SETGET_UINT32,
          ...
          FIELD_PSEUDO, FALSE, FALSE, const_cast<char*>( Lossyness ), NULL },
        { TIFFTAG_JXL_EFFORT, 0, 0, TIFF_ANY, 0, TIFF_SETGET_UINT32,
          TIFF_SETGET_UNDEFINED,
          FIELD_PSEUDO, FALSE, FALSE, const_cast<char*>( Effort ), NULL },
        { TIFFTAG_JXL_DISTANCE, 0, 0, TIFF_ANY, 0, TIFF_SETGET_FLOAT,
          TIFF_SETGET_UNDEFINED,
          FIELD_PSEUDO, FALSE, FALSE, const_cast<char*>( Distance), NULL },
};
