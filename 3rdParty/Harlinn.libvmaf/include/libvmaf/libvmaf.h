 ...
 */
HLIBVMAF_EXPORT int vmaf_init(VmafContext **vmaf, VmafConfiguration cfg);
 ...
 * @return 0 on success, or < 0 (a negative errno code) on error.
 */
HLIBVMAF_EXPORT int vmaf_use_features_from_model(VmafContext *vmaf, VmafModel *model);
 ...
 * @return 0 on success, or < 0 (a negative errno code) on error.
 */
HLIBVMAF_EXPORT int vmaf_use_features_from_model_collection(VmafContext *vmaf,
 ...
 * @return 0 on success, or < 0 (a negative errno code) on error.
 */
HLIBVMAF_EXPORT int vmaf_use_feature(VmafContext *vmaf, const char *feature_name,
 ...
 * @return 0 on success, or < 0 (a negative errno code) on error.
 */
HLIBVMAF_EXPORT int vmaf_import_feature_score(VmafContext *vmaf, const char *feature_name,
 ...
 * @return 0 on success, or < 0 (a negative errno code) on error.
 */
HLIBVMAF_EXPORT int vmaf_read_pictures(VmafContext *vmaf, VmafPicture *ref, VmafPicture *dist,
                       unsigned index);
 ...
 * @return 0 on success, or < 0 (a negative errno code) on error.
 */
HLIBVMAF_EXPORT int vmaf_score_at_index(VmafContext *vmaf, VmafModel *model, double *score,
                        unsigned index);
 ...
 * @return 0 on success, or < 0 (a negative errno code) on error.
 */
HLIBVMAF_EXPORT int vmaf_score_at_index_model_collection(VmafContext *vmaf,
                                         VmafModelCollection *model_collection,
 ...
 * @return 0 on success, or < 0 (a negative errno code) on error.
 */
HLIBVMAF_EXPORT int vmaf_feature_score_at_index(VmafContext *vmaf, const char *feature_name,
 ...
 * @return 0 on success, or < 0 (a negative errno code) on error.
 */
HLIBVMAF_EXPORT int vmaf_score_pooled(VmafContext *vmaf, VmafModel *model,
 ...
 * @return 0 on success, or < 0 (a negative errno code) on error.
 */
HLIBVMAF_EXPORT int vmaf_score_pooled_model_collection(VmafContext *vmaf,
                                       VmafModelCollection *model_collection,
 ...
 * @return 0 on success, or < 0 (a negative errno code) on error.
 */
HLIBVMAF_EXPORT int vmaf_feature_score_pooled(VmafContext *vmaf, const char *feature_name,
                              enum VmafPoolingMethod pool_method, double *score,
                              unsigned index_low, unsigned index_high);
 ...
 * @return 0 on success, or < 0 (a negative errno code) on error.
 */
HLIBVMAF_EXPORT int vmaf_close(VmafContext *vmaf);
 ...
 * @return 0 on success, or < 0 (a negative errno code) on error.
 */
HLIBVMAF_EXPORT int vmaf_write_output(VmafContext *vmaf, const char *output_path,
                      enum VmafOutputFormat fmt);

/**
 * Get libvmaf version.
 */
HLIBVMAF_EXPORT const char *vmaf_version(void);
