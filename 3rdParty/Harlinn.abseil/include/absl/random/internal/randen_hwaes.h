...
class RandenHwAes {
 public:
  ABSEIL_EXPORT static void Generate(const void* keys, void* state_void);
  ABSEIL_EXPORT static void Absorb(const void* seed_void, void* state_void);
  ABSEIL_EXPORT static const void* GetKeys();
};
...
ABSEIL_EXPORT bool HasRandenHwAesImplementation();
