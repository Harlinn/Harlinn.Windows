...
// than `p_fail`.
ABSEIL_EXPORT double RequiredSuccessProbability(double p_fail, int num_trials);
...
//
ABSEIL_EXPORT double BetaIncomplete(double x, double p, double q);
...
ABSEIL_EXPORT double BetaIncompleteInv(double p, double q, double alpha);
