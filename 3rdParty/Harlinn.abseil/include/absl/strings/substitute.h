...
class Arg {
 public:
  ...
  ABSEIL_EXPORT Arg(Hex hex);  // NOLINT(google-explicit-constructor)
  ABSEIL_EXPORT Arg(Dec dec);  // NOLINT(google-explicit-constructor)
  ...
  ABSEIL_EXPORT Arg(  // NOLINT(google-explicit-constructor)
...
ABSEIL_EXPORT void SubstituteAndAppendArray(
