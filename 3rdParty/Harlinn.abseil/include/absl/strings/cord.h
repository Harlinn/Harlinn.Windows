...
ABSEIL_EXPORT void CopyCordToString(const Cord& src, absl::Nonnull<std::string*> dst);
...
class Cord {
 ...
 public:
  ...
  explicit ABSEIL_EXPORT Cord(T&& src);
  template <typename T, EnableIfString<T> = 0>
  Cord& operator=(T&& src);
  ...
  ABSL_ATTRIBUTE_REINITIALIZES ABSEIL_EXPORT void Clear();
  ...
  ABSEIL_EXPORT bool Contains(absl::string_view rhs) const;
  ABSEIL_EXPORT bool Contains(const Cord& rhs) const;

  // Cord::operator std::string()
  //
  // Converts a Cord into a `std::string()`. This operator is marked explicit to
  // prevent unintended Cord usage in functions that take a string.
  explicit ABSEIL_EXPORT operator std::string() const;
  ...
  friend ABSEIL_EXPORT void CopyCordToString(const Cord& src,
  ...
  ABSEIL_EXPORT CharIterator Find(absl::string_view needle) const;
  ABSEIL_EXPORT CharIterator Find(const absl::Cord& needle) const;
 ...
 private:
  ...
  explicit ABSEIL_EXPORT Cord(absl::string_view src, MethodIdentifier method);
  ...
  class InlineRep {
   public:
    ...
    ABSEIL_EXPORT void AppendTreeToInlined(absl::Nonnull<CordRep*> tree,
                             MethodIdentifier method);
    ABSEIL_EXPORT void AppendTreeToTree(absl::Nonnull<CordRep*> tree,
                          MethodIdentifier method);
    ABSEIL_EXPORT void AppendTree(absl::Nonnull<CordRep*> tree, MethodIdentifier method);
    ABSEIL_EXPORT void PrependTreeToInlined(absl::Nonnull<CordRep*> tree,
                              MethodIdentifier method);
    ABSEIL_EXPORT void PrependTreeToTree(absl::Nonnull<CordRep*> tree,
                           MethodIdentifier method);
    ABSEIL_EXPORT void PrependTree(absl::Nonnull<CordRep*> tree, MethodIdentifier method);
  ...
  ABSEIL_EXPORT static bool GetFlatAux(absl::Nonnull<absl::cord_internal::CordRep*> rep,
  ...
  ABSEIL_EXPORT void CopyToArraySlowPath(absl::Nonnull<char*> dst) const;
  ...
  ABSEIL_EXPORT friend ResultType GenericCompare(const Cord& lhs, const RHS& rhs,
  ...
  ABSEIL_EXPORT absl::Nonnull<absl::cord_internal::CordRep*> TakeRep() const&;
  ABSEIL_EXPORT absl::Nonnull<absl::cord_internal::CordRep*> TakeRep() &&;
  ...
  ABSEIL_EXPORT absl::Nullable<const crc_internal::CrcCordState*> MaybeGetCrcCordState()
      const;

  ABSEIL_EXPORT CharIterator FindImpl(CharIterator it, absl::string_view needle) const;
};
...
extern ABSEIL_EXPORT std::ostream& operator<<(std::ostream& out, const Cord& cord);
...
ABSEIL_EXPORT void InitializeCordRepExternal(absl::string_view data,
...
extern template ABSEIL_TEMPLATE_EXPORT_DECL Cord::Cord(std::string&& src);
