...
ABSEIL_EXPORT bool CUnescape(absl::string_view source, std::string* dest, std::string* error);
...
ABSEIL_EXPORT std::string CEscape(absl::string_view src);
...
ABSEIL_EXPORT std::string CHexEscape(absl::string_view src);
...
ABSEIL_EXPORT std::string Utf8SafeCEscape(absl::string_view src);
...
// conversion.
ABSEIL_EXPORT std::string Utf8SafeCHexEscape(absl::string_view src);
...
// 2045.
ABSEIL_EXPORT void Base64Escape(absl::string_view src, std::string* dest);
ABSEIL_EXPORT std::string Base64Escape(absl::string_view src);
...
ABSEIL_EXPORT void WebSafeBase64Escape(absl::string_view src, std::string* dest);
ABSEIL_EXPORT std::string WebSafeBase64Escape(absl::string_view src);
...
ABSEIL_EXPORT bool Base64Unescape(absl::string_view src, std::string* dest);
...
ABSEIL_EXPORT bool WebSafeBase64Unescape(absl::string_view src, std::string* dest);

// HexStringToBytes()
//
// Converts an ASCII hex string into bytes, returning binary data of length
// `from.size()/2`.
ABSEIL_EXPORT std::string HexStringToBytes(absl::string_view from);

// BytesToHexString()
//
// Converts binary data into an ASCII text string, returning a string of size
// `2*from.size()`.
ABSEIL_EXPORT std::string BytesToHexString(absl::string_view from);
