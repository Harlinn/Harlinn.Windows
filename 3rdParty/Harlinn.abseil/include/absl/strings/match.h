...
ABSEIL_EXPORT bool StrContainsIgnoreCase(absl::string_view haystack,
                           absl::string_view needle) noexcept;
...
ABSEIL_EXPORT bool EqualsIgnoreCase(absl::string_view piece1,
...
ABSEIL_EXPORT bool StartsWithIgnoreCase(absl::string_view text,
                          absl::string_view prefix) noexcept;
...
// case in the comparison.
ABSEIL_EXPORT bool EndsWithIgnoreCase(absl::string_view text,
                        absl::string_view suffix) noexcept;

// Yields the longest prefix in common between both input strings.
// Pointer-wise, the returned result is a subset of input "a".
ABSEIL_EXPORT absl::string_view FindLongestCommonPrefix(absl::string_view a,
                                          absl::string_view b);

// Yields the longest suffix in common between both input strings.
// Pointer-wise, the returned result is a subset of input "a".
ABSEIL_EXPORT absl::string_view FindLongestCommonSuffix(absl::string_view a,
                                          absl::string_view b);
