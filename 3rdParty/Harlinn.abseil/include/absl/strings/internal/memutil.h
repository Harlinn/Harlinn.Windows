...
ABSEIL_EXPORT int memcasecmp(const char* s1, const char* s2, size_t len);
ABSEIL_EXPORT char* memdup(const char* s, size_t slen);
ABSEIL_EXPORT char* memrchr(const char* s, int c, size_t slen);
ABSEIL_EXPORT size_t memspn(const char* s, size_t slen, const char* accept);
ABSEIL_EXPORT size_t memcspn(const char* s, size_t slen, const char* reject);
ABSEIL_EXPORT char* mempbrk(const char* s, size_t slen, const char* accept);
...
ABSEIL_EXPORT const char* memmatch(const char* phaystack, size_t haylen, const char* pneedle,
                     size_t neelen);
