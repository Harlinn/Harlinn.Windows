...
ABSL_CONST_INIT ABSEIL_EXPORT extern const char kBase64Chars[];
ABSL_CONST_INIT ABSEIL_EXPORT extern const char kWebSafeBase64Chars[];
...
ABSEIL_EXPORT size_t CalculateBase64EscapedLenInternal(size_t input_len, bool do_padding);
...
ABSEIL_EXPORT size_t Base64EscapeInternal(const unsigned char* src, size_t szsrc, char* dest,
