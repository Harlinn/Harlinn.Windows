...
ABSL_MUST_USE_RESULT ABSEIL_EXPORT bool SimpleAtof(absl::string_view str,
...
// always use the "C" locale. If any errors are encountered, this function
// returns `false`, leaving `out` in an unspecified state.
ABSL_MUST_USE_RESULT ABSEIL_EXPORT bool SimpleAtod(absl::string_view str,
...
// unspecified state.
ABSL_MUST_USE_RESULT ABSEIL_EXPORT bool SimpleAtob(absl::string_view str,
...
//   // buf[0] == '4'
//   // buf[1] == '2'
ABSEIL_EXPORT void PutTwoDigits(uint32_t i, absl::Nonnull<char*> buf);
...
ABSEIL_EXPORT bool safe_strto64_base(absl::string_view text, absl::Nonnull<int64_t*> value,
                       int base);
ABSEIL_EXPORT bool safe_strto128_base(absl::string_view text,
...
ABSEIL_EXPORT bool safe_strtou64_base(absl::string_view text, absl::Nonnull<uint64_t*> value,
                        int base);
ABSEIL_EXPORT bool safe_strtou128_base(absl::string_view text,
...
// characters required.
ABSL_ATTRIBUTE_CONST_FUNCTION ABSEIL_EXPORT int GetNumDigitsOrNegativeIfNegative(
    signed char v);
ABSL_ATTRIBUTE_CONST_FUNCTION ABSEIL_EXPORT int GetNumDigitsOrNegativeIfNegative(
    unsigned char v);
ABSL_ATTRIBUTE_CONST_FUNCTION ABSEIL_EXPORT int GetNumDigitsOrNegativeIfNegative(
...
ABSL_ATTRIBUTE_CONST_FUNCTION ABSEIL_EXPORT int GetNumDigitsOrNegativeIfNegative(int v);
ABSL_ATTRIBUTE_CONST_FUNCTION ABSEIL_EXPORT int GetNumDigitsOrNegativeIfNegative(
    unsigned int v);
ABSL_ATTRIBUTE_CONST_FUNCTION ABSEIL_EXPORT int GetNumDigitsOrNegativeIfNegative(
    long v);  // NOLINT
...
ABSEIL_EXPORT size_t SixDigitsToBuffer(double d, absl::Nonnull<char*> buffer);

// All of these functions take an output buffer
// as an argument and return a pointer to the last byte they wrote, which is the
// terminating '\0'. At most `kFastToBufferSize` bytes are written.
ABSEIL_EXPORT absl::Nonnull<char*> FastIntToBuffer(int32_t i, absl::Nonnull<char*> buffer);
ABSEIL_EXPORT absl::Nonnull<char*> FastIntToBuffer(uint32_t i, absl::Nonnull<char*> buffer);
ABSEIL_EXPORT absl::Nonnull<char*> FastIntToBuffer(int64_t i, absl::Nonnull<char*> buffer);
ABSEIL_EXPORT absl::Nonnull<char*> FastIntToBuffer(uint64_t i, absl::Nonnull<char*> buffer);
...
ABSEIL_EXPORT absl::Nonnull<char*> FastIntToBufferBackward(int32_t i,
                                             absl::Nonnull<char*> buffer_end,
                                             uint32_t exact_digit_count);
ABSEIL_EXPORT absl::Nonnull<char*> FastIntToBufferBackward(uint32_t i,
                                             absl::Nonnull<char*> buffer_end,
                                             uint32_t exact_digit_count);
ABSEIL_EXPORT absl::Nonnull<char*> FastIntToBufferBackward(int64_t i,
                                             absl::Nonnull<char*> buffer_end,
                                             uint32_t exact_digit_count);
ABSEIL_EXPORT absl::Nonnull<char*> FastIntToBufferBackward(uint64_t i,
                                             absl::Nonnull<char*> buffer_end,
                                             uint32_t exact_digit_count);
