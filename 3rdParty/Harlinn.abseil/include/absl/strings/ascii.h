...
ABSEIL_EXPORT void AsciiStrToLower(absl::Nonnull<std::string*> s);
...
ABSEIL_EXPORT void AsciiStrToUpper(absl::Nonnull<std::string*> s);
...
ABSEIL_EXPORT void RemoveExtraAsciiWhitespace(absl::Nonnull<std::string*> str);
