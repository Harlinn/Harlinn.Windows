...
ABSEIL_EXPORT size_t GetEstimatedMemoryUsage(absl::Nonnull<const CordRep*> rep);
...
ABSEIL_EXPORT size_t GetMorePreciseMemoryUsage(absl::Nonnull<const CordRep*> rep);
...
ABSEIL_EXPORT size_t GetEstimatedFairShareMemoryUsage(absl::Nonnull<const CordRep*> rep);
