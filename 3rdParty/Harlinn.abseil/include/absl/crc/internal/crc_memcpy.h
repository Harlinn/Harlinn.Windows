...
class CrcMemcpy {
 public:
  ...
  ABSEIL_EXPORT static std::unique_ptr<CrcMemcpyEngine> GetTestEngine(int vector,
                                                        int integer);
 ...
 private:
  ...
  ABSEIL_EXPORT static ArchSpecificEngines GetArchSpecificEngines();
};
...
class FallbackCrcMemcpyEngine : public CrcMemcpyEngine {
 public:
  ...
  ABSEIL_EXPORT crc32c_t Compute(void* __restrict dst, const void* __restrict src,
