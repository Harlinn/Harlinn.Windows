...
class KernelTimeout {
 public:
  ...
  explicit ABSEIL_EXPORT KernelTimeout(absl::Time t);

  // Construct a relative timeout that should expire after `d`.
  explicit ABSEIL_EXPORT KernelTimeout(absl::Duration d);
  ...
  ABSEIL_EXPORT struct timespec MakeAbsTimespec() const;
  ...
  ABSEIL_EXPORT struct timespec MakeRelativeTimespec() const;
  ...
  ABSEIL_EXPORT int64_t MakeAbsNanos() const;
  ...
  ABSEIL_EXPORT DWord InMillisecondsFromNow() const;
  ...
  ABSEIL_EXPORT std::chrono::time_point<std::chrono::system_clock> ToChronoTimePoint() const;
  ...
  ABSEIL_EXPORT std::chrono::nanoseconds ToChronoDuration() const;
 ...
 private:
  ...
  ABSEIL_EXPORT static int64_t SteadyClockNow();
  ...
  // spurious wakeup.
  ABSEIL_EXPORT int64_t InNanosecondsFromNow() const;
