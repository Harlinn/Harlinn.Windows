...
class GraphCycles {
 public:
  ...
  // the graph.
  ABSEIL_EXPORT int FindPath(GraphId source, GraphId dest, int max_path_len,
               GraphId path[]) const;
  ...
  ABSEIL_EXPORT void UpdateStackTrace(GraphId id, int priority,
  ...
  ABSEIL_EXPORT int GetStackTrace(GraphId id, void*** ptr);

  // Check internal invariants. Crashes on failure, returns true on success.
  // Expensive: should only be called from graphcycles_test.cc.
  ABSEIL_EXPORT bool CheckInvariants() const;
