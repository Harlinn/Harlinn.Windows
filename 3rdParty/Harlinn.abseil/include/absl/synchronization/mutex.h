...
class ABSL_LOCKABLE Mutex {
 ...
 private:
  ...
  // TryLock slow path.
  ABSEIL_EXPORT bool TryLockSlow();
  // ReaderTryLock slow path.
  ABSEIL_EXPORT bool ReaderTryLockSlow();
  // Common code between Await() and AwaitWithTimeout/Deadline()
  ABSEIL_EXPORT bool AwaitCommon(const Condition& cond,
                   synchronization_internal::KernelTimeout t);
  ABSEIL_EXPORT bool LockWhenCommon(const Condition& cond,
...
class Condition {
 public:
  ...
  explicit ABSEIL_EXPORT Condition(const bool* cond);
