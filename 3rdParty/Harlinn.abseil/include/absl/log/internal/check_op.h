...
ABSL_ATTRIBUTE_PURE_FUNCTION ABSEIL_EXPORT std::string* MakeCheckFailString(
...
class CheckOpMessageBuilder final {
 public:
  ...
  ABSEIL_EXPORT explicit CheckOpMessageBuilder(const char* exprtext);
  ~CheckOpMessageBuilder() = default;
  // For inserting the first variable.
  std::ostream& ForVar1() { return stream_; }
  // For inserting the second variable (adds an intermediate ` vs. `).
  ABSEIL_EXPORT std::ostream& ForVar2();
  // Get the result (inserts the closing `)`).
  ABSEIL_EXPORT std::string* NewString();
...
ABSEIL_EXPORT void MakeCheckOpValueString(std::ostream& os, char v);
ABSEIL_EXPORT void MakeCheckOpValueString(std::ostream& os, signed char v);
ABSEIL_EXPORT void MakeCheckOpValueString(std::ostream& os, unsigned char v);
ABSEIL_EXPORT void MakeCheckOpValueString(std::ostream& os, const void* p);
