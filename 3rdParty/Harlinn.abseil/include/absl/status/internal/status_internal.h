...
class StatusRep {
 public:
  ...
  ABSEIL_EXPORT void Unref() const;
  ...
  ABSEIL_EXPORT EraseResult ErasePayload(absl::string_view type_url);
  ABSEIL_EXPORT void ForEachPayload(
      absl::FunctionRef<void(absl::string_view, const absl::Cord&)> visitor)
      const;

  ABSEIL_EXPORT std::string ToString(StatusToStringMode mode) const;

  ABSEIL_EXPORT bool operator==(const StatusRep& other) const;
  ...
  ABSEIL_EXPORT absl::Nonnull<StatusRep*> CloneAndUnref() const;
...
ABSEIL_EXPORT absl::Nonnull<std::string*> MakeCheckFailString(
