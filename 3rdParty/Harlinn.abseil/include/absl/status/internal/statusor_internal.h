...
class Helper {
 public:
  ...
  ABSEIL_EXPORT static void HandleInvalidStatusCtorArg(Status*);
  ABSEIL_EXPORT ABSL_ATTRIBUTE_NORETURN static void Crash(const absl::Status& status);
};
...
ABSEIL_EXPORT ABSL_ATTRIBUTE_NORETURN void ThrowBadStatusOrAccess(absl::Status status);
