...
class Helper {
 public:
  ...
  ABSEIL_EXPORT static void HandleInvalidStatusCtorArg(absl::Nonnull<Status*>);
  ABSL_ATTRIBUTE_NORETURN ABSEIL_EXPORT static void Crash(const absl::Status& status);
};
...
ABSL_ATTRIBUTE_NORETURN ABSEIL_EXPORT void ThrowBadStatusOrAccess(absl::Status status);
