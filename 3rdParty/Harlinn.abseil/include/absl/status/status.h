...
class ABSL_ATTRIBUTE_TRIVIAL_ABI Status final {
 ...
 private:
  ...
  ABSEIL_EXPORT static absl::Nonnull<status_internal::StatusRep*> PrepareToModify(
      uintptr_t rep);
  ...
  ABSEIL_EXPORT static absl::Nonnull<const std::string*> EmptyString();
  ABSEIL_EXPORT static absl::Nonnull<const std::string*> MovedFromString();
  ...
  ABSEIL_EXPORT static std::string ToStringSlow(uintptr_t rep, StatusToStringMode mode);
...
ABSEIL_EXPORT absl::Nonnull<const char*> StatusMessageAsCStr(
