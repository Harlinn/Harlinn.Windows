...
template ABSEIL_TEMPLATE_EXPORT FindInfo find_first_non_full(const CommonFields&, size_t);

ABSEIL_EXPORT FindInfo find_first_non_full_outofline(const CommonFields& common,
                                       size_t hash) {
