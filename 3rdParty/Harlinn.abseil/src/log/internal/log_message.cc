...
template ABSEIL_TEMPLATE_EXPORT void LogMessage::CopyToEncodedBuffer<LogMessage::StringType::kLiteral>(
    absl::string_view str);
template ABSEIL_TEMPLATE_EXPORT void LogMessage::CopyToEncodedBuffer<
