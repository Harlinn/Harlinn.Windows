...
ABSEIL_EXPORT int VLogLevel(absl::string_view file, const std::vector<VModuleInfo>* infos,
...
ABSEIL_EXPORT int RegisterAndInitialize(VLogSite* v) ABSL_LOCKS_EXCLUDED(mutex) {
...
ABSEIL_EXPORT void UpdateVLogSites() ABSL_UNLOCK_FUNCTION(mutex)
