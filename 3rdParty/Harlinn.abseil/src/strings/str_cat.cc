...
// Do not call directly - these are not part of the public API.
    ABSEIL_EXPORT void STLStringAppendUninitializedAmortized(std::string* dest,
                                           size_t to_append) {
...
ABSEIL_EXPORT std::string SingleArgStrCat(int x) { return IntegerToString(x); }
ABSEIL_EXPORT std::string SingleArgStrCat(unsigned int x) { return IntegerToString(x); }
// NOLINTNEXTLINE
ABSEIL_EXPORT std::string SingleArgStrCat(long x) { return IntegerToString(x); }
// NOLINTNEXTLINE
ABSEIL_EXPORT std::string SingleArgStrCat(unsigned long x) { return IntegerToString(x); }
// NOLINTNEXTLINE
ABSEIL_EXPORT std::string SingleArgStrCat(long long x) { return IntegerToString(x); }
// NOLINTNEXTLINE
ABSEIL_EXPORT std::string SingleArgStrCat(unsigned long long x) { return IntegerToString(x); }
ABSEIL_EXPORT std::string SingleArgStrCat(float x) { return FloatToString(x); }
ABSEIL_EXPORT std::string SingleArgStrCat(double x) { return FloatToString(x); }
...
ABSEIL_EXPORT void SingleArgStrAppend(std::string& str, int x) {
  return AppendIntegerToString(str, x);
}

ABSEIL_EXPORT void SingleArgStrAppend(std::string& str, unsigned int x) {
  return AppendIntegerToString(str, x);
}

// NOLINTNEXTLINE
ABSEIL_EXPORT void SingleArgStrAppend(std::string& str, long x) {
  return AppendIntegerToString(str, x);
}

// NOLINTNEXTLINE
ABSEIL_EXPORT void SingleArgStrAppend(std::string& str, unsigned long x) {
  return AppendIntegerToString(str, x);
}

// NOLINTNEXTLINE
ABSEIL_EXPORT void SingleArgStrAppend(std::string& str, long long x) {
  return AppendIntegerToString(str, x);
}

// NOLINTNEXTLINE
ABSEIL_EXPORT void SingleArgStrAppend(std::string& str, unsigned long long x) {
  return AppendIntegerToString(str, x);
}
...
ABSEIL_EXPORT void AppendPieces(absl::Nonnull<std::string*> dest,
...
ABSEIL_EXPORT void StrAppend(absl::Nonnull<std::string*> dest, const AlphaNum& a) {
