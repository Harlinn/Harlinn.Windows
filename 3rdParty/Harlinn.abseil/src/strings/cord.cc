...
template ABSEIL_EXPORT void Cord::Append(std::string&& src);
...
template ABSEIL_EXPORT void Cord::Prepend(std::string&& src);
...
ABSEIL_EXPORT std::ostream& operator<<(std::ostream& out, const Cord& cord) {
