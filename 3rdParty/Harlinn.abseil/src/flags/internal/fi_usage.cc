...
ABSEIL_EXPORT void FlagsHelp(std::ostream& out, absl::string_view filter, HelpFormat format,
...
ABSEIL_EXPORT void SetFlagsHelpMatchSubstr(absl::string_view substr) {
  absl::MutexLock l(&help_attributes_guard);
...
ABSEIL_EXPORT void SetFlagsHelpMode(HelpMode mode) {
  absl::MutexLock l(&help_attributes_guard);
  help_mode = mode;
}
...
ABSEIL_EXPORT void SetFlagsHelpFormat(HelpFormat format) {
  absl::MutexLock l(&help_attributes_guard);
  help_format = format;
}
