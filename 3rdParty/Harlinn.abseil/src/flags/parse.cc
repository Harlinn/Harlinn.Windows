...
ABSEIL_EXPORT bool WasPresentOnCommandLine(absl::string_view flag_name) {
...
// the given flag.
ABSEIL_EXPORT std::vector<std::string> GetMisspellingHints(const absl::string_view flag) {
...
ABSEIL_EXPORT std::vector<char*> ParseCommandLineImpl(int argc, char* argv[],
...
ABSEIL_EXPORT HelpMode ParseAbseilFlagsOnlyImpl(
...
ABSEIL_EXPORT void ParseAbseilFlagsOnly(int argc, char* argv[],
                          std::vector<char*>& positional_args,
                          std::vector<UnrecognizedFlag>& unrecognized_flags) {
  auto help_mode = flags_internal::ParseAbseilFlagsOnlyImpl(
...
ABSEIL_EXPORT void ReportUnrecognizedFlags(
    const std::vector<UnrecognizedFlag>& unrecognized_flags) {
...
ABSEIL_EXPORT std::vector<char*> ParseCommandLine(int argc, char* argv[]) {
