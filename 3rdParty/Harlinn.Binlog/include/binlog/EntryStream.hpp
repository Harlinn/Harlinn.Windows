...
public:
   ...
   */
  HBINLOG_EXPORT explicit IstreamEntryStream(std::istream& input);
   ...
   */
  HBINLOG_EXPORT Range nextEntryPayload() override;
...
public:
   ...
   * as long as *this is valid.
   */
  HBINLOG_EXPORT explicit RangeEntryStream(Range input);
