 ...
 */
HBINLOG_EXPORT std::chrono::nanoseconds ticksToNanoseconds(std::uint64_t frequency, std::int64_t ticks);
 ...
 */
HBINLOG_EXPORT std::chrono::nanoseconds clockToNsSinceEpoch(const ClockSync& clockSync, std::uint64_t clockValue);
 ...
 */
HBINLOG_EXPORT void nsSinceEpochToBrokenDownTimeUTC(std::chrono::nanoseconds sinceEpoch, BrokenDownTime& dst);
