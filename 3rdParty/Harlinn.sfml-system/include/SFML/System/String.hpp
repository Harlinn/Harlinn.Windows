...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API String(char ansiChar, const std::locale& locale = std::locale());
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API String(wchar_t wideChar);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API String(Uint32 utf32Char);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API String(const char* ansiString, const std::locale& locale = std::locale());
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API String(const std::string& ansiString, const std::locale& locale = std::locale());
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API String(const wchar_t* wideString);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API String(const std::wstring& wideString);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API String(const Uint32* utf32String);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API String(const std::basic_string<Uint32>& utf32String);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API String(const String& copy);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API operator std::string() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API operator std::wstring() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API std::string toAnsiString(const std::locale& locale = std::locale()) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API std::wstring toWideString() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API std::basic_string<Uint8> toUtf8() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API std::basic_string<Uint16> toUtf16() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API std::basic_string<Uint32> toUtf32() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API String& operator =(const String& right);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API Uint32 operator [](std::size_t index) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API Uint32& operator [](std::size_t index);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API std::size_t getSize() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API bool isEmpty() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API void erase(std::size_t position, std::size_t count = 1);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API void insert(std::size_t position, const String& str);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API std::size_t find(const String& str, std::size_t start = 0) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API void replace(std::size_t position, std::size_t length, const String& replaceWith);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API void replace(const String& searchFor, const String& replaceWith);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API String substring(std::size_t position, std::size_t length = InvalidPos) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API const Uint32* getData() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API Iterator begin();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API ConstIterator begin() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API ConstIterator end() const;
