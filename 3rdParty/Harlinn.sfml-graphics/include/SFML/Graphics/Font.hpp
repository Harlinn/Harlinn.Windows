...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API Font(const Font& copy);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool loadFromFile(const std::string& filename);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool loadFromMemory(const void* data, std::size_t sizeInBytes);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool loadFromStream(InputStream& stream);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API const Info& getInfo() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API const Glyph& getGlyph(Uint32 codePoint, unsigned int characterSize, bool bold, float outlineThickness = 0) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API float getKerning(Uint32 first, Uint32 second, unsigned int characterSize) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API float getLineSpacing(unsigned int characterSize) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API float getUnderlinePosition(unsigned int characterSize) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API float getUnderlineThickness(unsigned int characterSize) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API const Texture& getTexture(unsigned int characterSize) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API Font& operator =(const Font& right);
...
private:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void cleanup();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API Glyph loadGlyph(Uint32 codePoint, unsigned int characterSize, bool bold, float outlineThickness) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API IntRect findGlyphRect(Page& page, unsigned int width, unsigned int height) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool setCurrentSize(unsigned int characterSize) const;
