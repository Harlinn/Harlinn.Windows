...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool loadFromFile(const std::string& filename, Type type);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool loadFromFile(const std::string& vertexShaderFilename, const std::string& fragmentShaderFilename);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool loadFromFile(const std::string& vertexShaderFilename, const std::string& geometryShaderFilename, const std::string& fragmentShaderFilename);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool loadFromMemory(const std::string& shader, Type type);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool loadFromMemory(const std::string& vertexShader, const std::string& fragmentShader);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool loadFromMemory(const std::string& vertexShader, const std::string& geometryShader, const std::string& fragmentShader);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool loadFromStream(InputStream& stream, Type type);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool loadFromStream(InputStream& vertexShaderStream, InputStream& fragmentShaderStream);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool loadFromStream(InputStream& vertexShaderStream, InputStream& geometryShaderStream, InputStream& fragmentShaderStream);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniform(const std::string& name, float x);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniform(const std::string& name, const Glsl::Vec2& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniform(const std::string& name, const Glsl::Vec3& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniform(const std::string& name, const Glsl::Vec4& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniform(const std::string& name, int x);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniform(const std::string& name, const Glsl::Ivec2& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniform(const std::string& name, const Glsl::Ivec3& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniform(const std::string& name, const Glsl::Ivec4& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniform(const std::string& name, bool x);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniform(const std::string& name, const Glsl::Bvec2& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniform(const std::string& name, const Glsl::Bvec3& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniform(const std::string& name, const Glsl::Bvec4& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniform(const std::string& name, const Glsl::Mat3& matrix);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniform(const std::string& name, const Glsl::Mat4& matrix);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniform(const std::string& name, const Texture& texture);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniform(const std::string& name, CurrentTextureType);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniformArray(const std::string& name, const float* scalarArray, std::size_t length);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniformArray(const std::string& name, const Glsl::Vec2* vectorArray, std::size_t length);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniformArray(const std::string& name, const Glsl::Vec3* vectorArray, std::size_t length);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniformArray(const std::string& name, const Glsl::Vec4* vectorArray, std::size_t length);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniformArray(const std::string& name, const Glsl::Mat3* matrixArray, std::size_t length);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUniformArray(const std::string& name, const Glsl::Mat4* matrixArray, std::size_t length);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API SFML_DEPRECATED void setParameter(const std::string& name, float x);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API SFML_DEPRECATED void setParameter(const std::string& name, float x, float y);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API SFML_DEPRECATED void setParameter(const std::string& name, float x, float y, float z);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API SFML_DEPRECATED void setParameter(const std::string& name, float x, float y, float z, float w);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API SFML_DEPRECATED void setParameter(const std::string& name, const Vector2f& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API SFML_DEPRECATED void setParameter(const std::string& name, const Vector3f& vector);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API SFML_DEPRECATED void setParameter(const std::string& name, const Color& color);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API SFML_DEPRECATED void setParameter(const std::string& name, const Transform& transform);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API SFML_DEPRECATED void setParameter(const std::string& name, const Texture& texture);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API SFML_DEPRECATED void setParameter(const std::string& name, CurrentTextureType);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API unsigned int getNativeHandle() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API static void bind(const Shader* shader);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API static bool isAvailable();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API static bool isGeometryAvailable();
...
private:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool compile(const char* vertexShaderCode, const char* geometryShaderCode, const char* fragmentShaderCode);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void bindTextures() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API int getUniformLocation(const std::string& name);
