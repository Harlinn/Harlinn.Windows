...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API VertexBuffer();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API explicit VertexBuffer(PrimitiveType type);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API explicit VertexBuffer(Usage usage);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API VertexBuffer(PrimitiveType type, Usage usage);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API VertexBuffer(const VertexBuffer& copy);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool create(std::size_t vertexCount);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API std::size_t getVertexCount() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool update(const Vertex* vertices);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool update(const Vertex* vertices, std::size_t vertexCount, unsigned int offset);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool update(const VertexBuffer& vertexBuffer);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API VertexBuffer& operator =(const VertexBuffer& right);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void swap(VertexBuffer& right);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setPrimitiveType(PrimitiveType type);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API PrimitiveType getPrimitiveType() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setUsage(Usage usage);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API Usage getUsage() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API static void bind(const VertexBuffer* vertexBuffer);
