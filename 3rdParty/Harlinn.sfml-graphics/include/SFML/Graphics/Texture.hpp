...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API Texture(const Texture& copy);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool create(unsigned int width, unsigned int height);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool loadFromFile(const std::string& filename, const IntRect& area = IntRect());
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool loadFromMemory(const void* data, std::size_t size, const IntRect& area = IntRect());
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool loadFromStream(InputStream& stream, const IntRect& area = IntRect());
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool loadFromImage(const Image& image, const IntRect& area = IntRect());
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API Vector2u getSize() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API Image copyToImage() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void update(const Uint8* pixels);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void update(const Uint8* pixels, unsigned int width, unsigned int height, unsigned int x, unsigned int y);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void update(const Texture& texture);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void update(const Texture& texture, unsigned int x, unsigned int y);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void update(const Image& image);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void update(const Image& image, unsigned int x, unsigned int y);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void update(const Window& window);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void update(const Window& window, unsigned int x, unsigned int y);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setSmooth(bool smooth);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool isSmooth() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setSrgb(bool sRgb);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool isSrgb() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void setRepeated(bool repeated);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool isRepeated() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API bool generateMipmap();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API Texture& operator =(const Texture& right);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void swap(Texture& right);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API static void bind(const Texture* texture, CoordinateType coordinateType = Normalized);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API static unsigned int getMaximumSize();
...
private:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API static unsigned int getValidSize(unsigned int size);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_GRAPHICS_API void invalidateMipmap();
