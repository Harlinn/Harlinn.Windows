...
// integer status.
HAOM_EXPORT void aom_film_grain_table_append(aom_film_grain_table_t *t, int64_t time_stamp,
                                 int64_t end_time,
...
HAOM_EXPORT int aom_film_grain_table_lookup(aom_film_grain_table_t *t, int64_t time_stamp,
...
HAOM_EXPORT aom_codec_err_t aom_film_grain_table_read(
...
HAOM_EXPORT aom_codec_err_t aom_film_grain_table_write(
...
HAOM_EXPORT void aom_film_grain_table_free(aom_film_grain_table_t *t) {
  aom_film_grain_table_entry_t *entry = t->head;
  while (entry) {
    aom_film_grain_table_entry_t *next = entry->next;
    aom_free(entry);
