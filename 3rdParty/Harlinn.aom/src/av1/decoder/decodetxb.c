...
HAOM_EXPORT uint8_t av1_read_coeffs_txb(const AV1_COMMON *const cm, DecoderCodingBlock *dcb,
...
HAOM_EXPORT void av1_read_coeffs_txb_facade(const AV1_COMMON *const cm,
