...
HAOM_EXPORT int av1_add_film_grain(const aom_film_grain_t *params, const aom_image_t *src,
                       aom_image_t *dst) {
  uint8_t *luma, *cb, *cr;
...
HAOM_EXPORT int av1_add_film_grain_run(const aom_film_grain_t *params, uint8_t *luma,
