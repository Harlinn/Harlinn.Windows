...
HAOM_EXPORT void av1_tile_init(TileInfo *tile, const AV1_COMMON *cm, int row, int col) {
...
HAOM_EXPORT void av1_get_tile_limits(AV1_COMMON *const cm) {
...
HAOM_EXPORT void av1_calculate_tile_cols(const SequenceHeader *const seq_params,
...
HAOM_EXPORT void av1_calculate_tile_rows(const SequenceHeader *const seq_params,
...
HAOM_EXPORT void av1_tile_set_row(TileInfo *tile, const AV1_COMMON *cm, int row) {
...
HAOM_EXPORT void av1_tile_set_col(TileInfo *tile, const AV1_COMMON *cm, int col) {
...
HAOM_EXPORT int av1_get_sb_rows_in_tile(const AV1_COMMON *cm, const TileInfo *tile) {
  return CEIL_POWER_OF_TWO(tile->mi_row_end - tile->mi_row_start,
                           cm->seq_params->mib_size_log2);
}

HAOM_EXPORT int av1_get_sb_cols_in_tile(const AV1_COMMON *cm, const TileInfo *tile) {
...
//     ...
HAOM_EXPORT bool av1_get_uniform_tile_size(const AV1_COMMON *cm, int *w, int *h) {
...
HAOM_EXPORT int av1_is_min_tile_width_satisfied(const AV1_COMMON *cm) {
