...
HAOM_EXPORT uint8_t av1_get_filter_level(const AV1_COMMON *cm,
...
HAOM_EXPORT void av1_loop_filter_init(AV1_COMMON *cm) {
...
HAOM_EXPORT void av1_loop_filter_frame_init(AV1_COMMON *cm, int plane_start,
                                int plane_end) {
...
HAOM_EXPORT void av1_filter_block_plane_vert(const AV1_COMMON *const cm,
...
HAOM_EXPORT void av1_filter_block_plane_horz(const AV1_COMMON *const cm,
                                 const MACROBLOCKD *const xd, const int plane,
                                 const MACROBLOCKD_PLANE *const plane_ptr,
                                 const uint32_t mi_row, const uint32_t mi_col) {
  const uint32_t scale_horz = plane_ptr->subsampling_x;
