...
HAOM_EXPORT const int av1_palette_color_index_context_lookup[MAX_COLOR_CONTEXT_HASH + 1] = {
  -1, -1, 0, -1, -1, 4, 3, 2, 1
};
...
HAOM_EXPORT void av1_init_mode_probs(FRAME_CONTEXT *fc) {
...
HAOM_EXPORT void av1_setup_frame_contexts(AV1_COMMON *cm) {
...
HAOM_EXPORT void av1_setup_past_independence(AV1_COMMON *cm) {
