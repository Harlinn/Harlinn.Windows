...
HAOM_EXPORT int av1_get_shear_params(WarpedMotionParams *wm) {
#ifndef NDEBUG
...
HAOM_EXPORT void highbd_warp_plane(WarpedMotionParams *wm, const uint16_t *const ref,
...
HAOM_EXPORT void warp_plane(WarpedMotionParams *wm, const uint8_t *const ref, int width,
...
HAOM_EXPORT void av1_warp_plane(WarpedMotionParams *wm, int use_hbd, int bd,
...
HAOM_EXPORT int av1_find_projection(int np, const int *pts1, const int *pts2,
                        BLOCK_SIZE bsize, int mvy, int mvx,
