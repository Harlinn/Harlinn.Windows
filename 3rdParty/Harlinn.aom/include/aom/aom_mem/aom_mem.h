...
HAOM_EXPORT void *aom_memalign(size_t align, size_t size);
HAOM_EXPORT void *aom_malloc(size_t size);
HAOM_EXPORT void *aom_calloc(size_t num, size_t size);
HAOM_EXPORT void aom_free(void *memblk);
HAOM_EXPORT void *aom_memset16(void *dest, int val, size_t length);
