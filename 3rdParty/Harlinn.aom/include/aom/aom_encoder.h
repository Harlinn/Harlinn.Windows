 ...
 */
HAOM_EXPORT aom_codec_err_t aom_codec_enc_init_ver(aom_codec_ctx_t *ctx,
 ...
 */
HAOM_EXPORT aom_codec_err_t aom_codec_enc_config_default(aom_codec_iface_t *iface,
 ...
 *     A parameter was NULL, or the usage value was not recognized.
 */
HAOM_EXPORT aom_codec_err_t aom_codec_enc_config_set(aom_codec_ctx_t *ctx,
                                         const aom_codec_enc_cfg_t *cfg);
 ...
 */
HAOM_EXPORT aom_fixed_buf_t *aom_codec_get_global_headers(aom_codec_ctx_t *ctx);
 ...
 */
HAOM_EXPORT aom_codec_err_t aom_codec_encode(aom_codec_ctx_t *ctx, const aom_image_t *img,
 ...
 *     A parameter was NULL, the image format is unsupported, etc.
 */
HAOM_EXPORT aom_codec_err_t aom_codec_set_cx_data_buf(aom_codec_ctx_t *ctx,
 ...
 *
 */
HAOM_EXPORT const aom_codec_cx_pkt_t *aom_codec_get_cx_data(aom_codec_ctx_t *ctx,
 ...
 *
 */
HAOM_EXPORT const aom_image_t *aom_codec_get_preview_frame(aom_codec_ctx_t *ctx);
