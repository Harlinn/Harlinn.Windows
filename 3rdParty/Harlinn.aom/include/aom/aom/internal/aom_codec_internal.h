...
HAOM_EXPORT int aom_codec_pkt_list_add(struct aom_codec_pkt_list *,
...
HAOM_EXPORT void aom_internal_error(struct aom_internal_error_info *info,
                        aom_codec_err_t error, const char *fmt,
                        ...) CLANG_ANALYZER_NORETURN;

HAOM_EXPORT void aom_merge_corrupted_flag(int *corrupted, int value);
#ifdef __cplusplus
}  // extern "C"
#endif
