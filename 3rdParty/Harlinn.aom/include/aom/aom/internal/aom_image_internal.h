 ...
 */
HAOM_EXPORT aom_metadata_array_t *aom_img_metadata_array_alloc(size_t sz);
 ...
 */
HAOM_EXPORT void aom_img_metadata_array_free(aom_metadata_array_t *arr);
 ...
 *         returned.
 */
HAOM_EXPORT aom_image_t *aom_img_alloc_with_cb(aom_image_t *img, aom_img_fmt_t fmt,
