 ...
 *
 */
HAOM_EXPORT int aom_codec_version(void);
 ...
 *
 */
HAOM_EXPORT const char *aom_codec_version_str(void);
 ...
 *
 */
HAOM_EXPORT const char *aom_codec_version_extra_str(void);
 ...
 *
 */
HAOM_EXPORT const char *aom_codec_build_config(void);
 ...
 *
 */
HAOM_EXPORT const char *aom_codec_error(aom_codec_ctx_t *ctx);
 ...
 */
HAOM_EXPORT const char *aom_codec_error_detail(aom_codec_ctx_t *ctx);
