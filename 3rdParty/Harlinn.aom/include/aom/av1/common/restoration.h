...
HAOM_EXPORT void av1_alloc_restoration_struct(struct AV1Common *cm, RestorationInfo *rsi,
                                  int is_uv);
HAOM_EXPORT void av1_free_restoration_struct(RestorationInfo *rst_info);

HAOM_EXPORT void av1_extend_frame(uint8_t *data, int width, int height, int stride,
                      int border_horz, int border_vert, int highbd);
HAOM_EXPORT void av1_decode_xq(const int *xqd, int *xq, const sgr_params_type *params);
 ...
 */
HAOM_EXPORT void av1_loop_restoration_filter_unit(
 ...
 * \c frame.
 */
HAOM_EXPORT void av1_loop_restoration_filter_frame(YV12_BUFFER_CONFIG *frame,
                                       struct AV1Common *cm, int optimized_lr,
                                       void *lr_ctxt);
/*!\cond */

HAOM_EXPORT void av1_loop_restoration_precal(void);
...
HAOM_EXPORT void av1_foreach_rest_unit_in_plane(const struct AV1Common *cm, int plane,
                                    rest_unit_visitor_t on_rest_unit,
...
HAOM_EXPORT int av1_loop_restoration_corners_in_sb(const struct AV1Common *cm, int plane,
                                       int mi_row, int mi_col, BLOCK_SIZE bsize,
                                       int *rcol0, int *rcol1, int *rrow0,
                                       int *rrow1);

HAOM_EXPORT void av1_loop_restoration_save_boundary_lines(const YV12_BUFFER_CONFIG *frame,
                                              struct AV1Common *cm,
                                              int after_cdef);
HAOM_EXPORT void av1_loop_restoration_filter_frame_init(AV1LrStruct *lr_ctxt,
                                            YV12_BUFFER_CONFIG *frame,
                                            struct AV1Common *cm,
                                            int optimized_lr, int num_planes);
HAOM_EXPORT void av1_loop_restoration_copy_planes(AV1LrStruct *loop_rest_ctxt,
                                      struct AV1Common *cm, int num_planes);
HAOM_EXPORT void av1_foreach_rest_unit_in_row(
...
HAOM_EXPORT void av1_get_upsampled_plane_size(const struct AV1Common *cm, int is_uv,
                                  int *plane_w, int *plane_h);
HAOM_EXPORT int av1_lr_count_units(int unit_size, int plane_size);
HAOM_EXPORT void av1_lr_sync_read_dummy(void *const lr_sync, int r, int c, int plane);
HAOM_EXPORT void av1_lr_sync_write_dummy(void *const lr_sync, int r, int c,
                             const int sb_cols, int plane);
