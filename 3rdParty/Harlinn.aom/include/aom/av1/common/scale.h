...
HAOM_EXPORT MV32 av1_scale_mv(const MV *mv, int x, int y, const struct scale_factors *sf);

HAOM_EXPORT void av1_setup_scale_factors_for_frame(struct scale_factors *sf, int other_w,
