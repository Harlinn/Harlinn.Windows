...
HAOM_EXPORT int aom_noise_strength_lut_init(aom_noise_strength_lut_t *lut, int num_points);

/*!\brief Frees the noise strength lut. */
HAOM_EXPORT void aom_noise_strength_lut_free(aom_noise_strength_lut_t *lut);
 ...
 */
HAOM_EXPORT double aom_noise_strength_lut_eval(const aom_noise_strength_lut_t *lut,
                                   double x);
 ...
 */
HAOM_EXPORT int aom_noise_strength_solver_init(aom_noise_strength_solver_t *solver,
                                   int num_bins, int bit_depth);
HAOM_EXPORT void aom_noise_strength_solver_free(aom_noise_strength_solver_t *solver);

/*!\brief Gets the x coordinate of bin i.
 *
 * \param[in]  i  The bin whose coordinate to query.
 */
HAOM_EXPORT double aom_noise_strength_solver_get_center(
 ...
 */
HAOM_EXPORT void aom_noise_strength_solver_add_measurement(
...
HAOM_EXPORT int aom_noise_strength_solver_solve(aom_noise_strength_solver_t *solver);
 ...
 */
HAOM_EXPORT int aom_noise_strength_solver_fit_piecewise(
...
HAOM_EXPORT int aom_flat_block_finder_init(aom_flat_block_finder_t *block_finder,
                               int block_size, int bit_depth, int use_highbd);
HAOM_EXPORT void aom_flat_block_finder_free(aom_flat_block_finder_t *block_finder);

/*!\brief Helper to extract a block and low order "planar" model. */
HAOM_EXPORT void aom_flat_block_finder_extract_block(
 ...
 */
HAOM_EXPORT int aom_flat_block_finder_run(const aom_flat_block_finder_t *block_finder,
 ...
 */
HAOM_EXPORT int aom_noise_model_init(aom_noise_model_t *model,
                         const aom_noise_model_params_t params);
HAOM_EXPORT void aom_noise_model_free(aom_noise_model_t *model);
 ...
 */
HAOM_EXPORT aom_noise_status_t aom_noise_model_update(
 ...
 * a shot boundary).
 */
HAOM_EXPORT void aom_noise_model_save_latest(aom_noise_model_t *noise_model);
 ...
 */
HAOM_EXPORT int aom_noise_model_get_grain_parameters(aom_noise_model_t *const noise_model,
 ...
 */
HAOM_EXPORT int aom_wiener_denoise_2d(const uint8_t *const data[3], uint8_t *denoised[3],
 ...
 */
HAOM_EXPORT int aom_denoise_and_model_run(struct aom_denoise_and_model_t *ctx,
 ...
 */
HAOM_EXPORT struct aom_denoise_and_model_t *aom_denoise_and_model_alloc(int bit_depth,
                                                            int block_size,
                                                            float noise_level);

/*!\brief Frees the denoise context allocated with aom_denoise_and_model_alloc
 */
HAOM_EXPORT void aom_denoise_and_model_free(struct aom_denoise_and_model_t *denoise_model);
