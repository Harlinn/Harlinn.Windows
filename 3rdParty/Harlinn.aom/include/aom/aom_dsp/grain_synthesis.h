 ...
 */
HAOM_EXPORT int aom_add_film_grain_run(const aom_film_grain_t *grain_params, uint8_t *luma,
 ...
 */
HAOM_EXPORT int aom_add_film_grain(const aom_film_grain_t *grain_params,
