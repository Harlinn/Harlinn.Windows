...
HAOM_EXPORT const uint8_t *aom_reader_find_begin(aom_reader *r);

HAOM_EXPORT const uint8_t *aom_reader_find_end(aom_reader *r);
...
HAOM_EXPORT uint32_t aom_reader_tell(const aom_reader *r);
