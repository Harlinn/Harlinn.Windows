...
HAOM_EXPORT void aom_noise_tx_free(struct aom_noise_tx_t *aom_noise_tx);
...
// be 32-byte aligned.
HAOM_EXPORT void aom_noise_tx_forward(struct aom_noise_tx_t *aom_noise_tx,
                          const float *data);
...
HAOM_EXPORT void aom_noise_tx_filter(struct aom_noise_tx_t *aom_noise_tx, const float *psd);
...
// aligned.
HAOM_EXPORT void aom_noise_tx_inverse(struct aom_noise_tx_t *aom_noise_tx, float *data);

// Aggregates the power of the buffered transform data into the psd buffer.
HAOM_EXPORT void aom_noise_tx_add_energy(const struct aom_noise_tx_t *aom_noise_tx,
                             float *psd);
