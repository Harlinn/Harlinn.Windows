...
HAOM_EXPORT int aom_alloc_frame_buffer(YV12_BUFFER_CONFIG *ybf, int width, int height,
...
HAOM_EXPORT int aom_realloc_frame_buffer(YV12_BUFFER_CONFIG *ybf, int width, int height,
...
HAOM_EXPORT int aom_free_frame_buffer(YV12_BUFFER_CONFIG *ybf);
 ...
 */
HAOM_EXPORT void aom_remove_metadata_from_frame_buffer(YV12_BUFFER_CONFIG *ybf);
 ...
 */
HAOM_EXPORT int aom_copy_metadata_to_frame_buffer(YV12_BUFFER_CONFIG *ybf,
