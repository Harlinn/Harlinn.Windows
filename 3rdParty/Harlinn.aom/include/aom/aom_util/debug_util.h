...
HAOM_EXPORT void aom_bitstream_queue_set_frame_write(int frame_idx);
HAOM_EXPORT int aom_bitstream_queue_get_frame_writee(void);
HAOM_EXPORT void aom_bitstream_queue_set_frame_read(int frame_idx);
HAOM_EXPORT int aom_bitstream_queue_get_frame_read(void);
