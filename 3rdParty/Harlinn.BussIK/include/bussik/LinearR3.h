...
public:
	...
	BUSSIK_EXPORT static const VectorR3 Zero;
	BUSSIK_EXPORT static const VectorR3 UnitX;
	BUSSIK_EXPORT static const VectorR3 UnitY;
	BUSSIK_EXPORT static const VectorR3 UnitZ;
	BUSSIK_EXPORT static const VectorR3 NegUnitX;
	BUSSIK_EXPORT static const VectorR3 NegUnitY;
	BUSSIK_EXPORT static const VectorR3 NegUnitZ;
...
public:
	...
	BUSSIK_EXPORT VectorR3& Set(const Quaternion&);  // Convert quat to rotation vector
	...
	BUSSIK_EXPORT double MaxAbs() const;
	...
	BUSSIK_EXPORT VectorR3& Rotate(double theta, const VectorR3& u);     // rotate around u.
	BUSSIK_EXPORT VectorR3& RotateUnitInDirection(const VectorR3& dir);  // rotate in direction dir
	VectorR3& Rotate(const Quaternion&);                   // Rotate according to quaternion

	BUSSIK_EXPORT friend ostream& operator<<(ostream& os, const VectorR3& u);
};
...
BUSSIK_EXPORT extern const VectorR3 UnitVecIR3;
BUSSIK_EXPORT extern const VectorR3 UnitVecJR3;
BUSSIK_EXPORT extern const VectorR3 UnitVecKR3;
...
public:
	...
	BUSSIK_EXPORT static const Matrix3x3 Identity;
...
public:
	...
	BUSSIK_EXPORT Matrix3x3& ReNormalize();
	BUSSIK_EXPORT VectorR3 Solve(const VectorR3&) const;  // Returns solution

	inline void Transform(VectorR3*) const;
	inline void Transform(const VectorR3& src, VectorR3* dest) const;

protected:
	BUSSIK_EXPORT void OperatorTimesEquals(const Matrix3x3&);  // Internal use only
	void SetZero();                              // Set to the zero map
};

inline VectorR3 operator*(const Matrix3x3&, const VectorR3&);

BUSSIK_EXPORT ostream& operator<<(ostream& os, const Matrix3x3& A);
...
public:
	...
	BUSSIK_EXPORT static const Matrix3x4 Identity;
...
public:
	...
	BUSSIK_EXPORT Matrix3x4& ReNormalize();
...
protected:
	void SetZero();                              // Set to the zero map
	BUSSIK_EXPORT void OperatorTimesEquals(const Matrix3x3&);  // Internal use only
	BUSSIK_EXPORT void OperatorTimesEquals(const Matrix3x4&);  // Internal use only
};

inline VectorR3 operator*(const Matrix3x4&, const VectorR3&);

BUSSIK_EXPORT ostream& operator<<(ostream& os, const Matrix3x4& A);
...
public:
	...
	BUSSIK_EXPORT double Determinant() const;             // Returns the determinant
	BUSSIK_EXPORT LinearMapR3 Inverse() const;            // Returns inverse
	BUSSIK_EXPORT LinearMapR3& Invert();                  // Converts into inverse.
	VectorR3 Solve(const VectorR3&) const;  // Returns solution
...
inline LinearMapR3 operator/(const LinearMapR3&, double);
BUSSIK_EXPORT LinearMapR3 operator*(const LinearMapR3&, const LinearMapR3&);
...
public:
	...
	BUSSIK_EXPORT AffineMapR3 Inverse() const;            // Returns inverse
	BUSSIK_EXPORT AffineMapR3& Invert();                  // Converts into inverse.
	VectorR3 Solve(const VectorR3&) const;  // Returns solution
...
BUSSIK_EXPORT AffineMapR3 operator*(const AffineMapR3&, const AffineMapR3&);
BUSSIK_EXPORT AffineMapR3 operator*(const LinearMapR3&, const AffineMapR3&);
BUSSIK_EXPORT AffineMapR3 operator*(const AffineMapR3&, const LinearMapR3&);
...
public:
	...
	BUSSIK_EXPORT RotationMapR3& Set(const Quaternion&);
	BUSSIK_EXPORT RotationMapR3& Set(const VectorR3&, double theta);  // Set rotation axis and angle
	BUSSIK_EXPORT RotationMapR3& Set(const VectorR3&, double sintheta, double costheta);
	...
	BUSSIK_EXPORT bool ToAxisAndAngle(VectorR3* u, double* theta) const;  // returns unit vector u and angle
};

BUSSIK_EXPORT RotationMapR3 operator*(const RotationMapR3&, const RotationMapR3&);
// Matrix product (composition)
...
public:
	...
	BUSSIK_EXPORT RigidMapR3& SetRotationPart(const VectorR3&, double theta);  // Set rotation axis and angle
	BUSSIK_EXPORT RigidMapR3& SetRotationPart(const VectorR3&, double sintheta, double costheta);
	...
	BUSSIK_EXPORT bool CalcGlideRotation(VectorR3* u, VectorR3* v,
...
BUSSIK_EXPORT void GetOrtho(const VectorR3& x, VectorR3& y, VectorR3& z);
// Returns a vector v orthonormal to unit vector x
BUSSIK_EXPORT void GetOrtho(const VectorR3& x, VectorR3& y);
...
BUSSIK_EXPORT RotationMapR3 VrRotate(double theta, const VectorR3& u);
BUSSIK_EXPORT RotationMapR3 VrRotate(double costheta, double sintheta, const VectorR3& u);
BUSSIK_EXPORT RotationMapR3 VrRotateAlign(const VectorR3& fromVec, const VectorR3& toVec);
BUSSIK_EXPORT RotationMapR3 RotateToMap(const VectorR3& fromVec, const VectorR3& toVec);
...
BUSSIK_EXPORT ostream& operator<<(ostream& os, const VectorR3& u);
