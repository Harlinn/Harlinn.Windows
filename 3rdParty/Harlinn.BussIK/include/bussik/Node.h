...
public:
	BUSSIK_EXPORT Node(const VectorR3&, const VectorR3&, double, Purpose, double minTheta = -PI, double maxTheta = PI, double restAngle = 0.);

	BUSSIK_EXPORT void PrintNode();
	BUSSIK_EXPORT void InitNode();
	...
	BUSSIK_EXPORT void ComputeS(void);
	BUSSIK_EXPORT void ComputeW(void);
