...
public:
	...
	BUSSIK_EXPORT static const VectorR4 Zero;
	BUSSIK_EXPORT static const VectorR4 UnitX;
	BUSSIK_EXPORT static const VectorR4 UnitY;
	BUSSIK_EXPORT static const VectorR4 UnitZ;
	BUSSIK_EXPORT static const VectorR4 UnitW;
	BUSSIK_EXPORT static const VectorR4 NegUnitX;
	BUSSIK_EXPORT static const VectorR4 NegUnitY;
	BUSSIK_EXPORT static const VectorR4 NegUnitZ;
	BUSSIK_EXPORT static const VectorR4 NegUnitW;
...
public:
	...
	BUSSIK_EXPORT VectorR4& RotateUnitInDirection(const VectorR4& dir);  // rotate in direction dir
};
...
public:
	...
	BUSSIK_EXPORT static const Matrix4x4 Identity;
...
public:
	...
	BUSSIK_EXPORT void operator*=(const Matrix4x4& B);  // Matrix product

	BUSSIK_EXPORT Matrix4x4& ReNormalize();
};
...
public:
	...
	BUSSIK_EXPORT LinearMapR4 Inverse() const;            // Returns inverse
	BUSSIK_EXPORT LinearMapR4& Invert();                  // Converts into inverse.
	BUSSIK_EXPORT VectorR4 Solve(const VectorR4&) const;  // Returns solution
...
BUSSIK_EXPORT void GetOrtho(const VectorR4& u, RotationMapR4& rotmap);
BUSSIK_EXPORT void GetOrtho(const VectorR4& u, const VectorR4& v, RotationMapR4& rotmap);
BUSSIK_EXPORT void GetOrtho(const VectorR4& u, const VectorR4& v, const VectorR4& w,
			  RotationMapR4& rotmap);
BUSSIK_EXPORT void GetOrtho(int j, RotationMapR4& rotmap);  // Mainly for internal use
...
BUSSIK_EXPORT LinearMapR4 TimesTranspose(const VectorR4& u, const VectorR4& v);  // u * v^T.
inline void TimesTranspose(const VectorR4& u, const VectorR4& v, LinearMapR4& M);

// Rotation Maps

BUSSIK_EXPORT RotationMapR4 RotateToMap(const VectorR4& fromVec, const VectorR4& toVec);
...
BUSSIK_EXPORT ostream& operator<<(ostream& os, const VectorR4& u);
