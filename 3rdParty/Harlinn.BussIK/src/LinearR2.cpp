...
BUSSIK_EXPORT const VectorR2 VectorR2::Zero(0.0, 0.0);
BUSSIK_EXPORT const VectorR2 VectorR2::UnitX(1.0, 0.0);
BUSSIK_EXPORT const VectorR2 VectorR2::UnitY(0.0, 1.0);
BUSSIK_EXPORT const VectorR2 VectorR2::NegUnitX(-1.0, 0.0);
BUSSIK_EXPORT const VectorR2 VectorR2::NegUnitY(0.0, -1.0);
