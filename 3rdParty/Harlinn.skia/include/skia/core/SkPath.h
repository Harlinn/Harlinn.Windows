...
public:
     ...
     */
    SK_API static SkPath Make(const SkPoint[],  int pointCount,
                       const uint8_t[],  int verbCount,
                       const SkScalar[], int conicWeightCount,
                       SkPathFillType, bool isVolatile = false);

    SK_API static SkPath Rect(const SkRect&, SkPathDirection = SkPathDirection::kCW,
                       unsigned startIndex = 0);
    SK_API static SkPath Oval(const SkRect&, SkPathDirection = SkPathDirection::kCW);
    SK_API static SkPath Oval(const SkRect&, SkPathDirection, unsigned startIndex);
    SK_API static SkPath Circle(SkScalar center_x, SkScalar center_y, SkScalar radius,
                         SkPathDirection dir = SkPathDirection::kCW);
    SK_API static SkPath RRect(const SkRRect&, SkPathDirection dir = SkPathDirection::kCW);
    SK_API static SkPath RRect(const SkRRect&, SkPathDirection, unsigned startIndex);
    SK_API static SkPath RRect(const SkRect& bounds, SkScalar rx, SkScalar ry,
                        SkPathDirection dir = SkPathDirection::kCW);

    SK_API static SkPath Polygon(const SkPoint pts[], int count, bool isClosed,
    ...
    */
    SK_API SkPath(const SkPath& path);
    ...
    */
    SK_API SkPath& operator=(const SkPath& path);
    ...
    */
    SK_API bool isInterpolatable(const SkPath& compare) const;
    ...
    */
    SK_API bool interpolate(const SkPath& ending, SkScalar weight, SkPath* out) const;
    ...
    */
    SK_API bool isOval(SkRect* bounds) const;
    ...
    */
    SK_API bool isRRect(SkRRect* rrect) const;
    ...
    */
    SK_API bool isLastContourClosed() const;
    ...
    */
    SK_API static bool IsLineDegenerate(const SkPoint& p1, const SkPoint& p2, bool exact);
    ...
    */
    SK_API static bool IsQuadDegenerate(const SkPoint& p1, const SkPoint& p2,
    ...
    */
    SK_API static bool IsCubicDegenerate(const SkPoint& p1, const SkPoint& p2,
    ...
    */
    SK_API bool isLine(SkPoint line[2]) const;
    ...
    */
    SK_API SkPoint getPoint(int index) const;
    ...
    */
    SK_API int getPoints(SkPoint points[], int max) const;
    ...
    */
    SK_API int getVerbs(uint8_t verbs[], int max) const;

    /** Returns the approximate byte size of the SkPath in memory.

        @return  approximate size
    */
    SK_API size_t approximateBytesUsed() const;
    ...
    */
    SK_API SkRect computeTightBounds() const;
    ...
    */
    SK_API bool conservativelyContainsRect(const SkRect& rect) const;
    ...
    */
    SK_API void incReserve(int extraPtCount);
...
private:
    ...
    */
    SK_API SkPath& moveTo(SkScalar x, SkScalar y);
    ...
    */
    SK_API SkPath& rMoveTo(SkScalar dx, SkScalar dy);
    ...
    */
    SK_API SkPath& lineTo(SkScalar x, SkScalar y);
    ...
    */
    SK_API SkPath& rLineTo(SkScalar dx, SkScalar dy);
    ...
    */
    SK_API SkPath& quadTo(SkScalar x1, SkScalar y1, SkScalar x2, SkScalar y2);
    ...
    */
    SK_API SkPath& rQuadTo(SkScalar dx1, SkScalar dy1, SkScalar dx2, SkScalar dy2);
    ...
    /** Adds conic from last point towards (x1, y1), to (x2, y2), weighted by w.
        ...
        @return    reference to SkPath
    */
    SK_API SkPath& conicTo(SkScalar x1, SkScalar y1, SkScalar x2, SkScalar y2,
                    SkScalar w);
    ...
    */
    ...
    /** Adds conic from last point towards vector (dx1, dy1), to vector (dx2, dy2),
        ...
        @return     reference to SkPath
    */
    SK_API SkPath& rConicTo(SkScalar dx1, SkScalar dy1, SkScalar dx2, SkScalar dy2,
                     SkScalar w);
    ...
    /** Adds cubic from last point towards (x1, y1), then towards (x2, y2), ending at
        ...
        @return    reference to SkPath
    */
    SK_API SkPath& cubicTo(SkScalar x1, SkScalar y1, SkScalar x2, SkScalar y2,
    ...
    */
    ...
    /** Adds cubic from last point towards vector (dx1, dy1), then towards
        ...
        @return    reference to SkPath
    */
    SK_API SkPath& rCubicTo(SkScalar dx1, SkScalar dy1, SkScalar dx2, SkScalar dy2,
    ...
    */
    SK_API SkPath& arcTo(const SkRect& oval, SkScalar startAngle, SkScalar sweepAngle, bool forceMoveTo);
    ...
    */
    SK_API SkPath& arcTo(SkScalar x1, SkScalar y1, SkScalar x2, SkScalar y2, SkScalar radius);
    ...
    */
    ...
    /** Appends arc to SkPath. Arc is implemented by one or more conics weighted to
        ...
        @return             reference to SkPath
    */
    SK_API SkPath& arcTo(SkScalar rx, SkScalar ry, SkScalar xAxisRotate, ArcSize largeArc,
    ...
    */
    ...
    /** Appends arc to SkPath, relative to last SkPath SkPoint. Arc is implemented by one or
        ...
        @return             reference to SkPath
    */
    SK_API SkPath& rArcTo(SkScalar rx, SkScalar ry, SkScalar xAxisRotate, ArcSize largeArc,
...
public:
    ...
    */
    SK_API static int ConvertConicToQuads(const SkPoint& p0, const SkPoint& p1, const SkPoint& p2,
    ...
    */
    SK_API bool isRect(SkRect* rect, bool* isClosed = nullptr, SkPathDirection* direction = nullptr) const;
...
private:
     ...
     */
    SK_API SkPath& addRect(const SkRect& rect, SkPathDirection dir, unsigned start);
    ...
    */
    SK_API SkPath& addOval(const SkRect& oval, SkPathDirection dir = SkPathDirection::kCW);
    ...
    */
    SK_API SkPath& addOval(const SkRect& oval, SkPathDirection dir, unsigned start);
    ...
    /** Adds circle centered at (x, y) of size radius to SkPath, appending kMove_Verb,
        ...
        @return        reference to SkPath
    */
    SK_API SkPath& addCircle(SkScalar x, SkScalar y, SkScalar radius,
                      SkPathDirection dir = SkPathDirection::kCW);
    ...
    */
    SK_API SkPath& addArc(const SkRect& oval, SkScalar startAngle, SkScalar sweepAngle);
    ...
    /** Appends SkRRect to SkPath, creating a new closed contour. SkRRect has bounds
        ...
        @return      reference to SkPath
    */
    SK_API SkPath& addRoundRect(const SkRect& rect, SkScalar rx, SkScalar ry,
                         SkPathDirection dir = SkPathDirection::kCW);
    ...
    /** Appends SkRRect to SkPath, creating a new closed contour. SkRRect has bounds
        ...
        @return       reference to SkPath
    */
    SK_API SkPath& addRoundRect(const SkRect& rect, const SkScalar radii[],
                         SkPathDirection dir = SkPathDirection::kCW);
    ...
    */
    SK_API SkPath& addRRect(const SkRRect& rrect, SkPathDirection dir = SkPathDirection::kCW);
    ...
    */
    SK_API SkPath& addRRect(const SkRRect& rrect, SkPathDirection dir, unsigned start);
    ...
    */
    SK_API SkPath& addPoly(const SkPoint pts[], int count, bool close);
...
public:
    ...
    */
    ...
    /** Appends src to SkPath, offset by (dx, dy).
        ...
        @return      reference to SkPath
    */
    SK_API SkPath& addPath(const SkPath& src, SkScalar dx, SkScalar dy,
    ...
    */
    ...
    /** Appends src to SkPath, transformed by matrix. Transformed curves may have different
        ...
        @return        reference to SkPath
    */
    SK_API SkPath& addPath(const SkPath& src, const SkMatrix& matrix,
                    AddPathMode mode = kAppend_AddPathMode);
    ...
    */
    SK_API SkPath& reverseAddPath(const SkPath& src);
    ...
    */
    SK_API void offset(SkScalar dx, SkScalar dy, SkPath* dst) const;
    ...
    */
    SK_API void transform(const SkMatrix& matrix, SkPath* dst,
    ...
    */
    SK_API bool getLastPt(SkPoint* lastPt) const;
    ...
    */
    SK_API void setLastPt(SkScalar x, SkScalar y);
    ...
    */
    ...
    public:
        ...
        */
        SK_API Iter(const SkPath& path, bool forceClose);
        ...
        */
        SK_API void setPath(const SkPath& path, bool forceClose);
        ...
        */
        SK_API Verb next(SkPoint pts[4]);
        ...
        */
        SK_API bool isClosedContour() const;
    ...
    private:
        ...
        SK_API Verb autoClose(SkPoint pts[2]);
    };
...
public:
    ...
    public:
        ...
        */
        ...
        /** Sets SkPath::Iter to return elements of verb array, SkPoint array, and conic weight in
            ...
            @param path  SkPath to iterate
        */
        SK_API void setPath(const SkPath&);
    ...
    */
    SK_API bool contains(SkScalar x, SkScalar y) const;
    ...
    */
    SK_API void dump(SkWStream* stream, bool dumpAsHex) const;
    ...
    SK_API void dumpArrays(SkWStream* stream, bool dumpAsHex) const;
    ...
    */
    SK_API size_t writeToMemory(void* buffer) const;
    ...
    */
    SK_API size_t readFromMemory(const void* buffer, size_t length);
...
private:
    SK_API SkPath(sk_sp<SkPathRef>, SkPathFillType, bool isVolatile, SkPathConvexity,
     ...
     */
    SK_API void resetFields();

    /** Sets all fields other than fPathRef to the values in 'that'.
     *  Assumes the caller has already set fPathRef.
     *  Doesn't change fGenerationID or fSourcePath on Android.
     */
    SK_API void copyFields(const SkPath& that);

    SK_API size_t writeToMemoryAsRRect(void* buffer) const;
    SK_API size_t readAsRRect(const void*, size_t);
    SK_API size_t readFromMemory_EQ4Or5(const void*, size_t);
    ...
    */
    SK_API SkPath& reversePathTo(const SkPath&);
    ...
    SK_API SkPathConvexity computeConvexity() const;
    ...
    // called by stroker to see if all points (in the last contour) are equal and worthy of a cap
        SK_API bool isZeroLengthSincePoint(int startPtIndex) const;
    ...
    SK_API void setPt(int index, SkScalar x, SkScalar y);

    SK_API SkPath& dirtyAfterEdit();

    // Bottlenecks for working with fConvexity and fFirstDirection.
    // Notice the setters are const... these are mutable atomic fields.
    SK_API void  setConvexity(SkPathConvexity) const;

    SK_API void setFirstDirection(SkPathFirstDirection) const;
    SK_API SkPathFirstDirection getFirstDirection() const;

    /** Returns the comvexity type, computing if needed. Never returns kUnknown.
        @return  path's convexity type (convex or concave)
    */
    SK_API SkPathConvexity getConvexity() const;
    ...
    SK_API bool isConvexityAccurate() const;
     ...
     */
    SK_API void setConvexity(SkPathConvexity convexity);
