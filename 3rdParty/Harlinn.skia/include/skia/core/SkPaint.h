...
public:
    ...
    */
    SK_API explicit SkPaint(const SkColor4f& color, SkColorSpace* colorSpace = nullptr);
    ...
    */
    SK_API SkPaint(const SkPaint& paint);
    ...
    */
    SK_API SkPaint& operator=(const SkPaint& paint);
    ...
    */
    SK_API SkPaint& operator=(SkPaint&& paint);
    ...
    */
    SK_API void setStyle(Style style);

    /**
     *  Set paint's style to kStroke if true, or kFill if false.
     */
    SK_API void setStroke(bool);
    ...
    */
    ...
    /** Sets alpha and RGB used when stroking and filling. The color is four floating
        ...
        @param colorSpace  SkColorSpace describing the encoding of color
    */
    SK_API void setColor(const SkColor4f& color, SkColorSpace* colorSpace = nullptr);
    ...
    */
    SK_API void setARGB(U8CPU a, U8CPU r, U8CPU g, U8CPU b);
    ...
    */
    SK_API void setStrokeWidth(SkScalar width);
    ...
    */
    SK_API void setStrokeMiter(SkScalar miter);
    ...
    */
    SK_API void setStrokeCap(Cap cap);
    ...
    */
    SK_API void setStrokeJoin(Join join);
    ...
    */
    SK_API bool getFillPath(const SkPath& src, SkPath* dst, const SkRect* cullRect,
    ...
    */
    SK_API sk_sp<SkShader> refShader() const;
    ...
    */
    SK_API void setShader(sk_sp<SkShader> shader);
    ...
    */
    SK_API sk_sp<SkColorFilter> refColorFilter() const;
    ...
    */
    SK_API void setColorFilter(sk_sp<SkColorFilter> colorFilter);
     ...
     *  @return  the SkBlender assigned to this paint, otherwise nullptr
     */
    SK_API sk_sp<SkBlender> refBlender() const;
     ...
     */
    SK_API void setBlender(sk_sp<SkBlender> blender);
    ...
    */
    SK_API sk_sp<SkPathEffect> refPathEffect() const;
    ...
    */
    SK_API void setPathEffect(sk_sp<SkPathEffect> pathEffect);
    ...
    */
    SK_API sk_sp<SkMaskFilter> refMaskFilter() const;
    ...
    */
    SK_API void setMaskFilter(sk_sp<SkMaskFilter> maskFilter);
    ...
    */
    SK_API sk_sp<SkImageFilter> refImageFilter() const;
    ...
    */
    SK_API void setImageFilter(sk_sp<SkImageFilter> imageFilter);
    ...
    */
    SK_API bool nothingToDraw() const;
    ...
    */
    SK_API bool canComputeFastBounds() const;
    ...
    */
    ...
    /**     (to be made private)
        ...
        @return         fast computed bounds
    */
    SK_API const SkRect& doComputeFastBounds(const SkRect& orig, SkRect* storage,
                                      Style style) const;
