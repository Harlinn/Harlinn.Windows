...
public:
    ...
    /** Returns the canvas that records the drawing commands.
        ...
        @return the canvas.
    */
    SK_API SkCanvas* beginRecording(const SkRect& bounds, sk_sp<SkBBoxHierarchy> bbh);

    SK_API SkCanvas* beginRecording(const SkRect& bounds, SkBBHFactory* bbhFactory = nullptr);
    ...
    */
    SK_API SkCanvas* getRecordingCanvas();
     ...
     *  themselves.
     */
    SK_API sk_sp<SkPicture> finishRecordingAsPicture();
     ...
     */
    SK_API sk_sp<SkPicture> finishRecordingAsPictureWithCull(const SkRect& cullRect);
     ...
     */
    SK_API sk_sp<SkDrawable> finishRecordingAsDrawable();
...
private:
    ...
    */
    ...
    SK_API void partialReplay(SkCanvas* canvas) const;
