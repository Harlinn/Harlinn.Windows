...
class SkContourMeasure : public SkRefCnt {
public:
     ...
     */
    SK_API bool SK_WARN_UNUSED_RESULT getSegment(SkScalar startD, SkScalar stopD, SkPath* dst,
...
private:
    struct Segment {
        ...
        SK_API SkScalar getScalarT() const;
    ...
    SK_API SkContourMeasure(SkTDArray<Segment>&& segs, SkTDArray<SkPoint>&& pts,
                     SkScalar length, bool isClosed);
    SK_API ~SkContourMeasure() override {}

    SK_API const Segment* distanceToSegment(SkScalar distance, SkScalar* t) const;
...
public:
     ...
     */
    SK_API SkContourMeasureIter(const SkPath& path, bool forceClosed, SkScalar resScale = 1);
    SK_API ~SkContourMeasureIter();
     ...
     *  the path after this call.
     */
    SK_API void reset(const SkPath& path, bool forceClosed, SkScalar resScale = 1);
     ...
     */
    SK_API sk_sp<SkContourMeasure> next();
