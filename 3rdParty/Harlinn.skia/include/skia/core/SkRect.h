...
#include <skia/private/SkSafe32.h>
...
struct SkIRect {
    ...
    */
    SK_API bool SK_WARN_UNUSED_RESULT intersect(const SkIRect& a, const SkIRect& b);
    ...
    */
     ...
     */
    SK_API void join(const SkIRect& r);
...
struct SkRect {
    ...
    */
    SK_API void toQuad(SkPoint quad[4]) const;
    ...
    */
    SK_API bool setBoundsCheck(const SkPoint pts[], int count);
    ...
    */
    SK_API void setBoundsNoCheck(const SkPoint pts[], int count);
    ...
    */
    SK_API bool intersect(const SkRect& r);
    ...
    /** Returns true if a intersects b, and sets SkRect to intersection.
        ...
        @return   true if a and b have area in common
    */
    SK_API bool SK_WARN_UNUSED_RESULT intersect(const SkRect& a, const SkRect& b);
...
public:
    ...
    */
    SK_API void join(const SkRect& r);
