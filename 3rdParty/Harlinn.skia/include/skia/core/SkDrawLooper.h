...
public:
     ...
     */
    SK_API virtual Context* makeContext(SkArenaAlloc*) const = 0;
     ...
     */
    SK_API bool canComputeFastBounds(const SkPaint& paint) const;
    SK_API void computeFastBounds(const SkPaint& paint, const SkRect& src, SkRect* dst) const;
     ...
     */
    SK_API virtual bool asABlurShadow(BlurShadowRec*) const;
    ...
    SK_API void apply(SkCanvas* canvas, const SkPaint& paint,
