...
public:
    ...
    SK_API SkSurfaceProps();
    SK_API SkSurfaceProps(uint32_t flags, SkPixelGeometry);

    SK_API SkSurfaceProps(const SkSurfaceProps&);
    SK_API SkSurfaceProps& operator=(const SkSurfaceProps&);
