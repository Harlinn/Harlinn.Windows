...
struct SkPoint {
    ...
    */
    SK_API bool setNormalize(SkScalar x, SkScalar y);
    ...
    */
    SK_API bool setLength(SkScalar length);
    ...
    */
    SK_API bool setLength(SkScalar x, SkScalar y, SkScalar length);
    ...
    */
    SK_API void scale(SkScalar scale, SkPoint* dst) const;
    ...
    */
    SK_API static SkScalar Length(SkScalar x, SkScalar y);
    ...
    */
    SK_API static SkScalar Normalize(SkVector* vec);
