...
#pragma warning(pop)
    ...
    */
    SK_API bool isSimilarity(SkScalar tol = SK_ScalarNearlyZero) const;
    ...
    */
    SK_API bool preservesRightAngles(SkScalar tol = SK_ScalarNearlyZero) const;
    ...
    */
    SK_API SkMatrix& set9(const SkScalar buffer[9]);
    ...
    */
    ...
    /** Sets SkMatrix to translate by (dx, dy).
        ...
        @param dy  vertical translation
    */
    SK_API SkMatrix& setTranslate(SkScalar dx, SkScalar dy);
    ...
    */
    SK_API SkMatrix& setScale(SkScalar sx, SkScalar sy, SkScalar px, SkScalar py);
    ...
    /** Sets SkMatrix to scale by sx and sy about at pivot point at (0, 0).
        ...
        @param sy  vertical scale factor
    */
    SK_API SkMatrix& setScale(SkScalar sx, SkScalar sy);
    ...
    /** Sets SkMatrix to rotate by degrees about a pivot point at (px, py).
        ...
        @param py       pivot on y-axis
    */
    SK_API SkMatrix& setRotate(SkScalar degrees, SkScalar px, SkScalar py);
    ...
    /** Sets SkMatrix to rotate by degrees about a pivot point at (0, 0).
        ...
        @param degrees  angle of axes relative to upright axes
    */
    SK_API SkMatrix& setRotate(SkScalar degrees);
    ...
    /** Sets SkMatrix to rotate by sinValue and cosValue, about a pivot point at (px, py).
        ...
        @param py        pivot on y-axis
    */
    SK_API SkMatrix& setSinCos(SkScalar sinValue, SkScalar cosValue,
    ...
    */
    SK_API SkMatrix& setRSXform(const SkRSXform& rsxForm);
    ...
    /** Sets SkMatrix to skew by kx and ky, about a pivot point at (px, py).
        ...
        @param py  pivot on y-axis
    */
    SK_API SkMatrix& setSkew(SkScalar kx, SkScalar ky, SkScalar px, SkScalar py);
    ...
    /** Sets SkMatrix to skew by kx and ky, about a pivot point at (0, 0).
        ...
        @param ky  vertical skew factor
    */
    SK_API SkMatrix& setSkew(SkScalar kx, SkScalar ky);
    ...
    */
    SK_API SkMatrix& setConcat(const SkMatrix& a, const SkMatrix& b);
    ...
    */
    SK_API SkMatrix& preTranslate(SkScalar dx, SkScalar dy);
    ...
    /** Sets SkMatrix to SkMatrix multiplied by SkMatrix constructed from scaling by (sx, sy)
        ...
        @param py  pivot on y-axis
    */
    SK_API SkMatrix& preScale(SkScalar sx, SkScalar sy, SkScalar px, SkScalar py);
    ...
    /** Sets SkMatrix to SkMatrix multiplied by SkMatrix constructed from scaling by (sx, sy)
        ...
        @param sy  vertical scale factor
    */
    SK_API SkMatrix& preScale(SkScalar sx, SkScalar sy);
    ...
    /** Sets SkMatrix to SkMatrix multiplied by SkMatrix constructed from rotating by degrees
        ...
        @param py       pivot on y-axis
    */
    SK_API SkMatrix& preRotate(SkScalar degrees, SkScalar px, SkScalar py);
    ...
    /** Sets SkMatrix to SkMatrix multiplied by SkMatrix constructed from rotating by degrees
        ...
        @param degrees  angle of axes relative to upright axes
    */
    SK_API SkMatrix& preRotate(SkScalar degrees);
    ...
    /** Sets SkMatrix to SkMatrix multiplied by SkMatrix constructed from skewing by (kx, ky)
        ...
        @param py  pivot on y-axis
    */
    SK_API SkMatrix& preSkew(SkScalar kx, SkScalar ky, SkScalar px, SkScalar py);
    ...
    /** Sets SkMatrix to SkMatrix multiplied by SkMatrix constructed from skewing by (kx, ky)
        ...
        @param ky  vertical skew factor
    */
    SK_API SkMatrix& preSkew(SkScalar kx, SkScalar ky);
    ...
    */
    SK_API SkMatrix& preConcat(const SkMatrix& other);
    ...
    */
    SK_API SkMatrix& postTranslate(SkScalar dx, SkScalar dy);
    ...
    /** Sets SkMatrix to SkMatrix constructed from scaling by (sx, sy) about pivot point
        ...
        @param py  pivot on y-axis
    */
    SK_API SkMatrix& postScale(SkScalar sx, SkScalar sy, SkScalar px, SkScalar py);
    ...
    /** Sets SkMatrix to SkMatrix constructed from scaling by (sx, sy) about pivot point
        ...
        @param sy  vertical scale factor
    */
    SK_API SkMatrix& postScale(SkScalar sx, SkScalar sy);
    ...
    /** Sets SkMatrix to SkMatrix constructed from rotating by degrees about pivot point
        ...
        @param py       pivot on y-axis
    */
    SK_API SkMatrix& postRotate(SkScalar degrees, SkScalar px, SkScalar py);
    ...
    /** Sets SkMatrix to SkMatrix constructed from rotating by degrees about pivot point
        ...
        @param degrees  angle of axes relative to upright axes
    */
    SK_API SkMatrix& postRotate(SkScalar degrees);
    ...
    /** Sets SkMatrix to SkMatrix constructed from skewing by (kx, ky) about pivot point
        ...
        @param py  pivot on y-axis
    */
    SK_API SkMatrix& postSkew(SkScalar kx, SkScalar ky, SkScalar px, SkScalar py);
    ...
    /** Sets SkMatrix to SkMatrix constructed from skewing by (kx, ky) about pivot point
        ...
        @param ky  vertical skew factor
    */
    SK_API SkMatrix& postSkew(SkScalar kx, SkScalar ky);
    ...
    */
    SK_API SkMatrix& postConcat(const SkMatrix& other);
...
private:
    ...
    */
    SK_API bool setRectToRect(const SkRect& src, const SkRect& dst, ScaleToFit stf);
...
public:
    ...
    */
    SK_API bool setPolyToPoly(const SkPoint src[], const SkPoint dst[], int count);
    ...
    */
    SK_API static void SetAffineIdentity(SkScalar affine[6]);
    ...
    */
    SK_API bool SK_WARN_UNUSED_RESULT asAffine(SkScalar affine[6]) const;
    ...
    */
    SK_API SkMatrix& setAffine(const SkScalar affine[6]);
    ...
    */
    SK_API void mapPoints(SkPoint dst[], const SkPoint src[], int count) const;
    ...
    */
    SK_API void mapHomogeneousPoints(SkPoint3 dst[], const SkPoint3 src[], int count) const;

    /**
     *  Returns homogeneous points, starting with 2D src points (with implied w = 1).
     */
    SK_API void mapHomogeneousPoints(SkPoint3 dst[], const SkPoint src[], int count) const;
    ...
    */
    SK_API void mapXY(SkScalar x, SkScalar y, SkPoint* result) const;
    ...
    */
    SK_API void mapVectors(SkVector dst[], const SkVector src[], int count) const;
    ...
    */
    SK_API bool mapRect(SkRect* dst, const SkRect& src,
    ...
    */
    SK_API void mapRectScaleTranslate(SkRect* dst, const SkRect& src) const;
    ...
    */
    SK_API SkScalar mapRadius(SkScalar radius) const;
    ...
    */
    SK_API SkScalar getMinScale() const;
    ...
    */
    SK_API SkScalar getMaxScale() const;
    ...
    */
    SK_API bool SK_WARN_UNUSED_RESULT getMinMaxScales(SkScalar scaleFactors[2]) const;
    ...
    */
    SK_API bool decomposeScale(SkSize* scale, SkMatrix* remaining = nullptr) const;
    ...
    */
    SK_API static const SkMatrix& I();
    ...
    */
    SK_API static const SkMatrix& InvalidMatrix();
...
private:
    ...
    */
    ...
    SK_API static void ComputeInv(SkScalar dst[9], const SkScalar src[9], double invDet, bool isPersp);

    SK_API uint8_t computeTypeMask() const;
    SK_API uint8_t computePerspectiveTypeMask() const;
    ...
    */
    ...
    SK_API bool SK_WARN_UNUSED_RESULT invertNonIdentity(SkMatrix* inverse) const;

    SK_API static bool Poly2Proc(const SkPoint[], SkMatrix*);
    SK_API static bool Poly3Proc(const SkPoint[], SkMatrix*);
    SK_API static bool Poly4Proc(const SkPoint[], SkMatrix*);

    SK_API static void Identity_xy(const SkMatrix&, SkScalar, SkScalar, SkPoint*);
    SK_API static void Trans_xy(const SkMatrix&, SkScalar, SkScalar, SkPoint*);
    SK_API static void Scale_xy(const SkMatrix&, SkScalar, SkScalar, SkPoint*);
    SK_API static void ScaleTrans_xy(const SkMatrix&, SkScalar, SkScalar, SkPoint*);
    SK_API static void Rot_xy(const SkMatrix&, SkScalar, SkScalar, SkPoint*);
    SK_API static void RotTrans_xy(const SkMatrix&, SkScalar, SkScalar, SkPoint*);
    SK_API static void Persp_xy(const SkMatrix&, SkScalar, SkScalar, SkPoint*);

    SK_API static const MapXYProc gMapXYProcs[];

    SK_API static void Identity_pts(const SkMatrix&, SkPoint[], const SkPoint[], int);
    SK_API static void Trans_pts(const SkMatrix&, SkPoint dst[], const SkPoint[], int);
    SK_API static void Scale_pts(const SkMatrix&, SkPoint dst[], const SkPoint[], int);
    SK_API static void ScaleTrans_pts(const SkMatrix&, SkPoint dst[], const SkPoint[],
                               int count);
    SK_API static void Persp_pts(const SkMatrix&, SkPoint dst[], const SkPoint[], int);

    SK_API static void Affine_vpts(const SkMatrix&, SkPoint dst[], const SkPoint[], int);

    SK_API static const MapPtsProc gMapPtsProcs[];
    ...
    SK_API bool postIDiv(int divx, int divy);
    SK_API void doNormalizePerspective();
