...
public:
    ...
    */
    ...
    /** Sets bounds to oval, x-axis radii to half oval.width(), and all y-axis radii
        ...
        @param oval  bounds of oval
    */
    SK_API void setOval(const SkRect& oval);
    ...
    */
    SK_API void setRectXY(const SkRect& rect, SkScalar xRad, SkScalar yRad);
    ...
    */
    SK_API void setNinePatch(const SkRect& rect, SkScalar leftRad, SkScalar topRad,
    ...
    */
    SK_API void setRectRadii(const SkRect& rect, const SkVector radii[4]);
    ...
    */
    SK_API void inset(SkScalar dx, SkScalar dy, SkRRect* dst) const;
    ...
    */
    SK_API bool transform(const SkMatrix& matrix, SkRRect* dst) const;
    ...
    */
    SK_API void dump(bool asHex) const;
    SK_API SkString dumpToString(bool asHex) const;
...
private:
    SK_API static bool AreRectAndRadiiValid(const SkRect&, const SkVector[4]);
     ...
     */
    SK_API bool initializeRect(const SkRect&);

    SK_API void computeType();
    SK_API bool checkCornerContainment(SkScalar x, SkScalar y) const;
    // Returns true if the radii had to be scaled to fit rect
    SK_API bool scaleRadii();
