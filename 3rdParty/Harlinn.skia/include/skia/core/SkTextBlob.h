...
public:
    ...
    */
     ...
     */
    SK_API int getIntercepts(const SkScalar bounds[2], SkScalar intervals[],
    ...
    */
    SK_API static sk_sp<SkTextBlob> MakeFromText(const void* text, size_t byteLength, const SkFont& font,
    ...
    */
     ...
     */
    SK_API static sk_sp<SkTextBlob> MakeFromPosTextH(const void* text, size_t byteLength,
    ...
    /** Returns a textblob built from a single run of text with positions.
        ...
        @return        new textblob or nullptr
     */
    SK_API static sk_sp<SkTextBlob> MakeFromPosText(const void* text, size_t byteLength,
                                             const SkPoint pos[], const SkFont& font,
                                             SkTextEncoding encoding = SkTextEncoding::kUTF8);

    SK_API static sk_sp<SkTextBlob> MakeFromRSXform(const void* text, size_t byteLength,
    ...
    */
    SK_API size_t serialize(const SkSerialProcs& procs, void* memory, size_t memory_size) const;
    ...
    */
    SK_API sk_sp<SkData> serialize(const SkSerialProcs& procs) const;
    ...
    */
    SK_API static sk_sp<SkTextBlob> Deserialize(const void* data, size_t size,
    ...
    public:
        ...
        SK_API bool experimentalNext(ExperimentalRun*);
...
private:
    ...
    SK_API explicit SkTextBlob(const SkRect& bounds);
    ...
    SK_API void* operator new(size_t, void* p);
...
public:
    ...
    */
    SK_API const RunBuffer& allocRun(const SkFont& font, int count, SkScalar x, SkScalar y,
    ...
    */
    SK_API const RunBuffer& allocRunPosH(const SkFont& font, int count, SkScalar y,
                                  const SkRect* bounds = nullptr);
    ...
    */
    SK_API const RunBuffer& allocRunPos(const SkFont& font, int count,
                                 const SkRect* bounds = nullptr);

    // RunBuffer.pos points to SkRSXform array
    SK_API const RunBuffer& allocRunRSXform(const SkFont& font, int count);
    ...
    */
    SK_API const RunBuffer& allocRunText(const SkFont& font, int count, SkScalar x, SkScalar y,
    ...
    */
    SK_API const RunBuffer& allocRunTextPosH(const SkFont& font, int count, SkScalar y, int textByteCount,
                                      const SkRect* bounds = nullptr);
    ...
    */
    SK_API const RunBuffer& allocRunTextPos(const SkFont& font, int count, int textByteCount,
                                     const SkRect* bounds = nullptr);

    // RunBuffer.pos points to SkRSXform array
    SK_API const RunBuffer& allocRunTextRSXform(const SkFont& font, int count, int textByteCount,
                                         const SkRect* bounds = nullptr);

private:
    SK_API void reserve(size_t size);
    SK_API void allocInternal(const SkFont& font, SkTextBlob::GlyphPositioning positioning,
                       int count, int textBytes, SkPoint offset, const SkRect* bounds);
    SK_API bool mergeRun(const SkFont& font, SkTextBlob::GlyphPositioning positioning,
                  uint32_t count, SkPoint offset);
    SK_API void updateDeferredBounds();

    SK_API static SkRect ConservativeRunBounds(const SkTextBlob::RunRecord&);
    SK_API static SkRect TightRunBounds(const SkTextBlob::RunRecord&);
