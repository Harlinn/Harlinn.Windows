...
public:
     ...
     */
    SK_API static size_t GetFontCacheLimit();
     ...
     */
    SK_API static int SetFontCacheCountLimit(int count);
     ...
     */
    SK_API static void PurgeFontCache();

    /**
     *  This function returns the memory used for temporary images and other resources.
     */
    SK_API static size_t GetResourceCacheTotalBytesUsed();
     ...
     *  exceeds this limit.
     */
    SK_API static size_t GetResourceCacheTotalByteLimit();
    SK_API static size_t SetResourceCacheTotalByteLimit(size_t newLimit);

    /**
     *  For debugging purposes, this will attempt to purge the resource cache. It
     *  does not change the limit.
     */
    SK_API static void PurgeResourceCache();
     ...
     */
    SK_API static size_t GetResourceCacheSingleAllocationByteLimit();
    SK_API static size_t SetResourceCacheSingleAllocationByteLimit(size_t newLimit);
     ...
     */
    SK_API static void PurgeAllCaches();
     ...
     */
    SK_API static void SetFlags(const char* flags);
     ...
     */
    SK_API static ImageGeneratorFromEncodedDataFactory
