...
public:
     ...
     */
    SK_API bool getPixels(const SkImageInfo& info, void* pixels, size_t rowBytes);
     ...
     *                      to queryYUVAInfo().
     */
    SK_API bool getYUVAPlanes(const SkYUVAPixmaps& yuvaPixmaps);
     ...
     */
    SK_API GrSurfaceProxyView generateTexture(GrRecordingContext*, const SkImageInfo& info,
     ...
     */
    SK_API static std::unique_ptr<SkImageGenerator> MakeFromEncoded(sk_sp<SkData>);
     ...
     *  time.
     */
    SK_API static std::unique_ptr<SkImageGenerator> MakeFromPicture(const SkISize&, sk_sp<SkPicture>,
...
protected:
    ...
    SK_API SkImageGenerator(const SkImageInfo& info, uint32_t uniqueId = kNeedNewImageUniqueID);
...
#if SK_SUPPORT_GPU
    // returns nullptr
    SK_API virtual GrSurfaceProxyView onGenerateTexture(GrRecordingContext*, const SkImageInfo&,
...
private:
    ...
    SK_API static std::unique_ptr<SkImageGenerator> MakeFromEncodedImpl(sk_sp<SkData>);
