...
public:
     ...
     */
    SK_API void draw(SkCanvas*, const SkMatrix* = nullptr);
    SK_API void draw(SkCanvas*, SkScalar x, SkScalar y);
    ...
    SK_API SkPicture* newPictureSnapshot();
     ...
     */
    SK_API uint32_t getGenerationID();
     ...
     */
    SK_API void notifyDrawingChanged();
    ...
    SK_API Factory getFactory() const override { return nullptr; }
    SK_API const char* getTypeName() const override { return nullptr; }
...
protected:
     ...
     *  onDraw().
     */
    SK_API virtual SkPicture* onNewPictureSnapshot();
