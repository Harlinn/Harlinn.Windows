...
struct SkRGBA4f {
    ...
    */
    SK_API static SkRGBA4f FromColor(SkColor color);  // impl. depends on kAT
    ...
    */
    SK_API SkColor toSkColor() const;  // impl. depends on kAT

    /** Returns closest SkRGBA4f to SkPMColor. Only allowed if SkRGBA4f is premultiplied.

        @return        SkPMColor as SkRGBA4f
    */
    SK_API static SkRGBA4f FromPMColor(SkPMColor);  // impl. depends on kAT
    ...
    */
    ...
    SK_API uint32_t toBytes_RGBA() const;
    SK_API static SkRGBA4f FromBytes_RGBA(uint32_t color);
