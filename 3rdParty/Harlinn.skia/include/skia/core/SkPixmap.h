...
public:
    ...
    */
    SK_API void reset(const SkImageInfo& info, const void* addr, size_t rowBytes);
    ...
    */
    SK_API void setColorSpace(sk_sp<SkColorSpace> colorSpace);

    /** Deprecated.
    */
    SK_API bool SK_WARN_UNUSED_RESULT reset(const SkMask& mask);
    ...
    */
    SK_API bool SK_WARN_UNUSED_RESULT extractSubset(SkPixmap* subset, const SkIRect& area) const;
    ...
    */
    SK_API bool computeIsOpaque() const;
    ...
    */
    SK_API SkColor getColor(int x, int y) const;
     ...
     */
    SK_API float getAlphaf(int x, int y) const;
    ...
    */
    ...
    /** Copies a SkRect of pixels to dstPixels. Copy starts at (srcX, srcY), and does not
        ...
        @return             true if pixels are copied to dstPixels
    */
    SK_API bool readPixels(const SkImageInfo& dstInfo, void* dstPixels, size_t dstRowBytes, int srcX,
                    int srcY) const;
    ...
    */
    SK_API bool scalePixels(const SkPixmap& dst, const SkSamplingOptions&) const;
    ...
    */
    SK_API bool erase(SkColor color, const SkIRect& subset) const;
    ...
    */
    ...
    /** Writes color to pixels bounded by subset; returns true on success.
        ...
        @return        true if pixels are changed
    */
    SK_API bool erase(const SkColor4f& color, SkColorSpace* cs, const SkIRect* subset = nullptr) const;
