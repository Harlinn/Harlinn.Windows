...
public:
    ...
    */
    SK_API SkBitmap(const SkBitmap& src);
    ...
    */
    SK_API SkBitmap& operator=(const SkBitmap& src);
    ...
    */
    SK_API SkBitmap& operator=(SkBitmap&& src);
    ...
    */
    SK_API void swap(SkBitmap& other);
    ...
    */
    SK_API bool setAlphaType(SkAlphaType alphaType);
    ...
    */
    SK_API void getBounds(SkRect* bounds) const;
    ...
    */
    SK_API void getBounds(SkIRect* bounds) const;
    ...
    */
    SK_API bool setInfo(const SkImageInfo& imageInfo, size_t rowBytes = 0);
    ...
    */
    SK_API bool SK_WARN_UNUSED_RESULT tryAllocPixelsFlags(const SkImageInfo& info, uint32_t flags);
    ...
    */
    SK_API void allocPixelsFlags(const SkImageInfo& info, uint32_t flags);
    ...
    */
    SK_API bool SK_WARN_UNUSED_RESULT tryAllocPixels(const SkImageInfo& info, size_t rowBytes);
    ...
    */
    SK_API void allocPixels(const SkImageInfo& info, size_t rowBytes);
    ...
    */
    SK_API void allocPixels(const SkImageInfo& info);
    ...
    /** Sets SkImageInfo to width, height, and native color type; and allocates
        ...
        @return          true if pixel storage is allocated
    */
    SK_API bool SK_WARN_UNUSED_RESULT tryAllocN32Pixels(int width, int height, bool isOpaque = false);
    ...
    */
    SK_API void allocN32Pixels(int width, int height, bool isOpaque = false);
    ...
    */
    SK_API bool installPixels(const SkImageInfo& info, void* pixels, size_t rowBytes,
    ...
    */
    SK_API bool installPixels(const SkPixmap& pixmap);

    /** Deprecated.
    */
    SK_API bool installMaskPixels(const SkMask& mask);
    ...
    */
    SK_API void setPixels(void* pixels);
    ...
    */
    SK_API bool SK_WARN_UNUSED_RESULT tryAllocPixels(Allocator* allocator);
    ...
    */
    SK_API void allocPixels(Allocator* allocator);
    ...
    */
    SK_API SkIPoint pixelRefOrigin() const;
    ...
    */
    SK_API void setPixelRef(sk_sp<SkPixelRef> pixelRef, int dx, int dy);
    ...
    */
    SK_API void notifyPixelsChanged() const;
    ...
    */
    SK_API void erase(SkColor c, const SkIRect& area) const;
    ...
    */
    SK_API void* getAddr(int x, int y) const;
    ...
    */
    SK_API bool extractSubset(SkBitmap* dst, const SkIRect& subset) const;
    ...
    */
    SK_API bool readPixels(const SkImageInfo& dstInfo, void* dstPixels, size_t dstRowBytes,
    ...
    */
    SK_API bool readPixels(const SkPixmap& dst, int srcX, int srcY) const;
    ...
    */
    SK_API bool writePixels(const SkPixmap& src, int dstX, int dstY);
    ...
    */
    ...
    /** Sets dst to alpha described by pixels. Returns false if dst cannot be written to
        ...
        @return           true if alpha layer was constructed in dst SkPixelRef
    */
    SK_API bool extractAlpha(SkBitmap* dst, const SkPaint* paint, Allocator* allocator,
                      SkIPoint* offset) const;
    ...
    */
    SK_API bool peekPixels(SkPixmap* pixmap) const;
    SK_API sk_sp<SkShader> makeShader(SkTileMode tmx, SkTileMode tmy, const SkSamplingOptions&,
     ...
     */
    SK_API sk_sp<SkImage> asImage() const;

    /** Asserts if internal values are illegal or inconsistent. Only available if
        SK_DEBUG is defined at compile time.
    */
    SkDEBUGCODE( SK_API void validate() const;)
    ...
    */
    ...
    public:
        ...
        */
        SK_API bool allocPixelRef(SkBitmap* bitmap) override;
    };
