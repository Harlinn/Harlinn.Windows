...
public:
    ...
    */
    SK_API int shiftPerPixel() const;
...
public:
    ...
    */
    SK_API static SkImageInfo MakeS32(int width, int height, SkAlphaType at);
    ...
    */
    SK_API size_t computeOffset(int x, int y, size_t rowBytes) const;
    ...
    */
    SK_API size_t computeByteSize(size_t rowBytes) const;
