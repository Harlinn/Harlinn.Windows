...
public:
    ...
    */
    SK_API SkRegion(const SkRegion& region);
    ...
    */
    SK_API explicit SkRegion(const SkIRect& rect);
    ...
    */
    SK_API SkRegion& operator=(const SkRegion& region);
    ...
    */
    SK_API bool operator==(const SkRegion& other) const;
    ...
    */
    SK_API void swap(SkRegion& other);
    ...
    */
    SK_API int computeRegionComplexity() const;
    ...
    */
    SK_API bool getBoundaryPath(SkPath* path) const;
    ...
    */
    SK_API bool setRect(const SkIRect& rect);
    ...
    */
    SK_API bool setRects(const SkIRect rects[], int count);
    ...
    */
    SK_API bool setRegion(const SkRegion& region);
    ...
    */
    SK_API bool setPath(const SkPath& path, const SkRegion& clip);
    ...
    */
    SK_API bool intersects(const SkIRect& rect) const;
    ...
    */
    SK_API bool intersects(const SkRegion& other) const;
    ...
    */
    SK_API bool contains(int32_t x, int32_t y) const;
    ...
    */
    SK_API bool contains(const SkIRect& other) const;
    ...
    */
    SK_API bool contains(const SkRegion& other) const;
    ...
    */
    SK_API void translate(int dx, int dy, SkRegion* dst) const;
    ...
    */
    ...
    static constexpr int kOpCnt = kLastOp + 1;
    ...
    */
    SK_API bool op(const SkIRect& rect, const SkRegion& rgn, Op op);
    ...
    */
    SK_API bool op(const SkRegion& rgn, const SkIRect& rect, Op op);
    ...
    */
    SK_API bool op(const SkRegion& rgna, const SkRegion& rgnb, Op op);
    ...
    */
    ...
    public:
        ...
        */
        SK_API Iterator(const SkRegion& region);
        ...
        */
        SK_API void reset(const SkRegion& region);
    ...
    */
    ...
    public:
        ...
        */
        SK_API Cliperator(const SkRegion& region, const SkIRect& clip);
    ...
    */
    ...
    public:
        ...
        */
        SK_API Spanerator(const SkRegion& region, int y, int left, int right);
        ...
        */
        SK_API bool next(int* left, int* right);
...
private:
    ...
    SkDEBUGCODE( SK_API void dump() const;)
     ...
     *  run data.
     */
    SK_API const RunType*  getRuns(RunType tmpStorage[], int* intervals) const;
    ...
    SK_API bool setRuns(RunType runs[], int count);

    SK_API int count_runtype_values(int* itop, int* ibot) const;

    SK_API bool isValid() const;

    SK_API static void BuildRectRuns(const SkIRect& bounds,
                              RunType runs[kRectRegionRuns]);

    // If the runs define a simple rect, return true and set bounds to that
    // rect. If not, return false and ignore bounds.
    SK_API static bool RunsAreARect(const SkRegion::RunType runs[], int count,
                             SkIRect* bounds);
     ...
     */
    SK_API static bool Oper(const SkRegion&, const SkRegion&, SkRegion::Op, SkRegion*);
