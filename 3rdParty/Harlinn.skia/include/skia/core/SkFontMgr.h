...
public:
    ...
    SK_API static SkFontStyleSet* CreateEmpty();

protected:
    SK_API SkTypeface* matchStyleCSS3(const SkFontStyle& pattern);
...
public:
    SK_API int countFamilies() const;
    SK_API void getFamilyName(int index, SkString* familyName) const;
    SK_API SkFontStyleSet* createStyleSet(int index) const;
     ...
     */
    SK_API SkFontStyleSet* matchFamily(const char familyName[]) const;
     ...
     */
    SK_API SkTypeface* matchFamilyStyle(const char familyName[], const SkFontStyle&) const;
     ...
     */
    SK_API SkTypeface* matchFamilyStyleCharacter(const char familyName[], const SkFontStyle&,
     ...
     */
    SK_API sk_sp<SkTypeface> makeFromData(sk_sp<SkData>, int ttcIndex = 0) const;
     ...
     */
    SK_API sk_sp<SkTypeface> makeFromStream(std::unique_ptr<SkStreamAsset>, int ttcIndex = 0) const;

    /* Experimental, API subject to change. */
    SK_API sk_sp<SkTypeface> makeFromStream(std::unique_ptr<SkStreamAsset>, const SkFontArguments&) const;
     ...
     *  if it is not null.
     */
    SK_API sk_sp<SkTypeface> makeFromFile(const char path[], int ttcIndex = 0) const;

    SK_API sk_sp<SkTypeface> legacyMakeTypeface(const char familyName[], SkFontStyle style) const;

    /** Return the default fontmgr. */
    SK_API static sk_sp<SkFontMgr> RefDefault();
...
private:
    ...
    SK_API static sk_sp<SkFontMgr> Factory();
