...
public:
    ...
    */
    SK_API SkFont(sk_sp<SkTypeface> typeface, SkScalar size);
    ...
    /** Constructs SkFont with default values with SkTypeface.
        ...
        @return          initialized SkFont
    */
    SK_API explicit SkFont(sk_sp<SkTypeface> typeface);
    ...
    /** Constructs SkFont with default values with SkTypeface and size in points,
        ...
        @return          initialized SkFont
    */
    SK_API SkFont(sk_sp<SkTypeface> typeface, SkScalar size, SkScalar scaleX, SkScalar skewX);
    ...
    */
    SK_API bool operator==(const SkFont& font) const;
    ...
    */
    SK_API void setForceAutoHinting(bool forceAutoHinting);

    /** Requests, but does not require, to use bitmaps in fonts instead of outlines.

        @param embeddedBitmaps  setting to use bitmaps in fonts
    */
    SK_API void setEmbeddedBitmaps(bool embeddedBitmaps);

    /** Requests, but does not require, that glyphs respect sub-pixel positioning.

        @param subpixel  setting for sub-pixel positioning
    */
    SK_API void setSubpixel(bool subpixel);
    ...
    */
    SK_API void setLinearMetrics(bool linearMetrics);

    /** Increases stroke width when creating glyph bitmaps to approximate a bold typeface.

        @param embolden  setting for bold approximation
    */
    SK_API void setEmbolden(bool embolden);
    ...
    */
    SK_API void setBaselineSnap(bool baselineSnap);
    ...
    */
    SK_API void setEdging(Edging edging);

    /** Sets level of glyph outline adjustment.
        Does not check for valid values of hintingLevel.
    */
    SK_API void setHinting(SkFontHinting hintingLevel);
    ...
    /** Returns a font with the same attributes of this font, but with the specified size.
        ...
        @return      initialized SkFont
     */
    SK_API SkFont makeWithSize(SkScalar size) const;
    ...
    */
    ...
    /** Returns SkTypeface if set, or the default typeface.
        ...
        previously set.
    */
    SK_API SkTypeface* getTypefaceOrDefault() const;
    ...
    */
    ...
    /** Increases SkTypeface SkRefCnt by one.
        ...
        previously set.
    */
    SK_API sk_sp<SkTypeface> refTypefaceOrDefault() const;
    ...
    */
    SK_API void setSize(SkScalar textSize);
    ...
    /** Sets text scale on x-axis.
        ...
        @param scaleX  text horizontal scale
    */
    SK_API void setScaleX(SkScalar scaleX);
    ...
    /** Sets text skew on x-axis.
        ...
        @param skewX  additional shear on x-axis relative to y-axis
    */
    SK_API void setSkewX(SkScalar skewX);
    ...
    */
    SK_API int textToGlyphs(const void* text, size_t byteLength, SkTextEncoding encoding,
    ...
    /** Returns glyph index for Unicode character.
        ...
        @return     glyph index
    */
    SK_API SkGlyphID unicharToGlyph(SkUnichar uni) const;

    SK_API void unicharsToGlyphs(const SkUnichar uni[], int count, SkGlyphID glyphs[]) const;
    ...
    */
    ...
    /** Returns the advance width of text.
        ...
        @return            number of glyphs represented by text of length byteLength
    */
    SK_API SkScalar measureText(const void* text, size_t byteLength, SkTextEncoding encoding,
    ...
    */
     ...
     */
    SK_API void getWidthsBounds(const SkGlyphID glyphs[], int count, SkScalar widths[], SkRect bounds[],
     ...
     */
    SK_API void getPos(const SkGlyphID glyphs[], int count, SkPoint pos[], SkPoint origin = {0, 0}) const;
     ...
     */
    SK_API void getXPos(const SkGlyphID glyphs[], int count, SkScalar xpos[], SkScalar origin = 0) const;
     ...
     */
    SK_API std::vector<SkScalar> getIntercepts(const SkGlyphID glyphs[], int count, const SkPoint pos[],
     ...
     */
    SK_API bool getPath(SkGlyphID glyphID, SkPath* path) const;
   ...
   */
    SK_API void getPaths(const SkGlyphID glyphIDs[], int count,
    ...
    */
    SK_API SkScalar getMetrics(SkFontMetrics* metrics) const;
