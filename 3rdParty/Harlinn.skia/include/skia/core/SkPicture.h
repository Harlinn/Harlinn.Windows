...
public:
    ...
    */
    SK_API static sk_sp<SkPicture> MakeFromStream(SkStream* stream,
    ...
    */
    SK_API static sk_sp<SkPicture> MakeFromData(const SkData* data,
                                         const SkDeserialProcs* procs = nullptr);
    ...
    /**
        ...
        @return       SkPicture constructed from data
    */
    SK_API static sk_sp<SkPicture> MakeFromData(const void* data, size_t size,
                                         const SkDeserialProcs* procs = nullptr);
    ...
    */
    SK_API sk_sp<SkData> serialize(const SkSerialProcs* procs = nullptr) const;
    ...
    */
    SK_API void serialize(SkWStream* stream, const SkSerialProcs* procs = nullptr) const;
    ...
    */
    SK_API static sk_sp<SkPicture> MakePlaceholder(SkRect cull);
    ...
    */
     ...
     */
    SK_API sk_sp<SkShader> makeShader(SkTileMode tmx, SkTileMode tmy, SkFilterMode mode,
...
private:
    ...
    SK_API void serialize(SkWStream*, const SkSerialProcs*, class SkRefCntSet* typefaces,
        bool textBlobsOnly=false) const;
    SK_API static sk_sp<SkPicture> MakeFromStream(SkStream*, const SkDeserialProcs*,
     ...
     */
    SK_API static bool StreamIsSKP(SkStream*, struct SkPictInfo*);
    SK_API static bool BufferIsSKP(class SkReadBuffer*, struct SkPictInfo*);
    SK_API friend bool SkPicture_StreamIsSKP(SkStream*, struct SkPictInfo*);
    ...
    SK_API static bool IsValidPictInfo(const struct SkPictInfo& info);
    SK_API static sk_sp<SkPicture> Forwardport(const struct SkPictInfo&,
                                        const class SkPictureData*,
                                        class SkReadBuffer* buffer);

    SK_API struct SkPictInfo createHeader() const;
    SK_API class SkPictureData* backport() const;
