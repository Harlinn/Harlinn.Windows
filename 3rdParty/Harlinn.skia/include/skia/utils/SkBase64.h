...
public:
    ...
    */
    SK_API static size_t Encode(const void* src, size_t length, void* dst, const char* encode = nullptr);
    ...
    */
    SK_API static Error SK_WARN_UNUSED_RESULT Decode(const void* src, size_t  srcLength,
