...
#include <skia/private/SkShadowFlags.h>
...
public:
     ...
     */
    SK_API static void DrawShadow(SkCanvas* canvas, const SkPath& path, const SkPoint3& zPlaneParams,
     ...
     */
    SK_API static bool GetLocalBounds(const SkMatrix& ctm, const SkPath& path,
     ...
     */
    SK_API static void ComputeTonalColors(SkColor inAmbientColor, SkColor inSpotColor,
