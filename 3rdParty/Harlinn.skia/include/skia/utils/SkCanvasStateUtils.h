...
public:
     ...
     */
    SK_API static SkCanvasState* CaptureCanvasState(SkCanvas* canvas);
     ...
     */
    SK_API static std::unique_ptr<SkCanvas> MakeFromCanvasState(const SkCanvasState* state);
     ...
     */
    SK_API static void ReleaseCanvasState(SkCanvasState* state);
};
