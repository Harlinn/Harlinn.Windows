...
public:
    ...
    SK_API void error(skstd::string_view msg, PositionInfo position);
     ...
     */
    SK_API void error(int line, skstd::string_view msg);
...
private:
    SK_API PositionInfo position(int offset) const;
