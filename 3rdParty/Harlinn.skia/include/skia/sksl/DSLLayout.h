...
#include <skia/sksl/DSLLayout.h>

#include <skia/private/SkSLLayout.h>
...
private:
    ...
    SK_API DSLLayout& flag(SkSL::Layout::Flag mask, const char* name, PositionInfo pos);

    SK_API DSLLayout& intValue(int* target, int value, SkSL::Layout::Flag flag, const char* name,
                        PositionInfo pos);
