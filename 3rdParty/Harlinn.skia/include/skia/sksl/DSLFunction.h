...
public:
    ...
    SK_API void define(DSLBlock block, PositionInfo pos = PositionInfo::Capture());
     ...
     * Invokes the function with the given arguments.
     */
    SK_API DSLExpression call(SkTArray<DSLWrapper<DSLExpression>> args,
            PositionInfo pos = PositionInfo::Capture());

    SK_API DSLExpression call(ExpressionArray args, PositionInfo pos = PositionInfo::Capture());
...
private:
    ...
    SK_API void init(DSLModifiers modifiers, const DSLType& returnType, skstd::string_view name,
