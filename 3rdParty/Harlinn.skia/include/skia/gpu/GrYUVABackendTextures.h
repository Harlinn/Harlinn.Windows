...
public:
     ...
     */
    SK_API GrYUVABackendTextureInfo(const SkYUVAInfo&,
    ...
    SK_API bool operator==(const GrYUVABackendTextureInfo&) const;
...
public:
    ...
    SK_API GrYUVABackendTextures(const SkYUVAInfo&,
