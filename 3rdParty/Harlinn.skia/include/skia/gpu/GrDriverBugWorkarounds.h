...
class GrDriverBugWorkarounds {
 public:
  SK_API GrDriverBugWorkarounds();
  GrDriverBugWorkarounds(const GrDriverBugWorkarounds&) = default;
  SK_API explicit GrDriverBugWorkarounds(const std::vector<int32_t>& workarounds);
  ...
  SK_API void applyOverrides(const GrDriverBugWorkarounds& workarounds);
