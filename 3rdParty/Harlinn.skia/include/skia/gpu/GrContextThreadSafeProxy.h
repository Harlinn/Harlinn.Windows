 ...
 */
class GrContextThreadSafeProxy final : public SkNVRefCnt<GrContextThreadSafeProxy> {
public:
     ...
     */
    SK_API SkSurfaceCharacterization createCharacterization(
     ...
     * The caller should check that the returned format is valid.
     */
    SK_API GrBackendFormat compressedBackendFormat(SkImage::CompressionType c) const;
    ...
    SK_API GrContextThreadSafeProxyPriv priv();
    SK_API const GrContextThreadSafeProxyPriv priv() const;  // NOLINT(readability-const-return-type)

private:
    friend class GrContextThreadSafeProxyPriv; // for ctor and hidden methods

    // DDL TODO: need to add unit tests for backend & maybe options
    SK_API GrContextThreadSafeProxy(GrBackendApi, const GrContextOptions&);

    SK_API void abandonContext();
    ...
    SK_API void init(sk_sp<const GrCaps>, sk_sp<GrThreadSafePipelineBuilder>);
