...
public:
    ...
    SK_API void init(GrVkGetProc, VkInstance, VkPhysicalDevice,
    ...
    SK_API bool hasExtension(const char[], uint32_t minVersion) const;
...
private:
    SK_API void getSpecVersions(GrVkGetProc getProc, VkInstance, VkPhysicalDevice);
