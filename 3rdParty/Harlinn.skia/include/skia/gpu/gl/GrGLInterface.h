...
public:
    SK_API GrGLInterface();

    // Validates that the GrGLInterface supports its advertised standard. This means the necessary
    // function pointers have been initialized for both the GL version and any advertised
    // extensions.
    SK_API bool validate() const;

#if GR_GL_CHECK_ERROR
    SK_API GrGLenum checkError(const char* location, const char* call) const;
    SK_API bool checkAndResetOOMed() const;
    SK_API void suppressErrorLogging();
#endif
    ...
    SK_API virtual void abandon() const;
#endif
};
