...
#ifdef SK_VULKAN
#include <skia/private/GrVkTypesPriv.h>
#endif
...
public:
    ...
    SK_API GrBackendSurfaceMutableState(const GrBackendSurfaceMutableState& that);
    SK_API GrBackendSurfaceMutableState& operator=(const GrBackendSurfaceMutableState& that);
