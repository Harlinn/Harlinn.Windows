...
public:
    ...
    SK_API static void RegisterDrawableTypes();

    SK_API static sk_sp<SkParticleDrawable> MakeCircle(int radius);
    SK_API static sk_sp<SkParticleDrawable> MakeImage(const char* imagePath, const char* imageName,
                                               int cols, int rows);
};
