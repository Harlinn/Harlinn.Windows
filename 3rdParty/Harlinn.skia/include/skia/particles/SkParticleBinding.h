...
public:
    ...
    SK_API void visitFields(SkFieldVisitor* v) override;
    ...
    SK_API static void RegisterBindingTypes();
    ...
    SK_API static sk_sp<SkParticleBinding> MakeImage(const char* name,
    ...
    SK_API static sk_sp<SkParticleBinding> MakePath(const char* name,
