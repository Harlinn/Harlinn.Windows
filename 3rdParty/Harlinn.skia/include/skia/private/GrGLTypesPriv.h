...
public:
    ...
    struct SamplerOverriddenState {
        SK_API SamplerOverriddenState();
        SK_API void invalidate();
    ...
    // objects.
    SK_API void set(const SamplerOverriddenState* samplerState,
...
public:
    ...
    SK_API void cleanup();
    SK_API void assign(const GrGLBackendTextureInfo&, bool thisIsValid);
...
SK_API GrGLSurfaceInfo GrGLTextureSpecToSurfaceInfo(const GrGLTextureSpec& glSpec,
