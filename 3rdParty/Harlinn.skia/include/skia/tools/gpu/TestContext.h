...
#include "skia/tools/gpu/FenceSync.h"
...
public:
    ...
    SK_API void makeNotCurrent() const;
    SK_API void makeCurrent() const;
     ...
     */
    SK_API SkScopeExit SK_WARN_UNUSED_RESULT makeCurrentAndAutoRestore() const;

    virtual GrBackendApi backend() = 0;

    SK_API virtual sk_sp<GrDirectContext> makeContext(const GrContextOptions&);
     ...
     */
    SK_API void flushAndWaitOnSync(GrDirectContext* context);
     ...
     */
    SK_API virtual void testAbandon();
