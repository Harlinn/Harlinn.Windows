...
public:
    ...
    SK_API sk_sp<SkData> load(const SkData& key) override;
    SK_API void store(const SkData& key, const SkData& data, const SkString& description) override;
    ...
    SK_API void writeShadersToDisk(const char* path, GrBackendApi backend);
