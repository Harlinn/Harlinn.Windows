...
SK_API std::tuple<std::array<sk_sp<SkImage>, SkYUVAInfo::kMaxPlanes>, SkYUVAInfo>
...
public:
    ...
    SK_API static std::unique_ptr<LazyYUVImage> Make(sk_sp<SkData> data,
                                              GrMipmapped = GrMipmapped::kNo,
                                              sk_sp<SkColorSpace> = nullptr);
    SK_API static std::unique_ptr<LazyYUVImage> Make(SkYUVAPixmaps,
                                              GrMipmapped = GrMipmapped::kNo,
                                              sk_sp<SkColorSpace> = nullptr);
    ...
    SK_API sk_sp<SkImage> refImage(GrRecordingContext* rContext, Type);
...
private:
    ...
    SK_API bool reset(sk_sp<SkData> data, GrMipmapped, sk_sp<SkColorSpace>);
    SK_API bool reset(SkYUVAPixmaps pixmaps, GrMipmapped, sk_sp<SkColorSpace>);

    SK_API bool ensureYUVImage(GrRecordingContext* rContext, Type type);
};
