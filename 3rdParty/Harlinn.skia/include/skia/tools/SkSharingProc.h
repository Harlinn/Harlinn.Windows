...
struct SkSharingSerialContext {
    ...
    SK_API static void collectNonTextureImagesFromPicture(
    ...
    SK_API static sk_sp<SkData> serializeImage(SkImage* img, void* ctx);
};
...
struct SkSharingDeserialContext {
    ...
    SK_API static sk_sp<SkImage> deserializeImage(const void* data, size_t length, void* ctx);
};
