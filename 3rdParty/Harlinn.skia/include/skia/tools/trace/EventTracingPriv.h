 ...
 */
SK_API void initializeEventTracingForTools(const char* mode = nullptr);
...
public:
    ...
    SK_API uint8_t*    getCategoryGroupEnabled(const char* name);
    SK_API const char* getCategoryGroupName(const uint8_t* categoryEnabledFlag);
