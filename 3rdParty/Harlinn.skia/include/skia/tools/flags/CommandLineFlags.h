...
#define SK_COMMAND_LINE_API SK_API
...
public:
    ...
    */
    SK_API static bool ShouldSkip(const SkTDArray<const char*>& strings, const char* name);
    SK_API static bool ShouldSkip(const StringArray& strings, const char* name);

private:
    SK_API static SkFlagInfo* gHead;
    SK_API static SkString    gUsage;
...
#define DEFINE_SK_API_bool(name, defaultValue, helpString)            \
    SK_COMMAND_LINE_API bool FLAGS_##name;                            \
    SK_UNUSED static bool unused_##name = SkFlagInfo::CreateBoolFlag( \
            TO_STRING(name), nullptr, &FLAGS_##name, defaultValue, helpString)
...
#define DEFINE_SK_API_bool2(name, shortName, defaultValue, helpString)       \
    SK_COMMAND_LINE_API bool FLAGS_##name;                               \
    SK_UNUSED static bool unused_##name = SkFlagInfo::CreateBoolFlag( \
            TO_STRING(name), TO_STRING(shortName), &FLAGS_##name, defaultValue, helpString)
...
#define DECLARE_SK_API_bool(name) extern SK_COMMAND_LINE_API bool FLAGS_##name;
...
#define DEFINE_SK_API_string(name, defaultValue, helpString)        \
    SK_COMMAND_LINE_API CommandLineFlags::StringArray FLAGS_##name; \
    SK_UNUSED static bool         unused_##name = SkFlagInfo::CreateStringFlag( \
            TO_STRING(name), nullptr, &FLAGS_##name, defaultValue, helpString, nullptr)
...
#define DEFINE_SK_API_extended_string(name, defaultValue, helpString, extendedHelpString) \
    SK_COMMAND_LINE_API CommandLineFlags::StringArray FLAGS_##name;  \
    SK_UNUSED static bool         unused_##name = SkFlagInfo::CreateStringFlag(    \
            TO_STRING(name), nullptr, &FLAGS_##name, defaultValue, helpString, extendedHelpString)
...
#define DEFINE_SK_API_string2(name, shortName, defaultValue, helpString)                             \
    SK_COMMAND_LINE_API CommandLineFlags::StringArray FLAGS_##name;                                  \
    SK_UNUSED static bool         unused_##name = SkFlagInfo::CreateStringFlag(TO_STRING(name),      \
                                                                       TO_STRING(shortName), \
                                                                       &FLAGS_##name,        \
...
#define DECLARE_SK_API_string(name) extern SK_COMMAND_LINE_API CommandLineFlags::StringArray FLAGS_##name;
...
#define DEFINE_SK_API_int(name, defaultValue, helpString) \
    SK_COMMAND_LINE_API int FLAGS_##name; \
    SK_UNUSED static bool unused_##name = \
            SkFlagInfo::CreateIntFlag(TO_STRING(name), &FLAGS_##name, defaultValue, helpString)
...
#define DEFINE_SK_API_int_2(name, shortName, defaultValue, helpString)      \
    SK_COMMAND_LINE_API int FLAGS_##name; \
    SK_UNUSED static bool unused_##name = SkFlagInfo::CreateIntFlag( \
            TO_STRING(name), TO_STRING(shortName), &FLAGS_##name, defaultValue, helpString)
...
#define DECLARE_SK_API_int(name) extern SK_COMMAND_LINE_API int FLAGS_##name;
...
#define DEFINE_SK_API_double(name, defaultValue, helpString) \
    SK_COMMAND_LINE_API double FLAGS_##name; \
    SK_UNUSED static bool unused_##name = \
            SkFlagInfo::CreateDoubleFlag(TO_STRING(name), &FLAGS_##name, defaultValue, helpString)

#define DECLARE_double(name) extern double FLAGS_##name;

#define DECLARE_SK_API_double(name) extern SK_COMMAND_LINE_API double FLAGS_##name;
...
public:
     ...
     */
    SK_API static bool CreateStringFlag(const char*                    name,
                                 const char*                    shortName,
     ...
     *      --name=FALSE
     */
    SK_API bool match(const char* string);
...
private:
     ...
     *      individually.
     */
    SK_API static void SetDefaultStrings(CommandLineFlags::StringArray* array, const char* defaultStrings);
