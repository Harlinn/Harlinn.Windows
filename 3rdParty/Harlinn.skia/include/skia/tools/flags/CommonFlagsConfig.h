...
public:
    SK_API SkCommandLineConfig(const SkString&           tag,
                        const SkString&           backend,
                        const SkTArray<SkString>& viaParts);
    SK_API virtual ~SkCommandLineConfig();
...
public:
    ...
    SK_API SkCommandLineConfigGpu(const SkString&           tag,
                           const SkTArray<SkString>& viaParts,
...
public:
    SK_API SkCommandLineConfigSvg(const SkString& tag, const SkTArray<SkString>& viaParts, int pageIndex);
...
SK_API void ParseConfigs(const CommandLineFlags::StringArray& configList,
