...
public:
    SK_API UrlDataManager(SkString rootUrl);
     ...
     */
    SK_API SkString addData(SkData*, const char* contentType);
     ...
     * Use only once.
     */
    SK_API void indexImages(const std::vector<sk_sp<SkImage>>&);
     ...
     */
    SK_API int lookupImage(const SkImage*);
