...
public:
    ...
    SK_API const SkRect& revalidate(InvalidationController*, const SkMatrix&);
...
protected:
    ...
    SK_API explicit Node(uint32_t invalTraits);
    SK_API ~Node() override;
    ...
    SK_API void invalidate(bool damage = true);
    ...
    SK_API void observeInval(const sk_sp<Node>&);
    SK_API void unobserveInval(const sk_sp<Node>&);
...
private:
    ...
    void forEachInvalObserver(Func&& func ) const
    {
