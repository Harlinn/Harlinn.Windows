...
protected:
    SK_API sk_sp<SkShader> onRevalidateShader() final;

    SK_API virtual sk_sp<SkShader> onMakeShader(const std::vector<SkColor4f>& colors,
...
protected:
    SK_API sk_sp<SkShader> onMakeShader(const std::vector<SkColor4f>&,
