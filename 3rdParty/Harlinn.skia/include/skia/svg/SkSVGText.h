...
public:
    SK_API void renderText(const SkSVGRenderContext&, SkSVGTextContext*, SkSVGXmlSpace) const;
...
public:
    ...
    SVG_ATTR(XmlSpace, SkSVGXmlSpace, SkSVGXmlSpace::kDefault)
        ...
        SK_API void appendChild(sk_sp<SkSVGNode>) final;

protected:
    explicit SkSVGTextContainer(SkSVGTag t) : INHERITED(t) {}

    SK_API void onShapeText(const SkSVGRenderContext&, SkSVGTextContext*, SkSVGXmlSpace) const override;
