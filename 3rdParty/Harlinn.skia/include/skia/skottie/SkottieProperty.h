...
#include "src/skottie/text/SkottieShaper.h"
...
public:
    ...
    SK_API ~PropertyHandle();

    SK_API ValueT get() const;
    SK_API void set(const ValueT&);
...
public:
    ...
    SK_API virtual void onColorProperty    (const char node_name[],
                                     const LazyHandle<ColorPropertyHandle>&);
    SK_API virtual void onOpacityProperty  (const char node_name[],
                                     const LazyHandle<OpacityPropertyHandle>&);
    SK_API virtual void onTextProperty     (const char node_name[],
                                     const LazyHandle<TextPropertyHandle>&);
    SK_API virtual void onTransformProperty(const char node_name[],
                                     const LazyHandle<TransformPropertyHandle>&);
    SK_API virtual void onEnterNode(const char node_name[], NodeType node_type);
    SK_API virtual void onLeavingNode(const char node_name[], NodeType node_type);
};
