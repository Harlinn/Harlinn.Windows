...
public:
     ...
     */
    SK_API static sk_sp<SkImageFilter> AlphaThreshold(const SkRegion& region, SkScalar innerMin,
     ...
     */
    SK_API static sk_sp<SkImageFilter> Arithmetic(SkScalar k1, SkScalar k2, SkScalar k3, SkScalar k4,
     ...
     */
    SK_API static sk_sp<SkImageFilter> Blend(SkBlendMode mode, sk_sp<SkImageFilter> background,
     ...
     *  @cropRect         Optional rectangle to crop input and output.
     */
    SK_API static sk_sp<SkImageFilter> Blend(sk_sp<SkBlender> blender, sk_sp<SkImageFilter> background,
                                      sk_sp<SkImageFilter> foreground = nullptr,
                                      const CropRect& cropRect = {});
     ...
     *  @param cropRect Optional rectangle that crops the input and output.
     */
    SK_API static sk_sp<SkImageFilter> Blur(SkScalar sigmaX, SkScalar sigmaY, SkTileMode tileMode,
     ...
     *  @param cropRect Optional rectangle that crops the input and output.
     */
    SK_API static sk_sp<SkImageFilter> ColorFilter(sk_sp<SkColorFilter> cf, sk_sp<SkImageFilter> input,
                                            const CropRect& cropRect = {});
     ...
     */
    SK_API static sk_sp<SkImageFilter> Compose(sk_sp<SkImageFilter> outer, sk_sp<SkImageFilter> inner);
     ...
     */
    SK_API static sk_sp<SkImageFilter> DisplacementMap(SkColorChannel xChannelSelector,
     ...
     *  @param cropRect Optional rectangle that crops the input and output.
     */
    SK_API static sk_sp<SkImageFilter> DropShadow(SkScalar dx, SkScalar dy,
     ...
     *  @param cropRect Optional rectangle that crops the input and output.
     */
    SK_API static sk_sp<SkImageFilter> DropShadowOnly(SkScalar dx, SkScalar dy,
                                               SkScalar sigmaX, SkScalar sigmaY,
                                               SkColor color, sk_sp<SkImageFilter> input,
                                               const CropRect& cropRect = {});
     ...
     */
    SK_API static sk_sp<SkImageFilter> Image(sk_sp<SkImage> image, const SkRect& srcRect,
     ...
     *  @param cropRect Optional rectangle that crops the input and output.
     */
    SK_API static sk_sp<SkImageFilter> Magnifier(const SkRect& srcRect, SkScalar inset,
     ...
     */
    SK_API static sk_sp<SkImageFilter> MatrixConvolution(const SkISize& kernelSize,
     ...
     */
    SK_API static sk_sp<SkImageFilter> MatrixTransform(const SkMatrix& matrix,
     ...
     */
    SK_API static sk_sp<SkImageFilter> Merge(sk_sp<SkImageFilter>* const filters, int count,
                                      const CropRect& cropRect = {});
    /**
     ...
     */
    SK_API static sk_sp<SkImageFilter> Offset(SkScalar dx, SkScalar dy, sk_sp<SkImageFilter> input,
                                       const CropRect& cropRect = {});
     ...
     */
    SK_API static sk_sp<SkImageFilter> Paint(const SkPaint& paint, const CropRect& cropRect = {});
     ...
     */
    SK_API static sk_sp<SkImageFilter> Picture(sk_sp<SkPicture> pic, const SkRect& targetRect);
    ...
    SK_API static sk_sp<SkImageFilter> Shader(sk_sp<SkShader> shader, Dither dither,
                                       const CropRect& cropRect = {});
     ...
     */
    SK_API static sk_sp<SkImageFilter> Tile(const SkRect& src, const SkRect& dst,
                                     sk_sp<SkImageFilter> input);
     ...
     *  @param cropRect Optional rectangle that crops the input and output.
     */
    SK_API static sk_sp<SkImageFilter> Dilate(SkScalar radiusX, SkScalar radiusY,
                                       sk_sp<SkImageFilter> input,
                                       const CropRect& cropRect = {});
     ...
     *  @param cropRect Optional rectangle that crops the input and output.
     */
    SK_API static sk_sp<SkImageFilter> Erode(SkScalar radiusX, SkScalar radiusY,
                                      sk_sp<SkImageFilter> input,
                                      const CropRect& cropRect = {});
     ...
     *  @param cropRect     Optional rectangle that crops the input and output.
     */
    SK_API static sk_sp<SkImageFilter> DistantLitDiffuse(const SkPoint3& direction, SkColor lightColor,
     ...
     *  @param cropRect     Optional rectangle that crops the input and output.
     */
    SK_API static sk_sp<SkImageFilter> PointLitDiffuse(const SkPoint3& location, SkColor lightColor,
                                                SkScalar surfaceScale, SkScalar kd,
                                                sk_sp<SkImageFilter> input,
                                                const CropRect& cropRect = {});
    /**
     ...
     *  @param cropRect        Optional rectangle that crops the input and output.
     */
    SK_API static sk_sp<SkImageFilter> SpotLitDiffuse(const SkPoint3& location, const SkPoint3& target,
     ...
     *  @param cropRect     Optional rectangle that crops the input and output.
     */
    SK_API static sk_sp<SkImageFilter> DistantLitSpecular(const SkPoint3& direction, SkColor lightColor,
     ...
     *  @param cropRect     Optional rectangle that crops the input and output.
     */
    SK_API static sk_sp<SkImageFilter> PointLitSpecular(const SkPoint3& location, SkColor lightColor,
                                                 SkScalar surfaceScale, SkScalar ks,
                                                 SkScalar shininess, sk_sp<SkImageFilter> input,
                                                 const CropRect& cropRect = {});
    /**
     ...
     *  @param cropRect        Optional rectangle that crops the input and output.
     */
    SK_API static sk_sp<SkImageFilter> SpotLitSpecular(const SkPoint3& location, const SkPoint3& target,
                                                SkScalar falloffExponent, SkScalar cutoffAngle,
                                                SkColor lightColor, SkScalar surfaceScale,
