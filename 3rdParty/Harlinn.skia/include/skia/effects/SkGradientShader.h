...
public:
    ...
    /** Returns a shader that generates a linear gradient between the two specified points.
        ...
        example: https://fiddle.skia.org/c/@GradientShader_MakeLinear
    */
    SK_API static sk_sp<SkShader> MakeLinear(const SkPoint pts[2],
    ...
    */
    ...
    /** Returns a shader that generates a radial gradient given the center and radius.
        ...
        @param  mode    The tiling mode
    */
    SK_API static sk_sp<SkShader> MakeRadial(const SkPoint& center, SkScalar radius,
                                      const SkColor colors[], const SkScalar pos[], int count,
                                      SkTileMode mode,
                                      uint32_t flags, const SkMatrix* localMatrix);
    ...
    */
     ...
     */
    SK_API static sk_sp<SkShader> MakeTwoPointConical(const SkPoint& start, SkScalar startRadius,
    ...
    */
    SK_API static sk_sp<SkShader> MakeSweep(SkScalar cx, SkScalar cy,
                                     const SkColor colors[], const SkScalar pos[], int count,
                                     SkTileMode mode,
