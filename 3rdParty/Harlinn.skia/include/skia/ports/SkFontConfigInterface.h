...
public:
     ...
     */
    SK_API static sk_sp<SkFontConfigInterface> RefGlobal();

    /**
     *  Replace the current global instance with the specified one.
     */
    SK_API static void SetGlobal(sk_sp<SkFontConfigInterface> fc);
    ...
    struct FontIdentity {
        ...
        SK_API size_t writeToMemory(void* buffer = nullptr) const;
     ...
     */
    SK_API static SkFontConfigInterface* GetSingletonDirectInterface();
