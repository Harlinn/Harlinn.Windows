...
public:
     ...
     */
    SK_API static std::unique_ptr<SkAndroidCodec> MakeFromCodec(std::unique_ptr<SkCodec>);
     ...
     */
    SK_API static std::unique_ptr<SkAndroidCodec> MakeFromStream(std::unique_ptr<SkStream>,
     ...
     *  See SkCodec.h for more details.
     */
    SK_API static std::unique_ptr<SkAndroidCodec> MakeFromData(sk_sp<SkData>, SkPngChunkReader* = nullptr);

    SK_API virtual ~SkAndroidCodec();
    ...
    SK_API const SkImageInfo& getInfo() const { return fInfo; }
     ...
     */
    SK_API SkColorType computeOutputColorType(SkColorType requestedColorType);
     ...
     */
    SK_API SkAlphaType computeOutputAlphaType(bool requestedUnpremul);
     ...
     */
    SK_API sk_sp<SkColorSpace> computeOutputColorSpace(SkColorType outputColorType,
     ...
     *      to the output |size|.
     */
    SK_API int computeSampleSize(SkISize* size) const;
     ...
     *  original dimension.
     */
    SK_API SkISize getSampledDimensions(int sampleSize) const;
     ...
     */
    SK_API bool getSupportedSubset(SkIRect* desiredSubset) const;
     ...
     */
    SK_API SkISize getSampledSubsetDimensions(int sampleSize, const SkIRect& subset) const;
    ...
    SK_API SkCodec::Result getAndroidPixels(const SkImageInfo& info, void* pixels, size_t rowBytes,
