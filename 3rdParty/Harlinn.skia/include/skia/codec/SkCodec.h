...
public:
     ...
     */
    SK_API static const char* ResultToString(Result);
     ...
     */
    SK_API static std::unique_ptr<SkCodec> MakeFromStream(
     ...
     *      will not be used or modified.
     */
    SK_API static std::unique_ptr<SkCodec> MakeFromData(sk_sp<SkData>, SkPngChunkReader* = nullptr);

    SK_API virtual ~SkCodec();
     ...
     */
    SK_API Result getPixels(const SkImageInfo& info, void* pixels, size_t rowBytes, const Options*);
     ...
     */
    SK_API std::tuple<sk_sp<SkImage>, SkCodec::Result> getImage(const SkImageInfo& info,
                                                         const Options* opts = nullptr);
    SK_API std::tuple<sk_sp<SkImage>, SkCodec::Result> getImage();
     ...
     */
    SK_API bool queryYUVAInfo(const SkYUVAPixmapInfo::SupportedDataTypes& supportedDataTypes,
     ...
     *                      to queryYUVAInfo().
     */
    SK_API Result getYUVAPlanes(const SkYUVAPixmaps& yuvaPixmaps);
     ...
     */
    SK_API Result startIncrementalDecode(const SkImageInfo& dstInfo, void* dst, size_t rowBytes,
            const Options*);
     ...
     *  @return Enum representing success or reason for failure.
     */
    SK_API Result startScanlineDecode(const SkImageInfo& dstInfo, const Options* options);
     ...
     *      default value.
     */
    SK_API int getScanlines(void* dst, int countLines, size_t rowBytes);
     ...
     */
    SK_API bool skipScanlines(int countLines);
     ...
     */
    SK_API int outputScanline(int inputScanline) const;
     ...
     */
    SK_API std::vector<FrameInfo> getFrameInfo();
...
protected:
     ...
     */
    SK_API bool SK_WARN_UNUSED_RESULT rewindIfNeeded();
    ...
    SK_API virtual int onOutputScanline(int inputScanline) const;
     ...
     */
    SK_API virtual bool conversionSupported(const SkImageInfo& dst, bool srcIsOpaque,
    ...
    SK_API void applyColorXform(void* dst, const void* src, int count) const;
...
private:
    ...
    SK_API bool initializeColorXform(const SkImageInfo& dstInfo, SkEncodedInfo::Alpha, bool srcIsOpaque);
     ...
     *  it.
     */
    SK_API Result handleFrameIndex(const SkImageInfo&, void* pixels, size_t rowBytes, const Options&,
     ...
     */
    SK_API void fillIncompleteImage(const SkImageInfo& dstInfo, void* dst, size_t rowBytes,
