...
public:
    ...
    SKUNICODE_API static void ReorderVisual(const Level runLevels[], int levelsCount, int32_t logicalFromVisual[]);
};
...
class SkUnicode {
    public:
        ...
        SKUNICODE_API static std::unique_ptr<SkUnicode> Make();
};
