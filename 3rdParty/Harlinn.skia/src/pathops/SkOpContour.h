...
public:
...
#if DEBUG_COIN
    SK_API void debugMissingCoincidence(SkPathOpsDebug::GlitchLog* log) const;
    SK_API void debugMoveMultiples(SkPathOpsDebug::GlitchLog* ) const;
    SK_API void debugMoveNearby(SkPathOpsDebug::GlitchLog* log) const;
#endif
    ...
    SK_API void dumpContours() const;
    SK_API void dumpContoursAll() const;
    SK_API void dumpContoursAngles() const;
    SK_API void dumpContoursPts() const;
    SK_API void dumpContoursPt(int segmentID) const;
    SK_API void dumpContoursSegment(int segmentID) const;
    SK_API void dumpContoursSpan(int segmentID) const;
    SK_API void dumpContoursSpans() const;
    SK_API void dumpPt(int ) const;
    SK_API void dumpPts(const char* prefix = "seg") const;
    SK_API void dumpPtsX(const char* prefix) const;
    SK_API void dumpSegment(int ) const;
    SK_API void dumpSegments(const char* prefix = "seg", SkPathOp op = (SkPathOp) -1) const;
    SK_API void dumpSpan(int ) const;
    SK_API void dumpSpans() const;
...
//        SkASSERT(!fNext == !!contour);
    ...
    SK_API void toReversePath( SkPathWriter* path ) const;
    SK_API void toPath( SkPathWriter* path ) const;
...
public:
    ...
    SK_API void addConic(SkPoint pts[3], SkScalar weight);
    SK_API void addCubic(SkPoint pts[4]);
    SK_API void addCurve(SkPath::Verb verb, const SkPoint pts[4], SkScalar weight = 1);
    SK_API void addLine(const SkPoint pts[2]);
    SK_API void addQuad(SkPoint pts[3]);
    SK_API void flush();
