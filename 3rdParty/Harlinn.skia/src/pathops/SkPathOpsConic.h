...
struct SkDConic {
    ...
    SK_API void debugSet(const SkDPoint* pts, SkScalar weight);
    ...
    SK_API static int FindExtrema(const double src[], SkScalar weight, double tValue[1]);
    ...
    SK_API bool hullIntersects(const SkDCubic& cubic, bool* isLinear) const;
    ...
    SK_API SkDConic subDivide(double t1, double t2) const;
    ...
    SK_API SkDPoint subDivide(const SkDPoint& a, const SkDPoint& c, double t1, double t2,
