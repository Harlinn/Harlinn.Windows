...
struct SkDCurve {
    ...
    SK_API SkDPoint conicTop(const SkPoint curve[3], SkScalar curveWeight,
                      double s, double e, double* topT);
    SK_API SkDPoint cubicTop(const SkPoint curve[4], SkScalar , double s, double e, double* topT);
    void dump() const;
    void dumpID(int ) const;
    SK_API SkDPoint lineTop(const SkPoint[2], SkScalar , double , double , double* topT);
    SK_API double nearPoint(SkPath::Verb verb, const SkDPoint& xy, const SkDPoint& opp) const;
    SK_API void offset(SkPath::Verb verb, const SkDVector& );
    SK_API SkDPoint quadTop(const SkPoint curve[3], SkScalar , double s, double e, double* topT);

    SK_API void setConicBounds(const SkPoint curve[3], SkScalar curveWeight,
                        double s, double e, SkPathOpsBounds* );
    SK_API void setCubicBounds(const SkPoint curve[4], SkScalar ,
                        double s, double e, SkPathOpsBounds* );
    SK_API void setQuadBounds(const SkPoint curve[3], SkScalar ,
                       double s, double e, SkPathOpsBounds*);
};
...
public:
    ...
    SK_API void setCurveHullSweep(SkPath::Verb verb);
