...
SK_API bool SkPathOpsDebug::gDumpOp;  // set to true to write op to file before a crash
SK_API bool SkPathOpsDebug::gVerifyOp;  // set to true to compare result against regions
#endif

SK_API bool SkPathOpsDebug::gRunFail;  // set to true to check for success on tests known to fail
SK_API bool SkPathOpsDebug::gVeryVerbose;  // set to true to run extensive checking tests
...
#if DEBUG_SORT
SK_API int SkPathOpsDebug::gSortCountDefault = SK_MaxS32;
SK_API int SkPathOpsDebug::gSortCount;
#endif

#if DEBUG_ACTIVE_OP
SK_API const char* SkPathOpsDebug::kPathOpStr[] = {"diff", "sect", "union", "xor", "rdiff"};
#endif

#if defined SK_DEBUG || !FORCE_RELEASE

SK_API int SkPathOpsDebug::gContourID = 0;
SK_API int SkPathOpsDebug::gSegmentID = 0;
...
SK_API SkString SkPathOpsDebug::gActiveSpans;
#endif
