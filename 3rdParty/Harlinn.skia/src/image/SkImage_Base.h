...
public:
     ...
     */
    SK_API virtual void onAsyncRescaleAndReadPixels(const SkImageInfo&,
     ...
     */
    SK_API virtual void onAsyncRescaleAndReadPixelsYUV420(SkYUVColorSpace,
    ...
    SK_API GrDirectContext* directContext() const;
    ...
    SK_API std::tuple<GrSurfaceProxyView, GrColorType> asView(
     ...
     */
    SK_API std::unique_ptr<GrFragmentProcessor> asFragmentProcessor(GrRecordingContext*,
                                                             SkSamplingOptions,
                                                             const SkTileMode[2],
                                                             const SkMatrix&,
    ...
    SK_API virtual GrBackendTexture onGetBackendTexture(bool flushPendingGrContextIO,
    ...
    SK_API virtual bool onAsLegacyBitmap(GrDirectContext*, SkBitmap*) const;
...
protected:
    SK_API SkImage_Base(const SkImageInfo& info, uint32_t uniqueID);

#if SK_SUPPORT_GPU
    // Utility for making a copy of an existing view when the GrImageTexGenPolicy is not kDraw.
    SK_API static GrSurfaceProxyView CopyView(GrRecordingContext*,
                                       GrSurfaceProxyView src,
                                       GrMipmapped,
                                       GrImageTexGenPolicy);

    SK_API static std::unique_ptr<GrFragmentProcessor> MakeFragmentProcessorFromView(GrRecordingContext*,
                                                                              GrSurfaceProxyView,
                                                                              SkAlphaType,
                                                                              SkSamplingOptions,
                                                                              const SkTileMode[2],
     ...
     * function.
     */
    SK_API static GrSurfaceProxyView FindOrMakeCachedMipmappedView(GrRecordingContext*,
                                                            GrSurfaceProxyView,
