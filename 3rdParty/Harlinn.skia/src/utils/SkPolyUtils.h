 ...
 */
SK_API bool SkInsetConvexPolygon(const SkPoint* inputPolygonVerts, int inputPolygonSize,
 ...
 */
SK_API bool SkOffsetSimplePolygon(const SkPoint* inputPolygonVerts, int inputPolygonSize,
 ...
 */
SK_API bool SkComputeRadialSteps(const SkVector& offset0, const SkVector& offset1, SkScalar offset,
 ...
 */
SK_API int SkGetPolygonWinding(const SkPoint* polygonVerts, int polygonSize);
 ...
 */
SK_API bool SkIsConvexPolygon(const SkPoint* polygonVerts, int polygonSize);
 ...
 */
SK_API bool SkIsSimplePolygon(const SkPoint* polygonVerts, int polygonSize);
  ...
  */
SK_API bool SkTriangulateSimplePolygon(const SkPoint* polygonVerts, uint16_t* indexMap, int polygonSize,
                                 SkTDArray<uint16_t>* triangleIndices);

// Experiment: doesn't handle really big floats (returns false), always returns true for count <= 3
SK_API bool SkIsPolyConvex_experimental(const SkPoint[], int count);
