...
public:
     ...
     */
    SK_API static SkString Join(const char* rootPath, const char* relativePath);
     ...
     */
    SK_API static SkString Basename(const char* fullPath);
     ...
     */
    SK_API static SkString Dirname(const char* fullPath);
};
