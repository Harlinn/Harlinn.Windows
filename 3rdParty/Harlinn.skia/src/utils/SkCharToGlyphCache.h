...
public:
    ...
    SK_API void reset();       // forget all cache entries (to save memory)
     ...
     *  }
     */
    SK_API int findGlyphIndex(SkUnichar c) const;
     ...
     */
    SK_API void insertCharAndGlyph(int index, SkUnichar, SkGlyphID);
