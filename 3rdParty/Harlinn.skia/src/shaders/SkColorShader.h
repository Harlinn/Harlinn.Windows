...
public:
    ...
    */
    SK_API explicit SkColorShader(SkColor c);

    SK_API bool isOpaque() const override;
    bool isConstant() const override { return true; }

    SK_API GradientType asAGradient(GradientInfo* info) const override;
...
public:
    SK_API SkColor4Shader(const SkColor4f&, sk_sp<SkColorSpace>);
