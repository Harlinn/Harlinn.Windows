...
public:
    SK_API SkStreamBuffer(std::unique_ptr<SkStream>);
    SK_API ~SkStreamBuffer();
     ...
     */
    SK_API bool buffer(size_t bytes);
     ...
     */
    SK_API sk_sp<SkData> getDataAtPosition(size_t position, size_t length);
