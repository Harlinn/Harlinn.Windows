...
SK_API sk_sp<FileResourceProvider> FileResourceProvider::Make(SkString base_dir, bool predecode) {
...
SK_API sk_sp<DataURIResourceProviderProxy> DataURIResourceProviderProxy::Make(sk_sp<ResourceProvider> rp,
                                                                       bool predecode) {
