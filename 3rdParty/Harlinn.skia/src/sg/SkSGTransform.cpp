...
template <>
SK_API SkMatrix Matrix<SkMatrix>::asMatrix() const { return fMatrix; }

template <>
SK_API SkM44 Matrix<SkMatrix>::asM44() const { return SkM44(fMatrix); }

template <>
SK_API SkMatrix Matrix<SkM44>::asMatrix() const { return fMatrix.asM33(); }

template <>
SK_API SkM44 Matrix<SkM44>::asM44() const { return fMatrix; }
