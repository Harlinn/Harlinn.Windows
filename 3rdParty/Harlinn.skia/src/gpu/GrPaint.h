...
public:
    ...
    SK_API void setPorterDuffXPFactory(SkBlendMode mode);

    SK_API void setCoverageSetOpXPFactory(SkRegion::Op, bool invertCoverage = false);
     ...
     */
    SK_API bool isConstantBlendedColor(SkPMColor4f* constantColor) const;
