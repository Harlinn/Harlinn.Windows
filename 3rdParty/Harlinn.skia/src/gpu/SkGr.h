...
SK_API SkPMColor4f SkColorToPMColor4f(SkColor, const GrColorInfo&);

/** Converts an SkColor4f to the destination color space. */
SK_API SkColor4f SkColor4fPrepForDst(SkColor4f, const GrColorInfo&);
...
SK_API bool SkPaintToGrPaint(GrRecordingContext*,
...
/** Replaces the SkShader (if any) on skPaint with the passed in GrFragmentProcessor. The processor
    ...
    no primitive color. */
SK_API bool SkPaintToGrPaintReplaceShader(GrRecordingContext*,
                                   const GrColorInfo& dstColorInfo,
                                   const SkPaint& skPaint,
                                   const SkMatrixProvider& matrixProvider,
...
SK_API bool SkPaintToGrPaintWithBlend(GrRecordingContext*,
                               const GrColorInfo& dstColorInfo,
                               const SkPaint& skPaint,
                               const SkMatrixProvider& matrixProvider,
 ...
 */
SK_API sk_sp<GrSurfaceProxy> GrCopyBaseMipMapToTextureProxy(GrRecordingContext*,
 ...
 */
SK_API GrSurfaceProxyView GrCopyBaseMipMapToView(GrRecordingContext*,
                                          GrSurfaceProxyView,
                                          SkBudgeted = SkBudgeted::kYes);
 ...
 */
SK_API std::tuple<GrSurfaceProxyView, GrColorType>
 ...
 *      - SkImageGenerator
 */
SK_API void GrMakeKeyFromImageID(GrUniqueKey* key, uint32_t imageID, const SkIRect& imageBounds);
 ...
 */
SK_API sk_sp<SkIDChangeListener> GrMakeUniqueKeyInvalidationListener(GrUniqueKey*, uint32_t contextID);
