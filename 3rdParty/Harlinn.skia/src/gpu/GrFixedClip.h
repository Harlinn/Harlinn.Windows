...
public:
    ...
    SK_API SkIRect getConservativeBounds() const final;
    SK_API Effect apply(GrAppliedHardClip*, SkIRect*) const final;
    SK_API PreClipResult preApply(const SkRect& drawBounds, GrAA aa) const final;
