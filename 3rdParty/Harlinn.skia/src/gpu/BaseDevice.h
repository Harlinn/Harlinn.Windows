...
public:
    ...
    SK_API BaseDevice(sk_sp<GrRecordingContext>, const SkImageInfo&, const SkSurfaceProps&);

    SK_API GrSurfaceProxyView readSurfaceView();
    ...
    SK_API GrRenderTargetProxy* targetProxy();
    ...
    SK_API bool replaceBackingProxy(SkSurface::ContentChangeMode);
...
protected:
    ...
    SK_API static bool CheckAlphaTypeAndGetFlags(SkAlphaType, InitContents, DeviceFlags*);
    SK_API static SkImageInfo MakeInfo(SurfaceContext*,  DeviceFlags);
