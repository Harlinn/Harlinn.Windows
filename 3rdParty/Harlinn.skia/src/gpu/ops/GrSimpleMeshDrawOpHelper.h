...
public:
    ...
    SK_API GrSimpleMeshDrawOpHelper(GrProcessorSet*, GrAAType, InputFlags = InputFlags::kNone);
    SK_API ~GrSimpleMeshDrawOpHelper();
    ...
    SK_API bool isCompatible(const GrSimpleMeshDrawOpHelper& that, const GrCaps&, const SkRect& thisBounds,
     ...
     */
    SK_API GrProcessorSet::Analysis finalizeProcessors(const GrCaps&, const GrAppliedClip*, GrClampType,
                                                GrProcessorAnalysisCoverage geometryCoverage,
...
#if GR_TEST_UTILS
    SK_API SkString dumpInfo() const;
#endif
    ...
    SK_API static const GrPipeline* CreatePipeline(
                                const GrCaps*,
                                SkArenaAlloc*,
    ...
    SK_API const GrPipeline* createPipeline(GrOpFlushState* flushState);

    SK_API const GrPipeline* createPipeline(const GrCaps*,
                                     SkArenaAlloc*,
                                     GrSwizzle writeViewSwizzle,
                                     GrAppliedClip&&,
                                     const GrDstProxyView&);

    SK_API static GrProgramInfo* CreateProgramInfo(const GrCaps*,
                                            SkArenaAlloc*,
                                            const GrPipeline*,
...
protected:
    SK_API GrProcessorSet::Analysis finalizeProcessors(const GrCaps& caps, const GrAppliedClip*,
