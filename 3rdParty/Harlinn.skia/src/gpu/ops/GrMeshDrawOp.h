...
protected:
    SK_API GrMeshDrawOp(uint32_t classID);
    ...
    SK_API void createProgramInfo(GrMeshDrawTarget*);
    ...
    class PatternHelper {
    public:
        SK_API PatternHelper(GrMeshDrawTarget*, GrPrimitiveType, size_t vertexStride,
        ...
        SK_API void recordDraw(GrMeshDrawTarget*, const GrGeometryProcessor*) const;
        SK_API void recordDraw(GrMeshDrawTarget*, const GrGeometryProcessor*,
    ...
    protected:
        ...
        SK_API void init(GrMeshDrawTarget*, GrPrimitiveType, size_t vertexStride,
                  sk_sp<const GrBuffer> indexBuffer, int verticesPerRepetition,
                  int indicesPerRepetition, int repeatCount, int maxRepetitions);
    ...
    public:
        QuadHelper() = delete;
        SK_API QuadHelper(GrMeshDrawTarget*, size_t vertexStride, int quadsToDraw);
    ...
    SK_API static bool CombinedQuadCountWillOverflow(GrAAType aaType,
                                              bool willBeUpgradedToAA,
                                              int combinedQuadCount);

    SK_API virtual void onPrePrepareDraws(GrRecordingContext*,
                                   const GrSurfaceProxyView& writeView,
                                   GrAppliedClip*,
...
private:
    ...
    SK_API void onPrepare(GrOpFlushState* state) final;
