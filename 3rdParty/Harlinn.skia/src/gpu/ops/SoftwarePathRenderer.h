...
public:
    ...
    SK_API static bool GetShapeAndClipBounds(SurfaceDrawContext*,
                                      const GrClip*,
                                      const GrStyledShape&,
...
private:
    SK_API static void DrawNonAARect(SurfaceDrawContext*,
                              GrPaint&&,
    ...
    SK_API static void DrawAroundInvPath(SurfaceDrawContext*,
                                  GrPaint&&,
                                  const GrUserStencilSettings&,
                                  const GrClip*,
                                  const SkMatrix& viewMatrix,
    ...
    SK_API static void DrawToTargetWithShapeMask(GrSurfaceProxyView,
                                          SurfaceDrawContext*,
                                          GrPaint&&,
                                          const GrUserStencilSettings&,
                                          const GrClip*,
