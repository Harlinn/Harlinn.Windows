...
public:
    ...
    SK_API bool canUseStencil(const GrCaps& caps) const;
    ...
    SK_API int maxWindowRectangles(const GrCaps& caps) const;
    ...
    SK_API bool refsWrappedObjects() const;
...
protected:
    ...
    // Deferred version
    SK_API GrRenderTargetProxy(const GrCaps&,
    ...
    SK_API GrRenderTargetProxy(LazyInstantiateCallback&&,
                        const GrBackendFormat&,
                        SkISize,
                        int sampleCount,
                        SkBackingFit,
    ...
    // Wrapped version
    SK_API GrRenderTargetProxy(sk_sp<GrSurface>,
                        UseAllocator,
...
private:
    ...
    SkDEBUGCODE( SK_API void onValidateSurface(const GrSurface*) override;)
