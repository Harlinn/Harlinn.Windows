...
public:
    ...
    SK_API void addInterval(GrSurfaceProxy*, unsigned int start, unsigned int end, ActualUse actualUse
    ...
    SK_API bool makeBudgetHeadroom();
...
private:
    ...
    SK_API void expire(unsigned int curIndex);

    // These two methods wrap the interactions with the free pool
    SK_API void recycleRegister(Register* r);
    SK_API Register* findOrCreateRegisterFor(GrSurfaceProxy* proxy);
    ...
    public:
        ...
        SK_API Register(GrSurfaceProxy* originatingProxy, GrScratchKey, GrResourceProvider*);
        ...
        SK_API bool isRecyclable(const GrCaps&, GrSurfaceProxy* proxy, int knownUseCount) const;
        ...
        // proxies.
        SK_API bool instantiateSurface(GrSurfaceProxy*, GrResourceProvider*);
    ...
    public:
        ...
        SK_API Interval* popHead();
        SK_API void insertByIncreasingStart(Interval*);
        SK_API void insertByIncreasingEnd(Interval*);
