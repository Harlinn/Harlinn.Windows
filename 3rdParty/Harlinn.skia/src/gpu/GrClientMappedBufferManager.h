...
public:
    ...
    SK_API GrClientMappedBufferManager(GrDirectContext::DirectContextID owningDirectContext);
    ...
    SK_API ~GrClientMappedBufferManager();
     ...
     */
    SK_API void insert(sk_sp<GrGpuBuffer> b);
...
private:
    ...
    SK_API void remove(const sk_sp<GrGpuBuffer>& b);
};

SK_API bool SkShouldPostMessageToBus(const GrClientMappedBufferManager::BufferFinishedMessage&,
