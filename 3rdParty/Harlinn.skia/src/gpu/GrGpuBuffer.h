...
public:
     ...
     */
    SK_API static void ComputeScratchKeyForDynamicBuffer(size_t size, GrGpuBufferType, GrScratchKey*);
     ...
     */
    SK_API bool updateData(const void* src, size_t srcSizeInBytes);

protected:
    SK_API GrGpuBuffer(GrGpu*, size_t sizeInBytes, GrGpuBufferType, GrAccessPattern);
    SK_API GrGpuBufferType intendedType() const { return fIntendedType; }
...
private:
    ...
    SK_API void computeScratchKey(GrScratchKey* key) const override;
