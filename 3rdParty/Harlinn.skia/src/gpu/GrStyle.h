...
public:
     ...
     */
    SK_API static int KeySize(const GrStyle&, Apply, uint32_t flags = 0);
     ...
     */
    SK_API static void WriteKey(uint32_t*, const GrStyle&, Apply, SkScalar scale, uint32_t flags = 0);
     ...
     * matrix.
     */
    SK_API bool SK_WARN_UNUSED_RESULT applyPathEffectToPath(SkPath* dst, SkStrokeRec* remainingStoke,
     ...
     */
    SK_API bool SK_WARN_UNUSED_RESULT applyToPath(SkPath* dst, SkStrokeRec::InitStyle* fillOrHairline,
                                           const SkPath& src, SkScalar scale) const;
...
private:
    SK_API void initPathEffect(sk_sp<SkPathEffect> pe);
    ...
    SK_API bool applyPathEffect(SkPath* dst, SkStrokeRec* strokeRec, const SkPath& src) const;
