...
public:
    ...
    SK_API static void ComputeSharedAttachmentUniqueKey(const GrCaps& caps,
...
private:
    SK_API size_t onGpuMemorySize() const final;

    SK_API void computeScratchKey(GrScratchKey*) const final;
