...
public:
     ...
     */
    SK_API GrVkCaps(const GrContextOptions& contextOptions,
    ...
    SK_API bool isVkFormatTexturable(VkFormat) const;

    bool isFormatCopyable(const GrBackendFormat&) const override { return true; }

    SK_API bool isFormatAsColorTypeRenderable(GrColorType ct,
                                       const GrBackendFormat& format,
                                       int sampleCount = 1) const override;
    SK_API bool isFormatRenderable(const GrBackendFormat& format, int sampleCount) const override;
    SK_API bool isFormatRenderable(VkFormat, int sampleCount) const;

    SK_API int getRenderTargetSampleCount(int requestedCount, const GrBackendFormat&) const override;
    SK_API int getRenderTargetSampleCount(int requestedCount, VkFormat) const;

    SK_API int maxRenderTargetSampleCount(const GrBackendFormat&) const override;
    SK_API int maxRenderTargetSampleCount(VkFormat format) const;
     ...
     * target.
     */
    SK_API bool canCopyImage(VkFormat dstFormat,
                      int dstSampleCnt,
                      bool dstHasYcbcr,
                      VkFormat srcFormat,
                      int srcSamplecnt,
    ...
    SK_API bool canCopyAsBlit(VkFormat dstConfig,
                       int dstSampleCnt,
                       bool dstIsLinear,
                       bool dstHasYcbcr,
                       VkFormat srcConfig,
    ...
    SK_API bool canCopyAsResolve(VkFormat dstConfig,
                          int dstSampleCnt,
                          bool dstHasYcbcr,
                          VkFormat srcConfig,
                          int srcSamplecnt,
    ...
    SK_API int getFragmentUniformBinding() const;
    SK_API int getFragmentUniformSet() const;

    SK_API void addExtraSamplerKey(GrProcessorKeyBuilder*,
                            GrSamplerState,
    ...
    SK_API GrInternalSurfaceFlags getExtraSurfaceFlagsForDeferredRT() const override;

    SK_API VkShaderStageFlags getPushConstantStageFlags() const;
    ...
    SK_API bool renderTargetSupportsDiscardableMSAA(const GrVkRenderTarget*) const;
    SK_API bool programInfoWillUseDiscardableMSAA(const GrProgramInfo&) const;
...
private:
    ...
    SK_API void init(const GrContextOptions& contextOptions, const GrVkInterface* vkInterface,
    ...
    SK_API void initGrCaps(const GrVkInterface* vkInterface,
                    VkPhysicalDevice physDev,
                    const VkPhysicalDeviceProperties&,
                    const VkPhysicalDeviceMemoryProperties&,
                    const VkPhysicalDeviceFeatures2&,
                    const GrVkExtensions&);
    SK_API void initShaderCaps(const VkPhysicalDeviceProperties&, const VkPhysicalDeviceFeatures2&);

    SK_API void initFormatTable(const GrVkInterface*, VkPhysicalDevice, const VkPhysicalDeviceProperties&);
    SK_API void initStencilFormat(const GrVkInterface* iface, VkPhysicalDevice physDev);

    SK_API void applyDriverCorrectnessWorkarounds(const VkPhysicalDeviceProperties&);
    ...
    struct FormatInfo {
        ...
        SK_API void init(const GrVkInterface*, VkPhysicalDevice, const VkPhysicalDeviceProperties&,
                  VkFormat);
        SK_API static void InitFormatFlags(VkFormatFeatureFlags, uint16_t* flags);
        SK_API void initSampleCounts(const GrVkInterface*, VkPhysicalDevice,
    ...
    SK_API FormatInfo& getFormatInfo(VkFormat);
    SK_API const FormatInfo& getFormatInfo(VkFormat) const;

    VkFormat fColorTypeToFormatTable[kGrColorTypeCnt];
    SK_API void setColorType(GrColorType, std::initializer_list<VkFormat> formats);
