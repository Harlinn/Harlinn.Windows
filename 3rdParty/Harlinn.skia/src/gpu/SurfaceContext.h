...
public:
    ...
    SK_API SurfaceContext(GrRecordingContext*, GrSurfaceProxyView readView, const GrColorInfo&);

    SK_API virtual ~SurfaceContext() = default;
     ...
     */
    SK_API bool readPixels(GrDirectContext* dContext, GrPixmap dst, SkIPoint srcPt);
    ...
    SK_API void asyncRescaleAndReadPixels(GrDirectContext*,
    ...
    SK_API void asyncRescaleAndReadPixelsYUV420(GrDirectContext*,
     ...
     */
    SK_API bool writePixels(GrDirectContext* dContext,
                     GrCPixmap src,
                     SkIPoint dstPt);
     ...
     * conversions.
     */
    SK_API std::unique_ptr<skgpu::SurfaceFillContext> rescale(const GrImageInfo& info,
                                                       GrSurfaceOrigin,
                                                       SkIRect srcRect,
     ...
     */
    SK_API bool rescaleInto(SurfaceFillContext* dst,
                     SkIRect dstRect,
                     SkIRect srcRect,
                     SkImage::RescaleGamma,
                     SkImage::RescaleMode);
...
protected:
    ...
    SK_API const GrDrawingManager* drawingManager() const;
    ...
    SK_API PixelTransferResult transferPixels(GrColorType colorType, const SkIRect& rect);

    // The async read step of asyncRescaleAndReadPixels()
    SK_API void asyncReadPixels(GrDirectContext*,
                         const SkIRect& srcRect,
                         SkColorType,
                         ReadPixelsCallback,
                         ReadPixelsContext);
...
private:
     ...
     *       of fSurfaceContext.
     */
    SK_API sk_sp<GrRenderTask> copy(sk_sp<GrSurfaceProxy> src, SkIRect srcRect, SkIPoint dstPoint);

    SK_API bool internalWritePixels(GrDirectContext* dContext,
                             const GrCPixmap src[],
                             int numLevels,
                             SkIPoint);
