...
public:
    ...
    SK_API static GrQuad MakeFromRect(const SkRect&, const SkMatrix&);
    ...
    SK_API static GrQuad MakeFromSkQuad(const SkPoint pts[4], const SkMatrix&);
    ...
    SK_API bool aaHasEffectOnRect() const;
...
private:
    ...
    SK_API SkRect projectedBounds() const;
