...
namespace GrQuadUtils {
    ...
    SK_API void ResolveAAType(GrAAType requestedAAType, GrQuadAAFlags requestedEdgeFlags,
     ...
     */
    SK_API int ClipToW0(DrawQuad* quad, DrawQuad* extraVertices);
     ...
     */
    SK_API bool CropToRect(const SkRect& cropRect, GrAA cropAA, DrawQuad* quad, bool computeLocal=true);

    inline void Outset(const skvx::Vec<4, float>& edgeDistances, GrQuad* quad);

    SK_API bool WillUseHairline(const GrQuad& quad, GrAAType aaType, GrQuadAAFlags edgeFlags);
    ...
    public:
        ...
        SK_API void reset(const GrQuad& deviceQuad, const GrQuad* localQuad);
        ...
        SK_API skvx::Vec<4, float> inset(const skvx::Vec<4, float>& edgeDistances,
        ...
        SK_API void outset(const skvx::Vec<4, float>& edgeDistances,
        ...
        SK_API void getEdgeEquations(skvx::Vec<4, float>* a,
                              skvx::Vec<4, float>* b,
                              skvx::Vec<4, float>* c);
        ...
        SK_API skvx::Vec<4, float> getEdgeLengths();
    ...
    private:
        ...
        struct EdgeVectors {
            ...
            SK_API void reset(const skvx::Vec<4, float>& xs, const skvx::Vec<4, float>& ys,
        ...
        struct EdgeEquations {
            ...
            SK_API void reset(const EdgeVectors& edgeVectors);

            SK_API skvx::Vec<4, float> estimateCoverage(const skvx::Vec<4, float>& x2d,
                                                 const skvx::Vec<4, float>& y2d) const;

            SK_API bool isSubpixel(const skvx::Vec<4, float>& x2d, const skvx::Vec<4, float>& y2d) const;
            ...
            SK_API int computeDegenerateQuad(const skvx::Vec<4, float>& signedEdgeDistances,
        ...
        struct OutsetRequest {
            ...
            SK_API void reset(const EdgeVectors& edgeVectors, GrQuad::Type quadType,
        ...
        struct Vertices {
            ...
            SK_API void asGrQuads(GrQuad* deviceOut, GrQuad::Type deviceType,
            ...
            // numerically sound.
            SK_API void moveAlong(const EdgeVectors& edgeVectors,
            ...
            SK_API void moveTo(const skvx::Vec<4, float>& x2d,
        ...
        // and outset calls.
        SK_API const OutsetRequest& getOutsetRequest(const skvx::Vec<4, float>& edgeDistances);
        SK_API const EdgeEquations& getEdgeEquations();
        ...
        SK_API void adjustVertices(const skvx::Vec<4, float>& signedEdgeDistances, Vertices* vertices);
        ...
        SK_API int adjustDegenerateVertices(const skvx::Vec<4, float>& signedEdgeDistances,
                                     Vertices* vertices);
