...
public:
     ...
     */
    SK_API static sk_sp<GrGLProgram> Make(
            GrGLGpu*,
     ...
     */
    SK_API void updateUniforms(const GrRenderTarget*, const GrProgramInfo&);
...
private:
    ...
    SK_API void setRenderTargetState(const GrRenderTarget*, GrSurfaceOrigin, const GrGeometryProcessor&);
