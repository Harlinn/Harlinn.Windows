...
public:
     ...
     */
    SK_API GrGLCaps(const GrContextOptions& contextOptions, const GrGLContextInfo& ctxInfo,
             const GrGLInterface* glInterface);

    SK_API bool isFormatSRGB(const GrBackendFormat&) const override;

    SK_API bool isFormatTexturable(const GrBackendFormat&, GrTextureType) const override;
    SK_API bool isFormatTexturable(GrGLFormat) const;

    SK_API bool isFormatAsColorTypeRenderable(GrColorType ct, const GrBackendFormat& format,
                                       int sampleCount = 1) const override;
    SK_API bool isFormatRenderable(const GrBackendFormat& format, int sampleCount) const override;
    ...
    SK_API int getRenderTargetSampleCount(int requestedCount, GrGLFormat) const;

    int maxRenderTargetSampleCount(const GrBackendFormat& format) const override {
        return this->maxRenderTargetSampleCount(format.asGLFormat());
    }
    SK_API int maxRenderTargetSampleCount(GrGLFormat) const;

    SK_API bool isFormatCopyable(const GrBackendFormat&) const override;

    SK_API bool canFormatBeFBOColorAttachment(GrGLFormat) const;
     ...
     */
    SK_API void getTexImageExternalFormatAndType(GrGLFormat surfaceFormat, GrGLenum* externalFormat,
     ...
     */
    SK_API void getTexSubImageExternalFormatAndType(GrGLFormat surfaceFormat, GrColorType surfaceColorType,
     ...
     */
    SK_API void getTexSubImageDefaultFormatTypeAndColorType(GrGLFormat format,
                                                     GrGLenum* externalFormat,
                                                     GrGLenum* externalType,
                                                     GrColorType* colorType) const;

    SK_API void getReadPixelsFormat(GrGLFormat surfaceFormat, GrColorType surfaceColorType,
                             GrColorType memoryColorType, GrGLenum* externalFormat,
                             GrGLenum* externalType) const;
    ...
    */
    ...
    SK_API bool formatSupportsTexStorage(GrGLFormat) const;
     ...
     */
    SK_API bool shouldQueryImplementationReadSupport(GrGLFormat format) const;
     ...
     */
    SK_API void didQueryImplementationReadSupport(GrGLFormat format,
                                           GrGLenum readFormat,
     ...
     */
    SK_API void setStencilFormatIndexForFormat(GrGLFormat, int index);
    ...
    SK_API SurfaceReadPixelsSupport surfaceSupportsReadPixels(const GrSurface*) const override;

    SK_API SupportedWrite supportedWritePixelsColorType(GrColorType surfaceColorType,
    ...
    SK_API void onDumpJSON(SkJSONWriter*) const override;
    ...
    SK_API bool canCopyTexSubImage(GrGLFormat dstFormat, bool dstHasMSAARenderBuffer,
    ...
    SK_API bool canCopyAsBlit(GrGLFormat dstFormat, int dstSampleCnt,
                       const GrTextureType* dstTypeIfTexture,
    ...
    SK_API bool canCopyAsDraw(GrGLFormat dstFormat, bool srcIsTexturable) const;

    SK_API DstCopyRestrictions getDstCopyRestrictions(const GrRenderTargetProxy* src,
    ...
    SK_API GrBackendFormat getBackendFormatFromCompressionType(SkImage::CompressionType) const override;

    SK_API GrSwizzle getWriteSwizzle(const GrBackendFormat&, GrColorType) const override;

    SK_API uint64_t computeFormatKey(const GrBackendFormat&) const override;

    SK_API GrProgramDesc makeDesc(GrRenderTarget*,
                           const GrProgramInfo&,
    ...
    SK_API std::vector<TestFormatColorTypeCombination> getTestingCombinations() const override;
#endif
...
private:
    ...
    SK_API void getExternalFormat(GrGLFormat surfaceFormat, GrColorType surfaceColorType,
                           GrColorType memoryColorType, ExternalFormatUsage usage,
                           GrGLenum* externalFormat, GrGLenum* externalType) const;

    SK_API void init(const GrContextOptions&, const GrGLContextInfo&, const GrGLInterface*);
    SK_API void initGLSL(const GrGLContextInfo&, const GrGLInterface*);
    ...
    SK_API void applyDriverCorrectnessWorkarounds(const GrGLContextInfo&, const GrContextOptions&,
                                           const GrGLInterface*,
                                           GrShaderCaps*, FormatWorkarounds*);

    SK_API void onApplyOptionsOverrides(const GrContextOptions& options) override;

    SK_API bool onIsWindowRectanglesSupportedForRT(const GrBackendRenderTarget&) const override;

    SK_API void initFSAASupport(const GrContextOptions& contextOptions, const GrGLContextInfo&,
                         const GrGLInterface*);
    SK_API void initBlendEqationSupport(const GrGLContextInfo&);
    SK_API void initStencilSupport(const GrGLContextInfo&);
    // This must be called after initFSAASupport().
    SK_API void initFormatTable(const GrGLContextInfo&, const GrGLInterface*, const FormatWorkarounds&);
    SK_API void setupSampleCounts(const GrGLContextInfo&, const GrGLInterface*);
    SK_API bool onSurfaceSupportsWritePixels(const GrSurface*) const override;
    SK_API bool onCanCopySurface(const GrSurfaceProxy* dst, const GrSurfaceProxy* src,
                          const SkIRect& srcRect, const SkIPoint& dstPoint) const override;
    SK_API GrBackendFormat onGetDefaultBackendFormat(GrColorType) const override;
    SK_API bool onAreColorTypeAndFormatCompatible(GrColorType, const GrBackendFormat&) const override;

    SK_API SupportedRead onSupportedReadPixelsColorType(GrColorType, const GrBackendFormat&,
                                                 GrColorType) const override;

    SK_API GrSwizzle onGetReadSwizzle(const GrBackendFormat&, GrColorType) const override;

    SK_API GrDstSampleFlags onGetDstSampleFlagsForProxy(const GrRenderTargetProxy*) const override;

    SK_API bool onSupportsDynamicMSAA(const GrRenderTargetProxy*) const override;
    ...
    SK_API void setColorTypeFormat(GrColorType, GrGLFormat);
