...
public:
     ...
     */
    SK_API const GrDirectContext* getContext() const;
    SK_API GrDirectContext* getContext();
     ...
     **/
    SK_API virtual void dumpMemoryStatistics(SkTraceMemoryDump* traceMemoryDump) const;
    ...
    SK_API SK_API static uint32_t CreateUniqueID();
...
protected:
    ...
    SK_API void registerWithCache(SkBudgeted);
    ...
    // final class).
    SK_API void registerWithCacheWrapped(GrWrapCacheable);

    SK_API GrGpuResource(GrGpu*);
    SK_API virtual ~GrGpuResource();
     ...
     */
    SK_API SkString getResourceName() const;
     ...
     */
    SK_API void dumpMemoryStatisticsPriv(SkTraceMemoryDump* traceMemoryDump, const SkString& resourceName,
                                  const char* type, size_t size) const;


private:
    SK_API bool isPurgeable() const;
    SK_API bool hasRef() const;
    SK_API bool hasNoCommandBufferUsages() const;
     ...
     **/
    SK_API virtual void computeScratchKey(GrScratchKey*) const {}
    ...
    SK_API void setUniqueKey(const GrUniqueKey&);
    SK_API void removeUniqueKey();
    SK_API void notifyARefCntIsZero(LastRemovedRef removedRef) const;
    SK_API void removeScratchKey();
    SK_API void makeBudgeted();
    SK_API void makeUnbudgeted();
...
private:
    ...
    SK_API void ref(GrResourceCache* cache);
