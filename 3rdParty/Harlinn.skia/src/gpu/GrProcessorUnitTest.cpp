...
template SK_TEMPLATE_API class GrProcessorTestFactory<std::unique_ptr<GrFragmentProcessor>>;
template SK_TEMPLATE_API class GrProcessorTestFactory<GrGeometryProcessor*>;
