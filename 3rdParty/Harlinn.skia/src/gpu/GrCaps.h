...
#include <skia/gpu/GrDriverBugWorkarounds.h>
...
public:
    SK_API GrCaps(const GrContextOptions&);
    ...
    SK_API bool isFormatCompressed(const GrBackendFormat& format) const;
     ...
     */
    SK_API bool surfaceSupportsWritePixels(const GrSurface*) const;
     ...
     */
    SK_API SupportedRead supportedReadPixelsColorType(GrColorType srcColorType,
    ...
    SK_API bool validateSurfaceParams(const SkISize&, const GrBackendFormat&, GrRenderable renderable,
                               int renderTargetSampleCnt, GrMipmapped, GrTextureType) const;

    SK_API bool areColorTypeAndFormatCompatible(GrColorType grCT, const GrBackendFormat& format) const;

    /** These are used when creating a new texture internally. */
    SK_API GrBackendFormat getDefaultBackendFormat(GrColorType, GrRenderable) const;
     ...
     */
    SK_API GrSwizzle getReadSwizzle(const GrBackendFormat& format, GrColorType colorType) const;
    ...
    SK_API bool supportsDynamicMSAA(const GrRenderTargetProxy*) const;
     ...
     */
    SK_API std::tuple<GrColorType, GrBackendFormat> getFallbackColorTypeAndFormat(GrColorType,
...
protected:
    ...
    SK_API void finishInitialization(const GrContextOptions& options);
...
private:
    SK_API void applyOptionsOverrides(const GrContextOptions& options);
