...
public:
    ...
    SK_API SkISize backingStoreDimensions() const;
    ...
    SK_API bool isFunctionallyExact() const;
    ...
    SK_API bool isFormatCompressed(const GrCaps*) const;
     ...
     */
    SK_API bool canSkipResourceAllocator() const;
    ...
    SK_API static sk_sp<GrSurfaceProxy> Copy(GrRecordingContext*,
...
#if GR_TEST_UTILS
    SK_API int32_t testingOnly_getBackingRefCnt() const;
    SK_API GrInternalSurfaceFlags testingOnly_getFlags() const;
    SK_API SkString dump() const;
#endif

#ifdef SK_DEBUG
    SK_API void validate(GrContext_Base*) const;
    ...
    SK_API inline GrSurfaceProxyPriv priv();
    SK_API inline const GrSurfaceProxyPriv priv() const;  // NOLINT(readability-const-return-type)
...
protected:
    ...
    SK_API GrSurfaceProxy(const GrBackendFormat&,
                   SkISize,
                   SkBackingFit,
                   SkBudgeted,
                   GrProtected,
    ...
    SK_API GrSurfaceProxy(LazyInstantiateCallback&&,
    ...
    SK_API GrSurfaceProxy(sk_sp<GrSurface>,
                   SkBackingFit,
                   UseAllocator);
    ...
    SK_API void computeScratchKey(const GrCaps&, GrScratchKey*) const;

    virtual sk_sp<GrSurface> createSurface(GrResourceProvider*) const = 0;
    SK_API void assign(sk_sp<GrSurface> surface);

    SK_API sk_sp<GrSurface> createSurfaceImpl(GrResourceProvider*, int sampleCnt, GrRenderable,
                                       GrMipmapped) const;
    ...
    SK_API bool instantiateImpl(GrResourceProvider* resourceProvider, int sampleCnt, GrRenderable,
