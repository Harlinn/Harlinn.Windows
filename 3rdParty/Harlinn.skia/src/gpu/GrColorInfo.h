...
public:
    GrColorInfo() = default;
    SK_API GrColorInfo(const GrColorInfo&);
    SK_API GrColorInfo& operator=(const GrColorInfo&);
    SK_API GrColorInfo(GrColorType, SkAlphaType, sk_sp<SkColorSpace>);
    SK_API /* implicit */ GrColorInfo(const SkColorInfo&);
