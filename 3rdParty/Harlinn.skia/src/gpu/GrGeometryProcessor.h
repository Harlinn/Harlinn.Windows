...
public:
    ...
    SK_API GrGeometryProcessor(ClassID);

    int numTextureSamplers() const { return fTextureSamplerCnt; }
    SK_API const TextureSampler& textureSampler(int index) const;
     ...
     */
    SK_API static uint32_t ComputeCoordTransformsKey(const GrFragmentProcessor& fp);
...
public:
     ...
     **/
    SK_API FPCoordsMap emitCode(EmitArgs&, const GrPipeline& pipeline);
     ...
     */
    SK_API void emitTransformCode(GrGLSLVertexBuilder* vb, GrGLSLUniformHandler* uniformHandler);
...
protected:
    SK_API void setupUniformColor(GrGLSLFPFragmentBuilder* fragBuilder,
                           GrGLSLUniformHandler* uniformHandler,
    ...
    SK_API static void SetTransform(const GrGLSLProgramDataManager&,
                             const GrShaderCaps&,
    ...
    SK_API static void WriteOutputPosition(GrGLSLVertexBuilder*, GrGPArgs*, const char* posName);
    SK_API static void WriteOutputPosition(GrGLSLVertexBuilder*,
    ...
    SK_API static void WriteLocalCoord(GrGLSLVertexBuilder*,
                                GrGLSLUniformHandler*,
                                const GrShaderCaps&,
                                GrGPArgs*,
...
private:
    ...
    // GpArgs::fPositionVar.
    SK_API FPCoordsMap collectTransforms(GrGLSLVertexBuilder* vb,
                                  GrGLSLVaryingHandler* varyingHandler,
                                  GrGLSLUniformHandler* uniformHandler,
...
public:
    ...
    SK_API TextureSampler(GrSamplerState, const GrBackendFormat&, const GrSwizzle&);

    TextureSampler(const TextureSampler&) = delete;
    TextureSampler& operator=(const TextureSampler&) = delete;

    SK_API void reset(GrSamplerState, const GrBackendFormat&, const GrSwizzle&);
