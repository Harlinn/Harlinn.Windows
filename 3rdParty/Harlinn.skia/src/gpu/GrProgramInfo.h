...
public:
    ...
    SK_API GrStencilSettings nonGLStencilSettings() const;
...
#ifdef SK_DEBUG
    SK_API void validate(bool flushTime) const;
    SK_API void checkAllInstantiated() const;
    SK_API void checkMSAAAndMIPSAreResolved() const;
#endif
