...
public:
    SK_API GrGpu(GrDirectContext* direct);
    SK_API ~GrGpu() override;
    ...
    SK_API virtual void disconnect(DisconnectType);
     ...
     */
    SK_API sk_sp<GrTexture> createTexture(SkISize dimensions,
    ...
    SK_API sk_sp<GrTexture> createCompressedTexture(SkISize dimensions,
                                             const GrBackendFormat& format,
                                             SkBudgeted budgeted,
                                             GrMipmapped mipMapped,
                                             GrProtected isProtected,
     ...
     */
    SK_API sk_sp<GrTexture> wrapBackendTexture(const GrBackendTexture&,
                                        GrWrapOwnership,
                                        GrWrapCacheable,
                                        GrIOType);

    SK_API sk_sp<GrTexture> wrapCompressedBackendTexture(const GrBackendTexture&,
                                                  GrWrapOwnership,
                                                  GrWrapCacheable);
     ...
     */
    SK_API sk_sp<GrTexture> wrapRenderableBackendTexture(const GrBackendTexture&,
                                                  int sampleCnt,
                                                  GrWrapOwnership,
                                                  GrWrapCacheable);
     ...
     */
    SK_API sk_sp<GrRenderTarget> wrapBackendRenderTarget(const GrBackendRenderTarget&);

    /**
     * Implements GrResourceProvider::wrapVulkanSecondaryCBAsRenderTarget
     */
    SK_API sk_sp<GrRenderTarget> wrapVulkanSecondaryCBAsRenderTarget(const SkImageInfo&,
     ...
     */
    SK_API sk_sp<GrGpuBuffer> createBuffer(size_t size, GrGpuBufferType intendedType,
     ...
     */
    SK_API bool readPixels(GrSurface* surface,
                    SkIRect rect,
     ...
     */
    SK_API bool writePixels(GrSurface* surface,
                     SkIRect rect,
                     GrColorType surfaceColorType,
                     GrColorType srcColorType,
                     const GrMipLevel texels[],
     ...
     */
    SK_API bool transferPixelsTo(GrTexture* texture,
                          SkIRect rect,
                          GrColorType textureColorType,
     ...
     * @param offset           offset from the start of the buffer
     */
    SK_API bool transferPixelsFrom(GrSurface* surface,
                            SkIRect rect,
                            GrColorType surfaceColorType,
                            GrColorType bufferColorType,
                            sk_sp<GrGpuBuffer> transferBuffer,
    ...
    SK_API bool copySurface(GrSurface* dst, GrSurface* src, const SkIRect& srcRect,
    ...
    SK_API GrOpsRenderPass* getOpsRenderPass(GrRenderTarget* renderTarget,
                                      bool useMSAASurface,
    ...
    // inserted semaphores.
    SK_API void executeFlushInfo(SkSpan<GrSurfaceProxy*>,
                          SkSurface::BackendSurfaceAccess access,
                          const GrFlushInfo&,
                          const GrBackendSurfaceMutableState* newState);

    SK_API bool submitToGpu(bool syncCpu);
     ...
     */
    SK_API bool checkAndResetOOMed();
...
#if GR_TEST_UTILS
        SK_API void dump(SkString*);
        SK_API void dumpKeyValuePairs(SkTArray<SkString>* keys, SkTArray<double>* values);
#endif
    private:
     ...
     * texture format.
     */
    SK_API GrBackendTexture createBackendTexture(SkISize dimensions,
                                          const GrBackendFormat&,
                                          GrRenderable,
                                          GrMipmapped,
                                          GrProtected);

    SK_API bool clearBackendTexture(const GrBackendTexture&,
     ...
     * never be renderable.
     */
    SK_API GrBackendTexture createCompressedBackendTexture(SkISize dimensions,
                                                    const GrBackendFormat&,
                                                    GrMipmapped,
                                                    GrProtected);
...
protected:
    SK_API static bool CompressedDataIsCorrect(SkISize dimensions,
    ...
    SK_API void didWriteToSurface(GrSurface* surface, GrSurfaceOrigin origin, const SkIRect* bounds,
    ...
    SK_API void initCapsAndCompiler(sk_sp<const GrCaps> caps);
...
private:
    ...
    SK_API virtual sk_sp<GrRenderTarget> onWrapVulkanSecondaryCBAsRenderTarget(const SkImageInfo&,
                                                                        const GrVkDrawableInfo&);
    ...
    SK_API void reportSubmitHistograms();
    ...
    SK_API sk_sp<GrTexture> createTextureCommon(SkISize,
                                         const GrBackendFormat&,
                                         GrTextureType textureType,
                                         GrRenderable,
                                         int renderTargetSampleCnt,
    ...
    SK_API void callSubmittedProcs(bool success);
