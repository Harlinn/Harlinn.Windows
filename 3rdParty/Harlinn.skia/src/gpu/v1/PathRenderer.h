...
public:
     ...
     *                filled.
     */
    SK_API StencilSupport getStencilSupport(const GrStyledShape& shape) const;
     ...
     */
    SK_API bool drawPath(const DrawPathArgs& args);
    /**
...
protected:
    ...
    SK_API static void GetPathDevBounds(const SkPath& path,
                                 SkISize devSize,
...
private:
     ...
     */
    SK_API virtual void onStencilPath(const StencilPathArgs&);
