...
public:
    ...
    SK_API bool instantiate(GrResourceProvider*) override;
    ...
    // generation later.
    SK_API GrMipmapped mipmapped() const;
    ...
    SK_API static bool ProxiesAreCompatibleAsDynamicState(const GrSurfaceProxy* first,
    ...
    SK_API GrTextureProxyPriv texPriv();
    SK_API const GrTextureProxyPriv texPriv() const;  // NOLINT(readability-const-return-type)
...
protected:
    ...
    SK_API GrTextureProxy(const GrBackendFormat&,
                   SkISize,
                   GrMipmapped,
                   GrMipmapStatus,
                   SkBackingFit,
    ...
    SK_API GrTextureProxy(LazyInstantiateCallback&&,
    ...
    // Wrapped version
    SK_API GrTextureProxy(sk_sp<GrSurface>, UseAllocator, GrDDLProvider creatingProvider);

    SK_API ~GrTextureProxy() override;

    SK_API sk_sp<GrSurface> createSurface(GrResourceProvider*) const override;
...
private:
    ...
    SK_API LazySurfaceDesc callbackDesc() const override;
    ...
    SK_API size_t onUninstantiatedGpuMemorySize() const override;

    // Methods made available via GrTextureProxy::CacheAccess
    SK_API void setUniqueKey(GrProxyProvider*, const GrUniqueKey&);
    SK_API void clearUniqueKey();
