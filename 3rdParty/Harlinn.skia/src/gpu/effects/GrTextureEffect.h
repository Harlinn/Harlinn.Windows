...
public:
    ...
    SK_API static std::unique_ptr<GrFragmentProcessor> Make(
            GrSurfaceProxyView,
            SkAlphaType,
     ...
     */
    SK_API static std::unique_ptr<GrFragmentProcessor> Make(GrSurfaceProxyView, SkAlphaType,
     ...
     */
    SK_API static std::unique_ptr<GrFragmentProcessor> MakeSubset(GrSurfaceProxyView,
                                                           SkAlphaType,
                                                           const SkMatrix&,
                                                           GrSamplerState,
                                                           const SkRect& subset,
     ...
     */
    SK_API static std::unique_ptr<GrFragmentProcessor> MakeCustomLinearFilterInset(
            GrSurfaceProxyView,
            SkAlphaType,
            const SkMatrix&,
    ...
    public:
        SK_API void emitCode(EmitArgs&) override;
...
private:
    ...
    SK_API static ShaderMode GetShaderMode(GrSamplerState::WrapMode,
                                    GrSamplerState::Filter,
                                    GrSamplerState::MipmapMode);
    SK_API static bool ShaderModeIsClampToBorder(ShaderMode);
    ...
    // is not rectangle.
    SK_API static bool ShaderModeRequiresUnormCoord(ShaderMode);
    ...
    SK_API bool matrixEffectShouldNormalize() const;
