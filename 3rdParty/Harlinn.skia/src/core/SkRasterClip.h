...
public:
    SK_API SkRasterClip();
    SK_API explicit SkRasterClip(const SkIRect&);
    SK_API explicit SkRasterClip(const SkRegion&);
    SK_API explicit SkRasterClip(const SkRasterClip&);
    SK_API SkRasterClip(const SkPath& path, const SkIRect& bounds, bool doAA);

    SK_API ~SkRasterClip();

    SK_API SkRasterClip& operator=(const SkRasterClip&);
    ...
    SK_API bool op(const SkRegion&, SkClipOp);
    SK_API bool op(const SkRect&, const SkMatrix& matrix, SkClipOp, bool doAA);
    SK_API bool op(const SkRRect&, const SkMatrix& matrix, SkClipOp, bool doAA);
    SK_API bool op(const SkPath&, const SkMatrix& matrix, SkClipOp, bool doAA);
    SK_API bool op(sk_sp<SkShader>);

    SK_API void translate(int dx, int dy, SkRasterClip* dst) const;
...
private:
    ...
    SK_API void convertToAA();

    SK_API bool op(const SkRasterClip&, SkClipOp);
};
...
public:
    SK_API SkAAClipBlitterWrapper();
    SK_API SkAAClipBlitterWrapper(const SkRasterClip&, SkBlitter*);
    SK_API SkAAClipBlitterWrapper(const SkAAClip*, SkBlitter*);

    SK_API void init(const SkRasterClip&, SkBlitter*);
