...
public:
     ...
     *  read offset.
     */
    SK_API static int CountTTCEntries(SkStream*);
     ...
     *  read offset.
     */
    SK_API static int GetTableTags(SkStream*, int ttcIndex, SkFontTableTag tags[]);
     ...
     *  read offset.
     */
    SK_API static size_t GetTableData(SkStream*, int ttcIndex, SkFontTableTag tag,
