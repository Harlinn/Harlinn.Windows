...
public:
    ...
    */
    SK_API bool read(void* buffer, size_t size);
    SK_API bool skipToAlign4();
    ...
    SK_API const void* skip(size_t bytes);
...
public:
    ...
    size_t  pos() const { return fPos - fData; }
    SK_API void*   skip(size_t size); // return start of skipped data
...
private:
    SK_API void    writeNoSizeCheck(const void* buffer, size_t size);
