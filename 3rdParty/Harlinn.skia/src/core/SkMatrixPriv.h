...
public:
    ...
    */
    ...
    SK_API static void MapHomogeneousPointsWithStride(const SkMatrix& mx, SkPoint3 dst[], size_t dstStride,
    ...
    SK_API static SkRect MapRect(const SkM44& m, const SkRect& r);
    ...
    SK_API static SkScalar DifferentialAreaScale(const SkMatrix& m, const SkPoint& p);
};
