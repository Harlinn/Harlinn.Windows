...
SK_API skvm::F32 sk_program_transfer_fn(
    skvm::F32 v, TFKind,
    skvm::F32 G, skvm::F32 A, skvm::F32 B, skvm::F32 C, skvm::F32 D, skvm::F32 E, skvm::F32 F);

SK_API skvm::Color sk_program_transfer_fn(skvm::Builder*, skvm::Uniforms*,
...
SK_API SkColorSpace* sk_srgb_singleton();
SK_API SkColorSpace* sk_srgb_linear_singleton();
