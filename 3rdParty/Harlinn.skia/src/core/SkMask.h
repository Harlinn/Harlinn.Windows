...
struct SkMask {
    ...
    */
    ...
    SK_API static uint8_t* AllocImage(size_t bytes, AllocType = kUninit_Alloc);
    SK_API static void FreeImage(void* image);
     ...
     */
    SK_API static SkMask PrepareDestination(int radiusX, int radiusY, const SkMask& src);
};
