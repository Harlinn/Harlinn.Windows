...
SK_API void SkRecordOptimize(SkRecord*);

// Turns logical no-op Save-[non-drawing command]*-Restore patterns into actual no-ops.
SK_API void SkRecordNoopSaveRestores(SkRecord*);

#ifndef SK_BUILD_FOR_ANDROID_FRAMEWORK
// For some SaveLayer-[drawing command]-Restore patterns, merge the SaveLayer's alpha into the
// draw, and no-op the SaveLayer and Restore.
SK_API void SkRecordNoopSaveLayerDrawRestores(SkRecord*);
#endif
...
SK_API void SkRecordMergeSvgOpacityAndFilterLayers(SkRecord*);

// Experimental optimizers
SK_API void SkRecordOptimize2(SkRecord*);
