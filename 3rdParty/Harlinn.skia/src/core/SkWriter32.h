...
public:
     ...
     */
    SK_API void writeString(const char* str, size_t len = (size_t)-1);
     ...
     */
    SK_API static size_t WriteStringSize(const char* str, size_t len = (size_t)-1);
     ...
     */
    SK_API sk_sp<SkData> snapshotAsData() const;
private:
    SK_API void growToAtLeast(size_t size);
