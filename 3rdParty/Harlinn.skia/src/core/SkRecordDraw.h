...
SK_API void SkRecordFillBounds(const SkRect& cullRect, const SkRecord&,
...
SK_API void SkRecordComputeLayers(const SkRect& cullRect, const SkRecord&, SkRect bounds[],
                           const SkBigPicture::SnapshotArray*, SkLayerInfo* data);

// Draw an SkRecord into an SkCanvas.  A convenience wrapper around SkRecords::Draw.
SK_API void SkRecordDraw(const SkRecord&, SkCanvas*, SkPicture const* const drawablePicts[],
...
SK_API void SkRecordPartialDraw(const SkRecord&, SkCanvas*,
