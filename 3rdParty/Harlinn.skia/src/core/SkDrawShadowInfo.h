...
SK_API bool GetSpotShadowTransform(const SkPoint3& lightPos, SkScalar lightRadius,
...
SK_API void GetLocalBounds(const SkPath&, const SkDrawShadowRec&, const SkMatrix& ctm, SkRect* bounds);
