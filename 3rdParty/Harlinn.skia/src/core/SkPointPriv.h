...
public:
    ...
    SK_API static SkScalar DistanceToLineBetweenSqd(const SkPoint& pt, const SkPoint& a,
    ...
    SK_API static SkScalar DistanceToLineSegmentBetweenSqd(const SkPoint& pt, const SkPoint& a,
                                                   const SkPoint& b);
    ...
    SK_API static bool SetLengthFast(SkPoint* pt, float length);
