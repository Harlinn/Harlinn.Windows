...
SK_API void SkAppendScalar(SkString*, SkScalar, SkScalarAsStringType);
...
SK_API SkString SkTabString(const SkString& string, int tabCnt);

SK_API SkString SkStringFromUTF16(const uint16_t* src, size_t count);
