...
public:
    ...
    SK_API virtual void blitV(int x, int y, int height, SkAlpha alpha);

    /// Blit a solid rectangle one or more pixels wide.
    SK_API virtual void blitRect(int x, int y, int width, int height);
    ...
    */
    SK_API virtual void blitAntiRect(int x, int y, int width, int height,
                              SkAlpha leftAlpha, SkAlpha rightAlpha);

    // Blit a rect in AA with size at least 3 x 3 (small rect has too many edge cases...)
    SK_API void blitFatAntiRect(const SkRect& rect);

    /// Blit a pattern of pixels defined by a rectangle-clipped mask;
    /// typically used for text.
    SK_API virtual void blitMask(const SkMask&, const SkIRect& clip);

    /** If the blitter just sets a single value for each pixel, return the
        bitmap it draws into, and assign value. If not, return nullptr and ignore
        the value parameter.
    */
    SK_API virtual const SkPixmap* justAnOpaqueColor(uint32_t* value);
     ...
     *  returns false.
     */
    SK_API virtual bool isNullBlitter() const;
    ...
    SK_API void blitMaskRegion(const SkMask& mask, const SkRegion& clip);
    SK_API void blitRectRegion(const SkIRect& rect, const SkRegion& clip);
    SK_API void blitRegion(const SkRegion& clip);
    ///@}

    /** @name Factories
        Return the correct blitter to use given the specified context.
     */
    SK_API static SkBlitter* Choose(const SkPixmap& dst,
    ...
    SK_API static SkBlitter* ChooseSprite(const SkPixmap& dst,
                                   const SkPaint&,
                                   const SkPixmap& src,
                                   int left, int top,
    ...
    SK_API static bool UseLegacyBlitter(const SkPixmap&, const SkPaint&, const SkMatrix&);
...
public:
    ...
    SK_API bool isNullBlitter() const override;
};
...
public:
    ...
    SK_API void blitV(int x, int y, int height, SkAlpha alpha) override;
    SK_API void blitRect(int x, int y, int width, int height) override;
    SK_API void blitAntiRect(int x, int y, int width, int height,
...
public:
    ...
    SK_API void blitMask(const SkMask&, const SkIRect& clip) override;
    SK_API const SkPixmap* justAnOpaqueColor(uint32_t* value) override;
    SK_API void blitAntiH2(int x, int y, U8CPU a0, U8CPU a1) override;
    SK_API void blitAntiV2(int x, int y, U8CPU a0, U8CPU a1) override;
...
public:
    SK_API SkBlitter*  apply(SkBlitter* blitter, const SkRegion* clip,
