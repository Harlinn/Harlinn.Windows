...
#define DEFINE_DEFAULT(name) SK_API decltype(name) name = SK_OPTS_NS::name
...
#define M(st) (StageFn)SK_OPTS_NS::st,
    SK_API StageFn stages_highp[] = { SK_RASTER_PIPELINE_STAGES(M) };
    SK_API StageFn just_return_highp = (StageFn)SK_OPTS_NS::just_return;
    SK_API void (*start_pipeline_highp)(size_t,size_t,size_t,size_t,void**)
        = SK_OPTS_NS::start_pipeline;
#undef M

#define M(st) (StageFn)SK_OPTS_NS::lowp::st,
    SK_API StageFn stages_lowp[] = { SK_RASTER_PIPELINE_STAGES(M) };
    SK_API StageFn just_return_lowp = (StageFn)SK_OPTS_NS::lowp::just_return;
    SK_API void (*start_pipeline_lowp)(size_t,size_t,size_t,size_t,void**)
