...
public:
    ...
    SK_API SkColorSpace* getColorSpace() const;
     ...
     */
    SK_API void draw(SkCanvas*, SkScalar x, SkScalar y, const SkSamplingOptions&, const SkPaint*) const;
    void draw(SkCanvas* canvas, SkScalar x, SkScalar y) const {
        this->draw(canvas, x, y, SkSamplingOptions(), nullptr);
    }

    SK_API static sk_sp<SkSpecialImage> MakeFromImage(GrRecordingContext*,
                                               const SkIRect& subset,
                                               sk_sp<SkImage>,
                                               const SkSurfaceProps&);
    SK_API static sk_sp<SkSpecialImage> MakeFromRaster(const SkIRect& subset,
                                                const SkBitmap&,
                                                const SkSurfaceProps&);
    SK_API static sk_sp<SkSpecialImage> CopyFromRaster(const SkIRect& subset,
                                                const SkBitmap&,
                                                const SkSurfaceProps&);
#if SK_SUPPORT_GPU
    SK_API static sk_sp<SkSpecialImage> MakeDeferredFromGpu(GrRecordingContext*,
                                                     const SkIRect& subset,
                                                     uint32_t uniqueID,
                                                     GrSurfaceProxyView,
                                                     GrColorType,
     ...
     */
    SK_API sk_sp<SkSpecialSurface> makeSurface(SkColorType colorType,
     ...
     */
    SK_API sk_sp<SkSurface> makeTightSurface(SkColorType colorType,
                                      const SkColorSpace* colorSpace,
                                      const SkISize& size,
     ...
     */
    SK_API sk_sp<SkSpecialImage> makeSubset(const SkIRect& subset) const;
     ...
     */
    SK_API sk_sp<SkImage> asImage(const SkIRect* subset = nullptr) const;

    /**
     *  If the SpecialImage is backed by a gpu texture, return true.
     */
    SK_API bool isTextureBacked() const;

    /**
     * Return the GrRecordingContext if the SkSpecialImage is GrTexture-backed
     */
    SK_API GrRecordingContext* getContext() const;
     ...
     */
    SK_API GrSurfaceProxyView view(GrRecordingContext*) const;
#endif
     ...
     */
    SK_API bool getROPixels(SkBitmap*) const;

protected:
    SK_API SkSpecialImage(const SkIRect& subset, uint32_t uniqueID, const SkSurfaceProps&);
