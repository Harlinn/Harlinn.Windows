...
class SkBlurMask {
public:
    SK_API static bool SK_WARN_UNUSED_RESULT BlurRect(SkScalar sigma, SkMask *dst, const SkRect &src,
                                               SkBlurStyle, SkIPoint *margin = nullptr,
                                               SkMask::CreateMode createMode =
                                                  SkMask::kComputeBoundsAndRenderImage_CreateMode);
    SK_API static bool SK_WARN_UNUSED_RESULT BlurRRect(SkScalar sigma, SkMask *dst, const SkRRect &src,
                                                SkBlurStyle, SkIPoint *margin = nullptr,
                                                SkMask::CreateMode createMode =
                                                  SkMask::kComputeBoundsAndRenderImage_CreateMode);
    ...
    SK_API static bool SK_WARN_UNUSED_RESULT BoxBlur(SkMask* dst, const SkMask& src,
                                              SkScalar sigma, SkBlurStyle style,
                                              SkIPoint* margin = nullptr);

    // the "ground truth" blur does a gaussian convolution; it's slow
    // but useful for comparison purposes.
    SK_API static bool SK_WARN_UNUSED_RESULT BlurGroundTruth(SkScalar sigma, SkMask* dst,
                                                      const SkMask& src,
                                                      SkBlurStyle, SkIPoint* margin = nullptr);

    // If radius > 0, return the corresponding sigma, else return 0
    SK_API static SkScalar ConvertRadiusToSigma(SkScalar radius);
    // If sigma > 0.5, return the corresponding radius, else return 0
    SK_API static SkScalar ConvertSigmaToRadius(SkScalar sigma);
    ...
    */
    SK_API static uint8_t ProfileLookup(const uint8_t* profile, int loc, int blurredWidth, int sharpWidth);
    ...
    */
    SK_API static void ComputeBlurProfile(uint8_t* profile, int size, SkScalar sigma);
    ...
    */
    ...
    SK_API static void ComputeBlurredScanline(uint8_t* pixels, const uint8_t* profile,
