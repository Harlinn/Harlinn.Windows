...
// the SkShader.
SK_API sk_sp<SkShader> SkMakeBitmapShader(const SkBitmap& src, SkTileMode, SkTileMode,
...
SK_API sk_sp<SkShader> SkMakeBitmapShaderForPaint(const SkPaint& paint, const SkBitmap& src,
...
extern SK_API const SkPixelRef* SkBitmapImageGetPixelRef(const SkImage* rasterImage);
 ...
 */
SK_API bool SkImage_pinAsTexture(const SkImage*, GrRecordingContext*);
 ...
 */
SK_API void SkImage_unpinAsTexture(const SkImage*, GrRecordingContext*);
