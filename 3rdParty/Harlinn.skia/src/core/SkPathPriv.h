...
public:
     ...
     */
    SK_API static SkPathFirstDirection ComputeFirstDirection(const SkPath&);
     ...
     */
    SK_API static bool IsSimpleRect(const SkPath& path, bool isSimpleFill, SkRect* rect,
     ...
     */
    SK_API static void CreateDrawArcPath(SkPath* path, const SkRect& oval, SkScalar startAngle,
     ...
     * oval.
     */
    SK_API static bool DrawArcIsConvex(SkScalar sweepAngle, bool useCenter, bool isFillNoPathEffect);
    ...
    */
    ...
    SK_API static bool IsAxisAligned(const SkPath& path);
    ...
    SK_API static bool IsRectContour(const SkPath&, bool allowPartial, int* currVerb,
     ...
     */
    SK_API static bool IsNestedFillRects(const SkPath&, SkRect rect[2],
     ...
     */
    SK_API static bool PerspectiveClip(const SkPath& src, const SkMatrix&, SkPath* result);
     ...
     */
    SK_API static int GenIDChangeListenersCount(const SkPath&);
...
public:
    SK_API SkPathEdgeIter(const SkPath& path);
