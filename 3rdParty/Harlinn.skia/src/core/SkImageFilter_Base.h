...
public:
     ...
     */
    SK_API skif::FilterResult filterImage(const skif::Context& context) const;
     ...
     */
    SK_API skif::LayerSpace<SkIRect> getInputBounds(
     ...
     */
    SK_API skif::DeviceSpace<SkIRect> getOutputBounds(
    ...
    SK_API bool affectsTransparentBlack() const;
    ...
    SK_API MatrixCapability getCTMCapability() const;
...
protected:
    ...
    public:
         ...
         */
        SK_API void applyTo(const SkIRect& imageBounds, const SkMatrix& matrix, bool embiggen,
    ...
    SK_API SkImageFilter_Base(sk_sp<SkImageFilter> const* inputs, int inputCount,
                       const SkRect* cropRect);

    SK_API ~SkImageFilter_Base() override;
    ...
    SK_API virtual SkIRect onFilterBounds(const SkIRect&, const SkMatrix& ctm,
                                   MapDirection, const SkIRect* inputRect) const;
    SK_API virtual SkIRect onFilterNodeBounds(const SkIRect&, const SkMatrix& ctm,
                                       MapDirection, const SkIRect* inputRect) const;
    ...
    SK_API skif::LayerSpace<SkIRect> visitInputLayerBounds(
    ...
    // filters.
    SK_API skif::LayerSpace<SkIRect> visitOutputLayerBounds(
    ...
    SK_API skif::FilterResult filterInput(int index, const skif::Context& ctx) const;
     ...
     */
    SK_API bool applyCropRect(const Context&, const SkIRect& srcBounds, SkIRect* dstBounds) const;
     ...
     *  DEPRECATED - Remove once cropping is handled by a separate filter.
     */
    SK_API sk_sp<SkSpecialImage> applyCropRectAndPad(const Context&, SkSpecialImage* src,
...
#if SK_SUPPORT_GPU
    SK_API static sk_sp<SkSpecialImage> DrawWithFP(GrRecordingContext* context,
     ...
     */
    SK_API static sk_sp<SkSpecialImage> ImageToColorSpace(SkSpecialImage* src,
                                                   SkColorType colorType,
    ...
    SK_API static SkIRect DetermineRepeatedSrcBound(const SkIRect& srcBounds,
...
private:
     ...
     */
    SK_API virtual skif::FilterResult onFilterImage(const skif::Context& context) const;
     ...
     */
    SK_API virtual skif::LayerSpace<SkIRect> onGetInputLayerBounds(
            const skif::Mapping& mapping, const skif::LayerSpace<SkIRect>& desiredOutput,
    ...
    SK_API virtual skif::LayerSpace<SkIRect> onGetOutputLayerBounds(
            const skif::Mapping& mapping, const skif::LayerSpace<SkIRect>& contentBounds) const;
