...
public:
     ...
     */
    SK_API uint32_t find(void*) const;
     ...
     */
    SK_API void copyToArray(void* array[]) const;
...
private:
    ...
    SK_API static bool Less(const Pair& a, const Pair& b);
...
public:
    SK_API ~SkRefCntSet() override;

protected:
    // overrides
    SK_API void incPtr(void*) override;
    SK_API void decPtr(void*) override;
};
...
public:
     ...
     */
    SK_API uint32_t find(SkFlattenable::Factory);
     ...
     * function.
     */
    SK_API const char* getNextAddedFactoryName();
private:
