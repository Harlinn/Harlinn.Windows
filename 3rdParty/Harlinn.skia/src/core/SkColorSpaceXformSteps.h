...
struct SkColorSpaceXformSteps {
    ...
    SK_API SkColorSpaceXformSteps(const SkColorSpace* src, SkAlphaType srcAT,
    ...
    SK_API void apply(float rgba[4]) const;
    SK_API void apply(SkRasterPipeline*) const;
    SK_API skvm::Color program(skvm::Builder*, skvm::Uniforms*, skvm::Color) const;
