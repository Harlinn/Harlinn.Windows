...
public:
     ...
     * undefined.
     */
    SK_API bool determineBinaryType(const Context& context,
                             const Type& left,
                             const Type& right,
...
private:
    SK_API bool isOperator() const;
    SK_API bool isMatrixMultiply(const Type& left, const Type& right);
