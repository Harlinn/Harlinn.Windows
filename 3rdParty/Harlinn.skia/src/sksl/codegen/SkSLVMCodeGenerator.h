...
struct SkVMDebugInfo {
    SK_API void dump(SkWStream* o) const;
...
SK_API skvm::Color ProgramToSkVM(const Program& program,
 ...
 */
SK_API bool ProgramToSkVM(const Program& program,
                   const FunctionDefinition& function,
                   skvm::Builder* b,
                   SkVMDebugInfo* debugInfo,
                   SkSpan<skvm::Val> uniforms,
...
SK_API const FunctionDefinition* Program_GetFunction(const Program& program, const char* function);
...
SK_API std::unique_ptr<UniformInfo> Program_GetUniformInfo(const Program& program);

SK_API bool testingOnly_ProgramToSkVMShader(const Program& program,
                                     skvm::Builder* builder,
                                     SkVMDebugInfo* debugInfo);
