...
public:
    ...
    SK_API static std::unique_ptr<Block> Make(int line,
    ...
    SK_API static std::unique_ptr<Statement> MakeUnscoped(int line, StatementArray statements);
    ...
    SK_API std::unique_ptr<Statement> clone() const override;

    SK_API String description() const override;
