...
WEBM_EXPORT bool CopyPrimaryChromaticity(const mkvparser::PrimaryChromaticity& parser_pc,
                             PrimaryChromaticityPtr* muxer_pc);

WEBM_EXPORT bool MasteringMetadataValuePresent(double value);

WEBM_EXPORT bool CopyMasteringMetadata(const mkvparser::MasteringMetadata& parser_mm,
                           mkvmuxer::MasteringMetadata* muxer_mm);

WEBM_EXPORT bool ColourValuePresent(long long value);

WEBM_EXPORT bool CopyColour(const mkvparser::Colour& parser_colour,
                mkvmuxer::Colour* muxer_colour);

// Returns true if |features| is set to one or more valid values.
WEBM_EXPORT bool ParseVpxCodecPrivate(const uint8_t* private_data, int32_t length,
