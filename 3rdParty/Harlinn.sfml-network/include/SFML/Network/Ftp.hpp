...
public:
    ...
    public:
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API explicit Response(Status code = InvalidResponse, const std::string& message = "");
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API bool isOk() const;
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API Status getStatus() const;
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API const std::string& getMessage() const;
    ...
    public:
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API DirectoryResponse(const Response& response);
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API const std::string& getDirectory() const;
    ...
    public:
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API ListingResponse(const Response& response, const std::string& data);
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API const std::vector<std::string>& getListing() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Response connect(const IpAddress& server, unsigned short port = 21, Time timeout = Time::Zero);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Response disconnect();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Response login();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Response login(const std::string& name, const std::string& password);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Response keepAlive();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API DirectoryResponse getWorkingDirectory();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API ListingResponse getDirectoryListing(const std::string& directory = "");
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Response changeDirectory(const std::string& directory);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Response parentDirectory();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Response createDirectory(const std::string& name);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Response deleteDirectory(const std::string& name);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Response renameFile(const std::string& file, const std::string& newName);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Response deleteFile(const std::string& name);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Response download(const std::string& remoteFile, const std::string& localPath, TransferMode mode = Binary);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Response upload(const std::string& localFile, const std::string& remotePath, TransferMode mode = Binary, bool append = false);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Response sendCommand(const std::string& command, const std::string& parameter = "");
