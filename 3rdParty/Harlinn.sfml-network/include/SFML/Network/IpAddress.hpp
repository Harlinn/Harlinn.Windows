...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API IpAddress(const std::string& address);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API IpAddress(const char* address);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API IpAddress(Uint8 byte0, Uint8 byte1, Uint8 byte2, Uint8 byte3);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API explicit IpAddress(Uint32 address);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API std::string toString() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Uint32 toInteger() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API static IpAddress getLocalAddress();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API static IpAddress getPublicAddress(Time timeout = Time::Zero);
...
private:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API void resolve(const std::string& address);
