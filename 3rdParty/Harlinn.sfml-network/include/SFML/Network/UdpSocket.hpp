...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API unsigned short getLocalPort() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Status bind(unsigned short port, const IpAddress& address = IpAddress::Any);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Status send(const void* data, std::size_t size, const IpAddress& remoteAddress, unsigned short remotePort);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Status receive(void* data, std::size_t size, std::size_t& received, IpAddress& remoteAddress, unsigned short& remotePort);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Status send(Packet& packet, const IpAddress& remoteAddress, unsigned short remotePort);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Status receive(Packet& packet, IpAddress& remoteAddress, unsigned short& remotePort);
