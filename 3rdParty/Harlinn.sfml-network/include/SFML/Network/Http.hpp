...
public:
    ...
    public:
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API Request(const std::string& uri = "/", Method method = Get, const std::string& body = "");
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API void setField(const std::string& field, const std::string& value);
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API void setMethod(Method method);
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API void setUri(const std::string& uri);
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API void setHttpVersion(unsigned int major, unsigned int minor);
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API void setBody(const std::string& body);
    ...
    private:
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API std::string prepare() const;
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API bool hasField(const std::string& field) const;
    ...
    public:
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API const std::string& getField(const std::string& field) const;
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API unsigned int getMajorHttpVersion() const;
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API unsigned int getMinorHttpVersion() const;
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API const std::string& getBody() const;
    ...
    private:
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API void parse(const std::string& data);
        ...
        ///
        ////////////////////////////////////////////////////////////
        SFML_NETWORK_API void parseFields(std::istream &in);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Http(const std::string& host, unsigned short port = 0);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API void setHost(const std::string& host, unsigned short port = 0);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_NETWORK_API Response sendRequest(const Request& request, Time timeout = Time::Zero);
