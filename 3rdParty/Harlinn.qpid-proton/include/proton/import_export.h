 ...
 */
#ifdef BUILDING_HARLINN_QPIDPROTON
#define qpid_proton_core_EXPORTS 1
#define qpid_proton_EXPORTS 1
#define qpid_proton_proactor_EXPORTS 1
#else
#pragma comment(lib,"Harlinn.qpid-proton.lib")
#endif
