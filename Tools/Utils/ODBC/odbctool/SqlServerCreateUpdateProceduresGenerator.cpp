...
namespace Harlinn::ODBC::Tool
{
    ...
    WideString SqlServerCreateUpdateProceduresGenerator::GetProcedureParameters1( const ClassInfo& classInfo )
    {
    ...
    WideString SqlServerCreateUpdateProceduresGenerator::GetTopLevelUpdateStatement1( const ClassInfo& classInfo )
    {
        StringBuilder<wchar_t> statement;
    ...
    WideString SqlServerCreateUpdateProceduresGenerator::GetUpdateStatement1( const ClassInfo& classInfo )
    {
        StringBuilder<wchar_t> statement;
    ...
    void SqlServerCreateUpdateProceduresGenerator::CreateUpdateStatement1( const ClassInfo& classInfo )
    {
        auto procedureName = SqlServerHelper::GetUpdateProcedureName1( classInfo );
        auto baseClassesAndSelf = classInfo.BaseClassesAndSelf( );
    ...
    WideString SqlServerCreateUpdateProceduresGenerator::GetProcedureParameters2( const ClassInfo& classInfo )
    {
    ...
    WideString SqlServerCreateUpdateProceduresGenerator::GetTopLevelUpdateStatement2( const ClassInfo& classInfo )
    {
        StringBuilder<wchar_t> statement;
    ...
    WideString SqlServerCreateUpdateProceduresGenerator::GetUpdateStatement2( const ClassInfo& classInfo )
    {
        StringBuilder<wchar_t> statement;
    ...
    void SqlServerCreateUpdateProceduresGenerator::CreateUpdateStatement2( const ClassInfo& classInfo )
    {
        auto procedureName = SqlServerHelper::GetUpdateProcedureName2( classInfo );
        auto baseClassesAndSelf = classInfo.BaseClassesAndSelf( );
