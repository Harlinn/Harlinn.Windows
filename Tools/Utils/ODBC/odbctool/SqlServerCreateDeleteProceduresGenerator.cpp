...
namespace Harlinn::ODBC::Tool
{
    ...
    WideString SqlServerCreateDeleteProceduresGenerator::GetDeleteStatement( const ClassInfo& classInfo )
    {
    ...
    void SqlServerCreateDeleteProceduresGenerator::CreateDeleteProcedure( const ClassInfo& classInfo )
    {
        ...
        {
            auto rowVersionName = rowVersion->Name( );
            auto rowVersionType = SqlServerHelper::GetColumnType( *rowVersion );
