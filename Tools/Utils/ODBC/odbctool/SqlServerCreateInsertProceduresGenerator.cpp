...
namespace Harlinn::ODBC::Tool
{
    ...
    WideString SqlServerCreateInsertProceduresGenerator::GetInsertProcedure( const ClassInfo& classInfo )
    {
    ...
    WideString SqlServerCreateInsertProceduresGenerator::GetInsertTrigger( const ClassInfo& classInfo )
    {
        ...
        auto triggerName = SqlServerHelper::GetInsertTriggerName( classInfo );
    ...
    void SqlServerCreateInsertProceduresGenerator::CreateInsertProcedure( const ClassInfo& classInfo )
    {
    ...
    void SqlServerCreateInsertProceduresGenerator::CreateInsertTrigger( const ClassInfo& classInfo )
    {
