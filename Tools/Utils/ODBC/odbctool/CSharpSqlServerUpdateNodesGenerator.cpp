...
{
    void CSharpSqlServerUpdateNodesGenerator::Run( )
    {
    ...
    void CSharpSqlServerUpdateNodesGenerator::CreateUpdateNode( const ClassInfo& classInfo )
    {
    ...
    void CSharpSqlServerUpdateNodesGenerator::CreateCollectDependencies( const ClassInfo& classInfo )
    {
    ...
    void CSharpSqlServerUpdateNodesGenerator::CreateInsert( const ClassInfo& classInfo )
    {
    ...
    void CSharpSqlServerUpdateNodesGenerator::CreateInsert1( const ClassInfo& classInfo )
    {
    ...
    void CSharpSqlServerUpdateNodesGenerator::CreateUpdate( const ClassInfo& classInfo )
    {
    ...
    void CSharpSqlServerUpdateNodesGenerator::CreateUpdate1( const ClassInfo& classInfo )
    {
    ...
    void CSharpSqlServerUpdateNodesGenerator::CreateUpdate2( const ClassInfo& classInfo )
    {
    ...
    void CSharpSqlServerUpdateNodesGenerator::CreateDelete( const ClassInfo& classInfo )
    {
    ...
    void CSharpSqlServerUpdateNodesGenerator::CreateFactory( )
    {
        const auto& model = Model( );
        const auto& classes = model.Classes( );
        auto classCount = classes.size( );
    ...
    void CSharpSqlServerUpdateNodesGenerator::CreateUpdateHandler( )
    {
