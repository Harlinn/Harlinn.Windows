...
{
    void CppDatabaseReadersGenerator::Run( )
    {
    ...
    void CppDatabaseReadersGenerator::CreateBaseClass( )
    {
    ...
    void CppDatabaseReadersGenerator::CreateColumnDataType( const ClassInfo& classInfo )
    {
    ...
    void CppDatabaseReadersGenerator::CreateBindColumns( const ClassInfo& classInfo )
    {
        auto members = SqlServerHelper::GetOwnColumnsForSelect( classInfo );
        if ( members.empty( ) == false )
        {
    ...
    void CppDatabaseReadersGenerator::CreateReadUnboundData( const ClassInfo& classInfo )
    {
    ...
    void CppDatabaseReadersGenerator::CreateAccessor( const ClassInfo& classInfo, const MemberInfo& member )
    {
    ...
    void CppDatabaseReadersGenerator::CreateWriteColumns( const ClassInfo& classInfo )
    {
