...
{
    void CppComplexDatabaseReadersSourceGenerator::Run( )
    {
        ...
        WriteLine( );
        WriteLine( "#include \"ComplexDatabaseReaders.h\"" );
        WriteLine( );
    ...
    void CppComplexDatabaseReadersSourceGenerator::CreateColumnDataType( const ClassInfo& classInfo )
    {
    ...
    void CppComplexDatabaseReadersSourceGenerator::CreateQuery( const ClassInfo& classInfo )
    {
        auto className = CppHelper::GetComplexColumnDataType( classInfo );
        auto primaryKey = classInfo.PrimaryKey( );
    ...
    void CppComplexDatabaseReadersSourceGenerator::CreateBindColumns( const ClassInfo& classInfo )
    {
        auto className = CppHelper::GetComplexColumnDataType( classInfo );
    ...
    void CppComplexDatabaseReadersSourceGenerator::CreateReadUnboundData( const ClassInfo& classInfo )
    {
        auto className = CppHelper::GetComplexColumnDataType( classInfo );
        auto shortName = classInfo.ShortName( ).ToUpper( );
