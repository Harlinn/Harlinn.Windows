#pragma once
#ifndef CSHARPDATABASESGENERATOR_H_
#define CSHARPDATABASESGENERATOR_H_
/*
...
*/
#include "CodeGenerators/CSharp/Databases/MsSql/CSharpMsSqlGenerators.h"

namespace Harlinn::Tools::DbXGen::CodeGenerators::CSharp::Databases
{
