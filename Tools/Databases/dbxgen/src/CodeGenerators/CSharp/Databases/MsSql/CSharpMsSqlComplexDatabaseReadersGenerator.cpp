...
namespace Harlinn::Tools::DbXGen::CodeGenerators::CSharp::Databases::MsSql
{
    ...
    void CSharpMsSqlComplexDatabaseReadersGenerator::Run( )
    {
    ...
    void CSharpMsSqlComplexDatabaseReadersGenerator::CreateQuery( const ClassInfo& classInfo )
    {
    ...
    void CSharpMsSqlComplexDatabaseReadersGenerator::CreateFieldIds( const ClassInfo& classInfo )
    {
        auto members = MsSqlHelper::GetColumnsForComplexSelect( classInfo );
    ...
    void CSharpMsSqlComplexDatabaseReadersGenerator::CreateAccessors( const ClassInfo& classInfo )
    {
        auto shortName = classInfo.ShortName( ).ToUpper( );
    ...
    void CSharpMsSqlComplexDatabaseReadersGenerator::CreateAccessor( const MemberInfo& member, const WideString& propertyName, const WideString& fieldId )
    {
        auto getFunctionName = CSharpHelper::GetDataReaderGetFunctionName( member );
    ...
    void CSharpMsSqlComplexDatabaseReadersGenerator::CreateWriteTo( const ClassInfo& classInfo )
    {
    ...
    void CSharpMsSqlComplexDatabaseReadersGenerator::CreateGetDataObject( const ClassInfo& classInfo )
    {
