#pragma once
#ifndef HARLINN_JAVA_HJJNI_H_
#define HARLINN_JAVA_HJJNI_H_
/*
...
HJ_EXPORT jint JNI_CreateJavaVM( JavaVM** pvm, void** penv, void* args );

HJ_EXPORT jint JNI_GetCreatedJavaVMs( JavaVM**, jsize, jsize* );

// Defined by native libraries. 
__declspec(dllexport) jint __stdcall JNI_OnLoad( JavaVM* vm, void* reserved );

__declspec( dllexport ) void __stdcall JNI_OnUnload( JavaVM* vm, void* reserved );
