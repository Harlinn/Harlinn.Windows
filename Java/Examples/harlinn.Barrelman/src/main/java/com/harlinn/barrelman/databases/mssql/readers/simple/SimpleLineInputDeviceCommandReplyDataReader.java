...
public class SimpleLineInputDeviceCommandReplyDataReader extends ResultSetWrapper {
    ...
    public final static String BaseViewName = "LineInputDeviceCommandReplyView";
    public final static String ViewAliasName = "lidcr";
    ...
    public SimpleLineInputDeviceCommandReplyDataReader( ResultSet resultSet ) {
        super( resultSet );
    }
    ...
    public void writeTo(BinaryWriter destination) throws SQLException {
        destination.writeInt32( Kind.LineInputDeviceCommandReply );
