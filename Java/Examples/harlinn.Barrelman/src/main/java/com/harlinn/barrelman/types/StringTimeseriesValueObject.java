...
public class StringTimeseriesValueObject extends AbstractDataObjectWithGuidKey {

    public final int KIND = Kind.StringTimeseriesValue;
    ...
    public StringTimeseriesValueObject( byte objectState, Guid id, long rowVersion, Guid timeseries, DateTime timestamp, String value ) {
    ...
    public void assignTo( AbstractDataObject target ) {
        ...
        var targetObject = ( StringTimeseriesValueObject )target;
    ...
    public boolean equals(Object obj) {
        ...
        var other = (StringTimeseriesValueObject)obj;
