...
public class SimpleRadioCommandReplyDataReader extends ResultSetWrapper {
    ...
    public final static String BaseViewName = "RadioCommandReplyView";
    ...
    public SimpleRadioCommandReplyDataReader( ResultSet resultSet ) {
        super( resultSet );
    }
    ...
    public void writeTo(BinaryWriter destination) throws SQLException {
        destination.writeInt32( Kind.RadioCommandReply );
