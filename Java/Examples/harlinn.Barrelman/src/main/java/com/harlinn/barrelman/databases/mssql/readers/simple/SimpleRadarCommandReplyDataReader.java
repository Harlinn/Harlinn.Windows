...
public class SimpleRadarCommandReplyDataReader extends ResultSetWrapper {
    ...
    public final static int COMMAND_FIELD_ID = 6;
    public final static int STATUS_FIELD_ID = 7;
    public final static int MESSAGE_FIELD_ID = 8;

    public SimpleRadarCommandReplyDataReader( ResultSet resultSet ) {
        super( resultSet );
    }
    ...
    public void writeTo(BinaryWriter destination) throws SQLException {
        destination.writeInt32( Kind.RadarCommandReply );
