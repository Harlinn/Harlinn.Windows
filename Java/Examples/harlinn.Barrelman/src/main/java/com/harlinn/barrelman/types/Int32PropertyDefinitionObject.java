...
public class Int32PropertyDefinitionObject extends PropertyDefinitionObject {
    ...
    public void assignTo( AbstractDataObject target ) {
        ...
        var targetObject = ( Int32PropertyDefinitionObject )target;
    ...
    public boolean equals(Object obj) {
        ...
        var other = (Int32PropertyDefinitionObject)obj;
        if( !Comparer.equalsInt32( this._defaultValue, other._defaultValue ) ) {
            return false;
        }
