...
public class SBytePropertyDefinitionObject extends PropertyDefinitionObject {
    ...
    public final int KIND = Kind.SBytePropertyDefinition;
    ...
    public SBytePropertyDefinitionObject( byte objectState, Guid id, long rowVersion, Guid elementType, String name, String description, byte defaultValue, byte minValue, byte maxValue ) {
