...
public class SimpleRadomeCommandDataReader extends ResultSetWrapper {
    ...
    public final static String BaseViewName = "RadomeCommandView";
    ...
    public SimpleRadomeCommandDataReader( ResultSet resultSet ) {
        super( resultSet );
    }
    ...
    public void writeTo(BinaryWriter destination) throws SQLException {
        destination.writeInt32( Kind.RadomeCommand );
