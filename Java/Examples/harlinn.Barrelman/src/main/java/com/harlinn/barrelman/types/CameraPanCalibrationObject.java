...
public class CameraPanCalibrationObject extends AbstractDataObjectWithGuidKey {
    ...
    public final int KIND = Kind.CameraPanCalibration;
    ...
    public CameraPanCalibrationObject( byte objectState, Guid id, long rowVersion, Guid camera, DateTime timestamp ) {
    ...
    public void assignTo( AbstractDataObject target ) {
        ...
        var targetObject = ( CameraPanCalibrationObject )target;
    ...
    public boolean equals(Object obj) {
        ...
        var other = (CameraPanCalibrationObject)obj;
