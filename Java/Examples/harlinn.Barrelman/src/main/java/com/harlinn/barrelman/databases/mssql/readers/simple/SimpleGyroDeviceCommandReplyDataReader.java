...
public class SimpleGyroDeviceCommandReplyDataReader extends ResultSetWrapper {
    ...
    public final static String BaseViewName = "GyroDeviceCommandReplyView";
    public final static String ViewAliasName = "gdcr";
    ...
    public SimpleGyroDeviceCommandReplyDataReader( ResultSet resultSet ) {
        super( resultSet );
    }
    ...
    public void writeTo(BinaryWriter destination) throws SQLException {
        destination.writeInt32( Kind.GyroDeviceCommandReply );
