...
public class CameraCommandSetAutoFocusObject extends CameraCommandObject {
    ...
    public final int KIND = Kind.CameraCommandSetAutoFocus;

    private boolean _enabled = false;

    public CameraCommandSetAutoFocusObject( ) {
    }
    public CameraCommandSetAutoFocusObject( byte objectState, Guid id, long rowVersion, Guid camera, DateTime timestamp, int deviceCommandSourceType, Guid deviceCommandSourceId, Guid reply, boolean enabled ) {
