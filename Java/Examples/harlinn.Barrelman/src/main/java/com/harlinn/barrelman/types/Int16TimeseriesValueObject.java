...
public class Int16TimeseriesValueObject extends AbstractDataObjectWithGuidKey {
    ...
    public final int KIND = Kind.Int16TimeseriesValue;
    ...
    public Int16TimeseriesValueObject( byte objectState, Guid id, long rowVersion, Guid timeseries, DateTime timestamp, Short value ) {
    ...
    public void setValue( Short value ) {
        if( !Comparer.equalsNullableInt16( _value, value ) ) {
            _value = value;
            onPropertyChanged( );
        }
    }
    ...
    public void assignTo( AbstractDataObject target ) {
        ...
        var targetObject = ( Int16TimeseriesValueObject )target;
    ...
    public boolean equals(Object obj) {
        ...
        var other = (Int16TimeseriesValueObject)obj;
        ...
        if( !Comparer.equalsNullableInt16( this._value, other._value ) ) {
            return false;
        }
        return true;
    }
    ...
    public void writeTo( BinaryWriter destination ) {
        ...
        destination.writeNullableInt16( _value );
    }
