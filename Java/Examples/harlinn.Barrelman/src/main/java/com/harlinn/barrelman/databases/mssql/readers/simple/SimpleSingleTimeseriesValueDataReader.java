...
public class SimpleSingleTimeseriesValueDataReader extends ResultSetWrapper {
    ...
    public final static String BaseViewName = "SingleTimeseriesValueView";
    ...
    public SimpleSingleTimeseriesValueDataReader( ResultSet resultSet ) {
        super( resultSet );
    }
    ...
    public final Float getValue() throws SQLException {
        return getNullableSingle( VALUE_FIELD_ID );
    }

    public void writeTo(BinaryWriter destination) throws SQLException {
        destination.writeInt32( Kind.SingleTimeseriesValue );
        destination.writeUInt8( ObjectState.Stored );
        destination.writeGuid( getId( ) );
        destination.writeInt64( getRowVersion( ) );
        destination.writeGuid( getTimeseries( ) );
        destination.writeDateTime( getTimestamp( ) );
        destination.writeNullableSingle( getValue( ) );
    }
