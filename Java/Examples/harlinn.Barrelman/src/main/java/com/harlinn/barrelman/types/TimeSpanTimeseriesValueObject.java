...
public class TimeSpanTimeseriesValueObject extends AbstractDataObjectWithGuidKey {
    ...
    public void setValue( TimeSpan value ) {
        if( !Comparer.equalsNullableTimeSpan( _value, value ) ) {
            _value = value;
            onPropertyChanged( );
        }
    }
    ...
    public void assignTo( AbstractDataObject target ) {
        ...
        var targetObject = ( TimeSpanTimeseriesValueObject )target;
    ...
    public boolean equals(Object obj) {
        ...
        var other = (TimeSpanTimeseriesValueObject)obj;
        ...
        if( !Comparer.equalsNullableTimeSpan( this._value, other._value ) ) {
            return false;
        }
        return true;
    }
    ...
    public void writeTo( BinaryWriter destination ) {
        ...
        destination.writeNullableTimeSpan( _value );
    }
