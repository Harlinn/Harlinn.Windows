...
public class SimpleRadioCommandDataReader extends ResultSetWrapper {
    ...
    public final static String BaseViewName = "RadioCommandView";
    ...
    public SimpleRadioCommandDataReader( ResultSet resultSet ) {
        super( resultSet );
    }
    ...
    public void writeTo(BinaryWriter destination) throws SQLException {
        destination.writeInt32( Kind.RadioCommand );
    ...
    public RadioCommandObject GetDataObject( ) throws SQLException {
            return new RadioCommandObject( ObjectState.Stored, getId( ), getRowVersion( ), getRadio( ), getTimestamp( ), getDeviceCommandSourceType( ), getDeviceCommandSourceId( ), getReply( ) );
    }
