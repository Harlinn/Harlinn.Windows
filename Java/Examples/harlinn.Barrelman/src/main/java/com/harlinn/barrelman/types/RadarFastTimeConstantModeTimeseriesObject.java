...
public class RadarFastTimeConstantModeTimeseriesObject extends Int32TimeseriesObject {
    ...
    public final int KIND = Kind.RadarFastTimeConstantModeTimeseries;

    private Guid _radar;

    public RadarFastTimeConstantModeTimeseriesObject( ) {
    }
    public RadarFastTimeConstantModeTimeseriesObject( byte objectState, Guid id, long rowVersion, Guid catalog, String name, TimeSpan maxRetention, Guid radar ) {
