...
public class ReferenceTimeseriesValueObject extends AbstractDataObjectWithGuidKey {

    public final int KIND = Kind.ReferenceTimeseriesValue;
    ...
    public ReferenceTimeseriesValueObject( byte objectState, Guid id, long rowVersion, Guid timeseries, DateTime timestamp, Guid value ) {
    ...
    public void assignTo( AbstractDataObject target ) {
        ...
        var targetObject = ( ReferenceTimeseriesValueObject )target;
    ...
    public boolean equals(Object obj) {
        ...
        var other = (ReferenceTimeseriesValueObject)obj;
