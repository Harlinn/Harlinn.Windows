...
public class SimpleSByteTimeseriesValueDataReader extends ResultSetWrapper {
    ...
    public final static String BaseViewName = "SByteTimeseriesValueView";
    ...
    public SimpleSByteTimeseriesValueDataReader( ResultSet resultSet ) {
        super( resultSet );
    }
    ...
    public final Byte getValue() throws SQLException {
        return getNullableInt8( VALUE_FIELD_ID );
    }

    public void writeTo(BinaryWriter destination) throws SQLException {
        destination.writeInt32( Kind.SByteTimeseriesValue );
        destination.writeUInt8( ObjectState.Stored );
        destination.writeGuid( getId( ) );
        destination.writeInt64( getRowVersion( ) );
        destination.writeGuid( getTimeseries( ) );
        destination.writeDateTime( getTimestamp( ) );
        destination.writeNullableInt8( getValue( ) );
    }
