...
public class SimpleCameraCommandDataReader extends ResultSetWrapper {
    ...
    public SimpleCameraCommandDataReader( ResultSet resultSet ) {
        super( resultSet );
    }
    ...
    public void writeTo(BinaryWriter destination) throws SQLException {
        destination.writeInt32( Kind.CameraCommand );
