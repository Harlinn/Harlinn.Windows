...
public class Int32TimeseriesPropertyObject extends TimeseriesPropertyObject {
    ...
    public final int KIND = Kind.Int32TimeseriesProperty;

    private Guid _timeseries;

    public Int32TimeseriesPropertyObject( ) {
    }
    public Int32TimeseriesPropertyObject( byte objectState, Guid id, long rowVersion, Guid element, Guid definition, Guid timeseries ) {
    ...
    public void assignTo( AbstractDataObject target ) {
        ...
        var targetObject = ( Int32TimeseriesPropertyObject )target;
    ...
    public boolean equals(Object obj) {
        ...
        var other = (Int32TimeseriesPropertyObject)obj;
