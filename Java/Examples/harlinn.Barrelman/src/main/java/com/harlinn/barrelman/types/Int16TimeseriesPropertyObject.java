...
public class Int16TimeseriesPropertyObject extends TimeseriesPropertyObject {
    ...
    public final int KIND = Kind.Int16TimeseriesProperty;

    private Guid _timeseries;

    public Int16TimeseriesPropertyObject( ) {
    }
    public Int16TimeseriesPropertyObject( byte objectState, Guid id, long rowVersion, Guid element, Guid definition, Guid timeseries ) {
    ...
    public void assignTo( AbstractDataObject target ) {
        ...
        var targetObject = ( Int16TimeseriesPropertyObject )target;
    ...
    public boolean equals(Object obj) {
        ...
        var other = (Int16TimeseriesPropertyObject)obj;
