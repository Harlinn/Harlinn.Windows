...
public class SimpleWeatherStationCommandReplyDataReader extends ResultSetWrapper {
    ...
    public final static String BaseViewName = "WeatherStationCommandReplyView";
    public final static String ViewAliasName = "wscr";
    ...
    public SimpleWeatherStationCommandReplyDataReader( ResultSet resultSet ) {
        super( resultSet );
    }
    ...
    public void writeTo(BinaryWriter destination) throws SQLException {
        destination.writeInt32( Kind.WeatherStationCommandReply );
    ...
    public WeatherStationCommandReplyObject GetDataObject( ) throws SQLException {
            return new WeatherStationCommandReplyObject( ObjectState.Stored, getId( ), getRowVersion( ), getWeatherStation( ), getTimestamp( ), getCommand( ), getStatus( ), getMessage( ) );
    }
