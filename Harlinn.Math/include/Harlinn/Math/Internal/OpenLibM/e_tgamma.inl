...
namespace Harlinn::Math::Internal::OpenLibM
{
	namespace tgamma_internal
	{
		...
		*/
		constexpr double MAXGAML = 1755.455L;
		...
		*/
		...
		constexpr double MAXSTIR = 1024.0L;
		constexpr double SQTPI = 2.50662827463100050242E0L;
		...
		constexpr double PIL = 3.1415926535897932384626L;

		constexpr inline double stirf( double );

		/* Gamma function computed by Stirling's formula.
		 */
		constexpr inline double stirf( double x )
		{
			double y, w, v;
