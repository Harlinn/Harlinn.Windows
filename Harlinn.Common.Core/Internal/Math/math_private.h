 ...
 */
	inline void __scan_nan( uint32_t* __words, int __num_words, const char* __s );
...
#define	__ieee754_remainderf remainderf
	...
	constexpr inline int __kernel_rem_pio2( double*, double*, int, int, int );

	/* double precision kernel functions */
#ifdef INLINE_REM_PIO2
	__inline
#endif
	constexpr inline int __ieee754_rem_pio2( double, double* );
	constexpr inline double	__kernel_sin( double, double, int );
	constexpr inline double	__kernel_cos( double, double );
	constexpr inline double	__kernel_tan( double, double, int );
	constexpr inline double	__ldexp_exp( double, int );
	//double complex __ldexp_cexp( double complex, int );
	constexpr inline std::complex<double> __ldexp_cexp( std::complex<double>, int );

	/* float precision kernel functions */
#ifdef INLINE_REM_PIO2F
	__inline
#endif
	constexpr inline int	__ieee754_rem_pio2f( float, double* );
#ifdef INLINE_KERNEL_SINDF
	__inline
#endif
	constexpr inline float	__kernel_sindf( double );
#ifdef INLINE_KERNEL_COSDF
	__inline
#endif
	constexpr inline float	__kernel_cosdf( double );
#ifdef INLINE_KERNEL_TANDF
	__inline
#endif
	constexpr inline float	__kernel_tandf( double, int );
	constexpr inline float	__ldexp_expf( float, int );
	//float complex __ldexp_cexpf( float complex, int );
	constexpr inline std::complex<float> __ldexp_cexpf( std::complex<float>, int );

	/* long double precision kernel functions */
	constexpr inline long double __kernel_sinl( long double, long double, int );
	constexpr inline long double __kernel_cosl( long double, long double );
	constexpr inline long double __kernel_tanl( long double, long double, int );

	constexpr inline uint32_t Negate( uint32_t x )
	{
		return std::bit_cast< uint32_t >( -std::bit_cast< int32_t >( x ) );
	}
