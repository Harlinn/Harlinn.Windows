...
The code was originally published on [CodeProject.com](https://en.wikipedia.org/wiki/CodeProject) 
...
- [Harlinn.Math]() library.
  - [Fast Linear Algebra Classes for Games and Graphics](https://harlinn.github.io/Cpp/Cpp/Math/FastLinearAlgebra.html)
    ...
    that speeds up the rendering machinery. This image rendered in 459 seconds:
    
    <img src="./Readme/Images/lte-orb-silver.png" width="240"/>
   
    While this image rendered in 509 seconds using the original pbrt rendering machinery:
    ...
    to spot differences in functionality and performance.  
