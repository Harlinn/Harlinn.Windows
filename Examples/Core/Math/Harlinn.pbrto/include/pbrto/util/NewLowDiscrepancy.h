#pragma once
#ifndef PBRTO_UTIL_NEWLOWDISCREPANCY_H_
#define PBRTO_UTIL_NEWLOWDISCREPANCY_H_
...
namespace pbrto
{
    ...
    public:
        ...
        {
            NDCHECK_LT( digitIndex, nDigits );
            NDCHECK_LT( digitValue, base );
    ...
    PBRT_CPU_GPU inline uint32_t MultiplyGenerator( pstdo::span<const uint32_t> C, uint32_t a )
    {
        uint32_t v = 0;
    ...
    {
        NDCHECK_LT( dimension, NSobolDimensions );
        NDCHECK( a >= 0 && a < ( 1ull << SobolMatrixSize ) );
