...
PBRTO_EXPORT std::string FloatToString(float v);
PBRTO_EXPORT std::string DoubleToString(double v);
...
// base case
PBRTO_EXPORT void stringPrintfRecursive(std::string *s, const char *fmt);
...
PBRTO_EXPORT std::string copyToFormatString(const char **fmt_ptr, std::string *s);
