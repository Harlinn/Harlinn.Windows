...
namespace pbrto
{
    ...
    public:
        ...
        PBRT_CPU_GPU
#ifdef PBRT_USES_HCCMATH
            pstdo::optional<BSDFSample> Sample_f( const Vector3f& wo, Float uc, const Point2f& u, TransportMode mode, BxDFReflTransFlags sampleFlags = BxDFReflTransFlags::All ) const
#else
