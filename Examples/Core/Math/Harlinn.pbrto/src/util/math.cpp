...
template class PBRTO_EXPORT SquareMatrix<2>;
template PBRT_CPU_GPU PBRTO_EXPORT pstd::optional<SquareMatrix<2>> Inverse(const SquareMatrix<2> &);
template PBRT_CPU_GPU PBRTO_EXPORT SquareMatrix<2> operator*(const SquareMatrix<2> &m1, const SquareMatrix<2> &m2);
