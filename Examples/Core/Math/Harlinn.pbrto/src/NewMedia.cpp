...
namespace pbrto
{
    ...
    NSTAT_MEMORY_COUNTER( "Memory/Volume grids", volumeGridBytes );
    ...
    GridMedium::GridMedium( const Bounds3f& bounds, const Transform& renderFromMedium,
        ...
        SampledGrid<Float> d,
        pstdo::optional<SampledGrid<Float>> temperature,
    ...
    RGBGridMedium::RGBGridMedium( const Bounds3f& bounds, const Transform& renderFromMedium,
        Float g,
        pstdo::optional<SampledGrid<RGBUnboundedSpectrum>> rgbA,
        pstdo::optional<SampledGrid<RGBUnboundedSpectrum>> rgbS,
        Float sigmaScale,
        pstdo::optional<SampledGrid<RGBIlluminantSpectrum>> rgbLe,
    ...
    // For debugging: single, medium-wide majorant...
...
#else
        NLOG_VERBOSE( "Starting nanovdb grid GetMaxDensityGrid()" );
        ...
        NLOG_VERBOSE( "Finished nanovdb grid GetMaxDensityGrid()" );
#endif
    }
