...
define void @main() {
  ...
  %6 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %2, i32 0)  ; CBufferLoadLegacy(handle,regIndex)
  %7 = extractvalue %dx.types.CBufRet.f32 %6, 0
  %8 = extractvalue %dx.types.CBufRet.f32 %6, 1
  %9 = extractvalue %dx.types.CBufRet.f32 %6, 2
  %10 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %2, i32 1)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %18 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %2, i32 3)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %22 = fmul fast float %7, %3
  %23 = call float @dx.op.tertiary.f32(i32 46, float %11, float %4, float %22)  ; FMad(a,b,c)
  %24 = call float @dx.op.tertiary.f32(i32 46, float %15, float %5, float %23)  ; FMad(a,b,c)
  %25 = fadd fast float %24, %19
  %26 = fmul fast float %8, %3
  %27 = call float @dx.op.tertiary.f32(i32 46, float %12, float %4, float %26)  ; FMad(a,b,c)
  %28 = call float @dx.op.tertiary.f32(i32 46, float %16, float %5, float %27)  ; FMad(a,b,c)
  ...
  %32 = call float @dx.op.tertiary.f32(i32 46, float %17, float %5, float %31)  ; FMad(a,b,c)
  %33 = fadd fast float %32, %21
  %34 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %1, i32 0)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %44 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %1, i32 2)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %49 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %1, i32 3)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %54 = fmul fast float %35, %25
  %55 = call float @dx.op.tertiary.f32(i32 46, float %40, float %29, float %54)  ; FMad(a,b,c)
  %56 = call float @dx.op.tertiary.f32(i32 46, float %45, float %33, float %55)  ; FMad(a,b,c)
  %57 = fadd fast float %56, %50
  %58 = fmul fast float %36, %25
  %59 = call float @dx.op.tertiary.f32(i32 46, float %41, float %29, float %58)  ; FMad(a,b,c)
  %60 = call float @dx.op.tertiary.f32(i32 46, float %46, float %33, float %59)  ; FMad(a,b,c)
  %61 = fadd fast float %60, %51
  %62 = fmul fast float %37, %25
  %63 = call float @dx.op.tertiary.f32(i32 46, float %42, float %29, float %62)  ; FMad(a,b,c)
  %64 = call float @dx.op.tertiary.f32(i32 46, float %47, float %33, float %63)  ; FMad(a,b,c)
  %65 = fadd fast float %64, %52
  %66 = fmul fast float %38, %25
  %67 = call float @dx.op.tertiary.f32(i32 46, float %43, float %29, float %66)  ; FMad(a,b,c)
  %68 = call float @dx.op.tertiary.f32(i32 46, float %48, float %33, float %67)  ; FMad(a,b,c)
  %69 = fadd fast float %68, %53
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 0, float %57)  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 1, float %61)  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 2, float %65)  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
...
!8 = !{[5 x i32] [i32 3, i32 4, i32 15, i32 15, i32 15]}
...
const unsigned char g_pDepthOnlyVS[] = {
  0x44, 0x58, 0x42, 0x43, 0x09, 0x96, 0xe4, 0xc7, 0x3f, 0x46, 0x09, 0xf7,
  0x62, 0x0e, 0xce, 0xa3, 0x0d, 0xb2, 0x8b, 0xf0, 0x01, 0x00, 0x00, 0x00,
  0xa5, 0x11, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00,
