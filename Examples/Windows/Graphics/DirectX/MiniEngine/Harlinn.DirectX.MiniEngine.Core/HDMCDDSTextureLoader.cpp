...
#include "HDMCDDSTextureLoader.h"
...
{
    using DDS_HEADER = ::DirectX::DDS_HEADER;
    using DDS_PIXELFORMAT = ::DirectX::DDS_PIXELFORMAT;
    using DDS_HEADER_DXT10 = ::DirectX::DDS_HEADER_DXT10;
    const auto DDS_MAGIC = ::DirectX::DDS_MAGIC;
    constexpr auto DDS_RESOURCE_MISC_TEXTURECUBE = ::DirectX::DDS_RESOURCE_MISC_TEXTURECUBE;
    constexpr auto DDS_MISC_FLAGS2_ALPHA_MODE_MASK = ::DirectX::DDS_MISC_FLAGS2_ALPHA_MODE_MASK;
