...
define void @main() {
  ...
  %20 = fptosi float %8 to i32
  %21 = call float @dx.op.unary.f32(i32 27, float %4)  ; Round_ni(value)
  %22 = fptosi float %21 to i32
  %23 = add i32 %20, 1
  %24 = add i32 %20, 2
  %25 = add i32 %20, 3
  %26 = call %dx.types.ResRet.f32 @dx.op.textureLoad.f32(i32 66, %dx.types.Handle %1, i32 0, i32 %20, i32 %22, i32 undef, i32 undef, i32 undef, i32 undef)  ; TextureLoad(srv,mipLevelOrSampleCount,coord0,coord1,coord2,offset0,offset1,offset2)
  %27 = extractvalue %dx.types.ResRet.f32 %26, 0
  %28 = extractvalue %dx.types.ResRet.f32 %26, 1
  %29 = extractvalue %dx.types.ResRet.f32 %26, 2
  %30 = call %dx.types.ResRet.f32 @dx.op.textureLoad.f32(i32 66, %dx.types.Handle %1, i32 0, i32 %23, i32 %22, i32 undef, i32 undef, i32 undef, i32 undef)  ; TextureLoad(srv,mipLevelOrSampleCount,coord0,coord1,coord2,offset0,offset1,offset2)
  %31 = extractvalue %dx.types.ResRet.f32 %30, 0
  %32 = extractvalue %dx.types.ResRet.f32 %30, 1
  %33 = extractvalue %dx.types.ResRet.f32 %30, 2
  %34 = call %dx.types.ResRet.f32 @dx.op.textureLoad.f32(i32 66, %dx.types.Handle %1, i32 0, i32 %24, i32 %22, i32 undef, i32 undef, i32 undef, i32 undef)  ; TextureLoad(srv,mipLevelOrSampleCount,coord0,coord1,coord2,offset0,offset1,offset2)
  %35 = extractvalue %dx.types.ResRet.f32 %34, 0
  %36 = extractvalue %dx.types.ResRet.f32 %34, 1
  %37 = extractvalue %dx.types.ResRet.f32 %34, 2
  %38 = call %dx.types.ResRet.f32 @dx.op.textureLoad.f32(i32 66, %dx.types.Handle %1, i32 0, i32 %25, i32 %22, i32 undef, i32 undef, i32 undef, i32 undef)  ; TextureLoad(srv,mipLevelOrSampleCount,coord0,coord1,coord2,offset0,offset1,offset2)
...
!10 = !{[8 x i32] [i32 6, i32 3, i32 0, i32 7, i32 0, i32 0, i32 7, i32 0]}
...
const unsigned char g_pLanczosHorizontalPS[] = {
  0x44, 0x58, 0x42, 0x43, 0x2f, 0xb0, 0x3f, 0x03, 0xc0, 0xe0, 0xfc, 0x5a,
  0x58, 0x04, 0xc2, 0x02, 0x1e, 0xbb, 0x16, 0x22, 0x01, 0x00, 0x00, 0x00,
  0xa3, 0x1a, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00,
  ...
  0x82, 0x42, 0x0c, 0x28, 0x8b, 0x92, 0x0f, 0x28, 0x04, 0x3a, 0x4a, 0xa2,
  0x0c, 0x0a, 0x61, 0x04, 0xa0, 0x08, 0x28, 0x18, 0x01, 0xa0, 0x6f, 0x06,
  0x80, 0xc2, 0x19, 0x00, 0x12, 0x67, 0x00, 0x68, 0x1c, 0x0b, 0x31, 0x06,
  0xe0, 0x00, 0x80, 0x03, 0x00, 0x00, 0x00, 0x79, 0x18, 0x00, 0x00, 0x9a,
  ...
  0xa3, 0xdb, 0x20, 0x64, 0xc4, 0x86, 0xc5, 0x30, 0x83, 0x33, 0x40, 0x83,
  0x34, 0x50, 0x83, 0x41, 0x0d, 0x8c, 0x35, 0x60, 0x03, 0x22, 0x54, 0x65,
  0x78, 0x43, 0x6f, 0x6f, 0x72, 0x64, 0x13, 0x84, 0xc3, 0xdb, 0x20, 0x64,
  0xc3, 0x86, 0x65, 0x70, 0x83, 0x33, 0x58, 0x83, 0x34, 0x78, 0x83, 0xe1,
  ...
  0x41, 0x53, 0x48, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3a,
  0xeb, 0xed, 0x40, 0x2d, 0x90, 0x11, 0xf6, 0xca, 0xed, 0x2c, 0xeb, 0xc4,
  0x1d, 0x8d, 0x0a, 0x44, 0x58, 0x49, 0x4c, 0xd4, 0x0e, 0x00, 0x00, 0x62,
  0x00, 0x00, 0x00, 0xb5, 0x03, 0x00, 0x00, 0x44, 0x58, 0x49, 0x4c, 0x02,
  0x01, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0xbc, 0x0e, 0x00, 0x00, 0x42,
  0x43, 0xc0, 0xde, 0x21, 0x0c, 0x00, 0x00, 0xac, 0x03, 0x00, 0x00, 0x0b,
  0x82, 0x20, 0x00, 0x02, 0x00, 0x00, 0x00, 0x13, 0x00, 0x00, 0x00, 0x07,
  0x81, 0x23, 0x91, 0x41, 0xc8, 0x04, 0x49, 0x06, 0x10, 0x32, 0x39, 0x92,
  0x01, 0x84, 0x0c, 0x25, 0x05, 0x08, 0x19, 0x1e, 0x04, 0x8b, 0x62, 0x80,
  0x18, 0x45, 0x02, 0x42, 0x92, 0x0b, 0x42, 0xc4, 0x10, 0x32, 0x14, 0x38,
  ...
  0x01, 0xa0, 0x71, 0x2c, 0xc4, 0x18, 0x80, 0x03, 0x00, 0x0e, 0x00, 0x00,
  ...
  0x03, 0x9b, 0x20, 0x18, 0xd3, 0x06, 0x01, 0x0c, 0x88, 0x0d, 0x8b, 0xa2,
  0x6d, 0x5c, 0xe7, 0x0d, 0x9e, 0xf2, 0x85, 0x01, 0x11, 0xaa, 0x32, 0xbc,
  0xa1, 0xb7, 0x37, 0x39, 0xb2, 0x09, 0xc2, 0x91, 0x6d, 0x10, 0xc0, 0x60,
  ...
  0x20, 0x00, 0x00, 0xc0, 0x01, 0x00, 0x00, 0x13, 0x04, 0x41, 0x2c, 0x10,
  0x00, 0x00, 0x00, 0xd9, 0x00, 0x00, 0x00, 0x84, 0x8d, 0x00, 0xd0, 0x51,
  0x02, 0x64, 0x94, 0x4d, 0xb1, 0x94, 0x5d, 0xc9, 0x15, 0x61, 0x40, 0x79,
  ...
  
};
