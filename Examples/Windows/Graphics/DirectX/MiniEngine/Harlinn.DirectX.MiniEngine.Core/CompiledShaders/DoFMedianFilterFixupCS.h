...
; -------------------- ----- ------ -------- -------- ------- ------
; no parameters
; shader hash: 5852da845f3bee0730685e1f6b79d545
;
...
define void @main() {
  ...
  %9 = call %dx.types.ResRet.i32 @dx.op.rawBufferLoad.i32(i32 139, %dx.types.Handle %3, i32 %6, i32 0, i8 1, i32 4)  ; RawBufferLoad(srv,index,elementOffset,mask,alignment)
  ...
  %15 = add i32 %13, %7
  %16 = add i32 %14, %8
  %17 = call %dx.types.ResRet.f32 @dx.op.textureLoad.f32(i32 66, %dx.types.Handle %5, i32 0, i32 %15, i32 %16, i32 undef, i32 undef, i32 undef, i32 undef)  ; TextureLoad(srv,mipLevelOrSampleCount,coord0,coord1,coord2,offset0,offset1,offset2)
  %18 = extractvalue %dx.types.ResRet.f32 %17, 0
  %19 = extractvalue %dx.types.ResRet.f32 %17, 1
  %20 = extractvalue %dx.types.ResRet.f32 %17, 2
  call void @dx.op.textureStore.f32(i32 67, %dx.types.Handle %2, i32 %15, i32 %16, i32 undef, float %18, float %19, float %20, float %18, i8 15)  ; TextureStore(srv,coord0,coord1,coord2,value0,value1,value2,value3,mask)
  %21 = call %dx.types.ResRet.f32 @dx.op.textureLoad.f32(i32 66, %dx.types.Handle %4, i32 0, i32 %15, i32 %16, i32 undef, i32 undef, i32 undef, i32 undef)  ; TextureLoad(srv,mipLevelOrSampleCount,coord0,coord1,coord2,offset0,offset1,offset2)
  %22 = extractvalue %dx.types.ResRet.f32 %21, 0
  call void @dx.op.textureStore.f32(i32 67, %dx.types.Handle %1, i32 %15, i32 %16, i32 undef, float %22, float %22, float %22, float %22, i8 15)  ; TextureStore(srv,coord0,coord1,coord2,value0,value1,value2,value3,mask)
  ret void
}
...
const unsigned char g_pDoFMedianFilterFixupCS[] = {
  0x44, 0x58, 0x42, 0x43, 0x1b, 0x7c, 0x55, 0x35, 0x4e, 0xbd, 0x44, 0x1c,
  0xc1, 0x1f, 0xb8, 0x3a, 0x46, 0x66, 0xd1, 0x2c, 0x01, 0x00, 0x00, 0x00,
  0x7c, 0x12, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00,
  0x50, 0x00, 0x00, 0x00, 0x60, 0x00, 0x00, 0x00, 0x70, 0x00, 0x00, 0x00,
  0x38, 0x01, 0x00, 0x00, 0x7c, 0x02, 0x00, 0x00, 0x60, 0x0a, 0x00, 0x00,
  0x7c, 0x0a, 0x00, 0x00, 0x53, 0x46, 0x49, 0x30, 0x08, 0x00, 0x00, 0x00,
  ...
  ,
  ...
  0x9b, 0x9b, 0x22, 0xb4, 0x81, 0x1c, 0xd4, 0x21, 0xc3, 0x73, 0x29, 0x73,
  0xa3, 0x93, 0xcb, 0x83, 0x7a, 0x4b, 0x73, 0xa3, 0x9b, 0x9b, 0x12, 0xe0,
  0x41, 0x17, 0x32, 0x3c, 0x97, 0xb1, 0xb7, 0x3a, 0x37, 0xba, 0x32, 0xb9,
  0xb9, 0x29, 0xc1, 0x1f, 0x00, 0x00, 0x00, 0x00, 0x79, 0x18, 0x00, 0x00,
  ...
  0x00, 0x00, 0x00, 0x00, 0x58, 0x52, 0xda, 0x84, 0x5f, 0x3b, 0xee, 0x07,
  0x30, 0x68, 0x5e, 0x1f, 0x6b, 0x79, 0xd5, 0x45, 0x44, 0x58, 0x49, 0x4c,
  0xf8, 0x07, 0x00, 0x00, 0x62, 0x00, 0x05, 0x00, 0xfe, 0x01, 0x00, 0x00,
  0x44, 0x58, 0x49, 0x4c, 0x02, 0x01, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00,
  0xe0, 0x07, 0x00, 0x00, 0x42, 0x43, 0xc0, 0xde, 0x21, 0x0c, 0x00, 0x00,
  0xf5, 0x01, 0x00, 0x00, 0x0b, 0x82, 0x20, 0x00, 0x02, 0x00, 0x00, 0x00,
  ...
  0x0a, 0xa3, 0x10, 0x0a, 0x82, 0xa4, 0x11, 0x00, 0x1a, 0x0b, 0x84, 0xb8,
  0x19, 0x00, 0xf2, 0x66, 0x00, 0x08, 0x9c, 0x01, 0x20, 0x71, 0x06, 0x80,
  0xb2, 0x19, 0x00, 0x00, 0x79, 0x18, 0x00, 0x00, 0x4d, 0x00, 0x00, 0x00,
  ...
  ,
  ...
  0x43, 0x68, 0x5a, 0x35, 0x62, 0x90, 0x00, 0x20, 0x08, 0x06, 0xd3, 0xe7,
  0x10, 0x5d, 0x67, 0x8d, 0x18, 0x24, 0x00, 0x08, 0x82, 0xc1, 0x04, 0x06,
  0x4f, 0xf1, 0x7d, 0xd7, 0x88, 0x41, 0x02, 0x80, 0x20, 0x18, 0x4c, 0x61,
  0x00, 0x19, 0x5d, 0x87, 0x8d, 0x18, 0x18, 0x00, 0x08, 0x82, 0x01, 0x71,
  0x06, 0x8c, 0x37, 0x62, 0x60, 0x00, 0x20, 0x08, 0x06, 0xc4, 0x19, 0x44,
  0xdf, 0x88, 0x81, 0x01, 0x80, 0x20, 0x18, 0x10, 0x68, 0x20, 0x8d, 0xc1,
  0x88, 0x81, 0x02, 0x80, 0x20, 0x18, 0x28, 0x68, 0xe0, 0x18, 0x43, 0x18,
  0x2c, 0xde, 0x68, 0x42, 0x00, 0x54, 0xf0, 0x60, 0x09, 0xd5, 0x55, 0x00,
  0xa9, 0x0d, 0xd7, 0x0d, 0x4a, 0x40, 0xa0, 0x04, 0x04, 0x46, 0x0c, 0x1a,
  0x00, 0x04, 0xc1, 0x00, 0x72, 0x83, 0x8c, 0x49, 0x03, 0x21, 0xe8, 0xba,
  ...
  0xe4, 0xa0, 0x8b, 0xda, 0xc0, 0x28, 0xc2, 0x20, 0x0c, 0xc2, 0x20, 0x0c,
