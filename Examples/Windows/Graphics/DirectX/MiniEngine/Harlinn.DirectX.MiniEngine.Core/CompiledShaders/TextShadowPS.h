...
;
; shader hash: 00ea78a44e59f3fa89a05cbb42e5ecdd
;
...
define void @main() {
  ...
  %6 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %3, i32 2)  ; CBufferLoadLegacy(handle,regIndex)
  %7 = extractvalue %dx.types.CBufRet.f32 %6, 0
  %8 = call %dx.types.ResRet.f32 @dx.op.sample.f32(i32 60, %dx.types.Handle %1, %dx.types.Handle %2, float %4, float %5, float undef, float undef, i32 0, i32 0, i32 undef, float undef)  ; Sample(srv,sampler,coord0,coord1,coord2,coord3,offset0,offset1,offset2,clamp)
  ...
  %13 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %3, i32 0)  ; CBufferLoadLegacy(handle,regIndex)
  %14 = extractvalue %dx.types.CBufRet.f32 %13, 3
  %15 = fmul fast float %14, %12
  %16 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %3, i32 1)  ; CBufferLoadLegacy(handle,regIndex)
  %17 = extractvalue %dx.types.CBufRet.f32 %16, 2
  %18 = fmul fast float %17, %7
  %19 = extractvalue %dx.types.CBufRet.f32 %16, 0
  %20 = extractvalue %dx.types.CBufRet.f32 %16, 1
  %21 = fsub fast float %4, %19
  %22 = fsub fast float %5, %20
  ...
  %25 = fmul fast float %18, %24
  %26 = fadd fast float %25, 5.000000e-01
  %27 = call float @dx.op.unary.f32(i32 7, float %26)  ; Saturate(value)
  %28 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %3, i32 1)  ; CBufferLoadLegacy(handle,regIndex)
  %29 = extractvalue %dx.types.CBufRet.f32 %28, 3
  %30 = fmul fast float %29, %27
  %31 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %3, i32 0)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %36 = extractvalue %dx.types.CBufRet.f32 %31, 2
  %37 = fmul fast float %34, %15
  %38 = fmul fast float %35, %15
  %39 = fmul fast float %36, %15
  %40 = fsub fast float 1.000000e+00, %33
...
!7 = !{i32 0, i32 9}
!8 = !{!9}
!9 = !{i32 0, %cbFontParams* undef, !"", i32 0, i32 0, i32 1, i32 36, null}
!10 = !{!11}
...
const unsigned char g_pTextShadowPS[] = {
  0x44, 0x58, 0x42, 0x43, 0x0d, 0x12, 0xb6, 0xfe, 0x7b, 0xdd, 0xab, 0x99,
  0x27, 0x3c, 0x59, 0x2c, 0xfa, 0x0c, 0x05, 0x10, 0x01, 0x00, 0x00, 0x00,
  0x53, 0x12, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00,
  0x50, 0x00, 0x00, 0x00, 0xb5, 0x00, 0x00, 0x00, 0xef, 0x00, 0x00, 0x00,
  0xe7, 0x01, 0x00, 0x00, 0x97, 0x02, 0x00, 0x00, 0x47, 0x0a, 0x00, 0x00,
  ...
  0x00, 0x00, 0x00, 0x53, 0x54, 0x41, 0x54, 0xa8, 0x07, 0x00, 0x00, 0x62,
  0x00, 0x00, 0x00, 0xea, 0x01, 0x00, 0x00, 0x44, 0x58, 0x49, 0x4c, 0x02,
  0x01, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x90, 0x07, 0x00, 0x00, 0x42,
  0x43, 0xc0, 0xde, 0x21, 0x0c, 0x00, 0x00, 