...
AS
 SELECT
  ...
  [AisDeviceConfiguration].[Filter],
  [AisDeviceConfiguration].[NorthWestLatitude],
  [AisDeviceConfiguration].[NorthWestLongitude],
  [AisDeviceConfiguration].[SouthEastLatitude],
  [AisDeviceConfiguration].[SouthEastLongitude],
  [AisDeviceConfiguration].[ComPort],
  [AisDeviceConfiguration].[BaudRate],
  [AisDeviceConfiguration].[IPAddress],
  [AisDeviceConfiguration].[Port],
  [AisDeviceConfiguration].[UdpPort],
  [AisDeviceConfiguration].[Authenticate],
  [AisDeviceConfiguration].[UserName],
  [AisDeviceConfiguration].[Password],
  [AisDeviceConfiguration].[AuthenticationURL],
  [AisDeviceConfiguration].[ConnectionType],
  [AisDeviceConfiguration].[SourceUpdateRate],
  [AisDeviceConfiguration].[ConfigurationURL],
...
AS
 SELECT
  ...
  [CameraConfiguration].[CameraURL],
  [CameraConfiguration].[ConfigurationURL],
  [CameraConfiguration].[UserName],
  [CameraConfiguration].[Password],
